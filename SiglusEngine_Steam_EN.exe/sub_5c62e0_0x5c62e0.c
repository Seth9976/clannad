            ...
            do
                ...
                if (eax_2.b != 0)
                    if (eax_2 == 0xff)
                        ...
                        *edi_1 = eax_4.b + (*(((ebx_4 - eax_4) << 2) + data_1cd4384)).b
                        int32_t ebx_9
                        ebx_9.b = esi_1[1]
                        int32_t eax_6 = data_1cd4388
                        edi_1[1] = eax_6.b + (*(((ebx_9 - eax_6) << 2) + data_1cd438c)).b
                        int32_t ebx_14
                        ebx_14.b = esi_1[2]
                        int32_t eax_8 = data_1cd4390
                        eax_2 = eax_8 + *(((ebx_14 - eax_8) << 2) + data_1cd4394)
                        edi_1[2] = eax_2.b
                    else
                        int32_t edx_1 = *((eax_2 << 2) + data_1cd4328)
                        int32_t ebx_19
                        ebx_19.b = *esi_1
                        int32_t eax_9 = data_1cd4380
                        int32_t eax_11
                        eax_11.b = *edi_1
                        *edi_1 = eax_11.b + (*(((eax_9 + *(((ebx_19 - eax_9) << 2) + data_1cd4384)
                            - eax_11) << 2) + edx_1)).b
                        int32_t ebx_27
                        ebx_27.b = esi_1[1]
                        int32_t eax_13 = data_1cd4388
                        int32_t eax_15
                        eax_15.b = edi_1[1]
                        edi_1[1] = eax_15.b + (*(((eax_13
                            + *(((ebx_27 - eax_13) << 2) + data_1cd438c) - eax_15) << 2) + edx_1)).b
                        int32_t ebx_35
                        ebx_35.b = esi_1[2]
                        int32_t eax_17 = data_1cd4390
                        int32_t eax_19
                        eax_19.b = edi_1[2]
                        eax_2 = eax_19 + *(((eax_17 + *(((ebx_35 - eax_17) << 2) + data_1cd4394)
                            - eax_19) << 2) + edx_1)
                        edi_1[2] = eax_2.b
            ...
            do
                ...
                if (eax_20.b != 0)
                    if (eax_20 == 0xff)
                        ...
                        *edi_4 = eax_22.b + (*(((ebx_48 - eax_22) << 2) + data_1cd4384)).b
                        int32_t ebx_53
                        ebx_53.b = *(esi_4 + 1)
                        int32_t eax_24 = data_1cd4388
                        edi_4[1] = eax_24.b + (*(((ebx_53 - eax_24) << 2) + data_1cd438c)).b
                        int32_t ebx_58
                        ebx_58.b = *(esi_4 + 2)
                        int32_t eax_26 = data_1cd4390
                        eax_20 = eax_26 + *(((ebx_58 - eax_26) << 2) + data_1cd4394)
                        edi_4[2] = eax_20.b
                    else
                        int32_t edx_2 = *((eax_20 << 2) + data_1cd4328)
                        int32_t ebx_63
                        ebx_63.b = *esi_4
                        int32_t eax_27 = data_1cd4380
                        int32_t eax_29
                        eax_29.b = *edi_4
                        *edi_4 = eax_29.b + (*(((eax_27 + *(((ebx_63 - eax_27) << 2) + data_1cd4384)
                            - eax_29) << 2) + edx_2)).b
                        int32_t ebx_71
                        ebx_71.b = *(esi_4 + 1)
                        ...
                        edi_4[1] = eax_33.b + (*(((eax_31
                            + *(((ebx_71 - eax_31) << 2) + data_1cd438c) - eax_33) << 2) + edx_2)).b
                        int32_t ebx_79
                        ebx_79.b = *(esi_4 + 2)
                        int32_t eax_35 = data_1cd4390
                        int32_t eax_37
                        eax_37.b = edi_4[2]
                        eax_20 = eax_37 + *(((eax_35 + *(((ebx_79 - eax_35) << 2) + data_1cd4394)
                            - eax_37) << 2) + edx_2)
                        edi_4[2] = eax_20.b
        ...
        do
            ...
            if (eax_38.b != 0)
                if (eax_38 == 0xff)
                    ...
                    *edi_7 = eax_40.b + (*(((ebx_93 - eax_40) << 2) + data_1cd4384)).b
                    int32_t ebx_98
                    ebx_98.b = *(esi_6 + 1)
                    int32_t eax_42 = data_1cd4388
                    edi_7[1] = eax_42.b + (*(((ebx_98 - eax_42) << 2) + data_1cd438c)).b
                    int32_t ebx_103
                    ebx_103.b = *(esi_6 + 2)
                    int32_t eax_44 = data_1cd4390
                    eax_38 = eax_44 + *(((ebx_103 - eax_44) << 2) + data_1cd4394)
                    edi_7[2] = eax_38.b
                else
                    int32_t edx_3 = *((eax_38 << 2) + data_1cd4328)
                    int32_t ebx_108
                    ebx_108.b = *esi_6
                    int32_t eax_45 = data_1cd4380
                    int32_t eax_47
                    eax_47.b = *edi_7
                    *edi_7 = eax_47.b + (*(((eax_45 + *(((ebx_108 - eax_45) << 2) + data_1cd4384)
                        - eax_47) << 2) + edx_3)).b
                    int32_t ebx_116
                    ebx_116.b = *(esi_6 + 1)
                    ...
                    int32_t eax_51
                    eax_51.b = edi_7[1]
                    edi_7[1] = eax_51.b + (*(((eax_49 + *(((ebx_116 - eax_49) << 2) + data_1cd438c)
                        - eax_51) << 2) + edx_3)).b
                    int32_t ebx_124
                    ebx_124.b = *(esi_6 + 2)
                    ...
                    int32_t eax_55
                    eax_55.b = edi_7[2]
                    eax_38 = eax_55 + *(((eax_53 + *(((ebx_124 - eax_53) << 2) + data_1cd4394)
                        - eax_55) << 2) + edx_3)
                    edi_7[2] = eax_38.b
            ...
            do
                ...
                if (eax_56.b != 0)
                    if (eax_56 == 0xff)
                        ...
                        *edi_10 = eax_58.b + (*(((ebx_137 - eax_58) << 2) + data_1cd4384)).b
                        int32_t ebx_142
                        ebx_142.b = *(esi_8 + 1)
                        int32_t eax_60 = data_1cd4388
                        edi_10[1] = eax_60.b + (*(((ebx_142 - eax_60) << 2) + data_1cd438c)).b
                        int32_t ebx_147
                        ebx_147.b = *(esi_8 + 2)
                        int32_t eax_62 = data_1cd4390
                        eax_56 = eax_62 + *(((ebx_147 - eax_62) << 2) + data_1cd4394)
                        edi_10[2] = eax_56.b
                    else
                        ...
                        *edi_10 = eax_65.b + (*(((eax_63
                            + *(((ebx_152 - eax_63) << 2) + data_1cd4384) - eax_65) << 2) + edx_5)).b
                        int32_t ebx_160
                        ebx_160.b = *(esi_8 + 1)
                        int32_t eax_67 = data_1cd4388
                        int32_t eax_69
                        eax_69.b = edi_10[1]
                        edi_10[1] = eax_69.b + (*(((eax_67
                            + *(((ebx_160 - eax_67) << 2) + data_1cd438c) - eax_69) << 2) + edx_5)).b
                        int32_t ebx_168
                        ebx_168.b = *(esi_8 + 2)
                        int32_t eax_71 = data_1cd4390
                        int32_t eax_73
                        eax_73.b = edi_10[2]
                        eax_56 = eax_73 + *(((eax_71 + *(((ebx_168 - eax_71) << 2) + data_1cd4394)
                            - eax_73) << 2) + edx_5)
                        edi_10[2] = eax_56.b
            ...
            do
                ...
                if (eax_74.b != 0)
                    if (eax_74 == 0xff)
                        ...
                        *edi_13 = eax_76.b + (*(((ebx_181 - eax_76) << 2) + data_1cd4384)).b
                        int32_t ebx_186
                        ebx_186.b = *(esi_11 + 1)
                        int32_t eax_78 = data_1cd4388
                        edi_13[1] = eax_78.b + (*(((ebx_186 - eax_78) << 2) + data_1cd438c)).b
                        int32_t ebx_191
                        ebx_191.b = *(esi_11 + 2)
                        int32_t eax_80 = data_1cd4390
                        eax_74 = eax_80 + *(((ebx_191 - eax_80) << 2) + data_1cd4394)
                        edi_13[2] = eax_74.b
                    else
                        int32_t edx_8 = *((eax_74 << 2) + data_1cd4328)
                        int32_t ebx_196
                        ebx_196.b = *esi_11
                        int32_t eax_81 = data_1cd4380
                        int32_t eax_83
                        eax_83.b = *edi_13
                        *edi_13 = eax_83.b + (*(((eax_81
                            + *(((ebx_196 - eax_81) << 2) + data_1cd4384) - eax_83) << 2) + edx_8)).b
                        int32_t ebx_204
                        ebx_204.b = *(esi_11 + 1)
                        ...
                        edi_13[1] = eax_87.b + (*(((eax_85
                            + *(((ebx_204 - eax_85) << 2) + data_1cd438c) - eax_87) << 2) + edx_8)).b
                        int32_t ebx_212
                        ebx_212.b = *(esi_11 + 2)
                        int32_t eax_89 = data_1cd4390
                        int32_t eax_91
                        eax_91.b = edi_13[2]
                        eax_74 = eax_91 + *(((eax_89 + *(((ebx_212 - eax_89) << 2) + data_1cd4394)
                            - eax_91) << 2) + edx_8)
                        edi_13[2] = eax_74.b
        ...
        do
            ...
            if (eax_92.b != 0)
                if (eax_92 == 0xff)
                    ...
                    *edi_16 = eax_94.b + (*(((ebx_226 - eax_94) << 2) + data_1cd4384)).b
                    int32_t ebx_231
                    ebx_231.b = *(esi_13 + 1)
                    int32_t eax_96 = data_1cd4388
                    edi_16[1] = eax_96.b + (*(((ebx_231 - eax_96) << 2) + data_1cd438c)).b
                    int32_t ebx_236
                    ebx_236.b = *(esi_13 + 2)
                    int32_t eax_98 = data_1cd4390
                    eax_92 = eax_98 + *(((ebx_236 - eax_98) << 2) + data_1cd4394)
                    edi_16[2] = eax_92.b
                else
                    int32_t edx_11 = *((eax_92 << 2) + data_1cd4328)
                    int32_t ebx_241
                    ebx_241.b = *esi_13
                    int32_t eax_99 = data_1cd4380
                    int32_t eax_101
                    eax_101.b = *edi_16
                    *edi_16 = eax_101.b + (*(((eax_99 + *(((ebx_241 - eax_99) << 2) + data_1cd4384)
                        - eax_101) << 2) + edx_11)).b
                    int32_t ebx_249
                    ebx_249.b = *(esi_13 + 1)
                    int32_t eax_103 = data_1cd4388
                    int32_t eax_105
                    eax_105.b = edi_16[1]
                    edi_16[1] = eax_105.b + (*(((eax_103
                        + *(((ebx_249 - eax_103) << 2) + data_1cd438c) - eax_105) << 2) + edx_11)).b
                    int32_t ebx_257
                    ebx_257.b = *(esi_13 + 2)
                    int32_t eax_107 = data_1cd4390
                    int32_t eax_109
                    eax_109.b = edi_16[2]
                    eax_92 = eax_109 + *(((eax_107 + *(((ebx_257 - eax_107) << 2) + data_1cd4394)
                        - eax_109) << 2) + edx_11)
                    edi_16[2] = eax_92.b
    ...
    label_5c5ea7:
        ...
        if (eax_110.b != 0)
            if (eax_110 == 0xff)
                ...
                *edi_19 = eax_112.b + (*(((ebx_270 - eax_112) << 2) + data_1cd4384)).b
                int32_t ebx_275
                ebx_275.b = *(esi_15 + 1)
                int32_t eax_114 = data_1cd4388
                edi_19[1] = eax_114.b + (*(((ebx_275 - eax_114) << 2) + data_1cd438c)).b
                int32_t ebx_280
                ebx_280.b = *(esi_15 + 2)
                int32_t eax_116 = data_1cd4390
                eax_110 = eax_116 + *(((ebx_280 - eax_116) << 2) + data_1cd4394)
                edi_19[2] = eax_110.b
            else
                int32_t edx_14 = *((eax_110 << 2) + data_1cd4328)
                int32_t ebx_285
                ebx_285.b = *esi_15
                int32_t eax_117 = data_1cd4380
                int32_t eax_119
                eax_119.b = *edi_19
                *edi_19 = eax_119.b + (*(((eax_117 + *(((ebx_285 - eax_117) << 2) + data_1cd4384)
                    - eax_119) << 2) + edx_14)).b
                int32_t ebx_293
                ebx_293.b = *(esi_15 + 1)
                int32_t eax_121 = data_1cd4388
                int32_t eax_123
                eax_123.b = edi_19[1]
                edi_19[1] = eax_123.b + (*(((eax_121 + *(((ebx_293 - eax_121) << 2) + data_1cd438c)
                    - eax_123) << 2) + edx_14)).b
                int32_t ebx_301
                ebx_301.b = *(esi_15 + 2)
                ...
                int32_t eax_127
                eax_127.b = edi_19[2]
                eax_110 = eax_127 + *(((eax_125 + *(((ebx_301 - eax_125) << 2) + data_1cd4394)
                    - eax_127) << 2) + edx_14)
                edi_19[2] = eax_110.b
    ...
    label_5c600e:
        ...
        if (eax_128.b != 0)
            if (eax_128 == 0xff)
                ...
                *edi_22 = eax_130.b + (*(((ebx_314 - eax_130) << 2) + data_1cd4384)).b
                int32_t ebx_319
                ebx_319.b = *(esi_18 + 1)
                int32_t eax_132 = data_1cd4388
                edi_22[1] = eax_132.b + (*(((ebx_319 - eax_132) << 2) + data_1cd438c)).b
                int32_t ebx_324
                ebx_324.b = *(esi_18 + 2)
                int32_t eax_134 = data_1cd4390
                eax_128 = eax_134 + *(((ebx_324 - eax_134) << 2) + data_1cd4394)
                edi_22[2] = eax_128.b
            else
                int32_t edx_17 = *((eax_128 << 2) + data_1cd4328)
                int32_t ebx_329
                ebx_329.b = *esi_18
                int32_t eax_135 = data_1cd4380
                int32_t eax_137
                eax_137.b = *edi_22
                *edi_22 = eax_137.b + (*(((eax_135 + *(((ebx_329 - eax_135) << 2) + data_1cd4384)
                    - eax_137) << 2) + edx_17)).b
                int32_t ebx_337
                ebx_337.b = *(esi_18 + 1)
                int32_t eax_139 = data_1cd4388
                int32_t eax_141
                eax_141.b = edi_22[1]
                edi_22[1] = eax_141.b + (*(((eax_139 + *(((ebx_337 - eax_139) << 2) + data_1cd438c)
                    - eax_141) << 2) + edx_17)).b
                int32_t ebx_345
                ebx_345.b = *(esi_18 + 2)
                ...
                int32_t eax_145
                eax_145.b = edi_22[2]
                eax_128 = eax_145 + *(((eax_143 + *(((ebx_345 - eax_143) << 2) + data_1cd4394)
                    - eax_145) << 2) + edx_17)
                edi_22[2] = eax_128.b
    ...
    label_5c618e:
        ...
        if (eax_146.b != 0)
            if (eax_146 == 0xff)
                ...
                *edi_25 = eax_148.b + (*(((ebx_359 - eax_148) << 2) + data_1cd4384)).b
                int32_t ebx_364
                ebx_364.b = *(esi_20 + 1)
                int32_t eax_150 = data_1cd4388
                edi_25[1] = eax_150.b + (*(((ebx_364 - eax_150) << 2) + data_1cd438c)).b
                int32_t ebx_369
                ebx_369.b = *(esi_20 + 2)
                int32_t eax_152 = data_1cd4390
                eax_146 = eax_152 + *(((ebx_369 - eax_152) << 2) + data_1cd4394)
                edi_25[2] = eax_146.b
            else
                int32_t edx_20 = *((eax_146 << 2) + data_1cd4328)
                int32_t ebx_374
                ebx_374.b = *esi_20
                int32_t eax_153 = data_1cd4380
                int32_t eax_155
                eax_155.b = *edi_25
                *edi_25 = eax_155.b + (*(((eax_153 + *(((ebx_374 - eax_153) << 2) + data_1cd4384)
                    - eax_155) << 2) + edx_20)).b
                int32_t ebx_382
                ebx_382.b = *(esi_20 + 1)
                int32_t eax_157 = data_1cd4388
                int32_t eax_159
                eax_159.b = edi_25[1]
                edi_25[1] = eax_159.b + (*(((eax_157 + *(((ebx_382 - eax_157) << 2) + data_1cd438c)
                    - eax_159) << 2) + edx_20)).b
                int32_t ebx_390
                ebx_390.b = *(esi_20 + 2)
                ...
                int32_t eax_163
                eax_163.b = edi_25[2]
                eax_146 = eax_163 + *(((eax_161 + *(((ebx_390 - eax_161) << 2) + data_1cd4394)
                    - eax_163) << 2) + edx_20)
                edi_25[2] = eax_146.b
