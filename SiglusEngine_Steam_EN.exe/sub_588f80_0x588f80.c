...
do
    ...
    do
        ...
        *edi = eax_9.b +
            (*(((eax_7 + *(((ebx_7 - eax_7) << 2) + data_1cd4444) - eax_9) << 2) + data_1cd43b0)).b
        int32_t eax_11 = data_1cd44cc
        int32_t ebx_15
        ebx_15.b = edi[1]
        int32_t eax_13 = data_1cd44b8
        edi[1] = eax_13.b + (
            *(((eax_11 + *(((ebx_15 - eax_11) << 2) + data_1cd4444) - eax_13) << 2) + data_1cd43b0)).b
        int32_t eax_15 = data_1cd44cc
        int32_t ebx_23
        ebx_23.b = edi[2]
        int32_t eax_17 = data_1cd44b4
        result = eax_17.b + (
            *(((eax_15 + *(((ebx_23 - eax_15) << 2) + data_1cd4444) - eax_17) << 2) + data_1cd43b0)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
