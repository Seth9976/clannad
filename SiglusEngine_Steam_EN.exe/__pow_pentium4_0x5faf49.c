...
uint64_t xmm7_2[0x2] = xmm7_1 f* *((eax_3 << 2) + &data_6080b0)
double xmm5 = *((eax_3 << 2) + &data_6080b0)
double xmm6[0x2] = *(eax_3 * 8 + &data_6084c0)
double var_c
int32_t ecx_3
int32_t edx_1
uint32_t edx_2
...
if (((ecx - 0x10) | (0x7fef - ecx)) u>= 0x80000000)
    ...
    if (ecx_7 u>= 0x7ff00000)
        ...
        label_5fb753:
            var_c = xmm0_26
            sub_5f8379(&arg2, &arg3, &var_c, edx_17)
    ...
    label_5fb3f2:
        ...
        label_5fb418:
            ...
            xmm4 = xmm0.q
            xmm0 = _mm_srli_epi64(__andpd_xmmxuq_memxuq(xmm0, data_60b960), 0x2c)
            int32_t eax_39 = (zx.d(_mm_extract_epi16(xmm0, 0)) + 1) & 0x1fe
            xmm7_2 = _mm_or_pd(xmm7_15, xmm2_25) f* *((eax_39 << 2) + &data_6080b0)
            xmm5 = *((eax_39 << 2) + &data_6080b0)
            xmm6 = *(eax_39 * 8 + &data_6084c0)
            edx_1 = 0x43e7f
            goto label_5fafd3
    else
        ...
        if (edx_10 u>= 0x7ff0)
            ...
            if (zx.d(eax_29) == 0xff)
                eax_45 = zx.d(_mm_movemask_epi8(_mm_cmpeq_epi32(
                    _mm_sll_epi64(arg3, 
                        _mm_sub_epi32(
                            _mm_srli_epi64(__andpd_xmmxuq_memxuq(arg3, data_60b960), 0x34), 
                            0x3f4)), 
                    zx.o(0))))
        ...
        if (zx.d(eax_29) == 0xff)
            ecx_3 = (0x3ff01 + zx.d(_mm_movemask_epi8(_mm_cmpeq_epi32(
                _mm_sll_epi64(arg3, 
                    _mm_sub_epi32(_mm_srli_epi64(__andpd_xmmxuq_memxuq(arg3, data_60b960), 0x34), 
                        0x3f4)), 
...
uint64_t xmm4_1[0x2] = __andpd_xmmxuq_memxuq(xmm4, data_60b940)
int32_t eax_8 = (zx.d(eax_5) + 1) & 0x1fe
uint64_t xmm3_2[0x2] = xmm7_2.q f* *((eax_8 << 2) + &data_608cd0)
double xmm5_1 = xmm5 f* *((eax_8 << 2) + &data_608cd0)
double xmm6_1 = __addpd_xmmpd_mempd(xmm6, *(eax_8 * 8 + &data_6090e0))
uint64_t xmm4_2[0x2] = __orpd_xmmxuq_memxuq(xmm4_1, data_60b950)
...
uint64_t xmm5_2[0x2] = xmm5_1 f* *((eax_13 << 2) + &data_6098f0)
double xmm2_2 = xmm3_2.q f* *((eax_13 << 2) + &data_6098f0)
double xmm6_3 = __addpd_xmmpd_mempd(xmm6_1 + xmm0_3, *((eax_13 << 3) + &data_60a100))
...
if (((0x40a0 - eax_17) | (eax_17 - 0x3c70)) u< 0x80000000
    ...
    if (((0x1ff7f - eax_19) | (eax_19 + 0x1e1ff)) s> 0)
        ...
        double xmm3_11[0x2] = *((eax_19 & 0x7f) * 0x10 + 0x60b130)
        double xmm6_8[0x2] = data_60b970
        ...
        double xmm7_10[0x2] = data_60b980
    ...
    label_5fb7eb:
        ...
        double xmm3_23[0x2] = *(eax_68 * 0x10 + 0x60b130)
        double xmm6_12[0x2] = data_60b970
        ...
        double xmm7_20[0x2] = data_60b980
