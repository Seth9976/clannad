...
sub_55a6a0(eax_1, arg1, 0x2b, 0x621374)
HWND hDlg_1 = data_1af0abc
HWND hDlg = hDlg_1

if (data_1316d38 == 0)
    UpdateWindow(hDlg_1)
    SetWindowPos(hDlg_1, 0xfffffffe, data_1316d40, data_1316d44, data_1316d48, data_1316d4c, 
        SWP_SHOWWINDOW)
    hDlg_1 = data_1af0abc
...
if (GetDlgItem(hDlg_1, 0x4f32) != 0)
    ...
    sub_55a710(SendMessageA(hWnd, 0x1036, 0, SendMessageA(hWnd, 0x1037, 0, 0) | 0x21), 0x4f32, 
        hDlg_1, data_1316d38, &data_1316d38, 2, &data_63f888, 0x63f854)
...
int32_t result
int32_t ecx_1
result, ecx_1 = sub_4d1ba0(eax_6, 0x804, &data_20c3e70, 0xa5)
data_20c3e70 = 1

if (data_1316d38 == 0)
    int32_t var_160_4 = ecx_1
    result = sub_4c1470(result, data_1316d54, data_1316d50, hDlg, 0x4f32)
