...
if (z)
    ...
    if (data_640fb4 == 0)
        return __startOneArgErrorHandling(eax, 0x1e, result, 0x640130, var_4)
else
    int16_t x87control
    int16_t x87status_1
    ...
    if (test_bit(arg1:1.b, 2))
        ...
        long double x87_r0 = data_60ba8a
    ...
    if (data_640fb4 == 0)
        ...
        if (arg1.w != 0x27f)
            ...
            if (arg1.w != 0)
                ...
                if (arg1.w != 0)
                    return __startOneArgErrorHandling(8, 0x1e, result, 0x640130, var_4)
