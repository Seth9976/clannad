...
do
    ...
    do
        ...
        eax_9.b = *edi
        *edi = eax_9.b
            + (*(((eax_7 + *(((ebx_7 - eax_7) << 2) + data_1cd4444) - eax_9) << 2) + esi_5)).b
        ...
        eax_13.b = edi[1]
        edi[1] = eax_13.b
            + (*(((eax_11 + *(((ebx_15 - eax_11) << 2) + data_1cd4444) - eax_13) << 2) + esi_5)).b
        ...
        eax_17.b = edi[2]
        result = eax_17.b
            + (*(((eax_15 + *(((ebx_23 - eax_15) << 2) + data_1cd4444) - eax_17) << 2) + esi_5)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
