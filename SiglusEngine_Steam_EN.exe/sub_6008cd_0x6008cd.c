...
label_6009de:
    ...
    if ((ecx_1 & 0x100) != 0)
        ...
        if (((not.d(data_640fd8)).b & arg6) s>= 0)
            edx_1 = 1
            var_1c_1 = 1
    ...
    *arg1 = 1
    HANDLE hFile = sub_600845(arg3, var_c_1, var_10_1, &var_3c, esi_1, var_1c_1, var_14_1)
    ...
    if (hFile == 0xffffffff)
        ...
        label_600b6b:
            ...
            int32_t eax_35 = (&data_640ff8)[ecx_4 s>> 5]
            *(eax_35 + ecx_6 + 4) &= 0xfe
        ...
        var_c_1 = ecx_3
        hFile = sub_600845(arg3, ecx_3, var_10_1, &var_3c, esi_1, var_1c_1, var_14_1)
        hObject = hFile
    ...
    if (eax_38 == FILE_TYPE_UNKNOWN)
        ...
        int32_t eax_41 = (&data_640ff8)[ecx_8 s>> 5]
    ...
    sub_5f98e7(*arg2, hObject)
    int32_t edx_3
    edx_3.b = var_5
    int32_t ecx_12 = *arg2
    edx_3.b |= 1
    char var_5_1 = edx_3.b
    *((&data_640ff8)[ecx_12 s>> 5] + ((ecx_12 & 0x1f) << 6) + 4) = edx_3.b
    int32_t ecx_15 = *arg2
    int32_t ecx_17 = (ecx_15 & 0x1f) << 6
    int32_t eax_49 = (&data_640ff8)[ecx_15 s>> 5]
    *(eax_49 + ecx_17 + 0x24) &= 0x80
    ...
    if ((ecx_18.b & 2) != 0)
        ...
        if ((eax_50 & edx_4) != 0xffffffff)
            ...
            int32_t ecx_21
            int32_t edx_5
            eax_52, ecx_21, edx_5 = sub_5f4304(*arg2, &var_28, 1)
...
label_600cea:
    ...
    label_600ec5:
        ...
        while (true)
            void* eax_80 = sub_5f998f(*arg2, &var_18 + esi_3, ecx_22 - esi_3)
...
label_600dfd:
    eax_67 = sub_5f4304(*arg2, &var_18, 3)
    ...
    label_600f0e:
        ...
        int32_t ecx_26 = (&data_640ff8)[edx_11 s>> 5]
        int32_t eax_82
        ...
        *(ecx_26 + edx_13 + 0x24) ^= eax_82.b
        ...
        int32_t edx_14 = (&data_640ff8)[esi_4 s>> 5]
        int32_t eax_84
        ...
        *(edx_14 + esi_6 + 0x24) = (arg4.d u>> 0x10).b << 7 | eax_84.b
        ...
        if (var_7_1 == 0 && (ecx_29 & 8) != 0)
            ...
            int32_t eax_87 = (&data_640ff8)[ecx_30 s>> 5]
            *(eax_87 + ecx_32 + 4) |= 0x20
            ecx_29 = arg4
        
        if ((var_c_1 & 0xc0000000) == 0xc0000000 && (ecx_29 & 1) != 0)
            CloseHandle(hObject)
            HANDLE eax_90 = sub_600845(arg3, var_c_1 & 0x7fffffff, var_10_1, &var_3c, 
            ...
            if (eax_90 == 0xffffffff)
                ...
                int32_t eax_94 = (&data_640ff8)[ecx_33 s>> 5]
                *(eax_94 + ecx_35 + 4) &= 0xfe
                sub_5f97fa(*arg2)
                return *__errno()
            
            int32_t edx_15 = *arg2
            *(((edx_15 & 0x1f) << 6) + (&data_640ff8)[edx_15 s>> 5]) = eax_90
else
    if (arg5 == 0x20)
