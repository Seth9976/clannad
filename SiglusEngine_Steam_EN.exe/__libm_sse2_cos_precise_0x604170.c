...
if (not(cond:0))
    ...
    if (eax_2 u<= 0x10c5)
        ...
        *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x624c58)
        ...
        double xmm6[0x2] = data_625460
        double xmm5_2[0x2] = _mm_mul_pd(xmm5_1, xmm0_2)
        double xmm0_3[0x2] = _mm_mul_pd(xmm0_2, xmm0_2)
        double xmm2_3 = (*(0x624c50 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))).q f+
            *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x624c68)
        ...
        double xmm5_3[0x2] = __addpd_xmmpd_mempd(xmm5_2, data_625470)
        *(0x624c50 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))
        ...
        *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x624c58)
        *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x624c60)
        double xmm6_4[0x2] = _mm_mul_pd(xmm6_3, xmm2_5)
        _mm_unpackhi_pd(xmm6_4, xmm6_4)
        return 0x624c50 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5)
