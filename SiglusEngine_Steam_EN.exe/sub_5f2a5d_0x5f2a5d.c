...
eax, x87control_1 = sub_5fae98(x87control, 0x133f, 0xffff)
...
if (ecx_2.w != 0x7ff0)
    ...
    label_5f2ace:
        ...
        sub_5fae98(x87control_1, eax.w, 0xffff)
        return fconvert.t(arg2)
    
    int32_t var_24_1 = ecx_2
    var_24_1.q = fconvert.d(x87_r7)
    int32_t var_8
    long double st0_2 = sub_5fa47e(eax, var_24_1, &var_8)
    int32_t edx_1 = var_8
    ...
    if (arg3 s>= 0)
        ...
        label_5f2b51:
            ...
            if (eax_5 s> 0x400)
                ...
                var_24_2.q = fconvert.d(sub_5fa550(var_24_2, eax_5.w - 0x600, arg1))
            ...
            if (eax_5 s< 0xfffffc03)
                ...
                var_24_3.q = fconvert.d(sub_5fa550(var_24_3, eax_5.w + 0x600, arg1))
            ...
            var_2c:4.d = 0xffff
            var_2c.d = eax
            arg2 = fconvert.d(sub_5fa550(var_24_4, eax_5.w, arg1))
            sub_5fae98(x87control_1, var_2c)
            return fconvert.t(arg2)
        
    label_5f2c0d:
        var_24_1.q = fconvert.d(st0_2)
        var_24_1.q =
            fconvert.d(__copysign(fconvert.d(fconvert.t(data_63c608)), var_24_1, ecx_2, eax))
        var_2c_2 = (fconvert.d(fconvert.t(fconvert.d(float.t(arg3))))).d
        var_34:4.d = arg3
        var_34.d = arg3
    label_5f2c34:
