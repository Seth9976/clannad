...
HWND hDlg = data_1af0a60

if (hDlg != 0)
    if (arg1 != 0)
        sub_4d1ba0(result, 0xc04, &data_20cb670, 0xa5)
        hDlg = data_1af0a60
        data_20cb670 = 1
    
    WPARAM wParam = 0
    void* ebx_1 = &data_91f90c
    
    do
        if (data_20cb670 == 0)
            result = *((wParam << 2) + &data_20cb674)
        
        if (data_20cb670 != 0 || result != *((wParam << 2) + &data_20cba74))
            *((wParam << 2) + &data_20cba74) = *((wParam << 2) + &data_20cb674)
