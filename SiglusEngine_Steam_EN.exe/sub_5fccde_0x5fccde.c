    ...
    *__errno() = 0x16
    ...
    if ((arg1[3].b & 0x40) == 0)
        ...
        if (eax_6 == 0xffffffff || eax_6 == 0xfffffffe)
            ...
            edx_4 = ((eax_6 & 0x1f) << 6) + (&data_640ff8)[eax_6 s>> 5]
        ...
        if (eax_6 == 0xffffffff || eax_6 == 0xfffffffe)
            ...
            ecx_4 = ((eax_6 & 0x1f) << 6) + (&data_640ff8)[eax_6 s>> 5]
        ...
        while (true)
            ...
            if (result_1 s>= 0)
                ...
                if (edx_5.b - 0x20 u> 0x58)
                    ...
                    eax_15 = zx.d(*(sx.d(edx_5.b) + 0x60d2d0)) & 0xf
                
                uint32_t edi_2 = zx.d(*(eax_15 * 9 + var_23c_1 + 0x60d2f0))
                        ...
                        case 6
                            if (edx_5.b == 0x49)
                                ...
                                label_5fd07d:
                                    ...
                                    if (sub_5f92dc(edx_5.b, &var_274) != 0)
                                        sub_5fd87a(var_250_1, arg1, &result_2)
                        ...
                        case 7
                            ...
                            if (eax_37 s> 0x64)
                                ...
                                label_5fd136:
                                    ...
                                    if (i_3 s< 0)
                                        ...
                                        if (i_3 s> 0xa3)
                                            char* eax_59
                                            eax_59, edx_5 = sub_5f6ab6(&i_3[0x15d])
                                            edx_5.b = var_215_1
                                            var_25c_1 = eax_59
                                    ...
                                    DecodePointer(data_63c5e8)(&var_284, esi, var_240_1, 
                                        sx.d(edx_5.b), i_1, var_254, &var_274)
                                    int32_t edi_18 = ebx & 0x80
                                    
                                    if (edi_18 != 0 && i_1 == 0)
                                        DecodePointer(data_63c5f4)(esi, &var_274)
                                    
                                    if (var_215_1 == 0x67 && edi_18 == 0)
                                        DecodePointer(data_63c5f0)(esi, &var_274)
                            ...
                            label_5fd63b:
                                ...
                                if (var_24c != 0)
                                    ...
                                    sub_5fd8ee(&var_230, eax_83, arg1, &result_2, eax_4)
                                    ...
                                    if (var_248 == 0 || eax_84 s<= 0)
                                        sub_5fd8ee(esi, eax_84, arg1, &result_2, eax_4)
                                    label_5fd7a7:
                                        result_1 = result_2
                                    else
                                        char* ecx_19 = esi
                                        ...
                                        while (true)
                                            ...
                                            sub_5fd8ee(&var_10, var_264, arg1, &result_2, eax_4)
                                            eax_84 -= 1
                                            ecx_19 = &ecx_19[2]
