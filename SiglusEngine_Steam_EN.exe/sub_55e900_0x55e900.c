...
LRESULT hDlg_3 = hDlg
HWND hDlg_2 = data_1af0a70

if (hDlg_2 != 0)
    if (arg1 != 0)
        sub_4d1ba0(hDlg, 0x1804, &data_20c5700, 0xa5)
        hDlg_2 = data_1af0a70
        data_20c5700 = 1
        __builtin_memset(&data_20c6704, 0, 0x400)
        __builtin_memset(&data_20c6b04, 0, 0x400)
    
    for (WPARAM wParam = 0; wParam s< 0x100; wParam += 1)
        if (data_20c5700 == 0 && *((wParam << 2) + &data_20c6704) == 0)
            hDlg = *((wParam << 2) + &data_20c5704)
        
        if (data_20c5700 != 0 || *((wParam << 2) + &data_20c6704) != 0
                || hDlg != *((wParam << 2) + &data_20c5b04))
            int32_t var_154_1 = (&data_91f104)[wParam]
            *((wParam << 2) + &data_20c5b04) = *((wParam << 2) + &data_20c5704)
            void var_108
            ...
            int32_t var_154_3 = *((wParam << 2) + &data_20c6b04)
            sub_4c84d0(&var_108, "%d")
            ...
            int32_t eax_2
            int32_t edx_1
            edx_1:eax_2 = mulu.dp.d(0x51eb851f, (&data_91f104)[wParam])
            ...
            int32_t eax_16
            int32_t edx_6
            edx_6:eax_16 = mulu.dp.d(0x51eb851f, *((wParam << 2) + &data_20c6b04))
            ...
            if (*((wParam << 2) + &data_20c6704) != 0)
                hDlg = data_1392710 - *((wParam << 2) + &data_20c6304)
                
                if (hDlg u>= 0x4e20)
                    *((wParam << 2) + &data_20c6704) = 0
