...
do
    ...
    do
        ...
        eax_3.b = *edi
        *edi =
            eax_3.b + (*(((eax_1 + *(((ebx_1 - eax_1) << 2) + data_1cd43c8) - eax_3) << 2) + esi)).b
        int32_t ebx_9
        ebx_9.b = edi[1]
        int32_t eax_5
        ...
        eax_7.b = edi[1]
        edi[1] =
            eax_7.b + (*(((eax_5 + *(((ebx_9 - eax_5) << 2) + data_1cd43c8) - eax_7) << 2) + esi)).b
        int32_t ebx_17
        ebx_17.b = edi[2]
        int32_t eax_9
        ...
        eax_11.b = edi[2]
        result = eax_11.b
            + (*(((eax_9 + *(((ebx_17 - eax_9) << 2) + data_1cd43c8) - eax_11) << 2) + esi)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
