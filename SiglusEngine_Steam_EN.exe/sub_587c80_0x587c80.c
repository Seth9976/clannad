...
do
    ...
    do
        ...
        eax_10.b = *edi
        *edi = eax_10.b
            + (*(((eax_8 + *(((ebx_11 - eax_8) << 2) + data_1cd43c8) - eax_10) << 2) + esi_5)).b
        ...
        eax_15.b = edi[1]
        edi[1] = eax_15.b
            + (*(((eax_13 + *(((ebx_23 - eax_13) << 2) + data_1cd43c8) - eax_15) << 2) + esi_5)).b
        ...
        eax_20.b = edi[2]
        result = eax_20.b
            + (*(((eax_18 + *(((ebx_35 - eax_18) << 2) + data_1cd43c8) - eax_20) << 2) + esi_5)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
