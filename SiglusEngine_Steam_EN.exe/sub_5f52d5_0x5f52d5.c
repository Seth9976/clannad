...
int32_t var_8_1 = 0
int32_t var_90 = 0x20
int32_t* i_5 = sub_5f6a6e(0x20, 0x40)
int32_t* i = i_5
int32_t* i_2 = i
int32_t result
...
if (i != 0)
    ...
    if (startupInfo.cbReserved2 == 0 || lpReserved2 == 0)
        ...
        for (; data_20f34c8 s< i_1; i_1 = i_4)
            int32_t* j = sub_5f6a6e(0x20, 0x40)
            int32_t* j_1 = j
            ...
            while (j u< (&data_640ff8)[esi_1] + 0x800)
                j[1].w = 0xa00
                *j = 0xffffffff
                j[2] = 0
                j[9].b &= 0x80
            ...
            if (hFile_1 != 0xffffffff && hFile_1 != 0xfffffffe)
                ...
                if ((eax_4.b & 1) != 0)
                    ...
                    if ((eax_4.b & 8) != 0 || eax_5 != FILE_TYPE_UNKNOWN)
                        int32_t* esi_5 = ((edi_1 & 0x1f) << 6) + (&data_640ff8)[edi_1 s>> 5]
                        int32_t* var_28 = esi_5
                        *esi_5 = *edx_1
                        void* eax_9
                        eax_9.b = *var_2c_1
                        esi_5[1].b = eax_9.b
                        sub_5f36f7(&esi_5[3], 0xfa0, 0)
                        esi_5[2] += 1
                        edx_1 = var_24_1
    ...
    while (true)
        ...
        int32_t* esi_8 = (edi_2 << 6) + data_640ff8
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_5f557f
return result
