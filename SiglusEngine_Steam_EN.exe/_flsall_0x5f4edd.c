...
while (true)
    ...
    void* eax_1 = *(data_20f44e0 + (esi << 2))
    
    if (eax_1 != 0 && (*(eax_1 + 0xc) & 0x83) != 0)
        __lock_file2(esi, eax_1)
        int32_t var_8_2 = 1
        int32_t* eax_3 = *(data_20f44e0 + (esi << 2))
        
        if ((eax_3[3].b & 0x83) != 0)
            if (arg1 == 1)
                if (sub_5f4e2a(eax_3) != 0xffffffff)
                    result_2 += 1
                    int32_t result_3 = result_2
            else if (arg1 == 0 && (eax_3[3].b & 2) != 0)
                int32_t eax_5 = sub_5f4e2a(eax_3)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_5f4fb1
return result
