...
if (data_20f34c0 != 0)
    ...
    if (not(cond:0_1))
        ...
        int32_t xmm2[0x4] = data_6067f0
        int64_t xmm7 = xmm0.q
        uint64_t xmm0_1[0x2] = _mm_srli_epi64(xmm0, 0x34)
        int32_t eax_3 = xmm0_1
        int32_t xmm2_1[0x4] = _mm_sub_epi32(xmm2, __andpd_xmmxuq_memxuq(xmm0_1, data_606820))
        ...
        if ((eax_3 & 0x800) != 0)
            ...
            if (eax_3 s< 0xbff)
                arg3 = __andpd_xmmxuq_memxuq(
                    __orpd_xmmxuq_memxuq(__cmppd_xmmpd_mempd_immb(xmm0_3, data_606810, 1), 
                        data_606810), 
                    data_606800)
                return fconvert.t(arg3)
            
            if (eax_3 s<= 0xc32)
                arg3 = xmm1_3 f- __andpd_xmmxuq_memxuq(xmm0_4, data_6067e0)
                return fconvert.t(arg3)
        else
            if (eax_3 s< 0x3ff)
                return float.t(0)
        ...
        if (not(is_ordered.q(xmm7, xmm7)))
            ...
            sub_5f8379(&arg3, &arg3, &arg3, 0x3ed)
...
int32_t var_1c = data_63c5cc
int32_t eax_4
int16_t x87control
eax_4, x87control = sub_5fae98(arg2)
...
return __except1(var_30_1, 0xb, var_28_1)
