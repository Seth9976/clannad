    ...
    do
        ...
        if (ebx_3.b != 0)
            ...
            if (ebx_8.b != 0)
                ...
                eax_6.b = *edi
                *edi = eax_6.b + (
                    *(((eax_4 + *(((ebx_11 - eax_4) << 2) + data_1cd43b0) - eax_6) << 2) + esi_1)).b
                int32_t ebx_19
                ebx_19.b = edi[1]
                int32_t eax_8 = data_1cd44b8
                int32_t eax_10
                eax_10.b = edi[1]
                edi[1] = eax_10.b + (
                    *(((eax_8 + *(((ebx_19 - eax_8) << 2) + data_1cd43b0) - eax_10) << 2) + esi_1)).b
                int32_t ebx_27
                ebx_27.b = edi[2]
                int32_t eax_12 = data_1cd44b4
                int32_t eax_14
                eax_14.b = edi[2]
                edi[2] = eax_14.b + (*
                    (((eax_12 + *(((ebx_27 - eax_12) << 2) + data_1cd43b0) - eax_14) << 2) + esi_1)).b
