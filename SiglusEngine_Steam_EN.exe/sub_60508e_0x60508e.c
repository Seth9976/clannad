...
double xmm6[0x2] = data_627f90
double xmm5_2[0x2] = _mm_mul_pd(xmm5_1, xmm0_2)
double xmm0_3[0x2] = _mm_mul_pd(xmm0_2, xmm0_2)
double xmm3_4 = *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x627798)
double xmm2_3 = (*(0x627780 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))).q f+ xmm3_4
...
double xmm5_3[0x2] = __addpd_xmmpd_mempd(xmm5_2, data_627fa0)
double xmm4_3 = xmm4_2 * *(0x627780 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))
double xmm6_2[0x2] = __addpd_xmmpd_mempd(xmm6_1, *"UUUUUU")
double xmm5_4[0x2] = _mm_mul_pd(xmm5_3, xmm0_4)
double xmm3_6 = xmm3_5 f+ *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x627788)
double xmm4_4 = xmm4_3 + xmm3_6
double xmm6_3[0x2] = _mm_add_pd(xmm6_2, xmm5_4)
double xmm5_6 = *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x627788) - xmm3_6
double xmm1_7 = (xmm1_3 f* 1.2639164054974691e-22 - (xmm4_1 - xmm4_2 f- xmm2_1))
    * (xmm7 * xmm4_2 - xmm2_3) f+ *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x627790)
...
return 0x627780 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5)
