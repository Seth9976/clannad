...
if (eax_1 == ecx)
    if (eax == ecx_1)
        ...
        while (true)
            ...
            do
                ...
                *edi_1 = eax_2.b + (*(((ebx_1 - eax_2) << 2) + data_1cd43c8)).b
                int32_t ebx_6
                ebx_6.b = esi_1[1]
                int32_t eax_4
                eax_4.b = not.b(ebx_6.b)
                edi_1[1] = eax_4.b + (*(((ebx_6 - eax_4) << 2) + data_1cd43c8)).b
                int32_t ebx_11
                ebx_11.b = esi_1[2]
                int32_t eax_6
                eax_6.b = not.b(ebx_11.b)
                eax_7 = eax_6.b + (*(((ebx_11 - eax_6) << 2) + data_1cd43c8)).b
                edi_1[2] = eax_7
                esi_1 = &esi_1[4]
                edi_1 = &edi_1[4]
                i = i_6
    ...
    if (eax s< ecx_1)
        ...
        do
            ...
            do
                ...
                ebx_18.b = *esi_4
                int32_t eax_8
                eax_8.b = not.b(ebx_18.b)
                *edi_4 = eax_8.b + (*(((ebx_18 - eax_8) << 2) + data_1cd43c8)).b
                int32_t ebx_23
                ebx_23.b = esi_4[1]
                int32_t eax_10
                eax_10.b = not.b(ebx_23.b)
                edi_4[1] = eax_10.b + (*(((ebx_23 - eax_10) << 2) + data_1cd43c8)).b
                int32_t ebx_28
                ebx_28.b = esi_4[2]
                int32_t eax_12
                eax_12.b = not.b(ebx_28.b)
                eax_13 = eax_12.b + (*(((ebx_28 - eax_12) << 2) + data_1cd43c8)).b
                edi_4[2] = eax_13
                esi_4 = &esi_4[4]
                edi_4 = &edi_4[4]
                j = j_2
    ...
    while (true)
        ...
        do
            ...
            *edi_7 = eax_14.b + (*(((ebx_36 - eax_14) << 2) + data_1cd43c8)).b
            int32_t ebx_41
            ebx_41.b = esi_6[1]
            int32_t eax_16
            eax_16.b = not.b(ebx_41.b)
            edi_7[1] = eax_16.b + (*(((ebx_41 - eax_16) << 2) + data_1cd43c8)).b
            int32_t ebx_46
            ebx_46.b = esi_6[2]
            int32_t eax_18
            eax_18.b = not.b(ebx_46.b)
            eax_19 = eax_18.b + (*(((ebx_46 - eax_18) << 2) + data_1cd43c8)).b
            edi_7[2] = eax_19
            esi_6 = &esi_6[4]
            edi_7 = &edi_7[4]
            i_2 = i_8
    ...
    if (eax == ecx_1)
        ...
        while (true)
            ...
            do
                ...
                ebx_53.b = *esi_8
                int32_t eax_20
                eax_20.b = not.b(ebx_53.b)
                *edi_10 = eax_20.b + (*(((ebx_53 - eax_20) << 2) + data_1cd43c8)).b
                int32_t ebx_58
                ebx_58.b = esi_8[1]
                int32_t eax_22
                eax_22.b = not.b(ebx_58.b)
                edi_10[1] = eax_22.b + (*(((ebx_58 - eax_22) << 2) + data_1cd43c8)).b
                int32_t ebx_63
                ebx_63.b = esi_8[2]
                int32_t eax_24
                eax_24.b = not.b(ebx_63.b)
                eax_25 = eax_24.b + (*(((ebx_63 - eax_24) << 2) + data_1cd43c8)).b
                edi_10[2] = eax_25
                edi_10 = &edi_10[4]
                edx_1 += data_1cd43f8
    ...
    if (eax s< ecx_1)
        ...
        do
            ...
            do
                ...
                ebx_70.b = *esi_11
                int32_t eax_26
                eax_26.b = not.b(ebx_70.b)
                *edi_13 = eax_26.b + (*(((ebx_70 - eax_26) << 2) + data_1cd43c8)).b
                int32_t ebx_75
                ebx_75.b = esi_11[1]
                int32_t eax_28
                eax_28.b = not.b(ebx_75.b)
                edi_13[1] = eax_28.b + (*(((ebx_75 - eax_28) << 2) + data_1cd43c8)).b
                int32_t ebx_80
                ebx_80.b = esi_11[2]
                int32_t eax_30
                eax_30.b = not.b(ebx_80.b)
                eax_31 = eax_30.b + (*(((ebx_80 - eax_30) << 2) + data_1cd43c8)).b
                edi_13[2] = eax_31
                edi_13 = &edi_13[4]
                edx_3 += data_1cd43f8
    ...
    while (true)
        ...
        do
            ...
            ebx_88.b = *esi_13
            int32_t eax_32
            eax_32.b = not.b(ebx_88.b)
            *edi_16 = eax_32.b + (*(((ebx_88 - eax_32) << 2) + data_1cd43c8)).b
            int32_t ebx_93
            ebx_93.b = esi_13[1]
            int32_t eax_34
            eax_34.b = not.b(ebx_93.b)
            edi_16[1] = eax_34.b + (*(((ebx_93 - eax_34) << 2) + data_1cd43c8)).b
            int32_t ebx_98
            ebx_98.b = esi_13[2]
            int32_t eax_36
            eax_36.b = not.b(ebx_98.b)
            eax_37 = eax_36.b + (*(((ebx_98 - eax_36) << 2) + data_1cd43c8)).b
            edi_16[2] = eax_37
            edi_16 = &edi_16[4]
            edx_5 += data_1cd43f8
    ...
    label_5c7bc7:
        ...
        ebx_105.b = *esi_15
        int32_t eax_38
        eax_38.b = not.b(ebx_105.b)
        *edi_19 = eax_38.b + (*(((ebx_105 - eax_38) << 2) + data_1cd43c8)).b
        int32_t ebx_110
        ebx_110.b = esi_15[1]
        int32_t eax_40
        eax_40.b = not.b(ebx_110.b)
        edi_19[1] = eax_40.b + (*(((ebx_110 - eax_40) << 2) + data_1cd43c8)).b
        int32_t ebx_115
        ebx_115.b = esi_15[2]
        int32_t eax_42
        eax_42.b = not.b(ebx_115.b)
        char eax_43 = eax_42.b + (*(((ebx_115 - eax_42) << 2) + data_1cd43c8)).b
        edi_19[2] = eax_43
        int32_t edx_8 = edx_7
    ...
    label_5c7c8e:
        ...
        ebx_122.b = *esi_18
        int32_t eax_44
        eax_44.b = not.b(ebx_122.b)
        *edi_22 = eax_44.b + (*(((ebx_122 - eax_44) << 2) + data_1cd43c8)).b
        int32_t ebx_127
        ebx_127.b = esi_18[1]
        int32_t eax_46
        eax_46.b = not.b(ebx_127.b)
        edi_22[1] = eax_46.b + (*(((ebx_127 - eax_46) << 2) + data_1cd43c8)).b
        int32_t ebx_132
        ebx_132.b = esi_18[2]
        int32_t eax_48
        eax_48.b = not.b(ebx_132.b)
        char eax_49 = eax_48.b + (*(((ebx_132 - eax_48) << 2) + data_1cd43c8)).b
        edi_22[2] = eax_49
    ...
    label_5c7d6e:
        ...
        ebx_140.b = *esi_20
        int32_t eax_50
        eax_50.b = not.b(ebx_140.b)
        *edi_25 = eax_50.b + (*(((ebx_140 - eax_50) << 2) + data_1cd43c8)).b
        int32_t ebx_145
        ebx_145.b = esi_20[1]
        int32_t eax_52
        eax_52.b = not.b(ebx_145.b)
        edi_25[1] = eax_52.b + (*(((ebx_145 - eax_52) << 2) + data_1cd43c8)).b
        int32_t ebx_150
        ebx_150.b = esi_20[2]
        int32_t eax_54
        eax_54.b = not.b(ebx_150.b)
        char eax_55 = eax_54.b + (*(((ebx_150 - eax_54) << 2) + data_1cd43c8)).b
        edi_25[2] = eax_55
