    ...
    if (eax == ecx_1)
        ...
        while (true)
            ...
            do
                ...
                int32_t eax_6
                eax_6.b = *edi_1
                int32_t eax_7 = eax_6 - (eax_4 + *(((eax_2
                    + *(((ebx_1 - eax_2) << 2) + data_1cd43c8) - eax_4) << 2) + data_1cd4384))
    ...
    while (true)
        ...
        do
            ...
            *edi_16 = eax_97.b
            ...
            int32_t eax_108
            eax_108.b = edi_16[2]
            eax_109 = eax_108 - (eax_106 + *(((eax_104
                + *(((ebx_166 - eax_104) << 2) + data_1cd43c8) - eax_106) << 2) + data_1cd4394))
