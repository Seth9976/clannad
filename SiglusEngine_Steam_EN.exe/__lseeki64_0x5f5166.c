...
if (arg1 != 0xfffffffe)
    ...
    if (arg1 s< 0 || arg1 u>= data_20f34c8 || (sx.d(*((&data_640ff8)[eax_3] + ebx_3 + 4)) & 1) == 0)
        *___doserrno() = 0
        *__errno() = 9
        ...
        int32_t var_8_1 = 0
        int32_t eax_8 = (&data_640ff8)[eax_3]
        int32_t ebx_4
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_5f5261
return result
