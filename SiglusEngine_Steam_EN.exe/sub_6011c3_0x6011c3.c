...
if ((eax_2 & 0x7fff) != 0)
    ...
    *(edi_4 + 4) = esi_1[1]
    ...
    int32_t edx_12 = data_63c8f4
    
    if (ecx_10 s< edx_12 - data_63c8f8)
        var_14 = 0
        ...
        *edi_11 = *esi_5
        ...
        esi = 0
        i_1 = 2
    else if (ecx_10 s< data_63c8f0)
        int32_t esi_11 = data_63c904
        var_14 &= 0x7fffffff
        int32_t ecx_39 = data_63c8fc
        int32_t eax_85
        int32_t edx_42
...
int32_t eax_100 = data_63c900
int32_t esi_15 =
    esi << (0x1f - (data_63c8fc).b) | (sbb.d(eax_97, eax_97, eax_3 != 0) & 0x80000000) | var_14
