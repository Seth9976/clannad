    ...
    do
        ...
        if (ebx_3.b != 0)
            ...
            if (ebx_8.b != 0)
                ...
                int32_t ebx_11
                ebx_11.b = *edi
                int32_t eax_4 = data_1cd44bc
                int32_t eax_6 = data_1cd44c8
                int32_t eax_8
                eax_8.b = *edi
                *edi = eax_8.b + (*(((eax_6 + *(((eax_4 + *(((ebx_11 - eax_4) << 2) + data_1cd43b0)
                    - eax_6) << 2) + data_1cd4384) - eax_8) << 2) + esi_1)).b
                int32_t ebx_23
                ebx_23.b = edi[1]
                int32_t eax_10 = data_1cd44b8
                int32_t eax_12 = data_1cd44c4
                int32_t eax_14
                eax_14.b = edi[1]
                edi[1] = eax_14.b + (*(((eax_12 + *(((eax_10
                    + *(((ebx_23 - eax_10) << 2) + data_1cd43b0) - eax_12) << 2) + data_1cd438c)
                    - eax_14) << 2) + esi_1)).b
                int32_t ebx_35
                ebx_35.b = edi[2]
                int32_t eax_16 = data_1cd44b4
                int32_t eax_18 = data_1cd44c0
                int32_t eax_20
                eax_20.b = edi[2]
                edi[2] = eax_20.b + (*(((eax_18 + *(((eax_16
                    + *(((ebx_35 - eax_16) << 2) + data_1cd43b0) - eax_18) << 2) + data_1cd4394)
                    - eax_20) << 2) + esi_1)).b
