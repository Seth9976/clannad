    ...
    *__errno() = 9
    ...
    if ((*((&data_640ff8)[ebx_2] + edi_3 + 4) & 1) == 0)
        ...
        *___doserrno() = 0
        ...
        result_1 = sub_5f4d83(arg1, arg2, arg3)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_5f4d82
return result
