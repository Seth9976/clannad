...
do
    ...
    *(edi - 0x18) = 0
    ...
    if (*(edi + 0x48) != 0)
        ...
        result = *(edi - 0x14) << 5
        sub_4d1c30(result, *(edi + 0x48), *(edi - 0x18), result)
    ...
    *(edi - 8) = 0
    ...
    if (ecx_7 != 0)
        ...
        if (result s> 0)
            ...
            sub_4d1c30(result, *(edi + 0x58), *(edi - 8), result_1)
    ...
    *ecx_10 = 0
    ...
    if (*(edi + 0x64) != 0)
        ...
        sub_4d1c30(result, *(edi + 0x64), *(edi + 4), 0x200)
    
    edi += 0x3920
    i = i_1
    i_1 -= 1
while (i != 1)
sub_4d1c30(result, 0x1b04898, &data_1af4e90, 0xfa08)
return result
