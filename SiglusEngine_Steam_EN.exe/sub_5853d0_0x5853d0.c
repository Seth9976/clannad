...
if (arg5 != 0 && result != 0)
    ...
    int32_t result_5
    int32_t result_6
    sub_4d2170(&arg_24, arg4, arg2, &arg_24, &result_4, &result_5, &result_6)
    int32_t edx_2 = arg10 - arg8
    result = result_5
    int32_t result_8 = arg11 - arg9
            ...
            if (result_3 s>= edx_2)
                ...
                if (result s>= result_8)
                    ...
                    if (esi_1 s> 0 && result_7 s> 0)
                        ...
                        data_1cd43e0 = arg4
                        data_1cd43dc = arg5 + ((ebx_1 * arg6 + result_2) << 2)
                        data_1cd43d4 = arg7
                        data_1cd43e4 = (arg2 << 2) - ecx_5
                        data_1cd43d8 = (arg6 << 2) - ecx_5
