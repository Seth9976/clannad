...
HWND hDlg = data_1af0abc

if (hDlg != 0)
    if (arg1 != 0)
        sub_4d1ba0(result, 0x804, &data_20c3e70, 0xa5)
        hDlg = data_1af0abc
        data_20c3e70 = 1
    
    void* ebx_1 = &data_9265b0
    
    for (WPARAM wParam = 0; wParam s< 0x100; )
        if (data_20c3e70 == 0)
            result = *((wParam << 2) + &data_20c4274)
        
        if (data_20c3e70 != 0 || result != *((wParam << 2) + &data_20c3e74))
            bool cond:0_1 = *ebx_1 != 0
            result = *((wParam << 2) + &data_20c3e74)
            *((wParam << 2) + &data_20c4274) = result
            HWND hWnd
