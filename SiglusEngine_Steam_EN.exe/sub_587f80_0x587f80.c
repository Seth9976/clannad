...
do
    ...
    do
        ...
        *edi = eax_3.b +
            (*(((eax_1 + *(((ebx_1 - eax_1) << 2) + data_1cd43c8) - eax_3) << 2) + data_1cd4384)).b
        int32_t ebx_9
        ebx_9.b = edi[1]
        int32_t eax_5
        ...
        edi[1] = eax_7.b +
            (*(((eax_5 + *(((ebx_9 - eax_5) << 2) + data_1cd43c8) - eax_7) << 2) + data_1cd438c)).b
        int32_t ebx_17
        ebx_17.b = edi[2]
        int32_t eax_9
        ...
        result = eax_11.b + (
            *(((eax_9 + *(((ebx_17 - eax_9) << 2) + data_1cd43c8) - eax_11) << 2) + data_1cd4394)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
