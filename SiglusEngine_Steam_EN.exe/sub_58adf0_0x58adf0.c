    ...
    do
        ...
        *edi = eax_12
        ...
        char eax_18 = eax_17.b + (*(((eax_15 +
            *(((eax_13 + *(((ebx_19 - eax_13) << 2) + data_1cd4444) - eax_15) << 2) + data_1cd43b0)
            - eax_17) << 2) + data_1cd438c)).b
        edi[1] = eax_18
        int32_t eax_19 = data_1cd44cc
        int32_t ebx_31
        ebx_31.b = edi[2]
        int32_t eax_21 = data_1cd44b4
        int32_t eax_23 = data_1cd44c0
        result = eax_23.b + (*(((eax_21 +
            *(((eax_19 + *(((ebx_31 - eax_19) << 2) + data_1cd4444) - eax_21) << 2) + data_1cd43b0)
            - eax_23) << 2) + data_1cd4394)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
