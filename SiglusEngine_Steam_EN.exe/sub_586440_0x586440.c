        ...
        if (ebx_3.b != 0)
            ...
            if (ebx_8.b != 0)
                if (ebx_8 != 0xff)
                    ...
                    int32_t eax_7
                    eax_7.b = *edi
                    *edi = eax_7.b + (*(((data_1cd447c - eax_7) << 2) + esi_1)).b
                    int32_t eax_9
                    eax_9.b = *(edi + 1)
                    *(edi + 1) = eax_9.b + (*(((data_1cd4478 - eax_9) << 2) + esi_1)).b
                    int32_t eax_11
                    eax_11.b = *(edi + 2)
                    *(edi + 2) = eax_11.b + (*(((data_1cd4474 - eax_11) << 2) + esi_1)).b
                else
                    *edi = data_1cd448c
        
        int32_t eax_14 = data_1cd446c + 1
        
        if (eax_14 s>= data_1cd445c)
            eax_14 = 0
