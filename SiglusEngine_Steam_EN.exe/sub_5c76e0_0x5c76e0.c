            ...
            do
                ...
                if (ebx_1.b != 0)
                    ...
                    if (ebx_6.b != 0)
                        ...
                        int32_t ebx_9
                        ebx_9.b = *esi_1
                        int32_t eax_1 = data_1cd4380
                        int32_t eax_3
                        eax_3.b = *edi_1
                        *edi_1 = eax_3.b + (*(((eax_1 + *(((ebx_9 - eax_1) << 2) + data_1cd4384)
                            - eax_3) << 2) + edx_1)).b
                        int32_t ebx_17
                        ebx_17.b = *(esi_1 + 1)
                        int32_t eax_5 = data_1cd4388
                        int32_t eax_7
                        eax_7.b = edi_1[1]
                        edi_1[1] = eax_7.b + (*(((eax_5 + *(((ebx_17 - eax_5) << 2) + data_1cd438c)
                            - eax_7) << 2) + edx_1)).b
                        int32_t ebx_25
                        ebx_25.b = *(esi_1 + 2)
                        ...
                        int32_t eax_11
                        eax_11.b = edi_1[2]
                        result = eax_11 + *(((eax_9 + *(((ebx_25 - eax_9) << 2) + data_1cd4394)
                            - eax_11) << 2) + edx_1)
                        edi_1[2] = result.b
            ...
            do
                ...
                if (ebx_35.b != 0)
                    ...
                    if (ebx_40.b != 0)
                        ...
                        int32_t eax_14
                        eax_14.b = *edi_4
                        *edi_4 = eax_14.b + (*(((eax_12 + *(((ebx_43 - eax_12) << 2) + data_1cd4384)
                            - eax_14) << 2) + edx_2)).b
                        int32_t ebx_51
                        ebx_51.b = *(esi_4 + 1)
                        ...
                        edi_4[1] = eax_18.b + (*(((eax_16
                            + *(((ebx_51 - eax_16) << 2) + data_1cd438c) - eax_18) << 2) + edx_2)).b
                        int32_t ebx_59
                        ebx_59.b = *(esi_4 + 2)
                        int32_t eax_20 = data_1cd4390
                        int32_t eax_22
                        eax_22.b = edi_4[2]
                        result = eax_22 + *(((eax_20 + *(((ebx_59 - eax_20) << 2) + data_1cd4394)
                            - eax_22) << 2) + edx_2)
                        edi_4[2] = result.b
        ...
        do
            ...
            if (ebx_70.b != 0)
                ...
                if (ebx_75.b != 0)
                    ...
                    int32_t eax_25
                    eax_25.b = *edi_7
                    *edi_7 = eax_25.b + (*(((eax_23 + *(((ebx_78 - eax_23) << 2) + data_1cd4384)
                        - eax_25) << 2) + edx_3)).b
                    int32_t ebx_86
                    ebx_86.b = *(esi_6 + 1)
                    int32_t eax_27 = data_1cd4388
                    int32_t eax_29
                    eax_29.b = edi_7[1]
                    edi_7[1] = eax_29.b + (*(((eax_27 + *(((ebx_86 - eax_27) << 2) + data_1cd438c)
                        - eax_29) << 2) + edx_3)).b
                    int32_t ebx_94
                    ebx_94.b = *(esi_6 + 2)
                    int32_t eax_31 = data_1cd4390
                    int32_t eax_33
                    eax_33.b = edi_7[2]
                    result = eax_33 + *(((eax_31 + *(((ebx_94 - eax_31) << 2) + data_1cd4394)
                        - eax_33) << 2) + edx_3)
                    edi_7[2] = result.b
            ...
            do
                ...
                if (ebx_104.b != 0)
                    ...
                    if (ebx_109.b != 0)
                        ...
                        int32_t ebx_112
                        ebx_112.b = *esi_8
                        int32_t eax_34 = data_1cd4380
                        int32_t eax_36
                        eax_36.b = *edi_10
                        *edi_10 = eax_36.b + (*(((eax_34
                            + *(((ebx_112 - eax_34) << 2) + data_1cd4384) - eax_36) << 2) + edx_5)).b
                        int32_t ebx_120
                        ebx_120.b = *(esi_8 + 1)
                        ...
                        edi_10[1] = eax_40.b + (*(((eax_38
                            + *(((ebx_120 - eax_38) << 2) + data_1cd438c) - eax_40) << 2) + edx_5)).b
                        int32_t ebx_128
                        ebx_128.b = *(esi_8 + 2)
                        int32_t eax_42 = data_1cd4390
                        int32_t eax_44
                        eax_44.b = edi_10[2]
                        result = eax_44 + *(((eax_42 + *(((ebx_128 - eax_42) << 2) + data_1cd4394)
                            - eax_44) << 2) + edx_5)
                        edi_10[2] = result.b
                ...
                if (ebx_138.b != 0)
                    ...
                    if (ebx_143.b != 0)
                        ...
                        *edi_13 = eax_47.b + (*(((eax_45
                            + *(((ebx_146 - eax_45) << 2) + data_1cd4384) - eax_47) << 2) + edx_8)).b
                        int32_t ebx_154
                        ebx_154.b = *(esi_11 + 1)
                        ...
                        edi_13[1] = eax_51.b + (*(((eax_49
                            + *(((ebx_154 - eax_49) << 2) + data_1cd438c) - eax_51) << 2) + edx_8)).b
                        int32_t ebx_162
                        ebx_162.b = *(esi_11 + 2)
                        int32_t eax_53 = data_1cd4390
                        int32_t eax_55
                        eax_55.b = edi_13[2]
                        result = eax_55 + *(((eax_53 + *(((ebx_162 - eax_53) << 2) + data_1cd4394)
                            - eax_55) << 2) + edx_8)
                        edi_13[2] = result.b
        ...
        do
            ...
            if (ebx_173.b != 0)
                ...
                if (ebx_178.b != 0)
                    ...
                    int32_t ebx_181
                    ebx_181.b = *esi_13
                    int32_t eax_56 = data_1cd4380
                    int32_t eax_58
                    eax_58.b = *edi_16
                    *edi_16 = eax_58.b + (*(((eax_56 + *(((ebx_181 - eax_56) << 2) + data_1cd4384)
                        - eax_58) << 2) + edx_11)).b
                    int32_t ebx_189
                    ebx_189.b = *(esi_13 + 1)
                    ...
                    int32_t eax_62
                    eax_62.b = edi_16[1]
                    edi_16[1] = eax_62.b + (*(((eax_60 + *(((ebx_189 - eax_60) << 2) + data_1cd438c)
                        - eax_62) << 2) + edx_11)).b
                    int32_t ebx_197
                    ebx_197.b = *(esi_13 + 2)
                    int32_t eax_64 = data_1cd4390
                    int32_t eax_66
                    eax_66.b = edi_16[2]
                    result = eax_66 + *(((eax_64 + *(((ebx_197 - eax_64) << 2) + data_1cd4394)
                        - eax_66) << 2) + edx_11)
                    edi_16[2] = result.b
    ...
    label_5c7367:
        ...
        if (ebx_207.b != 0)
            ...
            if (ebx_212.b != 0)
                ...
                int32_t ebx_215
                ebx_215.b = *esi_15
                int32_t eax_67 = data_1cd4380
                int32_t eax_69
                eax_69.b = *edi_19
                *edi_19 = eax_69.b + (*(((eax_67 + *(((ebx_215 - eax_67) << 2) + data_1cd4384)
                    - eax_69) << 2) + edx_14)).b
                int32_t ebx_223
                ebx_223.b = *(esi_15 + 1)
                ...
                int32_t eax_73
                eax_73.b = edi_19[1]
                edi_19[1] = eax_73.b + (*(((eax_71 + *(((ebx_223 - eax_71) << 2) + data_1cd438c)
                    - eax_73) << 2) + edx_14)).b
                int32_t ebx_231
                ebx_231.b = *(esi_15 + 2)
                ...
                int32_t eax_77
                eax_77.b = edi_19[2]
                result = eax_77 + *(((eax_75 + *(((ebx_231 - eax_75) << 2) + data_1cd4394) - eax_77)
                    << 2) + edx_14)
                edi_19[2] = result.b
    ...
    label_5c748e:
        ...
        if (ebx_241.b != 0)
            ...
            if (ebx_246.b != 0)
                ...
                int32_t eax_80
                eax_80.b = *edi_22
                *edi_22 = eax_80.b + (*(((eax_78 + *(((ebx_249 - eax_78) << 2) + data_1cd4384)
                    - eax_80) << 2) + edx_17)).b
                int32_t ebx_257
                ebx_257.b = *(esi_18 + 1)
                ...
                int32_t eax_84
                eax_84.b = edi_22[1]
                edi_22[1] = eax_84.b + (*(((eax_82 + *(((ebx_257 - eax_82) << 2) + data_1cd438c)
                    - eax_84) << 2) + edx_17)).b
                int32_t ebx_265
                ebx_265.b = *(esi_18 + 2)
                int32_t eax_86 = data_1cd4390
                int32_t eax_88
                eax_88.b = edi_22[2]
                result = eax_88 + *(((eax_86 + *(((ebx_265 - eax_86) << 2) + data_1cd4394) - eax_88)
                    << 2) + edx_17)
                edi_22[2] = result.b
    ...
    label_5c75ce:
        ...
        if (ebx_276.b != 0)
            ...
            if (ebx_281.b != 0)
                ...
                int32_t eax_91
                eax_91.b = *edi_25
                *edi_25 = eax_91.b + (*(((eax_89 + *(((ebx_284 - eax_89) << 2) + data_1cd4384)
                    - eax_91) << 2) + edx_20)).b
                int32_t ebx_292
                ebx_292.b = *(esi_20 + 1)
                int32_t eax_93 = data_1cd4388
                int32_t eax_95
                eax_95.b = edi_25[1]
                edi_25[1] = eax_95.b + (*(((eax_93 + *(((ebx_292 - eax_93) << 2) + data_1cd438c)
                    - eax_95) << 2) + edx_20)).b
                int32_t ebx_300
                ebx_300.b = *(esi_20 + 2)
                int32_t eax_97 = data_1cd4390
                int32_t eax_99
                eax_99.b = edi_25[2]
                result = eax_99 + *(((eax_97 + *(((ebx_300 - eax_97) << 2) + data_1cd4394) - eax_99)
                    << 2) + edx_20)
                edi_25[2] = result.b
