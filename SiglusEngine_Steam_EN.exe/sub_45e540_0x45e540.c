        ...
        if (result s> 0)
            do
                if (*(esi_1 + 0x20) != 0)
                    ...
                    void* edx_2 = esi_1 + 0x64 + *(esi_1 + 0x1c)
                    ...
                    if (ecx != 0)
                        ...
                        int32_t var_1c_2 = 0
                        int32_t var_20_2 = 0
                        result = sub_584980(eax, data_702fec, data_702fe8, data_702ff0, edx_2, 
                            *(esi_1 + 4), *(esi_1 + 8), 0, 0, 1, *(esi_1 + 0x24), *(esi_1 + 0x28), 
                            data_702ff4, (data_702ff8).b, data_702ffc, data_703000, ecx_2, 0, 0, 0, 
                        ...
                        result = sub_584e80(eax, data_702fec, data_702fe8, data_702ff0, edx_2, 
                            *(esi_1 + 4), *(esi_1 + 8), ecx, ecx, 1, *(esi_1 + 0x24), 
                            *(esi_1 + 0x28), (data_702ff4).b)
