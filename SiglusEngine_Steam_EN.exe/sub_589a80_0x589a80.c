...
do
    ...
    do
        ...
        *edi = eax_10.b + (
            *(((eax_8 + *(((ebx_11 - eax_8) << 2) + data_1cd43c8) - eax_10) << 2) + data_1cd4384)).b
        ...
        edi[1] = eax_15.b + (
            *(((eax_13 + *(((ebx_23 - eax_13) << 2) + data_1cd43c8) - eax_15) << 2) + data_1cd438c)).b
        ...
        int32_t eax_20 = data_1cd44c0
        result = eax_20.b + (
            *(((eax_18 + *(((ebx_35 - eax_18) << 2) + data_1cd43c8) - eax_20) << 2) + data_1cd4394)).b
        edi[2] = result
        edi = &edi[4]
        j = j_1
        j_1 -= 1
