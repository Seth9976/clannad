...
if (eax != 0xfffffffe)
    sub_10002604((edi_1[1] + arg2 + 0x10) ^ *(eax + arg2 + 0x10))

sub_10002604((edi_1[3] + arg2 + 0x10) ^ *(edi_1[2] + arg2 + 0x10))
    ...
    if (i_2 != 0xfffffffe)
        ...
        do
            ...
            if (edi_1[i_2 * 3 + 5] == 0)
                ...
                if (eax_7 s> 0)
                    if (*arg1 == 0xe06d7363 && __IsNonwritableInCurrentImage(&
                            std::out_of_range::`vftable'{for `std::logic_error'}.
                            ___DestructExceptionObject) != 0)
                        int32_t var_2c_1 = 1
                        ___DestructExceptionObject(arg1)
                    
                    sub_100065f2(arg2, arg1)
                    void* eax_10 = arg2
                    ...
                    *(eax_10 + 0xc) = i
                    ...
                    if (eax_11 != 0xfffffffe)
                        sub_10002604((edi_1[1] + arg2 + 0x10) ^ *(eax_11 + arg2 + 0x10))
...
label_1000448b:
    ...
    if (eax_12 != 0xfffffffe)
        sub_10002604((edi_1[1] + arg2 + 0x10) ^ *(eax_12 + arg2 + 0x10))
