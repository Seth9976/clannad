...
label_1000f5e7:
    ...
    if (arg6 == 0)
        sub_1000f67d(eax_14, edx, ecx, esi, arg2, eax_14, arg4, edi, eax_1, arg7, arg8)
    label_1000f60b:
        result = __getptd()
    ...
    label_1000f44c:
        ...
        if (*(edi + 0xc) u> 0)
            int32_t var_2c
            int32_t var_14
            void* eax_15 = sub_1000ed06(edi, arg7, eax_1, &var_14, &var_2c)
                    ...
                    if (edx_1[-4] s<= eax_16 && eax_16 s<= edx_1[-3])
                        ...
                        label_1000f4ed:
                            ...
                            while (true)
                                ...
                                if (sub_1000fc9e(ecx_5, eax_20, esi[7]) != 0)
    ...
    if (eax_6[0x25] != 0)
        eax_8 = __getptd()[0x25]
        __getptd()[0x25] = 0
        eax_10, edx = sub_1000f799(esi, eax_8)
        ecx = eax_8
    ...
    if (*eax_8 s> 0)
        ...
        do
            if (type_info::operator==(*(eax_11 + eax_8[1] + 4), 
                ...
                sub_10004eaa(&var_40, 0x10016364)
                noreturn
