...
if ((ebx.b & 8) != 0 && (arg3 & 1) != 0)
    ...
    if (eax_2 == 0)
        ...
        if (p_4)
        label_100047b2:
            *ecx_3 = fconvert.d(fneg(fconvert.t(data_10017198)))
        else
            *ecx_3 = fconvert.d(fconvert.t(data_10017198))
    else if (eax_2 == 0x400)
        ecx_3 = arg2
        ...
        *ecx_3 = fconvert.d(fconvert.t(data_100171a8))
    else if (eax_2 == 0x800)
        ...
        if (not(p_2))
            *arg2 = fconvert.d(fconvert.t(data_10017198))
        else
            *arg2 = fconvert.d(fneg(fconvert.t(data_100171a8)))
    else if (eax_2 == 0xc00)
        ...
        long double x87_r0_2 = fconvert.t(data_100171a8)
    ...
    if (not(p_5))
        ...
        st0 = sub_100045da(esi_1, var_28_1, &arg1)
