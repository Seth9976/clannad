...
if ((eax_2 & 0x7fff) != 0)
    ...
    int32_t eax_10 = data_10017ee0 - 1
    int32_t var_30_1 = 0
    *edi_4 = *esi_1
    int32_t eax_12
    int32_t edx_3
    ...
    *(edi_4 + 4) = esi_1[1]
    ...
    int32_t edx_12 = data_10017edc
    
    if (ecx_10 s< edx_12 - data_10017ee0)
        var_14 = 0
        ...
        *edi_11 = *esi_5
        ...
        int32_t ecx_24 = data_10017ee4 + 1
        int32_t eax_63
        int32_t edx_30
        ...
        esi = 0
        i_1 = 2
    else if (ecx_10 s< data_10017ed8)
        int32_t esi_11 = data_10017eec
        var_14 &= 0x7fffffff
        int32_t ecx_39 = data_10017ee4
        int32_t eax_85
        int32_t edx_42
        ...
        *edi_24 = 0
        ...
        do
            ...
            ecx_38 -= 1
        while (temp5_1 - 1 s>= 0)
        esi = data_10017eec + data_10017ed8
        i_1 = 1
else
    esi = 0
    int32_t eax_8 = 0
...
int32_t eax_100 = data_10017ee8
int32_t esi_15 =
    esi << (0x1f - (data_10017ee4).b) | (sbb.d(eax_97, eax_97, eax_3 != 0) & 0x80000000) | var_14
