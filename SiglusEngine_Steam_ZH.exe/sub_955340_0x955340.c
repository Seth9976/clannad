    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                ebx_46.b = var_18[1]
                int32_t eax_20
                eax_20.b = not.b(ebx_46.b)
                int32_t var_f4
                int32_t var_e8
                int32_t var_dc
                int32_t eax_25 = var_f4 + *(((var_dc
                    + *(((eax_20 + *(((ebx_46 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)
                int32_t var_84
                int32_t ebx_59 = eax_25 + var_84
                int32_t ebx_67
                ...
                int32_t eax_28
                eax_28.b = edi[1]
                edi[1] = eax_28.b + (*(((ebx_67 - eax_28) << 2) + edx_2)).b
                int32_t ebx_76
                ebx_76.b = *var_18
                int32_t eax_30
                eax_30.b = not.b(ebx_76.b)
                int32_t var_f0
                int32_t var_e4
                int32_t var_d8
                int32_t eax_35 = var_f0 + *(((var_d8
                    + *(((eax_30 + *(((ebx_76 - eax_30) << 2) + var_d0) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4)
                int32_t var_80
                int32_t ebx_89 = eax_35 + var_80
                int32_t ebx_97
                ...
                int32_t eax_38
                eax_38.b = *edi
                result = eax_38 + *(((ebx_97 - eax_38) << 2) + edx_2)
                *edi = result.b
