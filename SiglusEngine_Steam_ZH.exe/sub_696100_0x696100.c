...
if (arg2 s< 0 || arg2 s>= arg3)
    ...
    var_8_1.b = 1
    int16_t var_48
    int16_t* eax_5 = sub_548cb0(eax_4, 0xafb9ec, &var_48, eax_4)
    var_8_1.b = 2
    int16_t var_30
    int16_t* eax_6 = sub_532b80(eax_5, eax_5, &var_30, 0xaf2fb4)
    var_8_1.b = 3
    int16_t var_60
    ...
    var_8_1.b = 5
    int16_t var_90
    sub_696370(arg1, sub_532b80(eax_7, eax_7, &var_90, 0xafba10))
    int32_t var_7c
