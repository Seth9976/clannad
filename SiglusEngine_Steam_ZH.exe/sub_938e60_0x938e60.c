...
do
    ...
    eax_18.b = edi[2]
    int32_t var_118
    int32_t eax_19 = eax_18 - *(ebx_24 + var_118)
    ...
    int32_t ebx_27
    ebx_27.b = var_18[1]
    int32_t eax_21 = edx_5 + *(((ebx_27 - edx_5) << 2) + eax_9)
    int32_t eax_22
    ...
    int32_t eax_28
    eax_28.b = edi[1]
    int32_t eax_29 = eax_28 - *(ebx_46 + var_118)
    ...
    int32_t ebx_49
    ebx_49.b = *var_18
    int32_t eax_31 = edx_5 + *(((ebx_49 - edx_5) << 2) + eax_9)
    int32_t eax_32
