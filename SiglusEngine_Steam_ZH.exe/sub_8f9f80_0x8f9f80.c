                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                int32_t var_ec
                                int32_t var_d0
                                int32_t ebx_43 = (*(((var_f8 + *(((eax_13
                                    + *(((eax_12 - eax_13) << 2) + var_d0) - var_f8) << 2) + var_ec))
                                    << 2) + *((eax_17 << 2) + &data_4e3da80)) - eax_21) << 2
                                edi[2] = eax_21.b + (*(ebx_43 + edx_2)).b
                                int32_t ebx_45
                                ebx_45.b = var_3c[1]
                                int32_t eax_24 = edx_6 + *(((ebx_45 - edx_6) << 2) + eax_10)
                                int32_t eax_25
                                ...
                                int32_t var_f4
                                int32_t var_e8
                                int32_t ebx_62 = (*(((var_f4 + *(((eax_25
                                    + *(((eax_24 - eax_25) << 2) + var_d0) - var_f4) << 2) + var_e8))
                                    << 2) + *((eax_29 << 2) + &data_4e3da80)) - eax_33) << 2
                                edi[1] = eax_33.b + (*(ebx_62 + edx_2)).b
                                int32_t ebx_64
                                ebx_64.b = *var_3c
                                int32_t eax_36 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_10)
                                int32_t eax_37
                                ...
                                int32_t var_f0
                                int32_t var_e4
                                int32_t ebx_81 = (*(((var_f0 + *(((eax_37
                                    + *(((eax_36 - eax_37) << 2) + var_d0) - var_f0) << 2) + var_e4))
                                    << 2) + *((eax_41 << 2) + &data_4e3da80)) - eax_45) << 2
                                *edi = eax_45.b + (*(ebx_81 + edx_2)).b
