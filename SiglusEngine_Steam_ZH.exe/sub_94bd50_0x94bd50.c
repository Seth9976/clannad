...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t var_d0
        int32_t eax_5 =
            var_e0 + *(((eax_2 + *(((ebx_5 - eax_2) << 2) + var_d0) - var_e0) << 2) + var_d4)
        int32_t var_88
        ...
        int32_t var_dc
        int32_t eax_13 =
            var_dc + *(((eax_10 + *(((ebx_31 - eax_10) << 2) + var_d0) - var_dc) << 2) + var_d4)
        int32_t var_84
        ...
        int32_t var_d8
        int32_t eax_21 =
            var_d8 + *(((eax_18 + *(((ebx_57 - eax_18) << 2) + var_d0) - var_d8) << 2) + var_d4)
        int32_t var_80
