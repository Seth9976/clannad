...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t var_d0
        int32_t eax_5 =
            var_f8 + *(((eax_2 + *(((ebx_5 - eax_2) << 2) + var_d0) - var_f8) << 2) + var_ec)
        int32_t var_88
        ...
        ebx_31.b = var_18[1]
        int32_t eax_10
        eax_10.b = not.b(ebx_31.b)
        int32_t var_f4
        int32_t var_e8
        int32_t eax_13 =
            var_f4 + *(((eax_10 + *(((ebx_31 - eax_10) << 2) + var_d0) - var_f4) << 2) + var_e8)
        int32_t var_84
        ...
        ebx_57.b = *var_18
        int32_t eax_18
        eax_18.b = not.b(ebx_57.b)
        int32_t var_f0
        int32_t var_e4
        int32_t eax_21 =
            var_f0 + *(((eax_18 + *(((ebx_57 - eax_18) << 2) + var_d0) - var_f0) << 2) + var_e4)
        int32_t var_80
