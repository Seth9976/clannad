            ...
            if (result != 0)
                ...
                if (result_2 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_f8
                        int32_t var_ec
                        int32_t eax_21 = var_f8 + *(((edx_10 + *(((ebx_23 - edx_10) << 2) + eax_17)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_32
                        ebx_32.b = var_18[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t eax_25 = var_f4 + *(((edx_10 + *(((ebx_32 - edx_10) << 2) + eax_17)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_41
                        ebx_41.b = *var_18
                        int32_t var_f0
                        int32_t var_e4
                        int32_t eax_29 = var_f0 + *(((edx_10 + *(((ebx_41 - edx_10) << 2) + eax_17)
                            - var_f0) << 2) + var_e4)
                        result = result_2
