                        ...
                        if (ebx_13 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                if (ebx_13 != 0xff)
                                    ...
                                    if (ebx_23 != 0)
                                        int32_t eax_8 = *((ebx_13 << 2) + &data_4d6e180)
                                        *((ebx_16 << 2) + eax_8)
                                        *((ebx_17 << 2) + eax_8)
                                        int32_t eax_9
                                        eax_9.b = edi[2]
                                        edi[2] = (divu.dp.d(mulu.dp.d(eax_9, edx_6), ecx_8)).b
                                        int32_t eax_14
                                        eax_14.b = edi[1]
                                        edi[1] = (divu.dp.d(mulu.dp.d(eax_14, edx_6), ecx_8)).b
                                        int32_t eax_19
                                        eax_19.b = *edi
                                        *edi = (divu.dp.d(mulu.dp.d(eax_19, edx_6), ecx_8)).b
                                        edi[3] = ecx_8.b
                                    else
                                        edi[2] = ebx_15.b
                                        edi[1] = ebx_16.b
