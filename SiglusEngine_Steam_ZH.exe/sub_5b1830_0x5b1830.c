...
int32_t (* var_c)(void* arg1) = sub_9ba460
TEB* fsbase
    ...
    if (eax_3 != ecx)
        ...
        if (arg2 u> eax_12)
            ...
            if (arg2 u> eax_21)
                ...
                int32_t ecx_17
                eax_22, ecx_17 = sub_552ff0(arg1, (edx_13 u>> 0x1f) + edx_13)
                
                if (eax_22.b != 0)
                    int32_t var_8_1 = 0
                    int32_t* var_30_6 = arg2
                    int32_t var_34_4 = ecx_17
                    arg1[1] = sub_553220(eax_22, ebx[1], *ebx, *arg1)
            else
                int128_t* ecx_9 = *ebx
                int32_t* var_30_2 = arg2
                void* esi_3 = eax_12 * 0x2c + ecx_9
                int32_t ecx_10
                eax_22, ecx_10 = sub_5b2210(eax_21, esi_3, ecx_9, *arg1)
                int32_t* var_30_3 = arg2
                int32_t var_34_3 = ecx_10
                arg1[1] = sub_553220(eax_22, ebx[1], esi_3, arg1[1])
        else
            int32_t* var_30_1 = arg2
            sub_5b2210(eax_12, ebx[1], *ebx, esi_1)
            int32_t eax_13
            int32_t edx_6
