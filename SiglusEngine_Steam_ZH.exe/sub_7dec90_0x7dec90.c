            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_d0
                        int32_t eax_17 = eax_16 + *(((eax_15 - eax_16) << 2) + var_d0)
                        int32_t ebx_27
                        ebx_27.b = esi_1[1]
                        int32_t eax_19 = edx_10 + *(((ebx_27 - edx_10) << 2) + eax_13)
                        int32_t eax_20
                        eax_20.b = not.b(eax_19.b)
                        int32_t eax_21 = eax_20 + *(((eax_19 - eax_20) << 2) + var_d0)
                        int32_t ebx_36
                        ebx_36.b = *esi_1
                        int32_t eax_23 = edx_10 + *(((ebx_36 - edx_10) << 2) + eax_13)
                        int32_t eax_24
                        ...
                        if (ebx_12 != 0xff)
                            ...
                            if (ebx_50 != 0)
                                int32_t eax_29 = *((ebx_12 << 2) + &data_4d6e180)
                                *((eax_21 << 2) + eax_29)
                                *((eax_25 << 2) + eax_29)
                                int32_t eax_30
                                eax_30.b = edi[2]
