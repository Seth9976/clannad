            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        eax_15.b = edi[2]
                        int32_t var_d0
                        edi[2] = eax_15.b + (*(((*(((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0))
                            << 2) + *((eax_11 << 2) + &data_4e3da80)) - eax_15) << 2) + edx_2)).b
                        int32_t ebx_31
                        ebx_31.b = esi_1[1]
                        int32_t eax_18 = edx_6 + *(((ebx_31 - edx_6) << 2) + eax_6)
                        int32_t eax_19
                        ...
                        int32_t ebx_46
                        ebx_46.b = *esi_1
                        int32_t eax_28 = edx_6 + *(((ebx_46 - edx_6) << 2) + eax_6)
                        int32_t eax_29
                        ...
                        int32_t eax_35
                        eax_35.b = *edi
                        *edi = eax_35.b + (*(((*(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0))
