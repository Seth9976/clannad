...
int32_t __saved_edi
int32_t var_1b4 = __security_cookie ^ &__saved_edi
...
if (ebx s< arg3)
    ...
    do
        ...
        var_c_1.b = 3
        int16_t var_e8
        int16_t* var_1b8_6 = sub_532b80(eax_9, eax_9, &var_e8, &data_af18c0)
        var_c_1.b = 4
        ...
        *(&var_a0 + (var_24 << 2)) = 0xffffffff.q
        var_24 += 2
        void var_238
        __builtin_memcpy(&var_238, &var_a0, 0x80)
        int32_t esi_3 = var_1a4
        arg1 = sub_5b7f70(*(result_1 + 0xa4) + esi_3, var_238)
        int32_t var_d4
