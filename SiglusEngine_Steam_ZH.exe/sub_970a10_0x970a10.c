    ...
    if (result != 0)
        ...
        if (result_1 != 0)
            ...
            if (ecx_6 != 0)
                ...
                int32_t var_e0
                int32_t var_d4
                int32_t eax_24 = var_e0
                    + *(((edx_10 + *(((ebx_14 - edx_10) << 2) + eax_20) - var_e0) << 2) + var_d4)
                int32_t ebx_23
                ebx_23.b = var_18[1]
                int32_t var_dc
                int32_t eax_28 = var_dc
                    + *(((edx_10 + *(((ebx_23 - edx_10) << 2) + eax_20) - var_dc) << 2) + var_d4)
                int32_t ebx_32
                ebx_32.b = *var_18
                int32_t var_d8
                int32_t eax_32 = var_d8
                    + *(((edx_10 + *(((ebx_32 - edx_10) << 2) + eax_20) - var_d8) << 2) + var_d4)
                result = result_1
                ...
                if (result != 0xff)
                    ...
                    if (ebx_46 != 0)
                        ...
                        *((eax_32 << 2) + eax_35)
                        ...
                        int32_t eax_46
                        eax_46.b = *edi
                        result = divu.dp.d(mulu.dp.d(eax_46, edx_6), ecx_6)
                        *edi = result.b
                        edi[3] = ecx_6.b
                    else
                        edi[2] = eax_24.b
