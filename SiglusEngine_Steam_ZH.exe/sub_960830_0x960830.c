...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t eax_26
            eax_26.b = edi[2]
            edi[2] = eax_26.b + (*(((*(((edx_6 + *(((ebx_17 - edx_6) << 2) + eax_19)) << 2)
            ...
            int32_t eax_34
            eax_34.b = edi[1]
            edi[1] = eax_34.b + (*(((*(((edx_6 + *(((ebx_28 - edx_6) << 2) + eax_19)) << 2)
                + *((eax_30 << 2) + &data_4e3da80)) - eax_34) << 2) + edx_2)).b
            int32_t ebx_39
            ebx_39.b = *var_18
            int32_t eax_38
            eax_38.b = *edi
            int32_t eax_42
            eax_42.b = *edi
            result = eax_42 + *(((*(((edx_6 + *(((ebx_39 - edx_6) << 2) + eax_19)) << 2)
                + *((eax_38 << 2) + &data_4e3da80)) - eax_42) << 2) + edx_2)
            *edi = result.b
