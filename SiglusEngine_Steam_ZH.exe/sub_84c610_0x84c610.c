                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t ebx_49 = ((var_f4 + *(((var_dc +
                            *(((edx_6 + *(((ebx_34 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8) - eax_24) << 2) + edx_2
                        edi[1] = eax_24.b + (*ebx_49).b
                        int32_t ebx_50
                        ebx_50.b = *esi_1
                        int32_t eax_32
                        eax_32.b = *edi
                        ...
                        int32_t ebx_65 = ((var_f0 + *(((var_d8 +
                            *(((edx_6 + *(((ebx_50 - edx_6) << 2) + eax_9) - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4) - eax_32) << 2) + edx_2
                        *edi = eax_32.b + (*ebx_65).b
