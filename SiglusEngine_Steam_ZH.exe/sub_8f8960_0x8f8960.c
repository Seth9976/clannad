                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t var_e8
                            int32_t var_dc
                            int32_t* ebx_53 = ((var_f4 + *(((var_dc + *(((edx_6
                                + *(((ebx_39 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)) << 2) + *((eax_29 << 2) + &data_4e3da80)
                            int32_t eax_33
                            eax_33.b = edi[1]
                            edi[1] = eax_33.b + (*(((*ebx_53 - eax_33) << 2) + edx_2)).b
                            int32_t ebx_58
                            ebx_58.b = *var_3c
                            int32_t eax_41
                            eax_41.b = *edi
                            ...
                            int32_t var_e4
                            int32_t var_d8
                            int32_t* ebx_72 = ((var_f0 + *(((var_d8 + *(((edx_6
                                + *(((ebx_58 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)) << 2) + *((eax_41 << 2) + &data_4e3da80)
                            int32_t eax_45
                            eax_45.b = *edi
                            *edi = eax_45.b + (*(((*ebx_72 - eax_45) << 2) + edx_2)).b
