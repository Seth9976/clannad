...
if (0x6666666 - edx_9 u>= eax_8)
    int32_t eax_11 = eax_8 + edx_9
    
    if (eax_11 u< esi_5)
        eax_11 = esi_5
    
    return sub_592540(arg1, eax_11) __tailcall
...
return sub_592540(arg1, eax_9) __tailcall
