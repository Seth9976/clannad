...
do
    ...
    do
        ...
        int32_t var_d0
        *(edi + 2) =
            (var_e0 + *(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - var_e0) << 2) + var_d4)).b
        int32_t ebx_17
        ebx_17.b = var_124[1]
        ...
        int32_t var_dc
        *(edi + 1) =
            (var_dc + *(((eax_16 + *(((eax_15 - eax_16) << 2) + var_d0) - var_dc) << 2) + var_d4)).b
        int32_t ebx_29
        ebx_29.b = *var_124
        ...
        int32_t var_d8
        *edi =
            (var_d8 + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_d8) << 2) + var_d4)).b
        result = var_124[3]
        *(edi + 3) = result
        edi += 4
        j = j_1
