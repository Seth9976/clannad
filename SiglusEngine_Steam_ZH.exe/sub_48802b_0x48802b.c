...
int64_t xmm4_4 = _mm_add_ps(_mm_add_ps(xmm4_2, xmm5_2), _mm_add_ps(xmm6_2, xmm7_2))
...
int64_t xmm5_8 = _mm_add_ps(xmm5_7, _mm_mul_ps(_mm_shuffle_ps(xmm6_7, xmm6_7, 0), xmm3_1))
...
int64_t xmm6_15 = _mm_add_ps(xmm6_14, _mm_mul_ps(_mm_shuffle_ps(xmm7_12, xmm7_12, 0), xmm3_1))
...
*arg1 = xmm4_4
*(arg1 + 8) = arg1[1] | xmm4_4 << 0x40
float xmm0_3[0x4] = _mm_add_ps(xmm0_2, xmm1_2)
arg1[2] = xmm5_8
*(arg1 + 0x18) = arg1[3] | xmm5_8 << 0x40
float xmm2_3[0x4] = _mm_add_ps(xmm2_2, xmm3_2)
arg1[4] = xmm6_15
*(arg1 + 0x28) = arg1[5] | xmm6_15 << 0x40
int64_t xmm0_4 = _mm_add_ps(xmm0_3, xmm2_3)
arg1[6] = xmm0_4
*(arg1 + 0x38) = arg1[7] | xmm0_4 << 0x40
return arg1
