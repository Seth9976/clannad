    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t ebx_32 = ((var_f8 + *(((var_e0
                ...
                - var_f8) << 2) + var_ec) - eax_26) << 2) + edx_2
            edi[2] = eax_26.b + (*ebx_32).b
            int32_t ebx_33
            ebx_33.b = var_18[1]
            int32_t eax_34
            eax_34.b = edi[1]
            ...
            int32_t ebx_48 = ((var_f4 + *(((var_dc
                + *(((edx_6 + *(((ebx_33 - edx_6) << 2) + eax_19) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8) - eax_34) << 2) + edx_2
            edi[1] = eax_34.b + (*ebx_48).b
            int32_t ebx_49
            ebx_49.b = *var_18
            int32_t eax_42
            eax_42.b = *edi
            ...
            int32_t ebx_64 = ((var_f0 + *(((var_d8
                + *(((edx_6 + *(((ebx_49 - edx_6) << 2) + eax_19) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4) - eax_42) << 2) + edx_2
            result = eax_42 + *ebx_64
            *edi = result.b
