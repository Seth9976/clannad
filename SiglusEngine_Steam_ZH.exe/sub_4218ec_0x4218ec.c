...
if (*(arg1 + 0x68) u> 0)
    ...
    do
        long double x87_r7_4 = fconvert.t(255f)
        ...
        if (*(arg1 + 0x5c) != 0)
            long double x87_r7_16 = fconvert.t(0.00392156886f)
        ...
        *ebx_32 = ((edx_12 << 8 | var_30_1) << 8 | var_34_1) << 8 | var_38_1
        arg4 = &arg4[ebx_2 * 4]
        eax_13 += ecx_9
        edi_4 += ecx_9
        ecx_11 += ecx_9
