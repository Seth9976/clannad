    ...
    if (temp0_1 + var_48 s>= 0)
        ...
        do
            ...
            if (edi s>= var_50)
                ...
                eax_11.b = *(edi + 2)
                int32_t var_d0
                *(edi + 2) = (*(((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0)) << 2)
                    + *((eax_11 << 2) + &data_4e3da80))).b
                int32_t ebx_17
                ebx_17.b = *(esi_1 + 1)
                int32_t eax_17 = edx_5 + *(((ebx_17 - edx_5) << 2) + eax_6)
                int32_t eax_18
                eax_18.b = not.b(eax_17.b)
                int32_t eax_20
                eax_20.b = *(edi + 1)
                *(edi + 1) = (*(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0)) << 2)
                    + *((eax_20 << 2) + &data_4e3da80))).b
                int32_t ebx_28
                ebx_28.b = *esi_1
                int32_t eax_26 = edx_5 + *(((ebx_28 - edx_5) << 2) + eax_6)
                int32_t eax_27
                eax_27.b = not.b(eax_26.b)
                int32_t eax_29
                eax_29.b = *edi
                *edi = (*(((eax_27 + *(((eax_26 - eax_27) << 2) + var_d0)) << 2)
