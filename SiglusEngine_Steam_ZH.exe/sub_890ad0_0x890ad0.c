    ...
    if (temp0_1 + var_48 s>= 0)
        ...
        do
            ...
            if (edi s>= var_50)
                ...
                eax_19.b = *(edi + 2)
                int32_t var_118
                *(edi + 2) = eax_19.b + (*(((*ebx_24 - eax_19) << 2) + var_118)).b
                int32_t ebx_29
                ebx_29.b = *(esi_1 + 1)
                int32_t eax_22 = edx_5 + *(((ebx_29 - edx_5) << 2) + eax_6)
                int32_t eax_23
                ...
                int32_t eax_33
                eax_33.b = *(edi + 1)
                *(edi + 1) = eax_33.b + (*(((*ebx_47 - eax_33) << 2) + var_118)).b
                int32_t ebx_52
                ebx_52.b = *esi_1
                int32_t eax_36 = edx_5 + *(((ebx_52 - edx_5) << 2) + eax_6)
                int32_t eax_37
                ...
                int32_t eax_47
                eax_47.b = *edi
                *edi = eax_47.b + (*(((*ebx_70 - eax_47) << 2) + var_118)).b
