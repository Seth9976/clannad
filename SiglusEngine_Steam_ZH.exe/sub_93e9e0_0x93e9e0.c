...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_ec
            int32_t var_d0
            int32_t eax_27 = eax_26 - *((neg.d(var_f8
                + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_f8) << 2) + var_ec)
                - 0xff) << 2) + edx_2)
            ...
            int32_t ebx_35
            ebx_35.b = var_18[1]
            int32_t eax_29 = edx_6 + *(((ebx_35 - edx_6) << 2) + eax_19)
            int32_t eax_30
            ...
            int32_t var_f4
            int32_t var_e8
            int32_t eax_35 = eax_34 - *((neg.d(var_f4
                + *(((eax_30 + *(((eax_29 - eax_30) << 2) + var_d0) - var_f4) << 2) + var_e8)
                - 0xff) << 2) + edx_2)
            ...
            int32_t ebx_53
            ebx_53.b = *var_18
            int32_t eax_37 = edx_6 + *(((ebx_53 - edx_6) << 2) + eax_19)
            int32_t eax_38
