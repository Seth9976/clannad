...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_ec
            int32_t eax_13 =
                var_f8 + *(((edx_10 + *(((ebx_6 - edx_10) << 2) + eax_9) - var_f8) << 2) + var_ec)
            int32_t ebx_15
            ebx_15.b = var_18[1]
            int32_t var_f4
            int32_t var_e8
            int32_t eax_17 =
                var_f4 + *(((edx_10 + *(((ebx_15 - edx_10) << 2) + eax_9) - var_f4) << 2) + var_e8)
            int32_t ebx_24
            ebx_24.b = *var_18
            int32_t var_f0
            int32_t var_e4
            int32_t eax_21 =
                var_f0 + *(((edx_10 + *(((ebx_24 - edx_10) << 2) + eax_9) - var_f0) << 2) + var_e4)
            result = result_1
