...
if ((edx_3 u>> 0x1f) + edx_3 s> 0)
    ...
    do
        ...
        int32_t eax_4
        int32_t edx_4
        edx_4:eax_4 = muls.dp.d(0x2f149903, *(arg1 + 0xa4) - *(arg1 + 0xa0))
...
int32_t eax_7
int32_t edx_6
edx_6:eax_7 = muls.dp.d(0x2f149903, *(arg1 + 0xa4) - *(arg1 + 0xa0))
int32_t i_2 = 0
...
if ((edx_7 u>> 0x1f) + edx_7 s> 0)
    ...
    do
        ...
        int32_t eax_11
        int32_t edx_8
        edx_8:eax_11 = muls.dp.d(0x2f149903, *(arg1 + 0xa4) - *(arg1 + 0xa0))
        edi_5 = var_c + 0x15c
        i_2 = i_1
        edx_9 = edx_8 s>> 6
        var_c = edi_5
