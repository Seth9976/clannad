            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    int32_t eax_12 = eax_11 -
                        *((neg.d(eax_9 + *(((eax_8 - eax_9) << 2) + var_d0) - 0xff) << 2) + edx_2)
                    ...
                    int32_t ebx_24
                    ebx_24.b = esi_1[1]
                    int32_t eax_14 = edx_6 + *(((ebx_24 - edx_6) << 2) + eax_6)
                    int32_t eax_15
                    eax_15.b = not.b(eax_14.b)
                    int32_t eax_17
                    eax_17.b = edi[1]
                    int32_t eax_18 = eax_17 - *((
                        neg.d(eax_15 + *(((eax_14 - eax_15) << 2) + var_d0) - 0xff) << 2) + edx_2)
                    ...
                    int32_t ebx_38
                    ebx_38.b = *esi_1
                    int32_t eax_20 = edx_6 + *(((ebx_38 - edx_6) << 2) + eax_6)
                    int32_t eax_21
                    eax_21.b = not.b(eax_20.b)
                    int32_t eax_23
                    eax_23.b = *edi
                    int32_t eax_24 = eax_23 - *((
                        neg.d(eax_21 + *(((eax_20 - eax_21) << 2) + var_d0) - 0xff) << 2) + edx_2)
