...
if (ebx s< arg3)
    ...
    do
        ...
        *(ebx_2 + 0x9c) = 0
        void* eax_13 = ebx_2 + 0xa0
        __builtin_memset(ebx_2 + 0xb8, 0, 0x20)
        *(ebx_2 + 0xd8) = 0xffffffff
        *(ebx_2 + 0xdc) = 0xffffffff
        __builtin_memset(ebx_2 + 0xe0, 0, 0x24)
        *(ebx_2 + 0x104) = 0xffffffff
        *(ebx_2 + 0x108) = 0xffffffff
        *(ebx_2 + 0x10c) = 0
        bool cond:0_1 = *(eax_13 + 0x14) u< 8
        *(eax_13 + 0x10) = 0
