...
if (arg2 != 0)
    ...
    void* result_1 = sub_75b7a5(eax_3, 0, FILE_CURRENT)
    ...
    if (result_1 s< 0)
        ...
        uint32_t i
        i.b = *(ecx_4 + (&data_b95720)[eax_5] + 0x24)
        i.b *= 2
        i.b s>>= 1
        ...
        if ((eax_6 & 0x108) != 0)
            ...
            if ((var_1028_1 & 3) != 0)
                if (i.b != 1 || *(ecx_4 + (&data_b95720)[eax_5] + 0x30) == 0)
                    result_3 = result_1
                    
                    if ((*(ecx_4 + (&data_b95720)[eax_5] + 4) & 0x80) != 0)
                ...
                if (*(var_1018 + 4) != 0)
                    ...
                    if (eax_10 != *(ecx_4 + eax_12 + 0x28) || edx_2 != *(ecx_4 + eax_12 + 0x2c))
                        result = 0xffffffff
                            ...
                            nullptr) == 0)
                        result = 0xffffffff
                    else if (sub_75b7a5(eax_3, result_1, FILE_BEGIN) s< 0)
                        result = 0xffffffff
                    else
                            ...
                            if (i_1 != 0)
                                ...
                                do
                                    ...
                                    if (numberOfBytesRead_1.b != 0xd)
                                        ecx_7 += sx.d(*(zx.d(numberOfBytesRead_1.b) + 0xb4cee0))
            ...
            label_74bb10:
                ...
                if (result_3 != 0)
                    ...
                    if (*(var_1018 + 4) != 0)
                        ...
                        if (sub_75b7a5(eax_3, 0, FILE_END) == result_1)
                        ...
                        int32_t eax_27
                        eax_27, i = sub_75b7a5(eax_3, result_1, FILE_BEGIN)
                        ...
                        if (eax_27 s>= 0)
                            ...
                            cond:4_1 = (*(ecx_4 + (&data_b95720)[eax_5] + 4) & 4) == 0
                        label_74bc28:
