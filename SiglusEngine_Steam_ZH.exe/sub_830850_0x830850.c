            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        eax_34.b = edi[1]
                        int32_t var_dc
                        int32_t ebx_62 = (*(((var_dc + *(((eax_26
                            + *(((eax_25 - eax_26) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                        ...
                        eax_46.b = *edi
                        int32_t var_d8
                        int32_t ebx_81 = (*(((var_d8 + *(((eax_38
                            + *(((eax_37 - eax_38) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
