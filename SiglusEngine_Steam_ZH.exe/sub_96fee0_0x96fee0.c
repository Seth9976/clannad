        ...
        if (result != 0)
            ...
            if (result_2 != 0)
                ...
                if (ecx_6 != 0)
                    ...
                    int32_t var_e0
                    int32_t var_d4
                    int32_t eax_23 = var_f8 + *(((var_e0 +
                        *(((edx_10 + *(((ebx_17 - edx_10) << 2) + eax_17) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec)
                    int32_t ebx_30
                    ebx_30.b = var_18[1]
                    int32_t var_f4
                    ...
                    int32_t eax_29 = var_f4 + *(((var_dc +
                        *(((edx_10 + *(((ebx_30 - edx_10) << 2) + eax_17) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)
                    int32_t ebx_43
                    ebx_43.b = *var_18
                    int32_t var_f0
                    ...
                    int32_t eax_35 = var_f0 + *(((var_d8 +
                        *(((edx_10 + *(((ebx_43 - edx_10) << 2) + eax_17) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4)
                    result = result_2
