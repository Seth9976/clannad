            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ecx_7 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_5 = var_f8 + *(((var_e0 + *(((ebx_4 - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_13
                        ebx_13.b = esi_1[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t eax_9 = var_f4 + *(((var_dc + *(((ebx_13 - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_22
                        ebx_22.b = *esi_1
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_13 = var_f0 + *(((var_d8 + *(((ebx_22 - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4)
