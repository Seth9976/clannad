...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_f4
            int32_t var_e8
            int32_t eax_35 = eax_34 + *(((var_f4
                + *(((eax_30 + *(((eax_29 - eax_30) << 2) + var_d0) - var_f4) << 2) + var_e8)) << 2)
                + edx_2)
            ...
            int32_t var_f0
            int32_t var_e4
            result = eax_42 + *(((var_f0
                + *(((eax_38 + *(((eax_37 - eax_38) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2)
                + edx_2)
