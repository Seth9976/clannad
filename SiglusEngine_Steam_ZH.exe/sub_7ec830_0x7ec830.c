            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_ec
                        int32_t var_d0
                        edi[2] = eax_9.b + (*(((var_f8 + *(((eax_5
                            + *(((ebx_22 - eax_5) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_9)
                            << 2) + edx_2)).b
                        int32_t ebx_34
                        ebx_34.b = var_124[1]
                        int32_t eax_11
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        edi[1] = eax_15.b + (*(((var_f4 + *(((eax_11
                            + *(((ebx_34 - eax_11) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_15)
                            << 2) + edx_2)).b
                        int32_t ebx_46
                        ebx_46.b = *var_124
                        int32_t eax_17
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        *edi = eax_21.b + (*(((var_f0 + *(((eax_17
                            + *(((ebx_46 - eax_17) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_21)
                            << 2) + edx_2)).b
