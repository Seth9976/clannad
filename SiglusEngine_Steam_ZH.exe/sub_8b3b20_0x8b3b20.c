            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_f8
                        int32_t var_ec
                        edi[2] = eax_15.b + (*(((var_f8 + *(((edx_6
                            + *(((ebx_17 - edx_6) << 2) + eax_10) - var_f8) << 2) + var_ec) - eax_15)
                            << 2) + edx_2)).b
                        int32_t ebx_29
                        ebx_29.b = var_3c[1]
                        int32_t eax_21
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        edi[1] = eax_21.b + (*(((var_f4 + *(((edx_6
                            + *(((ebx_29 - edx_6) << 2) + eax_10) - var_f4) << 2) + var_e8) - eax_21)
                            << 2) + edx_2)).b
                        int32_t ebx_41
                        ebx_41.b = *var_3c
                        int32_t eax_27
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        *edi = eax_27.b + (*(((var_f0 + *(((edx_6
                            + *(((ebx_41 - edx_6) << 2) + eax_10) - var_f0) << 2) + var_e4) - eax_27)
                            << 2) + edx_2)).b
