...
do
    ...
    do
        ...
        int32_t var_d0
        int32_t eax_4 =
            var_f8 + *(((eax_1 + *(((ebx_1 - eax_1) << 2) + var_d0) - var_f8) << 2) + var_ec)
        int32_t var_88
        ...
        *(edi + 2) = eax_7.b + (*(((ebx_18 - eax_7) << 2) + var_118)).b
        ...
        int32_t var_e8
        int32_t eax_12 =
            var_f4 + *(((eax_9 + *(((ebx_27 - eax_9) << 2) + var_d0) - var_f4) << 2) + var_e8)
        int32_t var_84
        ...
        *(edi + 1) = eax_15.b + (*(((ebx_44 - eax_15) << 2) + var_118)).b
        ...
        int32_t var_e4
        int32_t eax_20 =
            var_f0 + *(((eax_17 + *(((ebx_53 - eax_17) << 2) + var_d0) - var_f0) << 2) + var_e4)
        int32_t var_80
