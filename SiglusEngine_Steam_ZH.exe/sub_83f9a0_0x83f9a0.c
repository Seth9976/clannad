                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t eax_21 = var_f8 + *(((var_e0 + *(((eax_16
                            + *(((eax_15 - eax_16) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec)
                        int32_t ebx_35
                        ebx_35.b = var_124[1]
                        int32_t eax_23 = edx_10 + *(((ebx_35 - edx_10) << 2) + eax_13)
                        int32_t eax_24
                        ...
                        int32_t ebx_52
                        ebx_52.b = *var_124
                        int32_t eax_31 = edx_10 + *(((ebx_52 - edx_10) << 2) + eax_13)
                        int32_t eax_32
                        ...
                        if (ebx_12 != 0xff)
                            ...
                            if (ebx_74 != 0)
                                int32_t eax_41 = *((ebx_12 << 2) + &data_4d6e180)
                                *((eax_29 << 2) + eax_41)
                                *((eax_37 << 2) + eax_41)
                                int32_t eax_42
                                eax_42.b = edi[2]
