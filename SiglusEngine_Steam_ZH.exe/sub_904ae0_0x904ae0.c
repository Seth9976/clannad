            ...
            if (edi s>= var_50)
                ...
                if (ecx_7 != 0)
                    ...
                    if (var_114 != 0xff)
                        ...
                        if (ebx_45 != 0)
                            int32_t eax_22 = *((var_114 << 2) + &data_4d6e180)
                            *((eax_13 << 2) + eax_22)
                            *((eax_19 << 2) + eax_22)
                            int32_t eax_23
                            eax_23.b = edi[2]
                            edi[2] = (divu.dp.d(mulu.dp.d(eax_23, edx_5), ecx_7)).b
                            int32_t eax_28
                            eax_28.b = edi[1]
                            edi[1] = (divu.dp.d(mulu.dp.d(eax_28, edx_5), ecx_7)).b
                            int32_t eax_33
                            eax_33.b = *edi
                            *edi = divu.dp.d(mulu.dp.d(eax_33, edx_5), ecx_7).b
                            edi[3] = ecx_7.b
                        else
                            edi[2] = eax_7.b
                            edi[1] = eax_13.b
