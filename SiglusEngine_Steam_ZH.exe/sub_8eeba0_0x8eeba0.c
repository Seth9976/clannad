                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t eax_9 = var_f8 + *(((var_e0 + *(((eax_4
                                + *(((ebx_16 - eax_4) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec)
                            int32_t var_88
                            int32_t ebx_29 = eax_9 + var_88
                            int32_t ebx_37
                            ...
                            int32_t eax_12
                            eax_12.b = edi[2]
                            edi[2] = eax_12.b + (*(((ebx_37 - eax_12) << 2) + edx_2)).b
                            int32_t ebx_46
                            ebx_46.b = var_3c[1]
                            int32_t eax_14
                            eax_14.b = not.b(ebx_46.b)
                            int32_t var_f4
                            int32_t var_e8
                            int32_t var_dc
                            int32_t eax_19 = var_f4 + *(((var_dc + *(((eax_14
                                + *(((ebx_46 - eax_14) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)
                            int32_t var_84
                            int32_t ebx_59 = eax_19 + var_84
                            int32_t ebx_67
                            ...
                            if (eax_19 + var_84 s< 0)
                                ...
                                int32_t ebx_62
                                ebx_62.b = edi[1]
                                ebx_67 = *(((ebx_62 - 0xff) << 2) + *((ebx_59 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_22
                            eax_22.b = edi[1]
                            edi[1] = eax_22.b + (*(((ebx_67 - eax_22) << 2) + edx_2)).b
                            int32_t ebx_76
                            ebx_76.b = *var_3c
                            int32_t eax_24
                            eax_24.b = not.b(ebx_76.b)
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t eax_29 = var_f0 + *(((var_d8 + *(((eax_24
                                + *(((ebx_76 - eax_24) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)
                            int32_t var_80
                            int32_t ebx_89 = eax_29 + var_80
                            int32_t ebx_97
                            ...
                            if (eax_29 + var_80 s< 0)
                                ...
                                int32_t ebx_92
                                ebx_92.b = *edi
                                ebx_97 = *(((ebx_92 - 0xff) << 2) + *((ebx_89 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_32
                            eax_32.b = *edi
                            *edi = eax_32.b + (*(((ebx_97 - eax_32) << 2) + edx_2)).b
