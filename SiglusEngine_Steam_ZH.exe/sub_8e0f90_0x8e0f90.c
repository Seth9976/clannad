        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    int32_t eax_14
                    eax_14.b = edi[2]
                    edi[2] = eax_14.b + (*(((ebx_26 - eax_14) << 2) + edx_2)).b
                    int32_t ebx_35
                    ebx_35.b = var_3c[1]
                    int32_t var_dc
                    int32_t eax_19 = var_dc
                        + *(((edx_6 + *(((ebx_35 - edx_6) << 2) + eax_7) - var_dc) << 2) + var_d4)
                    int32_t var_84
                    ...
                    int32_t eax_27 = var_d8
                        + *(((edx_6 + *(((ebx_61 - edx_6) << 2) + eax_7) - var_d8) << 2) + var_d4)
                    int32_t var_80
                    ...
                    int32_t eax_30
                    eax_30.b = *edi
                    *edi = eax_30.b + (*(((ebx_78 - eax_30) << 2) + edx_2)).b
