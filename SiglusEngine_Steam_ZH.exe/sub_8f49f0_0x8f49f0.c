            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ebx_7 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_32 = (*(((var_e0 + *(((eax_10
                            + *(((eax_9 - eax_10) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2)
                        ...
                        eax_42.b = *edi
                        int32_t var_d8
                        int32_t ebx_70 = (*(((var_d8 + *(((eax_34
                            + *(((eax_33 - eax_34) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
