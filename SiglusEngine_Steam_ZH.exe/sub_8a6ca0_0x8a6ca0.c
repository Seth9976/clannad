                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                int32_t var_e0
                                int32_t var_d4
                                int32_t eax_15 = var_e0 + *(((edx_10
                                    + *(((ebx_19 - edx_10) << 2) + eax_11) - var_e0) << 2) + var_d4)
                                int32_t ebx_28
                                ebx_28.b = esi_1[1]
                                int32_t var_dc
                                int32_t eax_19 = var_dc + *(((edx_10
                                    + *(((ebx_28 - edx_10) << 2) + eax_11) - var_dc) << 2) + var_d4)
                                int32_t ebx_37
                                ebx_37.b = *esi_1
                                int32_t var_d8
                                int32_t eax_23 = var_d8 + *(((edx_10
                                    + *(((ebx_37 - edx_10) << 2) + eax_11) - var_d8) << 2) + var_d4)
                                ...
                                if (ebx_13 != 0xff)
                                    ...
                                    if (ebx_51 != 0)
                                        int32_t eax_27 = *((ebx_13 << 2) + &data_4d6e180)
                                        *((eax_19 << 2) + eax_27)
                                        *((eax_23 << 2) + eax_27)
                                        int32_t eax_28
                                        eax_28.b = edi[2]
