    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t* ebx_31 = ((var_f8 + *(((var_e0
                ...
                - var_f8) << 2) + var_ec)) << 2) + *((eax_26 << 2) + &data_4e3da80)
            int32_t eax_30
            eax_30.b = edi[2]
            edi[2] = eax_30.b + (*(((*ebx_31 - eax_30) << 2) + edx_2)).b
            int32_t ebx_36
            ebx_36.b = var_18[1]
            int32_t eax_38
            eax_38.b = edi[1]
            ...
            int32_t* ebx_50 = ((var_f4 + *(((var_dc
                + *(((edx_6 + *(((ebx_36 - edx_6) << 2) + eax_19) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8)) << 2) + *((eax_38 << 2) + &data_4e3da80)
            int32_t eax_42
            eax_42.b = edi[1]
            edi[1] = eax_42.b + (*(((*ebx_50 - eax_42) << 2) + edx_2)).b
            int32_t ebx_55
            ebx_55.b = *var_18
            int32_t eax_50
            eax_50.b = *edi
            ...
            int32_t* ebx_69 = ((var_f0 + *(((var_d8
                + *(((edx_6 + *(((ebx_55 - edx_6) << 2) + eax_19) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4)) << 2) + *((eax_50 << 2) + &data_4e3da80)
            int32_t eax_54
            eax_54.b = *edi
            result = eax_54 + *(((*ebx_69 - eax_54) << 2) + edx_2)
            *edi = result.b
