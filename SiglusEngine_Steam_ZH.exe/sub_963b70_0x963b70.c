...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t eax_23
            eax_23.b = edi[2]
            edi[2] = eax_23.b + (*(((*ebx_27 - eax_23) << 2) + edx_2)).b
            int32_t ebx_32
            ebx_32.b = var_18[1]
            int32_t eax_25
            eax_25.b = not.b(ebx_32.b)
            int32_t eax_31
            eax_31.b = edi[1]
            int32_t var_f4
            int32_t var_e8
            ...
            int32_t* ebx_46 = ((var_f4 + *(((var_dc
                + *(((eax_25 + *(((ebx_32 - eax_25) << 2) + var_d0) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8)) << 2) + *((eax_31 << 2) + &data_4e3da80)
            int32_t eax_35
            eax_35.b = edi[1]
            edi[1] = eax_35.b + (*(((*ebx_46 - eax_35) << 2) + edx_2)).b
            int32_t ebx_51
            ebx_51.b = *var_18
            int32_t eax_37
            eax_37.b = not.b(ebx_51.b)
            int32_t eax_43
            eax_43.b = *edi
            int32_t var_f0
            int32_t var_e4
            ...
            int32_t* ebx_65 = ((var_f0 + *(((var_d8
                + *(((eax_37 + *(((ebx_51 - eax_37) << 2) + var_d0) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4)) << 2) + *((eax_43 << 2) + &data_4e3da80)
            int32_t eax_47
            eax_47.b = *edi
            result = eax_47 + *(((*ebx_65 - eax_47) << 2) + edx_2)
            *edi = result.b
