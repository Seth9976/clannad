...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t var_d0
        int32_t eax_3 = eax_2 + *(((ebx_5 - eax_2) << 2) + var_d0)
        int32_t var_88
        ...
        ebx_27.b = var_18[1]
        int32_t eax_8
        eax_8.b = not.b(ebx_27.b)
        int32_t eax_9 = eax_8 + *(((ebx_27 - eax_8) << 2) + var_d0)
        int32_t var_84
        ...
        ebx_49.b = *var_18
        int32_t eax_14
        eax_14.b = not.b(ebx_49.b)
        int32_t eax_15 = eax_14 + *(((ebx_49 - eax_14) << 2) + var_d0)
        int32_t var_80
