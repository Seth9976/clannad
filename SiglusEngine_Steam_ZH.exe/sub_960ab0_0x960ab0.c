...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_ec
            int32_t var_d0
            int32_t ebx_34 = (*(((var_f8
                + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_f8) << 2) + var_ec)) << 2)
                + *((eax_26 << 2) + &data_4e3da80)) - eax_30) << 2
            edi[2] = eax_30.b + (*(ebx_34 + edx_2)).b
            int32_t ebx_36
            ebx_36.b = var_18[1]
            int32_t eax_33 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_19)
            int32_t eax_34
            ...
            int32_t var_f4
            int32_t var_e8
            int32_t ebx_53 = (*(((var_f4
                + *(((eax_34 + *(((eax_33 - eax_34) << 2) + var_d0) - var_f4) << 2) + var_e8)) << 2)
                + *((eax_38 << 2) + &data_4e3da80)) - eax_42) << 2
            edi[1] = eax_42.b + (*(ebx_53 + edx_2)).b
            int32_t ebx_55
            ebx_55.b = *var_18
            int32_t eax_45 = edx_6 + *(((ebx_55 - edx_6) << 2) + eax_19)
            int32_t eax_46
            ...
            int32_t var_f0
            int32_t var_e4
            int32_t ebx_72 = (*(((var_f0
                + *(((eax_46 + *(((eax_45 - eax_46) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2)
                + *((eax_50 << 2) + &data_4e3da80)) - eax_54) << 2
            result = eax_54 + *(ebx_72 + edx_2)
            *edi = result.b
