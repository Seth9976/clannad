            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_ec
                        int32_t var_d0
                        int32_t eax_10 = var_f8 + *(((eax_7 + *(((ebx_14 - eax_7) << 2) + var_d0)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_23
                        ebx_23.b = esi_1[1]
                        int32_t eax_11
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        int32_t eax_14 = var_f4 + *(((eax_11 + *(((ebx_23 - eax_11) << 2) + var_d0)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_32
                        ebx_32.b = *esi_1
                        int32_t eax_15
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        int32_t eax_18 = var_f0 + *(((eax_15 + *(((ebx_32 - eax_15) << 2) + var_d0)
                            - var_f0) << 2) + var_e4)
