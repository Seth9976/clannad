        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t eax_20
                    eax_20.b = edi[2]
                    edi[2] = eax_20.b + (*(((*ebx_36 - eax_20) << 2) + edx_2)).b
                    int32_t ebx_41
                    ebx_41.b = var_18[1]
                    int32_t eax_22
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t* ebx_55 = ((var_f4 + *(((var_dc +
                        *(((eax_22 + *(((ebx_41 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)) << 2) + *((eax_28 << 2) + &data_4e3da80)
                    int32_t eax_32
                    eax_32.b = edi[1]
                    edi[1] = eax_32.b + (*(((*ebx_55 - eax_32) << 2) + edx_2)).b
                    int32_t ebx_60
                    ebx_60.b = *var_18
                    int32_t eax_34
                    eax_34.b = not.b(ebx_60.b)
                    int32_t eax_40
                    eax_40.b = *edi
                    int32_t var_f0
                    int32_t var_e4
                    ...
                    int32_t* ebx_74 = ((var_f0 + *(((var_d8 +
                        *(((eax_34 + *(((ebx_60 - eax_34) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4)) << 2) + *((eax_40 << 2) + &data_4e3da80)
                    int32_t eax_44
                    eax_44.b = *edi
                    result = eax_44 + *(((*ebx_74 - eax_44) << 2) + edx_2)
                    *edi = result.b
