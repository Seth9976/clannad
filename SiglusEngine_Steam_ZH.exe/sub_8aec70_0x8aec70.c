        ...
        do
            ...
            if (edi s>= var_50)
                ...
                int32_t ebx_20 = ((var_f8 + *(((var_e0
                    ...
                    - var_f8) << 2) + var_ec) - eax_14) << 2) + var_118
                *(edi + 2) = eax_14.b + (*ebx_20).b
                int32_t ebx_21
                ebx_21.b = var_3c[1]
                int32_t eax_22
                eax_22.b = *(edi + 1)
                ...
                int32_t ebx_36 = ((var_f4 + *(((var_dc
                    ...
                    - var_f4) << 2) + var_e8) - eax_22) << 2) + var_118
                *(edi + 1) = eax_22.b + (*ebx_36).b
                int32_t ebx_37
                ebx_37.b = *var_3c
                int32_t eax_30
                eax_30.b = *edi
                ...
                int32_t ebx_52 = ((var_f0 + *(((var_d8
                    + *(((edx_5 + *(((ebx_37 - edx_5) << 2) + eax_7) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4) - eax_30) << 2) + var_118
                *edi = eax_30.b + (*ebx_52).b
