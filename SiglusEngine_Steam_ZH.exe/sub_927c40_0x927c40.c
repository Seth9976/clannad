...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            eax_23.b = edi[1]
            int32_t var_dc
            int32_t eax_24 = eax_23 + *(((var_dc
                + *(((eax_19 + *(((ebx_25 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                + edx_2)
            ...
            result = eax_29 + *(((var_d8
                + *(((eax_25 + *(((ebx_37 - eax_25) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                + edx_2)
