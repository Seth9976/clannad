        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                int32_t ebx_51 = *(((var_f4 + *(((var_dc
                    + *(((edx_6 + *(((ebx_36 - edx_6) << 2) + eax_16) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)) << 2) + edx_2)
                int32_t eax_31
                eax_31.b = edi[1]
                int32_t eax_32 = eax_31 - ebx_51
                ...
                int32_t ebx_67 = *(((var_f0 + *(((var_d8
                    + *(((edx_6 + *(((ebx_52 - edx_6) << 2) + eax_16) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4)) << 2) + edx_2)
                int32_t eax_39
                eax_39.b = *edi
                result = eax_39 - ebx_67
