...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t ebx_33
            ebx_33.b = var_18[1]
            int32_t eax_29 = edx_6 + *(((ebx_33 - edx_6) << 2) + eax_19)
            int32_t eax_30
            eax_30.b = not.b(eax_29.b)
            int32_t eax_34
            eax_34.b = edi[1]
            int32_t var_dc
            int32_t eax_35 = eax_34 + *(((var_dc
                + *(((eax_30 + *(((eax_29 - eax_30) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                + edx_2)
            ...
            int32_t ebx_49
            ebx_49.b = *var_18
            int32_t eax_37 = edx_6 + *(((ebx_49 - edx_6) << 2) + eax_19)
            int32_t eax_38
            eax_38.b = not.b(eax_37.b)
            int32_t eax_42
            eax_42.b = *edi
            int32_t var_d8
            result = eax_42 + *(((var_d8
                + *(((eax_38 + *(((eax_37 - eax_38) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                + edx_2)
