...
int32_t ebx = arg1[2]
int32_t esi = arg1[1]
int32_t result = (ebx - esi) s/ 0x150
...
if (0xc30c30 - edx_9 u>= eax_8)
    int32_t eax_11 = eax_8 + edx_9
    
    if (eax_11 u< esi_5)
        eax_11 = esi_5
    
    return sub_632f70(arg1, eax_11) __tailcall
...
return sub_632f70(arg1, eax_9) __tailcall
