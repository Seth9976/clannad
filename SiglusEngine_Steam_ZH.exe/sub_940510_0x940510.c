    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t eax_25 = eax_24
                - *((neg.d(eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - 0xff) << 2) + edx_2)
            ...
            int32_t ebx_31
            ebx_31.b = var_18[1]
            int32_t eax_27 = edx_6 + *(((ebx_31 - edx_6) << 2) + eax_19)
            int32_t eax_28
            eax_28.b = not.b(eax_27.b)
            int32_t eax_30
            eax_30.b = edi[1]
            int32_t eax_31 = eax_30
                - *((neg.d(eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - 0xff) << 2) + edx_2)
            ...
            int32_t ebx_45
            ebx_45.b = *var_18
            int32_t eax_33 = edx_6 + *(((ebx_45 - edx_6) << 2) + eax_19)
            int32_t eax_34
            eax_34.b = not.b(eax_33.b)
            int32_t eax_36
            eax_36.b = *edi
            result = eax_36
                - *((neg.d(eax_34 + *(((eax_33 - eax_34) << 2) + var_d0) - 0xff) << 2) + edx_2)
