...
if (arg3 != 0)
    ...
    if (hWnd s> 0)
        ...
        do
            ...
            if (*arg4 s>= hWnd_1)
                int32_t eax_8 = *(data_bac4e0 + 0x14)
                
                if (eax_8 != 0)
                    ecx_2 = eax_8(arg2[1], eax_2)
            
            LRESULT (__stdcall* const var_50_3)(HWND hWnd, uint32_t Msg, WPARAM wParam, 
                LPARAM lParam) = ecx_2
            int32_t var_34 = 1
            int16_t var_2c
            int16_t* eax_9 = sub_6ad9b0(&var_2c)
            int32_t var_8_1 = 0
            int32_t ecx_5 = *(data_bac4e0 + 0x34)
            
            if (ecx_5 != 0)
                ecx_5(arg2[1], *arg4, 0, eax_9, eax_2)
            ...
            hWnd = sub_585900(&var_34, *(ecx_7 + 0x80), ecx_7, arg2, arg4, &var_34)
            *arg4 += 1
            ebx_1 += 1
            var_30_1 += 0x260
            ecx_2 = SendMessageW
        while (ebx_1 s< hWnd_2)
