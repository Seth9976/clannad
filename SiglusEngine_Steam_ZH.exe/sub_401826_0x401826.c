...
if (i_1 u> 0)
    ...
    do
        ...
        long double x87_r7_5 = fconvert.t(arg5[4]) * fconvert.t(*(edx_1 + 4))
            + fconvert.t(arg5[8]) * fconvert.t(*(edx_1 + 8))
        ...
        float var_c_1 = fconvert.s(fconvert.t(*(edx_1 + 8)) * fconvert.t(arg5[0xa])
            + fconvert.t(*edx_1) * fconvert.t(arg5[2])
            + fconvert.t(*(edx_1 + 4)) * fconvert.t(arg5[6]) + fconvert.t(arg5[0xe]))
        long double x87_r7_18 = fconvert.t(arg5[3]) * fconvert.t(*edx_1)
            + fconvert.t(arg5[7]) * fconvert.t(*(edx_1 + 4))
        long double x87_r6_16 = fconvert.t(arg5[0xb]) * fconvert.t(*(edx_1 + 8))
        edx_1 += arg4
        i = i_1
        i_1 -= 1
        float var_8_1 = fconvert.s(x87_r7_18 + x87_r6_16 + fconvert.t(arg5[0xf]))
        *edi_1 = fconvert.s(x87_r7_5)
        void* edi_2 = &edi_1[1]
        float* esi_1 = &var_10
        *edi_2 = *esi_1
        void* edi_3 = edi_2 + 4
