        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t eax_11
                    eax_11.b = edi[2]
                    int32_t eax_12 = eax_11 - *(ebx_31 + edx_2)
                    ...
                    ebx_34.b = esi_1[1]
                    int32_t eax_13
                    eax_13.b = not.b(ebx_34.b)
                    int32_t var_f4
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_49 = neg.d(var_f4 + *(((var_dc +
                        *(((eax_13 + *(((ebx_34 - eax_13) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - 0xff) << 2
                    int32_t eax_19
                    eax_19.b = edi[1]
                    int32_t eax_20 = eax_19 - *(ebx_49 + edx_2)
                    ...
                    ebx_52.b = *esi_1
                    int32_t eax_21
                    eax_21.b = not.b(ebx_52.b)
                    int32_t var_f0
                    int32_t var_e4
                    int32_t var_d8
                    int32_t ebx_67 = neg.d(var_f0 + *(((var_d8 +
                        *(((eax_21 + *(((ebx_52 - eax_21) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - 0xff) << 2
                    int32_t eax_27
                    eax_27.b = *edi
                    int32_t eax_28 = eax_27 - *(ebx_67 + edx_2)
