...
if (*(arg1 + 0x3c) == 0)
    result = sub_5cca20(&arg2)
    
    if (result s< 0)
        return result
    
    (*arg2[9])(&arg2[9], 0xaf2580, arg1 + 0x3c)

if (*(arg1 + 0x40) == 0)
    result = sub_5ccae0(&arg2)
    
    if (result s< 0)
        return result
    
    (*arg2[9])(&arg2[9], 0xaf2570, arg1 + 0x40)
...
if (*(arg1 + 0x98) == 0)
    ...
    paccel.key = 0
    paccel.cmd = 0
    *(arg1 + 0x98) = CreateAcceleratorTableW(&paccel, 1)
