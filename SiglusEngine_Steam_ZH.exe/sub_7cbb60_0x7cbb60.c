            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t* ebx_59 = ((var_f4 + *(((var_dc + *(((edx_6
                            + *(((ebx_45 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8)) << 2) + *((eax_30 << 2) + &data_4e3da80)
                        int32_t eax_34
                        eax_34.b = edi[1]
                        edi[1] = eax_34.b + (*(((*ebx_59 - eax_34) << 2) + edx_2)).b
                        int32_t ebx_64
                        ebx_64.b = *esi_1
                        int32_t eax_42
                        eax_42.b = *edi
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t* ebx_78 = ((var_f0 + *(((var_d8 + *(((edx_6
                            + *(((ebx_64 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4)) << 2) + *((eax_42 << 2) + &data_4e3da80)
                        int32_t eax_46
                        eax_46.b = *edi
                        *edi = eax_46.b + (*(((*ebx_78 - eax_46) << 2) + edx_2)).b
