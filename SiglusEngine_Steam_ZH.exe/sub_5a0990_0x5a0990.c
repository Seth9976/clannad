...
int32_t (* var_c)(void* arg1) = sub_9b9320
TEB* fsbase
...
if (ecx_2 u> arg2)
    result = esi + (arg2 - ecx_2) * 0xc
    arg1[1] = result
else if (ecx_2 u< arg2)
    sub_5a0ae0(arg1, arg2 - ecx_2)
    int32_t var_8_1 = 0
    ...
    sub_5a0c90(arg1[1], arg2 - ((edx_5 u>> 0x1f) + edx_5))
    esi = arg1[1]
    int32_t eax_10
    int32_t edx_8
    edx_8:eax_10 = muls.dp.d(0x2aaaaaab, esi - *arg1)
    int32_t edx_9 = edx_8 s>> 1
    result = esi + (arg2 - ((edx_9 u>> 0x1f) + edx_9)) * 0xc
    arg1[1] = result
