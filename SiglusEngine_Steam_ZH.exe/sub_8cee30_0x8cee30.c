                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                eax_15.b = edi[2]
                                int32_t var_d0
                                int32_t eax_16 = eax_15 - *(((eax_13
                                    + *(((eax_12 - eax_13) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                int32_t ebx_38
                                ebx_38.b = var_3c[1]
                                int32_t eax_18 = edx_6 + *(((ebx_38 - edx_6) << 2) + eax_10)
                                int32_t eax_19
                                eax_19.b = not.b(eax_18.b)
                                int32_t eax_21
                                eax_21.b = edi[1]
                                int32_t eax_22 = eax_21 - *(((eax_19
                                    + *(((eax_18 - eax_19) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                int32_t ebx_50
                                ebx_50.b = *var_3c
                                int32_t eax_24 = edx_6 + *(((ebx_50 - edx_6) << 2) + eax_10)
                                int32_t eax_25
                                eax_25.b = not.b(eax_24.b)
                                int32_t eax_27
                                eax_27.b = *edi
                                int32_t eax_28 = eax_27 - *(((eax_25
                                    + *(((eax_24 - eax_25) << 2) + var_d0)) << 2) + edx_2)
