            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_17 = eax_16 - *((neg.d(var_e0 + *(((eax_12
                            + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        int32_t ebx_36
                        ebx_36.b = esi_1[1]
                        int32_t eax_19 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_9)
                        int32_t eax_20
                        eax_20.b = not.b(eax_19.b)
                        int32_t eax_24
                        eax_24.b = edi[1]
                        int32_t var_dc
                        int32_t eax_25 = eax_24 - *((neg.d(var_dc + *(((eax_20
                            + *(((eax_19 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        int32_t ebx_54
                        ebx_54.b = *esi_1
                        int32_t eax_27 = edx_6 + *(((ebx_54 - edx_6) << 2) + eax_9)
                        int32_t eax_28
                        eax_28.b = not.b(eax_27.b)
                        int32_t eax_32
                        eax_32.b = *edi
                        int32_t var_d8
                        int32_t eax_33 = eax_32 - *((neg.d(var_d8 + *(((eax_28
                            + *(((eax_27 - eax_28) << 2) + var_d0) - var_d8) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
