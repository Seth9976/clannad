...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t ebx_39
        ebx_39.b = var_18[1]
        int32_t eax_20 = edx_6 + *(((ebx_39 - edx_6) << 2) + eax_8)
        int32_t eax_21
        eax_21.b = not.b(eax_20.b)
        int32_t var_dc
        int32_t eax_24 =
            var_dc + *(((eax_21 + *(((eax_20 - eax_21) << 2) + var_d0) - var_dc) << 2) + var_d4)
        int32_t var_84
        ...
        int32_t ebx_69
        ebx_69.b = *var_18
        int32_t eax_30 = edx_6 + *(((ebx_69 - edx_6) << 2) + eax_8)
        int32_t eax_31
        eax_31.b = not.b(eax_30.b)
        int32_t var_d8
        int32_t eax_34 =
            var_d8 + *(((eax_31 + *(((eax_30 - eax_31) << 2) + var_d0) - var_d8) << 2) + var_d4)
        int32_t var_80
