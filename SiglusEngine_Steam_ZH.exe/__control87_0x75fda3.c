...
int32_t esi_5 = (not.d(arg5) & ecx) | (arg4 & arg5)
...
int32_t eax_15 = (not.d(edi_1) & ecx_4) | (edi_1 & arg4)
...
if (eax_15 != ecx_4)
    ...
    if (eax_18 == 0x40)
        ecx_4 = ecx_5 | &data_2000000
    else
        int32_t __saved_ebp
        int32_t entry_ebx
        
        if (eax_18 != 0x8000)
            return sub_76006d(eax_18 - 0x8040, edx_7, ecx_5, &__saved_ebp, esi_5, arg1, entry_ebx)
                __tailcall
        ecx_4 = ecx_5 | &data_3000000

int32_t ecx_7 = ecx_4 | esi_5

if (((ecx_4 ^ esi_5) & 0x8031f) == 0)
    return ecx_7

return ecx_7 | 0x80000000
