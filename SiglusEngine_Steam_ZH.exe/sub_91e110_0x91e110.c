...
do
    ...
    int32_t var_d4
    int32_t var_d0
    int32_t eax_19 = eax_18 + var_f8 + *(((var_e0
    ...
    int32_t ebx_22
    ebx_22.b = var_18[1]
    int32_t eax_21 = edx_5 + *(((ebx_22 - edx_5) << 2) + eax_9)
    int32_t eax_22
    ...
    int32_t var_e8
    int32_t var_dc
    int32_t eax_29 = eax_28 + var_f4 + *(((var_dc
    ...
    int32_t ebx_39
    ebx_39.b = *var_18
    int32_t eax_31 = edx_5 + *(((ebx_39 - edx_5) << 2) + eax_9)
    int32_t eax_32
