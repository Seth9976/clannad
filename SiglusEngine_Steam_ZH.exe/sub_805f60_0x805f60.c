            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_10 = eax_9 - *(((var_e0 + *(((eax_5
                            + *(((ebx_22 - eax_5) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2)
                            + edx_2)
                        ...
                        eax_15.b = edi[1]
                        int32_t var_dc
                        int32_t eax_16 = eax_15 - *(((var_dc + *(((eax_11
                            + *(((ebx_34 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                            + edx_2)
                        ...
                        eax_21.b = *edi
                        int32_t var_d8
                        int32_t eax_22 = eax_21 - *(((var_d8 + *(((eax_17
                            + *(((ebx_46 - eax_17) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + edx_2)
