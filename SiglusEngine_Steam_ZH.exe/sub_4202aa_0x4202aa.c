...
if (*(arg1 + 0x68) u> 0)
    ...
    do
        ...
        float var_48_1 = fconvert.s((fconvert.t(var_58) + fconvert.t(arg4[-2])) * fconvert.t(31f))
        float var_44_1 = fconvert.s((fconvert.t(var_54) + fconvert.t(arg4[-1])) * fconvert.t(31f))
        float var_40_1 = fconvert.s((fconvert.t(var_50) + fconvert.t(*arg4)) * fconvert.t(31f))
        float var_3c_1 = fconvert.s(fconvert.t(var_4c) + fconvert.t(arg4[1]))
        ...
        if (*(arg1 + 0x5c) != 0)
            long double x87_r7_15 = fconvert.t(0.0322580636f)
            float* ebx_5 = *(arg1 + 0x5c) + edi_4 + 0x10
            long double x87_r6_16 = (fconvert.t(var_48_1) - float.t(var_38_1)) * x87_r7_15
            *ebx_5 = fconvert.s(fconvert.t(0.1875f) * x87_r6_16 + fconvert.t(*ebx_5))
            float* ebx_7 = *(arg1 + 0x5c) + eax_12 + 0x10
            *ebx_7 = fconvert.s(fconvert.t(0.3125f) * x87_r6_16 + fconvert.t(*ebx_7))
            float* ebx_9 = *(arg1 + 0x5c) + ecx_11 + 0x10
            *ebx_9 = fconvert.s(fconvert.t(0.0625f) * x87_r6_16 + fconvert.t(*ebx_9))
            float* ebx_11 = *(arg1 + 0x5c) + edi_4 + 0x14
            var_58 = fconvert.s(x87_r6_16 * fconvert.t(0.4375))
            long double x87_r6_20 = (fconvert.t(var_44_1) - float.t(var_34_1)) * x87_r7_15
            *ebx_11 = fconvert.s(fconvert.t(0.1875f) * x87_r6_20 + fconvert.t(*ebx_11))
            float* ebx_13 = *(arg1 + 0x5c) + eax_12 + 0x14
            *ebx_13 = fconvert.s(fconvert.t(0.3125f) * x87_r6_20 + fconvert.t(*ebx_13))
            float* ebx_15 = *(arg1 + 0x5c) + ecx_11 + 0x14
            *ebx_15 = fconvert.s(fconvert.t(0.0625f) * x87_r6_20 + fconvert.t(*ebx_15))
            float* ebx_17 = *(arg1 + 0x5c) + edi_4 + 0x18
            var_54 = fconvert.s(x87_r6_20 * fconvert.t(0.4375))
            ...
            *ebx_17 = fconvert.s(fconvert.t(0.1875f) * x87_r7_16 + fconvert.t(*ebx_17))
            float* ebx_19 = *(arg1 + 0x5c) + eax_12 + 0x18
            ...
            *ebx_21 = fconvert.s(fconvert.t(0.0625f) * x87_r7_16 + fconvert.t(*ebx_21))
            ...
            long double x87_r7_19 = fconvert.t(var_3c_1) - float.t(edx_12)
            *ebx_23 = fconvert.s(fconvert.t(0.1875f) * x87_r7_19 + fconvert.t(*ebx_23))
            float* ebx_25 = *(arg1 + 0x5c) + eax_12 + 0x1c
            *ebx_25 = fconvert.s(fconvert.t(0.3125f) * x87_r7_19 + fconvert.t(*ebx_25))
            float* ebx_27 = *(arg1 + 0x5c) + ecx_11 + 0x1c
            *ebx_27 = fconvert.s(fconvert.t(0.0625f) * x87_r7_19 + fconvert.t(*ebx_27))
            var_4c = fconvert.s(x87_r7_19 * fconvert.t(0.4375))
        ...
        int16_t* ebx_32 = var_8
        *ebx_32 = (((edx_12 << 5 | var_38_1) << 5 | var_34_1) << 5).w | var_30_1.w
        arg4 = &arg4[ebx_2 * 4]
        eax_12 += ecx_9
        edi_4 += ecx_9
        ecx_11 += ecx_9
