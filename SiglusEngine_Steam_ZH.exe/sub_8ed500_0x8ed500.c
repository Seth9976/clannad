                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t eax_15
                            eax_15.b = edi[2]
                            edi[2] = eax_15.b + (*(((ebx_33 - eax_15) << 2) + edx_2)).b
                            int32_t ebx_42
                            ebx_42.b = var_3c[1]
                            int32_t eax_18 = edx_6 + *(((ebx_42 - edx_6) << 2) + eax_10)
                            int32_t var_84
                            int32_t ebx_47 = eax_18 + var_84
                            int32_t ebx_55
                            ...
                            if (eax_18 + var_84 s< 0)
                                ...
                                int32_t ebx_50
                                ebx_50.b = edi[1]
                                ebx_55 = *(((ebx_50 - 0xff) << 2) + *((ebx_47 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_21
                            eax_21.b = edi[1]
                            edi[1] = eax_21.b + (*(((ebx_55 - eax_21) << 2) + edx_2)).b
                            int32_t ebx_64
                            ebx_64.b = *var_3c
                            int32_t eax_24 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_10)
                            int32_t var_80
                            int32_t ebx_69 = eax_24 + var_80
                            int32_t ebx_77
                            ...
                            if (eax_24 + var_80 s< 0)
                                ...
                                int32_t ebx_72
                                ebx_72.b = *edi
                                ebx_77 = *(((ebx_72 - 0xff) << 2) + *((ebx_69 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_27
                            eax_27.b = *edi
                            *edi = eax_27.b + (*(((ebx_77 - eax_27) << 2) + edx_2)).b
