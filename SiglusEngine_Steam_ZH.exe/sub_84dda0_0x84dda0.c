                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t ebx_40 = ((var_f8 + *(((var_e0 + *(((eax_12
                                + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec) - eax_18) << 2) + edx_2
                            edi[2] = eax_18.b + (*ebx_40).b
                            int32_t ebx_41
                            ebx_41.b = esi_1[1]
                            int32_t eax_21 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_9)
                            int32_t eax_22
                            ...
                            int32_t var_e8
                            int32_t var_dc
                            int32_t ebx_60 = ((var_f4 + *(((var_dc + *(((eax_22
                                + *(((eax_21 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8) - eax_28) << 2) + edx_2
                            edi[1] = eax_28.b + (*ebx_60).b
                            int32_t ebx_61
                            ebx_61.b = *esi_1
                            int32_t eax_31 = edx_6 + *(((ebx_61 - edx_6) << 2) + eax_9)
                            int32_t eax_32
                            ...
                            int32_t var_e4
                            int32_t var_d8
                            int32_t ebx_80 = ((var_f0 + *(((var_d8 + *(((eax_32
                                + *(((eax_31 - eax_32) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4) - eax_38) << 2) + edx_2
                            *edi = eax_38.b + (*ebx_80).b
