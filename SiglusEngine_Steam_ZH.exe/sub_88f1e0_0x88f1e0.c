                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        int32_t* ebx_49 = ((var_f4 + *(((var_dc +
                            *(((edx_6 + *(((ebx_35 - edx_6) << 2) + eax_6) - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8)) << 2) + *((eax_25 << 2) + &data_4e3da80)
                        int32_t eax_29
                        eax_29.b = edi[1]
                        edi[1] = eax_29.b + (*(((*ebx_49 - eax_29) << 2) + edx_2)).b
                        int32_t ebx_54
                        ebx_54.b = *esi_1
                        int32_t eax_37
                        eax_37.b = *edi
                        ...
                        int32_t* ebx_68 = ((var_f0 + *(((var_d8 +
                            *(((edx_6 + *(((ebx_54 - edx_6) << 2) + eax_6) - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4)) << 2) + *((eax_37 << 2) + &data_4e3da80)
                        int32_t eax_41
                        eax_41.b = *edi
                        *edi = eax_41.b + (*(((*ebx_68 - eax_41) << 2) + edx_2)).b
