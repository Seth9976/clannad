...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t eax_8
        eax_8.b = edi[2]
        int32_t eax_9 = eax_8 - *(ebx_20 + edx_2)
        ...
        int32_t ebx_38 = neg.d(var_f4 + *(((var_dc
            + *(((eax_10 + *(((ebx_23 - eax_10) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
            << 2) + var_e8) - 0xff) << 2
        int32_t eax_16
        eax_16.b = edi[1]
        int32_t eax_17 = eax_16 - *(ebx_38 + edx_2)
        ...
        ebx_41.b = *var_18
        int32_t eax_18
        eax_18.b = not.b(ebx_41.b)
        int32_t var_f0
        int32_t var_e4
        int32_t var_d8
        int32_t ebx_56 = neg.d(var_f0 + *(((var_d8
            + *(((eax_18 + *(((ebx_41 - eax_18) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
            << 2) + var_e4) - 0xff) << 2
        int32_t eax_24
        eax_24.b = *edi
        result = eax_24 - *(ebx_56 + edx_2)
