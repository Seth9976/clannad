            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_45 = neg.d(var_f8 + *(((var_e0 + *(((eax_14
                            + *(((eax_13 - eax_14) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec) - 0xff) << 2
                        int32_t eax_20
                        eax_20.b = edi[2]
                        int32_t eax_21 = eax_20 - *(ebx_45 + edx_2)
                        ...
                        int32_t ebx_48
                        ebx_48.b = esi_1[1]
                        int32_t eax_23 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_11)
                        int32_t eax_24
                        eax_24.b = not.b(eax_23.b)
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_67 = neg.d(var_f4 + *(((var_dc + *(((eax_24
                            + *(((eax_23 - eax_24) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - 0xff) << 2
                        int32_t eax_30
                        eax_30.b = edi[1]
                        int32_t eax_31 = eax_30 - *(ebx_67 + edx_2)
                        ...
                        int32_t ebx_70
                        ebx_70.b = *esi_1
                        int32_t eax_33 = edx_6 + *(((ebx_70 - edx_6) << 2) + eax_11)
                        int32_t eax_34
                        eax_34.b = not.b(eax_33.b)
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_89 = neg.d(var_f0 + *(((var_d8 + *(((eax_34
                            + *(((eax_33 - eax_34) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - 0xff) << 2
                        int32_t eax_40
                        eax_40.b = *edi
                        int32_t eax_41 = eax_40 - *(ebx_89 + edx_2)
