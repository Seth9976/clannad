                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t ebx_39 = neg.d(var_f8 + *(((var_e0 + *(((eax_13
                                + *(((eax_12 - eax_13) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec) - 0xff) << 2
                            int32_t eax_19
                            eax_19.b = edi[2]
                            int32_t eax_20 = eax_19 - *(ebx_39 + edx_2)
                            ...
                            int32_t ebx_42
                            ebx_42.b = var_3c[1]
                            int32_t eax_22 = edx_6 + *(((ebx_42 - edx_6) << 2) + eax_10)
                            int32_t eax_23
                            eax_23.b = not.b(eax_22.b)
                            int32_t var_f4
                            int32_t var_e8
                            int32_t var_dc
                            int32_t ebx_61 = neg.d(var_f4 + *(((var_dc + *(((eax_23
                                + *(((eax_22 - eax_23) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8) - 0xff) << 2
                            int32_t eax_29
                            eax_29.b = edi[1]
                            int32_t eax_30 = eax_29 - *(ebx_61 + edx_2)
                            ...
                            int32_t ebx_64
                            ebx_64.b = *var_3c
                            int32_t eax_32 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_10)
                            int32_t eax_33
                            eax_33.b = not.b(eax_32.b)
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t ebx_83 = neg.d(var_f0 + *(((var_d8 + *(((eax_33
                                + *(((eax_32 - eax_33) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4) - 0xff) << 2
                            int32_t eax_39
                            eax_39.b = *edi
                            int32_t eax_40 = eax_39 - *(ebx_83 + edx_2)
