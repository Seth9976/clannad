            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ebx_7 != 0)
                        ...
                        eax_12.b = edi[2]
                        int32_t var_d0
                        edi[2] = eax_12.b + (*(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0)
                            - eax_12) << 2) + edx_2)).b
                        int32_t ebx_27
                        ebx_27.b = edi[1]
                        int32_t eax_15 = edx_6 + *(((ebx_27 - edx_6) << 2) + eax_7)
                        int32_t eax_16
                        eax_16.b = not.b(eax_15.b)
                        int32_t eax_18
                        eax_18.b = edi[1]
                        edi[1] = eax_18.b + (*(((eax_16 + *(((eax_15 - eax_16) << 2) + var_d0)
                            - eax_18) << 2) + edx_2)).b
                        int32_t ebx_39
                        ebx_39.b = *edi
                        int32_t eax_21 = edx_6 + *(((ebx_39 - edx_6) << 2) + eax_7)
                        int32_t eax_22
                        eax_22.b = not.b(eax_21.b)
                        int32_t eax_24
                        eax_24.b = *edi
                        *edi = eax_24.b + (*(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0)
                            - eax_24) << 2) + edx_2)).b
