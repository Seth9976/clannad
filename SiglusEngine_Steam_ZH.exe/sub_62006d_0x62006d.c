...
void* entry_ebx
int16_t es
eax_1, es = __les_gprz_memp(*(entry_ebx + (arg1 << 2)))
bool s
bool o

if (s != o)
    return sub_620072(eax_1, arg2, arg4, arg5, arg3, arg6) __tailcall

*(entry_ebx - 0x3ba3930) += arg3.b
arg3.b += *(entry_ebx + 0x2b14e8cf)
__int1()
