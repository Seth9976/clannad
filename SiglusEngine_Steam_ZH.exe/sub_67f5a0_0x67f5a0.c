...
int32_t (* var_c)(void* arg1) = sub_9c77f0
TEB* fsbase
...
if (ecx_2 u> arg2)
    ...
    int32_t* esi_2 = (arg2 - ecx_2) * 0x4c + edx_4
    eax_3 = sub_642980(esi_2, edx_4)
    arg1[1] = esi_2
else if (ecx_2 u< arg2)
    sub_67f770(arg1, arg2 - ecx_2)
    int32_t var_8_1 = 0
    ...
    sub_67fcb0(arg1[1], arg2 - ((edx_6 u>> 0x1f) + edx_6))
    int32_t eax_10
    int32_t edx_9
    edx_9:eax_10 = muls.dp.d(0x6bca1af3, arg1[1] - *arg1)
    int32_t edx_10 = edx_9 s>> 5
    int32_t eax_14 = (arg2 - ((edx_10 u>> 0x1f) + edx_10)) * 0x4c
    arg1[1] += eax_14
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_14
