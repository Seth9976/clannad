...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            eax_28.b = edi[2]
            int32_t var_d0
            edi[2] = eax_28.b + (*(((*(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0)) << 2)
                + *((eax_24 << 2) + &data_4e3da80)) - eax_28) << 2) + edx_2)).b
            int32_t ebx_32
            ebx_32.b = var_18[1]
            int32_t eax_31 = edx_6 + *(((ebx_32 - edx_6) << 2) + eax_19)
            int32_t eax_32
            ...
            int32_t eax_38
            eax_38.b = edi[1]
            edi[1] = eax_38.b + (*(((*(((eax_32 + *(((eax_31 - eax_32) << 2) + var_d0)) << 2)
                + *((eax_34 << 2) + &data_4e3da80)) - eax_38) << 2) + edx_2)).b
            int32_t ebx_47
            ebx_47.b = *var_18
            int32_t eax_41 = edx_6 + *(((ebx_47 - edx_6) << 2) + eax_19)
            int32_t eax_42
            ...
            int32_t eax_48
            eax_48.b = *edi
            result = eax_48 + *(((*(((eax_42 + *(((eax_41 - eax_42) << 2) + var_d0)) << 2)
                + *((eax_44 << 2) + &data_4e3da80)) - eax_48) << 2) + edx_2)
            *edi = result.b
