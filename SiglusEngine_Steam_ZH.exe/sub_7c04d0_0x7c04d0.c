            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t ebx_48
                        ebx_48.b = esi_1[1]
                        int32_t eax_19 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_11)
                        int32_t var_84
                        int32_t ebx_53 = eax_19 + var_84
                        int32_t ebx_61
                        ...
                        int32_t eax_22
                        eax_22.b = edi[1]
                        edi[1] = eax_22.b + (*(((ebx_61 - eax_22) << 2) + edx_2)).b
                        int32_t ebx_70
                        ebx_70.b = *esi_1
                        int32_t eax_25 = edx_6 + *(((ebx_70 - edx_6) << 2) + eax_11)
                        int32_t var_80
                        ...
                        int32_t eax_28
                        eax_28.b = *edi
                        *edi = eax_28.b + (*(((ebx_83 - eax_28) << 2) + edx_2)).b
