                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                int32_t eax_21
                                eax_21.b = edi[2]
                                edi[2] = eax_21.b + (*(((*ebx_40 - eax_21) << 2) + edx_2)).b
                                int32_t ebx_45
                                ebx_45.b = var_3c[1]
                                int32_t eax_29
                                eax_29.b = edi[1]
                                ...
                                int32_t* ebx_59 = ((var_f4 + *(((var_dc + *(((edx_6
                                    + *(((ebx_45 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4)
                                    - var_f4) << 2) + var_e8)) << 2) + *((eax_29 << 2) + &data_4e3da80)
                                int32_t eax_33
                                eax_33.b = edi[1]
                                edi[1] = eax_33.b + (*(((*ebx_59 - eax_33) << 2) + edx_2)).b
                                int32_t ebx_64
                                ebx_64.b = *var_3c
                                int32_t eax_41
                                eax_41.b = *edi
                                ...
                                int32_t* ebx_78 = ((var_f0 + *(((var_d8 + *(((edx_6
                                    + *(((ebx_64 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4)
                                    - var_f0) << 2) + var_e4)) << 2) + *((eax_41 << 2) + &data_4e3da80)
                                int32_t eax_45
                                eax_45.b = *edi
                                *edi = eax_45.b + (*(((*ebx_78 - eax_45) << 2) + edx_2)).b
