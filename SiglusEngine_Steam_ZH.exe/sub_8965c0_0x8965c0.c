                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_e0
                            int32_t var_d4
                            int32_t ebx_34 = (*(((var_e0 + *(((edx_6
                                + *(((ebx_21 - edx_6) << 2) + eax_9) - var_e0) << 2) + var_d4)) << 2)
                                + *((eax_14 << 2) + &data_4e3da80)) - eax_18) << 2
                            edi[2] = eax_18.b + (*(ebx_34 + edx_2)).b
                            int32_t ebx_36
                            ebx_36.b = esi_1[1]
                            int32_t eax_24
                            eax_24.b = edi[1]
                            ...
                            eax_28.b = edi[1]
                            int32_t var_dc
                            int32_t ebx_49 = (*(((var_dc + *(((edx_6
                                + *(((ebx_36 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)) << 2)
                                + *((eax_24 << 2) + &data_4e3da80)) - eax_28) << 2
                            edi[1] = eax_28.b + (*(ebx_49 + edx_2)).b
                            int32_t ebx_51
                            ebx_51.b = *esi_1
                            int32_t eax_34
                            eax_34.b = *edi
                            ...
                            eax_38.b = *edi
                            int32_t var_d8
                            int32_t ebx_64 = (*(((var_d8 + *(((edx_6
                                + *(((ebx_51 - edx_6) << 2) + eax_9) - var_d8) << 2) + var_d4)) << 2)
                                + *((eax_34 << 2) + &data_4e3da80)) - eax_38) << 2
                            *edi = eax_38.b + (*(ebx_64 + edx_2)).b
