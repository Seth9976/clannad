        ...
        if (*(eax_5 + 0xc) u<= *(eax_5 + 4))
            ...
            if (ecx u> 0)
                while (true)
                    ...
                    int32_t ebx_4 = var_8_1 << 2
                    int32_t edx_7 = *(*(ecx_6 + (*(ebx_4 + *(eax_10 + 0x10)) << 2)) + 0x10)
                    char* ecx_7 = *(ecx_6 + (*(ebx_4 + *(eax_10 + 8)) << 2))
                    ...
                    label_4c49c5:
                        ...
                        int32_t var_40_3 = 0
                        int32_t var_44_3 = 0
                        var_48_4 = *(eax_20 + 8) + ebx_4
                        int32_t var_4c_3 = 1
                        var_50_4 = *(eax_20 + 0x10) + ebx_4
                        var_54_1 = 0x4e
                    else
                    label_4c4946:
                        char ecx_8
                        ...
                        if (edx_7 == 3 && (ecx_8 & 4) != 0 && (ecx_8 & 8) != 0)
                            goto label_4c49c5
                        ...
                        result = sub_4d75f7(arg1, 0x4e, &var_14, 1, *(arg1[0x40] + 8) + ebx_4, 
                        ...
                        var_48_4 = &var_14
                        int32_t var_4c_2 = 1
                        var_50_4 = *(arg1[0x40] + 0x10) + ebx_4
                        var_54_1 = 1
                    
                    result = sub_4d75f7(arg1, var_54_1, var_50_4, 1, var_48_4, nullptr, nullptr, 1, 
                        0, 0, 0, 0)
            ...
            result = sub_4d75f7(arg1, 0x4e, &var_14, 1, *(arg1[0x40] + 8), nullptr, nullptr, 1, 0, 
                0, 0, 0)
