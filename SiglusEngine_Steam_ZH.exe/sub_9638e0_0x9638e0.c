        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_ec
                    int32_t var_d0
                    int32_t ebx_35 = (*(((var_f8 +
                        *(((eax_10 + *(((ebx_22 - eax_10) << 2) + var_d0) - var_f8) << 2) + var_ec))
                        << 2) + *((eax_14 << 2) + &data_4e3da80)) - eax_18) << 2
                    edi[2] = eax_18.b + (*(ebx_35 + edx_2)).b
                    int32_t ebx_37
                    ebx_37.b = var_18[1]
                    int32_t eax_20
                    eax_20.b = not.b(ebx_37.b)
                    int32_t eax_24
                    eax_24.b = edi[1]
                    int32_t eax_28
                    eax_28.b = edi[1]
                    int32_t var_f4
                    int32_t var_e8
                    int32_t ebx_50 = (*(((var_f4 +
                        *(((eax_20 + *(((ebx_37 - eax_20) << 2) + var_d0) - var_f4) << 2) + var_e8))
                        << 2) + *((eax_24 << 2) + &data_4e3da80)) - eax_28) << 2
                    edi[1] = eax_28.b + (*(ebx_50 + edx_2)).b
                    int32_t ebx_52
                    ebx_52.b = *var_18
                    int32_t eax_30
                    eax_30.b = not.b(ebx_52.b)
                    int32_t eax_34
                    eax_34.b = *edi
                    int32_t eax_38
                    eax_38.b = *edi
                    ...
                    int32_t ebx_65 = (*(((var_f0 +
                        *(((eax_30 + *(((ebx_52 - eax_30) << 2) + var_d0) - var_f0) << 2) + var_e4))
                        << 2) + *((eax_34 << 2) + &data_4e3da80)) - eax_38) << 2
                    result = eax_38 + *(ebx_65 + edx_2)
                    *edi = result.b
