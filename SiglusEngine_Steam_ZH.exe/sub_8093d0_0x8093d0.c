...
do
    ...
    do
        ...
        int32_t eax_15 = eax_14 - *((neg.d(var_f8
            + *(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - var_f8) << 2) + var_ec) - 0xff) << 2)
            + var_118)
        ...
        *(edi + 2) = eax_15.b
        ...
        int32_t eax_23 = eax_22 - *((neg.d(var_f4
            + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_f4) << 2) + var_e8) - 0xff) << 2)
            + var_118)
        ...
        *(edi + 1) = eax_23.b
        ...
        result = eax_30 - *((neg.d(var_f0
            + *(((eax_26 + *(((eax_25 - eax_26) << 2) + var_d0) - var_f0) << 2) + var_e4) - 0xff) << 2)
            + var_118)
