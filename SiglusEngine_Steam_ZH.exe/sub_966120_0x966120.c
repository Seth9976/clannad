...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_d4
            int32_t eax_6 =
                var_f8 + *(((var_e0 + *(((ebx_2 - var_e0) << 2) + var_d4) - var_f8) << 2) + var_ec)
            int32_t ebx_11
            ebx_11.b = var_18[1]
            int32_t var_f4
            int32_t var_e8
            int32_t var_dc
            int32_t eax_10 =
                var_f4 + *(((var_dc + *(((ebx_11 - var_dc) << 2) + var_d4) - var_f4) << 2) + var_e8)
            int32_t ebx_20
            ebx_20.b = *var_18
            int32_t var_f0
            int32_t var_e4
            int32_t var_d8
            int32_t eax_14 =
                var_f0 + *(((var_d8 + *(((ebx_20 - var_d8) << 2) + var_d4) - var_f0) << 2) + var_e4)
            result = result_1
