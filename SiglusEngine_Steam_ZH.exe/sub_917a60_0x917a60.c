        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_d4
                    int32_t var_d0
                    int32_t ebx_45 = ((var_f8 + *(((var_e0 +
                        *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec) - eax_25) << 2) + edx_2
                    edi[2] = eax_25.b + (*ebx_45).b
                    int32_t ebx_46
                    ebx_46.b = var_18[1]
                    int32_t eax_28 = edx_6 + *(((ebx_46 - edx_6) << 2) + eax_16)
                    int32_t eax_29
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_65 = ((var_f4 + *(((var_dc +
                        *(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - eax_35) << 2) + edx_2
                    edi[1] = eax_35.b + (*ebx_65).b
                    int32_t ebx_66
                    ebx_66.b = *var_18
                    int32_t eax_38 = edx_6 + *(((ebx_66 - edx_6) << 2) + eax_16)
                    int32_t eax_39
                    ...
                    int32_t var_e4
                    int32_t var_d8
                    int32_t ebx_85 = ((var_f0 + *(((var_d8 +
                        *(((eax_39 + *(((eax_38 - eax_39) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - eax_45) << 2) + edx_2
                    result = eax_45 + *ebx_85
                    *edi = result.b
