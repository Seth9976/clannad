...
int32_t eax_3
int32_t edx
edx:eax_3 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
int32_t i_3 = 0
...
if ((edx_1 u>> 0x1f) + edx_1 s> 0)
    ...
    do
        ...
        *(esi_2 + 0x154) = *(esi_2 + 0x150)
        int32_t eax_13
        int32_t edx_3
        edx_3:eax_13 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
        i = i_3 + 1
        var_18_1 = edi_1
        edx_4 = edx_3 s>> 6
        i_3 = i
...
int32_t eax_17
int32_t edx_5
edx_5:eax_17 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
int32_t i_2 = 0
...
if (result s> 0)
    ...
    do
        int32_t esi_4 = *(ebx + 0xb4)
        int32_t* edi_5 = *(ebx + 0xa0) + result
        ...
        int32_t eax_20
        int32_t edx_7
        edx_7:eax_20 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
        edx_8 = edx_7 s>> 6
        result = result_1
