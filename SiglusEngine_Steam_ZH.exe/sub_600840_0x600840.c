...
int32_t eax_3
int32_t edx_2
edx_2:eax_3 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
int32_t i_1 = 0
...
if ((edx_3 u>> 0x1f) + edx_3 s> 0)
    ...
    do
        ...
        int32_t eax_11
        int32_t edx_5
        edx_5:eax_11 = muls.dp.d(0x2f149903, *(ebx + 0xa4) - *(ebx + 0xa0))
        var_18_1 = edi_1
        edx_6 = edx_5 s>> 6
    while (i s< (edx_6 u>> 0x1f) + edx_6)

int32_t edi_4 = *(ebx + 0xa4)
int32_t* result_1 = *(ebx + 0xa0)
int32_t* result
