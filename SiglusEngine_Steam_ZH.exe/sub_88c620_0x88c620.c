                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_d0
                                int32_t eax_4 = eax_3 + *(((ebx_23 - eax_3) << 2) + var_d0)
                                int32_t var_88
                                int32_t ebx_28 = eax_4 + var_88
                                int32_t ebx_36
                                ...
                                if (eax_4 + var_88 s< 0)
                                    ...
                                    ebx_31.b = edi[2]
                                    ebx_36 =
                                        *(((ebx_31 - 0xff) << 2) + *((ebx_28 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_7
                                eax_7.b = edi[2]
                                edi[2] = eax_7.b + (*(((ebx_36 - eax_7) << 2) + edx_2)).b
                                int32_t ebx_45
                                ebx_45.b = esi_1[1]
                                int32_t eax_9
                                eax_9.b = not.b(ebx_45.b)
                                int32_t eax_10 = eax_9 + *(((ebx_45 - eax_9) << 2) + var_d0)
                                int32_t var_84
                                int32_t ebx_50 = eax_10 + var_84
                                int32_t ebx_58
                                ...
                                if (eax_10 + var_84 s< 0)
                                    ...
                                    ebx_53.b = edi[1]
                                    ebx_58 =
                                        *(((ebx_53 - 0xff) << 2) + *((ebx_50 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_13
                                eax_13.b = edi[1]
                                edi[1] = eax_13.b + (*(((ebx_58 - eax_13) << 2) + edx_2)).b
                                int32_t ebx_67
                                ebx_67.b = *esi_1
                                int32_t eax_15
                                eax_15.b = not.b(ebx_67.b)
                                int32_t eax_16 = eax_15 + *(((ebx_67 - eax_15) << 2) + var_d0)
                                int32_t var_80
                                int32_t ebx_72 = eax_16 + var_80
                                int32_t ebx_80
                                ...
                                if (eax_16 + var_80 s< 0)
                                    ...
                                    ebx_75.b = *edi
                                    ebx_80 =
                                        *(((ebx_75 - 0xff) << 2) + *((ebx_72 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_19
                                eax_19.b = *edi
                                *edi = eax_19.b + (*(((ebx_80 - eax_19) << 2) + edx_2)).b
