        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    int32_t eax_8
                    eax_8.b = edi[2]
                    edi[2] = eax_8.b + (*(((ebx_27 - eax_8) << 2) + edx_2)).b
                    int32_t ebx_36
                    ebx_36.b = esi_1[1]
                    int32_t eax_10
                    eax_10.b = not.b(ebx_36.b)
                    int32_t var_f4
                    int32_t var_e8
                    int32_t var_dc
                    int32_t eax_15 = var_f4 + *(((var_dc +
                        *(((eax_10 + *(((ebx_36 - eax_10) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)
                    int32_t var_84
                    int32_t ebx_49 = eax_15 + var_84
                    int32_t ebx_57
                    ...
                    int32_t eax_18
                    eax_18.b = edi[1]
                    edi[1] = eax_18.b + (*(((ebx_57 - eax_18) << 2) + edx_2)).b
                    int32_t ebx_66
                    ebx_66.b = *esi_1
                    int32_t eax_20
                    eax_20.b = not.b(ebx_66.b)
                    int32_t var_f0
                    int32_t var_e4
                    int32_t var_d8
                    int32_t eax_25 = var_f0 + *(((var_d8 +
                        *(((eax_20 + *(((ebx_66 - eax_20) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4)
                    int32_t var_80
                    int32_t ebx_79 = eax_25 + var_80
                    int32_t ebx_87
                    ...
                    int32_t eax_28
                    eax_28.b = *edi
                    *edi = eax_28.b + (*(((ebx_87 - eax_28) << 2) + edx_2)).b
