        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    eax_27.b = edi[1]
                    int32_t var_dc
                    int32_t eax_28 = eax_27 - *(((var_dc +
                        *(((edx_6 + *(((ebx_38 - edx_6) << 2) + eax_16) - var_dc) << 2) + var_d4)) << 2)
                        + edx_2)
                    ...
                    eax_33.b = *edi
                    int32_t var_d8
                    result = eax_33 - *(((var_d8 +
                        *(((edx_6 + *(((ebx_50 - edx_6) << 2) + eax_16) - var_d8) << 2) + var_d4)) << 2)
                        + edx_2)
