                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                eax_14.b = edi[2]
                                int32_t var_d0
                                int32_t eax_15 = eax_14 + *(((eax_12
                                    + *(((eax_11 - eax_12) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                int32_t ebx_39
                                ebx_39.b = esi_1[1]
                                int32_t eax_17 = edx_6 + *(((ebx_39 - edx_6) << 2) + eax_9)
                                int32_t eax_18
                                eax_18.b = not.b(eax_17.b)
                                int32_t eax_20
                                eax_20.b = edi[1]
                                int32_t eax_21 = eax_20 + *(((eax_18
                                    + *(((eax_17 - eax_18) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                int32_t ebx_51
                                ebx_51.b = *esi_1
                                int32_t eax_23 = edx_6 + *(((ebx_51 - edx_6) << 2) + eax_9)
                                int32_t eax_24
                                eax_24.b = not.b(eax_23.b)
                                int32_t eax_26
                                eax_26.b = *edi
                                int32_t eax_27 = eax_26 + *(((eax_24
                                    + *(((eax_23 - eax_24) << 2) + var_d0)) << 2) + edx_2)
