            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_f8
                        int32_t var_ec
                        int32_t eax_17 = var_f8 + *(((edx_10 + *(((ebx_18 - edx_10) << 2) + eax_13)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_27
                        ebx_27.b = esi_1[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t eax_21 = var_f4 + *(((edx_10 + *(((ebx_27 - edx_10) << 2) + eax_13)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_36
                        ebx_36.b = *esi_1
                        int32_t var_f0
                        int32_t var_e4
                        int32_t eax_25 = var_f0 + *(((edx_10 + *(((ebx_36 - edx_10) << 2) + eax_13)
                            - var_f0) << 2) + var_e4)
