                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_14 + var_88 s< 0)
                            ...
                            ebx_36.b = edi[2]
                            ebx_41 =
                                *(((ebx_36 - 0xff) << 2) + *((ebx_33 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_17
                        eax_17.b = edi[2]
                        edi[2] = eax_17.b + (*(((ebx_41 - eax_17) << 2) + edx_2)).b
                        int32_t ebx_50
                        ebx_50.b = esi_1[1]
                        int32_t eax_20 = edx_6 + *(((ebx_50 - edx_6) << 2) + eax_6)
                        int32_t eax_21
                        eax_21.b = not.b(eax_20.b)
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t eax_26 = var_f4 + *(((var_dc + *(((eax_21
                            + *(((eax_20 - eax_21) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8)
                        int32_t var_84
                        int32_t ebx_67 = eax_26 + var_84
                        int32_t ebx_75
                        ...
                        if (eax_26 + var_84 s< 0)
                            ...
                            ebx_70.b = edi[1]
                            ebx_75 =
                                *(((ebx_70 - 0xff) << 2) + *((ebx_67 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_29
                        eax_29.b = edi[1]
                        edi[1] = eax_29.b + (*(((ebx_75 - eax_29) << 2) + edx_2)).b
                        int32_t ebx_84
                        ebx_84.b = *esi_1
                        int32_t eax_32 = edx_6 + *(((ebx_84 - edx_6) << 2) + eax_6)
                        int32_t eax_33
                        eax_33.b = not.b(eax_32.b)
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_38 = var_f0 + *(((var_d8 + *(((eax_33
                            + *(((eax_32 - eax_33) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4)
                        int32_t var_80
                        int32_t ebx_101 = eax_38 + var_80
                        int32_t ebx_109
                        
                        if (eax_38 + var_80 s< 0)
                            if (ebx_101 s< 0xffffff01)
                                ebx_101 = 0xffffff01
                            
                            int32_t ebx_112
                            ebx_112.b = *edi
                            ebx_109 = *((ebx_112 << 2) + *((ebx_101 << 2) + data_4ced578))
                        else
                            if (ebx_101 s> 0xff)
                                ebx_101 = 0xff
                            ...
                            ebx_104.b = *edi
                            ebx_109 =
                                *(((ebx_104 - 0xff) << 2) + *((ebx_101 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_41
                        eax_41.b = *edi
                        *edi = eax_41.b + (*(((ebx_109 - eax_41) << 2) + edx_2)).b
