                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t var_e0
                            int32_t var_d4
                            int32_t eax_16 = eax_15 - *((neg.d(var_e0 + *(((edx_6
                                + *(((ebx_20 - edx_6) << 2) + eax_10) - var_e0) << 2) + var_d4) - 0xff)
                                << 2) + edx_2)
                            ...
                            eax_21.b = edi[1]
                            int32_t var_dc
                            int32_t eax_22 = eax_21 - *((neg.d(var_dc + *(((edx_6
                                + *(((ebx_34 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4) - 0xff)
                                << 2) + edx_2)
                            ...
                            eax_27.b = *edi
                            int32_t var_d8
                            int32_t eax_28 = eax_27 - *((neg.d(var_d8 + *(((edx_6
                                + *(((ebx_48 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4) - 0xff)
                                << 2) + edx_2)
