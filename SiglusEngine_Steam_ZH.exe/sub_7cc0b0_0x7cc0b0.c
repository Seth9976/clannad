            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t ebx_33 = (*(((var_e0 +
                        *(((edx_6 + *(((ebx_20 - edx_6) << 2) + eax_11) - var_e0) << 2) + var_d4)) << 2)
                        + *((eax_16 << 2) + &data_4e3da80)) - eax_20) << 2
                    edi[2] = eax_20.b + (*(ebx_33 + edx_2)).b
                    int32_t ebx_35
                    ebx_35.b = esi_1[1]
                    int32_t eax_26
                    eax_26.b = edi[1]
                    ...
                    eax_30.b = edi[1]
                    int32_t var_dc
                    int32_t ebx_48 = (*(((var_dc +
                        *(((edx_6 + *(((ebx_35 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4)) << 2)
                        + *((eax_26 << 2) + &data_4e3da80)) - eax_30) << 2
                    edi[1] = eax_30.b + (*(ebx_48 + edx_2)).b
                    int32_t ebx_50
                    ebx_50.b = *esi_1
                    int32_t eax_36
                    eax_36.b = *edi
                    ...
                    eax_40.b = *edi
                    int32_t var_d8
                    int32_t ebx_63 = (*(((var_d8 +
                        *(((edx_6 + *(((ebx_50 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4)) << 2)
                        + *((eax_36 << 2) + &data_4e3da80)) - eax_40) << 2
                    *edi = eax_40.b + (*(ebx_63 + edx_2)).b
