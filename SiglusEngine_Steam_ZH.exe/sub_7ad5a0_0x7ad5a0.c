            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_19 = eax_18 - *((neg.d(var_e0 + *(((eax_14
                            + *(((eax_13 - eax_14) << 2) + var_d0) - var_e0) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        int32_t ebx_44
                        ebx_44.b = esi_1[1]
                        int32_t eax_21 = edx_6 + *(((ebx_44 - edx_6) << 2) + eax_11)
                        int32_t eax_22
                        eax_22.b = not.b(eax_21.b)
                        int32_t eax_26
                        eax_26.b = edi[1]
                        int32_t var_dc
                        int32_t eax_27 = eax_26 - *((neg.d(var_dc + *(((eax_22
                            + *(((eax_21 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        int32_t ebx_62
                        ebx_62.b = *esi_1
                        int32_t eax_29 = edx_6 + *(((ebx_62 - edx_6) << 2) + eax_11)
                        int32_t eax_30
                        eax_30.b = not.b(eax_29.b)
                        int32_t eax_34
                        eax_34.b = *edi
                        int32_t var_d8
                        int32_t eax_35 = eax_34 - *((neg.d(var_d8 + *(((eax_30
                            + *(((eax_29 - eax_30) << 2) + var_d0) - var_d8) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
