...
long double x87_r4_5 = fconvert.t(*arg2) * fconvert.t(*arg3)
    + fconvert.t(arg2[1]) * fconvert.t(arg3[4]) + fconvert.t(arg2[2]) * fconvert.t(arg3[8])
    + fconvert.t(arg2[3]) * fconvert.t(arg3[0xc])
