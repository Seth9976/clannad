                    ...
                    if (ebx_8 != 0)
                        ...
                        int32_t ebx_35 = ((var_f8 + *(((var_e0 +
                            *(((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0) - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec) - eax_15) << 2) + edx_2
                        edi[2] = eax_15.b + (*ebx_35).b
                        int32_t ebx_36
                        ebx_36.b = esi_1[1]
                        int32_t eax_18 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_6)
                        int32_t eax_19
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_55 = ((var_f4 + *(((var_dc + *(((eax_19
                            + *(((eax_18 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - eax_25) << 2) + edx_2
                        edi[1] = eax_25.b + (*ebx_55).b
                        int32_t ebx_56
                        ebx_56.b = *esi_1
                        int32_t eax_28 = edx_6 + *(((ebx_56 - edx_6) << 2) + eax_6)
                        int32_t eax_29
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_75 = ((var_f0 + *(((var_d8 + *(((eax_29
                            + *(((eax_28 - eax_29) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - eax_35) << 2) + edx_2
                        *edi = eax_35.b + (*ebx_75).b
