                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            eax_20.b = edi[1]
                            int32_t var_dc
                            edi[1] = eax_20.b + (*(((var_dc + *(((edx_6
                                + *(((ebx_33 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)
                                - eax_20) << 2) + edx_2)).b
                            int32_t ebx_45
                            ebx_45.b = *esi_1
                            int32_t eax_26
                            eax_26.b = *edi
                            int32_t var_d8
                            *edi = eax_26.b + (*(((var_d8 + *(((edx_6
                                + *(((ebx_45 - edx_6) << 2) + eax_9) - var_d8) << 2) + var_d4)
                                - eax_26) << 2) + edx_2)).b
