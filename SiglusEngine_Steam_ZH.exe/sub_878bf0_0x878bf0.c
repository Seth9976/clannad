            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d0
                        int32_t eax_6 = eax_5 - *((
                            neg.d(eax_3 + *(((ebx_14 - eax_3) << 2) + var_d0) - 0xff) << 2) + edx_2)
                        ...
                        ebx_24.b = esi_1[1]
                        int32_t eax_7
                        eax_7.b = not.b(ebx_24.b)
                        int32_t eax_9
                        eax_9.b = edi[1]
                        int32_t eax_10 = eax_9 - *((
                            neg.d(eax_7 + *(((ebx_24 - eax_7) << 2) + var_d0) - 0xff) << 2) + edx_2)
                        ...
                        int32_t eax_14 = eax_13 - *((
                            neg.d(eax_11 + *(((ebx_34 - eax_11) << 2) + var_d0) - 0xff) << 2) + edx_2)
