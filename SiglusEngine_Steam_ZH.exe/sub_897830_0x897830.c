            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t* ebx_36 = ((var_f8 + *(((var_e0 + *(((eax_12
                            + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec)) << 2) + *((eax_18 << 2) + &data_4e3da80)
                        int32_t eax_22
                        eax_22.b = edi[2]
                        edi[2] = eax_22.b + (*(((*ebx_36 - eax_22) << 2) + edx_2)).b
                        int32_t ebx_41
                        ebx_41.b = esi_1[1]
                        int32_t eax_25 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_9)
                        int32_t eax_26
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t* ebx_59 = ((var_f4 + *(((var_dc + *(((eax_26
                            + *(((eax_25 - eax_26) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8)) << 2) + *((eax_32 << 2) + &data_4e3da80)
                        int32_t eax_36
                        eax_36.b = edi[1]
                        edi[1] = eax_36.b + (*(((*ebx_59 - eax_36) << 2) + edx_2)).b
                        int32_t ebx_64
                        ebx_64.b = *esi_1
                        int32_t eax_39 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_9)
                        int32_t eax_40
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t* ebx_82 = ((var_f0 + *(((var_d8 + *(((eax_40
                            + *(((eax_39 - eax_40) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4)) << 2) + *((eax_46 << 2) + &data_4e3da80)
                        int32_t eax_50
                        eax_50.b = *edi
                        *edi = eax_50.b + (*(((*ebx_82 - eax_50) << 2) + edx_2)).b
