            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        int32_t ebx_32
                        ebx_32.b = esi_1[1]
                        int32_t eax_16 = edx_6 + *(((ebx_32 - edx_6) << 2) + eax_6)
                        int32_t eax_17
                        eax_17.b = not.b(eax_16.b)
                        int32_t eax_21
                        eax_21.b = edi[1]
                        int32_t var_dc
                        int32_t eax_22 = eax_21 + *(((var_dc + *(((eax_17
                            + *(((eax_16 - eax_17) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                            + edx_2)
                        ...
                        int32_t ebx_48
                        ebx_48.b = *esi_1
                        int32_t eax_24 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_6)
                        int32_t eax_25
                        eax_25.b = not.b(eax_24.b)
                        int32_t eax_29
                        eax_29.b = *edi
                        int32_t var_d8
                        int32_t eax_30 = eax_29 + *(((var_d8 + *(((eax_25
                            + *(((eax_24 - eax_25) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + edx_2)
