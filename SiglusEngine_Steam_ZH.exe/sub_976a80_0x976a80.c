    ...
    if (result != 0)
        ...
        if (result_1 != 0)
            ...
            if (ecx_6 != 0)
                ...
                int32_t var_d0
                int32_t eax_15 = eax_14 + *(((ebx_10 - eax_14) << 2) + var_d0)
                int32_t ebx_15
                ebx_15.b = var_18[1]
                int32_t eax_16
                eax_16.b = not.b(ebx_15.b)
                int32_t eax_17 = eax_16 + *(((ebx_15 - eax_16) << 2) + var_d0)
                int32_t ebx_20
                ebx_20.b = *var_18
                int32_t eax_18
                eax_18.b = not.b(ebx_20.b)
                int32_t eax_19 = eax_18 + *(((ebx_20 - eax_18) << 2) + var_d0)
                result = result_1
