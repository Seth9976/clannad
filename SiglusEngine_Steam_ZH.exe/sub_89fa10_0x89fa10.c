        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ecx_7 != 0)
                    ...
                    int32_t ebx_40
                    ebx_40.b = *esi_1
                    int32_t eax_26 = edx_9 + *(((ebx_40 - edx_9) << 2) + eax_8)
                    int32_t eax_27
                    ...
                    if (var_114 != 0xff)
                        ...
                        if (ebx_62 != 0)
                            int32_t eax_36 = *((var_114 << 2) + &data_4d6e180)
                            *((eax_24 << 2) + eax_36)
                            *((eax_32 << 2) + eax_36)
                            int32_t eax_37
                            eax_37.b = edi[2]
                            edi[2] = (divu.dp.d(mulu.dp.d(eax_37, edx_5), ecx_7)).b
                            int32_t eax_42
                            eax_42.b = edi[1]
                            edi[1] = (divu.dp.d(mulu.dp.d(eax_42, edx_5), ecx_7)).b
                            int32_t eax_47
                            eax_47.b = *edi
                            *edi = (divu.dp.d(mulu.dp.d(eax_47, edx_5), ecx_7)).b
                            edi[3] = ecx_7.b
                        else
                            edi[2] = eax_16.b
                            edi[1] = eax_24.b
