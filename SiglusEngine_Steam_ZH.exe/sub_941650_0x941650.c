...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_ec
            int32_t var_d0
            int32_t eax_18 = eax_17 - *((neg.d(var_f8
                + *(((eax_13 + *(((ebx_13 - eax_13) << 2) + var_d0) - var_f8) << 2) + var_ec)
                - 0xff) << 2) + edx_2)
            ...
            int32_t eax_24 = eax_23 - *((neg.d(var_f4
                + *(((eax_19 + *(((ebx_27 - eax_19) << 2) + var_d0) - var_f4) << 2) + var_e8)
                - 0xff) << 2) + edx_2)
            ...
            ebx_41.b = *var_18
            int32_t eax_25
            eax_25.b = not.b(ebx_41.b)
            int32_t eax_29
            eax_29.b = *edi
            int32_t var_f0
            int32_t var_e4
            result = eax_29 - *((neg.d(var_f0
                + *(((eax_25 + *(((ebx_41 - eax_25) << 2) + var_d0) - var_f0) << 2) + var_e4)
                - 0xff) << 2) + edx_2)
