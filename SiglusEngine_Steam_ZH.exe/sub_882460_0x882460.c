            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    int32_t eax_3 = var_e0
                        + *(((eax + *(((ebx_6 - eax) << 2) + var_d0) - var_e0) << 2) + var_d4)
                    int32_t var_88
                    int32_t ebx_15 = eax_3 + var_88
                    int32_t ebx_23
                    ...
                    int32_t eax_6
                    eax_6.b = edi[2]
                    edi[2] = eax_6.b + (*(((ebx_23 - eax_6) << 2) + edx_2)).b
                    int32_t ebx_32
                    ebx_32.b = esi_1[1]
                    int32_t eax_8
                    eax_8.b = not.b(ebx_32.b)
                    int32_t var_dc
                    int32_t eax_11 = var_dc
                        + *(((eax_8 + *(((ebx_32 - eax_8) << 2) + var_d0) - var_dc) << 2) + var_d4)
                    int32_t var_84
                    int32_t ebx_41 = eax_11 + var_84
                    int32_t ebx_49
                    ...
                    int32_t eax_14
                    eax_14.b = edi[1]
                    edi[1] = eax_14.b + (*(((ebx_49 - eax_14) << 2) + edx_2)).b
                    int32_t ebx_58
                    ebx_58.b = *esi_1
                    int32_t eax_16
                    eax_16.b = not.b(ebx_58.b)
                    int32_t var_d8
                    int32_t eax_19 = var_d8 +
                        *(((eax_16 + *(((ebx_58 - eax_16) << 2) + var_d0) - var_d8) << 2) + var_d4)
                    int32_t var_80
                    int32_t ebx_67 = eax_19 + var_80
                    int32_t ebx_75
                    ...
                    int32_t eax_22
                    eax_22.b = *edi
                    *edi = eax_22.b + (*(((ebx_75 - eax_22) << 2) + edx_2)).b
