        ...
        do
            ...
            if (edi s>= var_50)
                ...
                int32_t ebx_25 = ((var_f8 + *(((var_e0
                    ...
                    - var_f8) << 2) + var_ec) - eax_15) << 2) + var_118
                *(edi + 2) = eax_15.b + (*ebx_25).b
                int32_t ebx_26
                ebx_26.b = *(esi_1 + 1)
                int32_t eax_18 = edx_5 + *(((ebx_26 - edx_5) << 2) + eax_6)
                int32_t eax_19
                ...
                int32_t var_e8
                int32_t var_dc
                int32_t ebx_45 = ((var_f4 + *(((var_dc
                    + *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8) - eax_25) << 2) + var_118
                *(edi + 1) = eax_25.b + (*ebx_45).b
                int32_t ebx_46
                ebx_46.b = *esi_1
                int32_t eax_28 = edx_5 + *(((ebx_46 - edx_5) << 2) + eax_6)
                int32_t eax_29
                ...
                int32_t ebx_65 = ((var_f0 + *(((var_d8
                    ...
                    - var_f0) << 2) + var_e4) - eax_35) << 2) + var_118
                *edi = eax_35.b + (*ebx_65).b
