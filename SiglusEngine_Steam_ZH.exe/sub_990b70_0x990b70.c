...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t var_ec
        int32_t var_d0
        edi[2] = eax_15.b + (*(((var_f8
            + *(((eax_11 + *(((eax_10 - eax_11) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_15)
            << 2) + edx_2)).b
        int32_t ebx_25
        ebx_25.b = edi[1]
        ...
        int32_t var_f4
        int32_t var_e8
        edi[1] = eax_23.b + (*(((var_f4
            + *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_23)
            << 2) + edx_2)).b
        int32_t ebx_41
        ebx_41.b = *edi
        ...
        result = eax_31 + *(((var_f0
            + *(((eax_27 + *(((eax_26 - eax_27) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_31)
            << 2) + edx_2)
        *edi = result.b
