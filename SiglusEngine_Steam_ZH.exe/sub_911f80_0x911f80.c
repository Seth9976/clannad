...
do
    ...
    if (ebx_1 != 0)
        ...
        *(edi + 2) = eax_15.b + (*(((var_e0
            + *(((eax_11 + *(((eax_10 - eax_11) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_15)
            << 2) + edx_2)).b
        int32_t ebx_25
        ebx_25.b = var_18[1]
        ...
        *(edi + 1) = eax_23.b + (*(((var_dc
            + *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_23)
            << 2) + edx_2)).b
        int32_t ebx_41
        ebx_41.b = *var_18
        ...
        result = eax_31 + *(((var_d8
            + *(((eax_27 + *(((eax_26 - eax_27) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_31)
            << 2) + edx_2)
        *edi = result.b
