...
do
    ...
    int32_t var_118
    int32_t var_d0
    int32_t eax_15 = eax_14 - *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0)) << 2) + var_118)
    ...
    int32_t eax_20
    eax_20.b = edi[1]
    int32_t eax_21 = eax_20 - *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0)) << 2) + var_118)
    ...
    int32_t eax_26
    eax_26.b = *edi
    result = eax_26 - *(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0)) << 2) + var_118)
