                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                int32_t eax_15
                                eax_15.b = edi[2]
                                edi[2] = eax_15.b + (*(((ebx_39 - eax_15) << 2) + edx_2)).b
                                int32_t ebx_48
                                ebx_48.b = var_3c[1]
                                int32_t eax_18 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_10)
                                int32_t var_84
                                int32_t ebx_53 = eax_18 + var_84
                                int32_t ebx_61
                                ...
                                if (eax_18 + var_84 s< 0)
                                    ...
                                    ebx_56.b = edi[1]
                                    ebx_61 =
                                        *(((ebx_56 - 0xff) << 2) + *((ebx_53 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_21
                                eax_21.b = edi[1]
                                edi[1] = eax_21.b + (*(((ebx_61 - eax_21) << 2) + edx_2)).b
                                int32_t ebx_70
                                ebx_70.b = *var_3c
                                int32_t eax_24 = edx_6 + *(((ebx_70 - edx_6) << 2) + eax_10)
                                int32_t var_80
                                int32_t ebx_75 = eax_24 + var_80
                                int32_t ebx_83
                                ...
                                if (eax_24 + var_80 s< 0)
                                    ...
                                    ebx_78.b = *edi
                                    ebx_83 =
                                        *(((ebx_78 - 0xff) << 2) + *((ebx_75 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_27
                                eax_27.b = *edi
                                *edi = eax_27.b + (*(((ebx_83 - eax_27) << 2) + edx_2)).b
