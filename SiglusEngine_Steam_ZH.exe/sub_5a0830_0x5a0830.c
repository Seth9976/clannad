...
int32_t (* var_c)(void* arg1) = sub_9b9300
TEB* fsbase
    ...
    if (eax_3 != ecx)
        ...
        if (arg2 u> eax_12)
            ...
            if (arg2 u> (edx_9 u>> 0x1f) + edx_9)
                ...
                int32_t ecx_18
                eax_24, ecx_18 = sub_5a0a70(arg1, (edx_13 u>> 0x1f) + edx_13)
                
                if (eax_24.b != 0)
                    int32_t var_8_1 = 0
                    int32_t* var_30_6 = arg2
                    int32_t var_34_2 = ecx_18
                    arg1[1] = sub_5a0cb0(eax_24, ebx[1], *ebx, *arg1)
            else
                int64_t* ecx_10 = *ebx
                int32_t eax_23 = eax_12 * 3
                void* esi_2 = ecx_10 + (eax_23 << 2)
                int32_t ecx_11
                eax_24, ecx_11 = sub_5a0c60(eax_23, esi_2, ecx_10, *arg1)
                int32_t* var_30_3 = arg2
                int32_t var_34_1 = ecx_11
                arg1[1] = sub_5a0cb0(eax_24, ebx[1], esi_2, arg1[1])
        else
            sub_5a0c60(eax_12, ebx[1], *ebx, esi_1)
            int32_t eax_13
            int32_t edx_6
            edx_6:eax_13 = muls.dp.d(0x2aaaaaab, ebx[1] - *ebx)
            int32_t edx_7 = edx_6 s>> 1
            arg1[1] = *arg1 + ((edx_7 u>> 0x1f) + edx_7) * 0xc
    else
        arg1[1] = *arg1
