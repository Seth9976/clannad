                ...
                if (result_2 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        if (result != 0xff)
                            ...
                            if (ebx_27 != 0)
                                int32_t eax_13 = *((result << 2) + &data_4d6e180)
                                *((ebx_20 << 2) + eax_13)
                                *((ebx_21 << 2) + eax_13)
                                int32_t eax_14
                                eax_14.b = edi[2]
                                edi[2] = (divu.dp.d(mulu.dp.d(eax_14, edx_6), ecx_6)).b
                                int32_t eax_19
                                eax_19.b = edi[1]
                                edi[1] = (divu.dp.d(mulu.dp.d(eax_19, edx_6), ecx_6)).b
                                int32_t eax_24
                                eax_24.b = *edi
                                result = divu.dp.d(mulu.dp.d(eax_24, edx_6), ecx_6)
                                *edi = result.b
                                edi[3] = ecx_6.b
                            else
                                edi[2] = ebx_19.b
