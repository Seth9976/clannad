...
uint64_t st2 = _m_punpckldq(st5, st1.d)
...
_m_punpckldq(arg1, arg1.d)
st4 = __pfmul_mmxq_mmxq(__pfadd_mmxq_mmxq(temp0_23, temp0_22), st2)

if (((ecx ^ ecx u>> 1) & 1) != 0)
    _m_punpckhdq(st4, _m_punpckldq(temp0_22, st4.d).d)

return eax_1 ^ (eax_1 & 0x80000000)
