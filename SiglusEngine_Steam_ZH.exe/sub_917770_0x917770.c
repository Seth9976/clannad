...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_d4
            int32_t var_d0
            int32_t ebx_36 = ((var_f8 + *(((var_e0
                + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_e0) << 2) + var_d4)
                - var_f8) << 2) + var_ec) - eax_28) << 2) + edx_2
            edi[2] = eax_28.b + (*ebx_36).b
            int32_t ebx_37
            ebx_37.b = var_18[1]
            int32_t eax_31 = edx_6 + *(((ebx_37 - edx_6) << 2) + eax_19)
            int32_t eax_32
            ...
            int32_t ebx_56 = ((var_f4 + *(((var_dc
                + *(((eax_32 + *(((eax_31 - eax_32) << 2) + var_d0) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8) - eax_38) << 2) + edx_2
            edi[1] = eax_38.b + (*ebx_56).b
            int32_t ebx_57
            ebx_57.b = *var_18
            int32_t eax_41 = edx_6 + *(((ebx_57 - edx_6) << 2) + eax_19)
            int32_t eax_42
            ...
            int32_t var_e4
            int32_t var_d8
            int32_t ebx_76 = ((var_f0 + *(((var_d8
                + *(((eax_42 + *(((eax_41 - eax_42) << 2) + var_d0) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4) - eax_48) << 2) + edx_2
            result = eax_48 + *ebx_76
            *edi = result.b
