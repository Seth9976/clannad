            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d0
                        edi[2] = eax_5.b + (
                            *(((eax_3 + *(((ebx_14 - eax_3) << 2) + var_d0) - eax_5) << 2) + edx_2)).b
                        int32_t ebx_22
                        ebx_22.b = esi_1[1]
                        int32_t eax_7
                        eax_7.b = not.b(ebx_22.b)
                        int32_t eax_9
                        eax_9.b = edi[1]
                        edi[1] = eax_9.b + (
                            *(((eax_7 + *(((ebx_22 - eax_7) << 2) + var_d0) - eax_9) << 2) + edx_2)).b
                        int32_t ebx_30
                        ebx_30.b = *esi_1
                        int32_t eax_11
                        ...
                        int32_t eax_13
                        eax_13.b = *edi
                        *edi = eax_13.b + (*(((eax_11 + *(((ebx_30 - eax_11) << 2) + var_d0)
                            - eax_13) << 2) + edx_2)).b
