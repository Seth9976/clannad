...
struct NT3::C_control::NT3::Cc_button::VTable** result = arg1
struct NT3::C_control::NT3::Cc_button::VTable** result_1 = result
sub_6bfab0(arg1)
result[0x23] = 7
result[0x22] = 0
result[0x1e].w = 0
result[0x17] = 7
int32_t var_8_1 = 0
*result = &NT3::Cc_button::`vftable'{for `NT3::C_control'}
int32_t var_18 = 7
int32_t var_1c = 0
int16_t var_2c = 0
