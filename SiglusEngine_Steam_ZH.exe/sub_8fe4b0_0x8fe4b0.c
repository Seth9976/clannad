            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ecx_7 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_5 = var_f8 + *(((var_e0 + *(((ebx_3 - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_12
                        ebx_12.b = var_3c[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t eax_9 = var_f4 + *(((var_dc + *(((ebx_12 - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_21
                        ebx_21.b = *var_3c
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_13 = var_f0 + *(((var_d8 + *(((ebx_21 - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4)
