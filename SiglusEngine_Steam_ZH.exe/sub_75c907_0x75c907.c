...
if ((eax_2 & 0x7fff) != 0)
    ...
    *(edi_4 + 4) = esi_1[1]
    ...
    int32_t edx_12 = data_b4d09c
    
    if (ecx_10 s< edx_12 - data_b4d0a0)
        var_14 = 0
        ...
        *edi_11 = *esi_5
        ...
        esi = 0
        i_1 = 2
    else if (ecx_10 s< data_b4d098)
        int32_t esi_11 = data_b4d0ac
        var_14 &= 0x7fffffff
        int32_t ecx_39 = data_b4d0a4
        int32_t eax_85
        int32_t edx_42
...
int32_t eax_100 = data_b4d0a8
int32_t esi_15 =
    esi << (0x1f - (data_b4d0a4).b) | (sbb.d(eax_97, eax_97, eax_3 != 0) & 0x80000000) | var_14
