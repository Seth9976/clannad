...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_d0
            int32_t eax_6 =
                var_f8 + *(((eax_3 + *(((ebx_2 - eax_3) << 2) + var_d0) - var_f8) << 2) + var_ec)
            int32_t ebx_11
            ebx_11.b = var_18[1]
            int32_t eax_7
            ...
            int32_t var_e8
            int32_t eax_10 =
                var_f4 + *(((eax_7 + *(((ebx_11 - eax_7) << 2) + var_d0) - var_f4) << 2) + var_e8)
            int32_t ebx_20
            ebx_20.b = *var_18
            int32_t eax_11
            ...
            int32_t var_e4
            int32_t eax_14 =
                var_f0 + *(((eax_11 + *(((ebx_20 - eax_11) << 2) + var_d0) - var_f0) << 2) + var_e4)
            result = result_1
