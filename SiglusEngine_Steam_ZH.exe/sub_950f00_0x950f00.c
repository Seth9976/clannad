...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_d0
            int32_t eax_25 =
                var_f8 + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_f8) << 2) + var_ec)
            int32_t var_88
            ...
            int32_t ebx_47
            ebx_47.b = var_18[1]
            int32_t eax_31 = edx_6 + *(((ebx_47 - edx_6) << 2) + eax_19)
            int32_t eax_32
            eax_32.b = not.b(eax_31.b)
            int32_t var_f4
            int32_t var_e8
            int32_t eax_35 =
                var_f4 + *(((eax_32 + *(((eax_31 - eax_32) << 2) + var_d0) - var_f4) << 2) + var_e8)
            int32_t var_84
            ...
            int32_t ebx_77
            ebx_77.b = *var_18
            int32_t eax_41 = edx_6 + *(((ebx_77 - edx_6) << 2) + eax_19)
            int32_t eax_42
            eax_42.b = not.b(eax_41.b)
            int32_t var_f0
            int32_t var_e4
            int32_t eax_45 =
                var_f0 + *(((eax_42 + *(((eax_41 - eax_42) << 2) + var_d0) - var_f0) << 2) + var_e4)
            int32_t var_80
