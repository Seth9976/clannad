                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                int32_t var_f4
                                int32_t var_e8
                                int32_t ebx_50 = (*(((var_f4 + *(((eax_14
                                    + *(((ebx_37 - eax_14) << 2) + var_d0) - var_f4) << 2) + var_e8))
                                    << 2) + *((eax_18 << 2) + &data_4e3da80)) - eax_22) << 2
                                edi[1] = eax_22.b + (*(ebx_50 + edx_2)).b
                                int32_t ebx_52
                                ebx_52.b = *var_3c
                                int32_t eax_24
                                eax_24.b = not.b(ebx_52.b)
                                int32_t eax_28
                                eax_28.b = *edi
                                int32_t eax_32
                                eax_32.b = *edi
                                int32_t var_f0
                                int32_t var_e4
                                int32_t ebx_65 = (*(((var_f0 + *(((eax_24
                                    + *(((ebx_52 - eax_24) << 2) + var_d0) - var_f0) << 2) + var_e4))
