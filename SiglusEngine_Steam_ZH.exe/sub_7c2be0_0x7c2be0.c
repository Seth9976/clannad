            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d0
                        int32_t eax_6 = eax_5 + *(((ebx_22 - eax_5) << 2) + var_d0)
                        int32_t var_88
                        ...
                        ebx_44.b = esi_1[1]
                        int32_t eax_11
                        eax_11.b = not.b(ebx_44.b)
                        int32_t eax_12 = eax_11 + *(((ebx_44 - eax_11) << 2) + var_d0)
                        int32_t var_84
                        ...
                        ebx_66.b = *esi_1
                        int32_t eax_17
                        eax_17.b = not.b(ebx_66.b)
                        int32_t eax_18 = eax_17 + *(((ebx_66 - eax_17) << 2) + var_d0)
                        int32_t var_80
