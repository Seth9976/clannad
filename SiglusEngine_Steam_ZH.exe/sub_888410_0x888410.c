                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                if (eax_17 + var_88 s< 0)
                                    ...
                                    ebx_47.b = edi[2]
                                    ebx_52 =
                                        *(((ebx_47 - 0xff) << 2) + *((ebx_44 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_20
                                eax_20.b = edi[2]
                                edi[2] = eax_20.b + (*(((ebx_52 - eax_20) << 2) + edx_2)).b
                                int32_t ebx_61
                                ebx_61.b = esi_1[1]
                                int32_t eax_23 = edx_6 + *(((ebx_61 - edx_6) << 2) + eax_9)
                                int32_t eax_24
                                ...
                                if (eax_29 + var_84 s< 0)
                                    ...
                                    ebx_81.b = edi[1]
                                    ebx_86 =
                                        *(((ebx_81 - 0xff) << 2) + *((ebx_78 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_32
                                eax_32.b = edi[1]
                                edi[1] = eax_32.b + (*(((ebx_86 - eax_32) << 2) + edx_2)).b
                                int32_t ebx_95
                                ebx_95.b = *esi_1
                                int32_t eax_35 = edx_6 + *(((ebx_95 - edx_6) << 2) + eax_9)
                                int32_t eax_36
                                ...
                                int32_t eax_41 = var_f0 + *(((var_d8 + *(((eax_36
                                    ...
                                    - var_f0) << 2) + var_e4)
                                int32_t var_80
                                int32_t ebx_112 = eax_41 + var_80
                                int32_t ebx_120
                                
                                if (eax_41 + var_80 s< 0)
                                    if (ebx_112 s< 0xffffff01)
                                        ebx_112 = 0xffffff01
                                    
                                    int32_t ebx_123
                                    ebx_123.b = *edi
                                    ebx_120 = *((ebx_123 << 2) + *((ebx_112 << 2) + data_4ced578))
                                else
                                    if (ebx_112 s> 0xff)
                                        ebx_112 = 0xff
                                    ...
                                    int32_t ebx_115
                                    ebx_115.b = *edi
                                    ebx_120 = *(((ebx_115 - 0xff) << 2)
                                        + *((ebx_112 << 2) + data_4ced578)) + 0xff
                                
                                int32_t eax_44
                                eax_44.b = *edi
                                *edi = eax_44.b + (*(((ebx_120 - eax_44) << 2) + edx_2)).b
