...
do
    ...
    if (ecx_5 != 0)
        ...
        int32_t var_d0
        int32_t eax_7 =
            var_f8 + *(((eax_4 + *(((ebx_1 - eax_4) << 2) + var_d0) - var_f8) << 2) + var_ec)
        int32_t ebx_10
        ebx_10.b = var_18[1]
        int32_t eax_8
        ...
        int32_t var_e8
        int32_t eax_11 =
            var_f4 + *(((eax_8 + *(((ebx_10 - eax_8) << 2) + var_d0) - var_f4) << 2) + var_e8)
        int32_t ebx_19
        ebx_19.b = *var_18
        int32_t eax_12
        eax_12.b = not.b(ebx_19.b)
        int32_t var_f0
        int32_t var_e4
        int32_t eax_15 =
            var_f0 + *(((eax_12 + *(((ebx_19 - eax_12) << 2) + var_d0) - var_f0) << 2) + var_e4)
        result = result_1
