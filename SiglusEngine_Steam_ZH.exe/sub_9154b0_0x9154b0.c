...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_f8
            int32_t var_ec
            edi[2] = eax_24.b + (*(((var_f8
                + *(((edx_6 + *(((ebx_17 - edx_6) << 2) + eax_19) - var_f8) << 2) + var_ec)
                - eax_24) << 2) + edx_2)).b
            int32_t ebx_29
            ebx_29.b = var_18[1]
            int32_t eax_30
            ...
            int32_t var_f4
            int32_t var_e8
            edi[1] = eax_30.b + (*(((var_f4
                + *(((edx_6 + *(((ebx_29 - edx_6) << 2) + eax_19) - var_f4) << 2) + var_e8)
                - eax_30) << 2) + edx_2)).b
            int32_t ebx_41
            ebx_41.b = *var_18
            int32_t eax_36
            ...
            int32_t var_f0
            int32_t var_e4
            result = eax_36 + *(((var_f0
                + *(((edx_6 + *(((ebx_41 - edx_6) << 2) + eax_19) - var_f0) << 2) + var_e4)
                - eax_36) << 2) + edx_2)
            *edi = result.b
