                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                eax_18.b = edi[2]
                                int32_t var_d0
                                edi[2] = eax_18.b + (*(((*(((eax_12
                                    + *(((eax_11 - eax_12) << 2) + var_d0)) << 2)
                                    + *((eax_14 << 2) + &data_4e3da80)) - eax_18) << 2) + edx_2)).b
                                int32_t ebx_42
                                ebx_42.b = esi_1[1]
                                int32_t eax_21 = edx_6 + *(((ebx_42 - edx_6) << 2) + eax_9)
                                int32_t eax_22
                                ...
                                int32_t eax_28
                                eax_28.b = edi[1]
                                edi[1] = eax_28.b + (*(((*(((eax_22
                                    + *(((eax_21 - eax_22) << 2) + var_d0)) << 2)
                                    + *((eax_24 << 2) + &data_4e3da80)) - eax_28) << 2) + edx_2)).b
                                int32_t ebx_57
                                ebx_57.b = *esi_1
                                int32_t eax_31 = edx_6 + *(((ebx_57 - edx_6) << 2) + eax_9)
                                int32_t eax_32
