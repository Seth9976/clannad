            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        edi[2] = eax_17.b + (*(((var_e0 + *(((eax_13
                            + *(((eax_12 - eax_13) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_17)
                            << 2) + edx_2)).b
                        int32_t ebx_33
                        ebx_33.b = var_3c[1]
                        ...
                        eax_25.b = edi[1]
                        int32_t var_dc
                        edi[1] = eax_25.b + (*(((var_dc + *(((eax_21
                            + *(((eax_20 - eax_21) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_25)
                            << 2) + edx_2)).b
                        int32_t ebx_49
                        ebx_49.b = *var_3c
                        ...
                        eax_33.b = *edi
                        int32_t var_d8
                        *edi = eax_33.b + (*(((var_d8 + *(((eax_29
                            + *(((eax_28 - eax_29) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_33)
                            << 2) + edx_2)).b
