                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                if (ecx_8 != 0)
                                    ...
                                    int32_t var_d0
                                    int32_t eax_6 = eax_5 + *(((ebx_21 - eax_5) << 2) + var_d0)
                                    int32_t ebx_26
                                    ebx_26.b = esi_1[1]
                                    int32_t eax_7
                                    eax_7.b = not.b(ebx_26.b)
                                    int32_t eax_8 = eax_7 + *(((ebx_26 - eax_7) << 2) + var_d0)
                                    int32_t ebx_31
                                    ebx_31.b = *esi_1
                                    int32_t eax_9
                                    eax_9.b = not.b(ebx_31.b)
                                    int32_t eax_10 = eax_9 + *(((ebx_31 - eax_9) << 2) + var_d0)
                                    ...
                                    if (ebx_19 != 0xff)
                                        ...
                                        if (ebx_41 != 0)
                                            int32_t eax_14 = *((ebx_19 << 2) + &data_4d6e180)
                                            *((eax_8 << 2) + eax_14)
                                            *((eax_10 << 2) + eax_14)
                                            int32_t eax_15
                                            eax_15.b = edi[2]
