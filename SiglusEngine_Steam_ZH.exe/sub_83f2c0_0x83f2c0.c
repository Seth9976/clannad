            ...
            if (ebx_9 != 0)
                ...
                if (ecx_6 != 0)
                    ...
                    int32_t eax_19 = var_f8 +
                        *(((eax_16 + *(((eax_15 - eax_16) << 2) + var_d0) - var_f8) << 2) + var_ec)
                    int32_t ebx_28
                    ebx_28.b = var_124[1]
                    int32_t eax_21 = edx_10 + *(((ebx_28 - edx_10) << 2) + eax_13)
                    int32_t eax_22
                    ...
                    int32_t ebx_41
                    ebx_41.b = *var_124
                    int32_t eax_27 = edx_10 + *(((ebx_41 - edx_10) << 2) + eax_13)
                    int32_t eax_28
                    ...
                    if (ebx_9 != 0xff)
                        ...
                        if (ebx_59 != 0)
                            int32_t eax_35 = *((ebx_9 << 2) + &data_4d6e180)
                            *((eax_25 << 2) + eax_35)
                            *((eax_31 << 2) + eax_35)
                            int32_t eax_36
                            eax_36.b = *(edi + 2)
