...
do
    ...
    int32_t var_d4
    int32_t var_d0
    int32_t eax_17 = eax_16 + *(((var_e0
        + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2) + var_118)
    ...
    eax_24.b = edi[1]
    int32_t var_dc
    int32_t eax_25 = eax_24 + *(((var_dc
        + *(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2) + var_118)
    ...
    eax_32.b = *edi
    int32_t var_d8
    result = eax_32 + *(((var_d8
        + *(((eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2) + var_118)
