...
arg3 = ecx_1 & 1
int16_t* edi_3 =
    *(arg1 + 0x60) * ecx_1 + (ebx - 1) * arg3 * 6 + *(arg1 + 0x64) * arg4 + *(arg1 + 0x20)
int32_t eax_9 = *(arg1 + 0x34) + (((arg4 & 3) + ((ecx_1 & 3) << 3)) << 2)
int32_t edx_4
int32_t ebx_1
...
if (*(arg1 + 0x68) u> 0)
    ...
    int32_t ecx_8 = (edx_4 + ebx_1) << 4
    arg4 = (ebx_1 - edx_4) << 4
    arg5 = eax_16 + arg5 + 8
    
    do
        long double x87_r7_3 = fconvert.t(*(eax_9 + ((arg3 & 3) << 2)))
        float var_8_1 = fconvert.s(x87_r7_3)
        float var_44_1 =
            fconvert.s((fconvert.t(var_54) + fconvert.t(*(arg5 - 8))) * fconvert.t(65535f))
        float var_40_1 =
            fconvert.s((fconvert.t(var_50) + fconvert.t(*(arg5 - 4))) * fconvert.t(65535f))
        float var_3c_1 = fconvert.s((fconvert.t(var_4c) + fconvert.t(*arg5)) * fconvert.t(65535f))
        ...
        if (*(arg1 + 0x5c) != 0)
            ...
            *ebx_16 = fconvert.s(fconvert.t(0.0625f) * x87_r6_18 + fconvert.t(*ebx_16))
            float* edx_14 = *(arg1 + 0x5c) + arg4 + 0x18
            var_50 = fconvert.s(x87_r6_18 * fconvert.t(0.4375))
            long double x87_r7_12 = x87_r7_11 * (fconvert.t(var_3c_1) - float.t(var_1c_1))
            *edx_14 = fconvert.s(fconvert.t(0.1875f) * x87_r7_12 + fconvert.t(*edx_14))
            float* edx_16 = *(arg1 + 0x5c) + eax_16 + 0x18
            *edx_16 = fconvert.s(fconvert.t(0.3125f) * x87_r7_12 + fconvert.t(*edx_16))
            float* edx_18 = *(arg1 + 0x5c) + ecx_8 + 0x18
            *edx_18 = fconvert.s(fconvert.t(0.0625f) * x87_r7_12 + fconvert.t(*edx_18))
