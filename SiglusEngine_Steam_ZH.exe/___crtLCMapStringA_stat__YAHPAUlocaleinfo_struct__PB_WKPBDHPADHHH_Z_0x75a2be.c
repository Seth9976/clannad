...
if (cchWideChar != 0)
    ...
    if (lpWideCharStr == 0)
        ...
        if (MultiByteToWideChar(arg8, MB_PRECOMPOSED, arg4, cbMultiByte_1, lpWideCharStr, 
                cchWideChar) != 0)
            cchWideChar_1 = sub_7552a4(arg2, arg3, lpWideCharStr, cchWideChar_2, nullptr, 0)
                ...
                if ((arg3 & 0x400) == 0)
                    ...
                    label_75a460:
                        ...
                        if (lpWideCharStr_1 != 0)
                            if (sub_7552a4(arg2, arg3, lpWideCharStr, cchWideChar_2, 
                    ...
                    sub_7552a4(arg2, arg3, lpWideCharStr, cchWideChar_2, arg6, arg7)
