        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                *(edi + 2) = eax_21.b
                int32_t ebx_37
                ebx_37.b = *(esi_1 + 1)
                int32_t eax_23 = edx_6 + *(((ebx_37 - edx_6) << 2) + eax_11)
                int32_t eax_24
                ...
                *(edi + 1) = eax_31.b
                int32_t ebx_57
                ebx_57.b = *esi_1
                int32_t eax_33 = edx_6 + *(((ebx_57 - edx_6) << 2) + eax_11)
                int32_t eax_34
