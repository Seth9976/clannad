...
int32_t (* var_c)(void* arg1) = sub_9bbc2d
TEB* fsbase
...
int32_t* ebp
eax_4, ebp = sub_746f27(esi, 0x8007000e, 0xf4)
...
if (esi_2 == 0)
    ...
    *esi_2 = &ATL::CComPolyObject<class ATL::CAxHostWindow>::`vftable'{for `IUnknown'}
    sub_5cc4e0(&esi_2[2], esi_2)
    ebp[-1].b = 2
    (*(*data_bac3f8 + 4))(var_14)
...
if (esi_2 != 0)
    ...
    esi_2[1] -= 1
    result = (*esi_2)->vFunc_0(esi_2, &data_af2640, ebx)
