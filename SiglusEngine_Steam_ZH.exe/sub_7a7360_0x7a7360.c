    ...
    do
        ...
        if (ebx_1 != 0)
            ...
            int32_t eax_13 = eax_12
                - *((neg.d(eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - 0xff) << 2) + edx_1)
            ...
            int32_t ebx_23
            ebx_23.b = *(esi_1 + 1)
            int32_t eax_15 = edx_5 + *(((ebx_23 - edx_5) << 2) + eax_7)
            int32_t eax_16
            eax_16.b = not.b(eax_15.b)
            int32_t eax_18
            eax_18.b = edi[1]
            int32_t eax_19 = eax_18
                - *((neg.d(eax_16 + *(((eax_15 - eax_16) << 2) + var_d0) - 0xff) << 2) + edx_1)
            ...
            int32_t ebx_37
            ebx_37.b = *esi_1
            int32_t eax_21 = edx_5 + *(((ebx_37 - edx_5) << 2) + eax_7)
            int32_t eax_22
            eax_22.b = not.b(eax_21.b)
            int32_t eax_24
            eax_24.b = *edi
            int32_t eax = eax_24
                - *((neg.d(eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - 0xff) << 2) + edx_1)
