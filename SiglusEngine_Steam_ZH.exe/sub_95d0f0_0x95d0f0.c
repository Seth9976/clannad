...
do
    ...
    *(edi + 2) = eax_11.b + (*(ebx_14 + var_118)).b
    ...
    eax_21.b = *(edi + 1)
    int32_t var_dc
    int32_t ebx_29 = (*(((var_dc
        + *(((eax_13 + *(((ebx_16 - eax_13) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
    ...
    *(edi + 1) = eax_21.b + (*(ebx_29 + var_118)).b
    ...
    eax_31.b = *edi
    int32_t var_d8
    int32_t ebx_44 = (*(((var_d8
        + *(((eax_23 + *(((ebx_31 - eax_23) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
