                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        if (ecx_6 != 0)
                            ...
                            int32_t var_e0
                            int32_t var_d4
                            int32_t eax_17 = var_e0 + *(((edx_10
                                + *(((ebx_24 - edx_10) << 2) + eax_13) - var_e0) << 2) + var_d4)
                            int32_t ebx_33
                            ebx_33.b = var_124[1]
                            int32_t var_dc
                            int32_t eax_21 = var_dc + *(((edx_10
                                + *(((ebx_33 - edx_10) << 2) + eax_13) - var_dc) << 2) + var_d4)
                            int32_t ebx_42
                            ebx_42.b = *var_124
                            int32_t var_d8
                            int32_t eax_25 = var_d8 + *(((edx_10
                                + *(((ebx_42 - edx_10) << 2) + eax_13) - var_d8) << 2) + var_d4)
