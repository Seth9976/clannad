...
do
    ...
    if (ebx_1 != 0)
        ...
        *(edi + 2) = eax_6.b + (*(((var_f8
            + *(((eax_2 + *(((ebx_5 - eax_2) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_6) << 2)
            + edx_2)).b
        int32_t ebx_17
        ebx_17.b = var_18[1]
        int32_t eax_8
        ...
        *(edi + 1) = eax_12.b + (*(((var_f4
            + *(((eax_8 + *(((ebx_17 - eax_8) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_12) << 2)
            + edx_2)).b
        int32_t ebx_29
        ebx_29.b = *var_18
        int32_t eax_14
        ...
        result = eax_18 + *(((var_f0
            + *(((eax_14 + *(((ebx_29 - eax_14) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_18)
            << 2) + edx_2)
        *edi = result.b
