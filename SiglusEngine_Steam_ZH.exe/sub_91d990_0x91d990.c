...
do
    ...
    int32_t var_ec
    int32_t var_d0
    int32_t eax_17 = eax_16 + var_f8
        + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_f8) << 2) + var_ec)
    ...
    int32_t ebx_18
    ebx_18.b = var_18[1]
    int32_t eax_19 = edx_5 + *(((ebx_18 - edx_5) << 2) + eax_9)
    int32_t eax_20
    ...
    int32_t ebx_31
    ebx_31.b = *var_18
    int32_t eax_27 = edx_5 + *(((ebx_31 - edx_5) << 2) + eax_9)
    int32_t eax_28
    ...
    int32_t var_f0
    int32_t var_e4
    result = eax_32 + var_f0
        + *(((eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - var_f0) << 2) + var_e4)
