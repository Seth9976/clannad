                        ...
                        if (ebx_12 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                int32_t eax_18 = var_f8 + *(((eax_15
                                    + *(((eax_14 - eax_15) << 2) + var_d0) - var_f8) << 2) + var_ec)
                                int32_t ebx_31
                                ebx_31.b = var_3c[1]
                                int32_t eax_20 = edx_10 + *(((ebx_31 - edx_10) << 2) + eax_12)
                                int32_t eax_21
                                eax_21.b = not.b(eax_20.b)
                                int32_t var_f4
                                int32_t var_e8
                                int32_t eax_24 = var_f4 + *(((eax_21
                                    + *(((eax_20 - eax_21) << 2) + var_d0) - var_f4) << 2) + var_e8)
                                int32_t ebx_44
                                ebx_44.b = *var_3c
                                int32_t eax_26 = edx_10 + *(((ebx_44 - edx_10) << 2) + eax_12)
                                int32_t eax_27
                                eax_27.b = not.b(eax_26.b)
                                int32_t var_f0
                                int32_t var_e4
                                int32_t eax_30 = var_f0 + *(((eax_27
                                    + *(((eax_26 - eax_27) << 2) + var_d0) - var_f0) << 2) + var_e4)
                                ...
                                if (ebx_12 != 0xff)
                                    ...
                                    if (ebx_62 != 0)
                                        int32_t eax_34 = *((ebx_12 << 2) + &data_4d6e180)
                                        *((eax_24 << 2) + eax_34)
                                        *((eax_30 << 2) + eax_34)
                                        int32_t eax_35
                                        eax_35.b = edi[2]
