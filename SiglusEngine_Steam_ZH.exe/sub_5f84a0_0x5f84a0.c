...
int32_t (* var_c)(void* arg1) = sub_9bd300
TEB* fsbase
...
if (arg2 != 0)
    if (arg2 u<= 0x2e8ba2e)
        eax_3 = sub_745f3f(arg2 * 0x58)
        esi = eax_3
        struct _EXCEPTION_REGISTRATION_RECORD** var_18_1 = esi
    
    if (arg2 u> 0x2e8ba2e || esi == 0)
        sub_743132()
        noreturn

int32_t var_8_1 = 0
int32_t var_2c_2 = arg2
sub_553320(eax_3, arg1[1], *arg1, esi)
int32_t eax_5
int32_t edx_1
...
*arg1 = esi
arg1[2] = arg2 * 0x58 + esi
void* result = ((edx_2 u>> 0x1f) + edx_2) * 0x58 + esi
arg1[1] = result
fsbase->NtTib.ExceptionList = ExceptionList
return result
