...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_d0
            edi[2] = eax_15.b
                + (*(((eax_13 + *(((ebx_13 - eax_13) << 2) + var_d0) - eax_15) << 2) + edx_2)).b
            int32_t ebx_21
            ebx_21.b = var_18[1]
            int32_t eax_17
            eax_17.b = not.b(ebx_21.b)
            int32_t eax_19
            eax_19.b = edi[1]
            edi[1] = eax_19.b
                + (*(((eax_17 + *(((ebx_21 - eax_17) << 2) + var_d0) - eax_19) << 2) + edx_2)).b
            int32_t ebx_29
            ebx_29.b = *var_18
            int32_t eax_21
            ...
            eax_23.b = *edi
            result =
                eax_23 + *(((eax_21 + *(((ebx_29 - eax_21) << 2) + var_d0) - eax_23) << 2) + edx_2)
            *edi = result.b
