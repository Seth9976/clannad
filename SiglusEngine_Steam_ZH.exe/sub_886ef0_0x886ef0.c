            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t eax_14
                        eax_14.b = edi[2]
                        edi[2] = eax_14.b + (*(((ebx_31 - eax_14) << 2) + edx_2)).b
                        int32_t ebx_40
                        ebx_40.b = esi_1[1]
                        int32_t eax_17 = edx_6 + *(((ebx_40 - edx_6) << 2) + eax_9)
                        int32_t var_84
                        int32_t ebx_45 = eax_17 + var_84
                        int32_t ebx_53
                        ...
                        if (eax_17 + var_84 s< 0)
                            ...
                            ebx_48.b = edi[1]
                            ebx_53 =
                                *(((ebx_48 - 0xff) << 2) + *((ebx_45 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_20
                        eax_20.b = edi[1]
                        edi[1] = eax_20.b + (*(((ebx_53 - eax_20) << 2) + edx_2)).b
                        int32_t ebx_62
                        ebx_62.b = *esi_1
                        int32_t eax_23 = edx_6 + *(((ebx_62 - edx_6) << 2) + eax_9)
                        int32_t var_80
                        int32_t ebx_67 = eax_23 + var_80
                        int32_t ebx_75
                        ...
                        int32_t eax_26
                        eax_26.b = *edi
                        *edi = eax_26.b + (*(((ebx_75 - eax_26) << 2) + edx_2)).b
