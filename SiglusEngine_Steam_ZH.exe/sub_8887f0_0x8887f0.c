                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t eax_15 = var_e0 + *(((eax_12
                                + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4)
                            int32_t var_88
                            int32_t ebx_34 = eax_15 + var_88
                            int32_t ebx_42
                            ...
                            if (eax_15 + var_88 s< 0)
                                ...
                                int32_t ebx_37
                                ebx_37.b = edi[2]
                                ebx_42 = *(((ebx_37 - 0xff) << 2) + *((ebx_34 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_18
                            eax_18.b = edi[2]
                            edi[2] = eax_18.b + (*(((ebx_42 - eax_18) << 2) + edx_2)).b
                            int32_t ebx_51
                            ebx_51.b = esi_1[1]
                            int32_t eax_21 = edx_6 + *(((ebx_51 - edx_6) << 2) + eax_9)
                            int32_t eax_22
                            eax_22.b = not.b(eax_21.b)
                            int32_t var_dc
                            int32_t eax_25 = var_dc + *(((eax_22
                                + *(((eax_21 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4)
                            int32_t var_84
                            int32_t ebx_64 = eax_25 + var_84
                            int32_t ebx_72
                            ...
                            if (eax_25 + var_84 s< 0)
                                ...
                                int32_t ebx_67
                                ebx_67.b = edi[1]
                                ebx_72 = *(((ebx_67 - 0xff) << 2) + *((ebx_64 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_28
                            eax_28.b = edi[1]
                            edi[1] = eax_28.b + (*(((ebx_72 - eax_28) << 2) + edx_2)).b
                            int32_t ebx_81
                            ebx_81.b = *esi_1
                            int32_t eax_31 = edx_6 + *(((ebx_81 - edx_6) << 2) + eax_9)
                            int32_t eax_32
                            eax_32.b = not.b(eax_31.b)
                            int32_t var_d8
                            int32_t eax_35 = var_d8 + *(((eax_32
                                + *(((eax_31 - eax_32) << 2) + var_d0) - var_d8) << 2) + var_d4)
                            int32_t var_80
                            int32_t ebx_94 = eax_35 + var_80
                            int32_t ebx_102
                            ...
                            if (eax_35 + var_80 s< 0)
                                ...
                                ebx_97.b = *edi
                                ebx_102 =
                                    *(((ebx_97 - 0xff) << 2) + *((ebx_94 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_38
                            eax_38.b = *edi
                            *edi = eax_38.b + (*(((ebx_102 - eax_38) << 2) + edx_2)).b
