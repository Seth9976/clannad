...
void var_fc
int32_t var_bc[0x4]
int32_t result = sub_4c73cc(arg1, eax, 0xacbd58, &var_fc, &var_8, &var_bc, &var_1c, edi_2, 1)

if (result == 1)
    var_c = 1
    result =
        sub_4c73cc(arg1, *(arg1 + 0x100), 0xacbdd8, &var_fc, &var_8, &var_bc, &var_1c, edi_2, 1)
...
if (var_c == 0)
    ecx_5 = ecx_4 | 0x73800000
else
    ecx_5 = ecx_4 | 0x73700000
