...
if (edi u> esi && edi u< count + esi)
    ...
    if ((edi_1 & 3) == 0)
        ...
        if (ecx_3 u< 8)
            jump((&jump_table_748cc4)[neg.d(ecx_3)])
        ...
        switch (jump_table_748c18[eax_1])
            case 0x748c28
                eax_1.b = *(esi_4 + 3)
                *(edi_1 + 3) = eax_1.b
                ecx_3 = ecx_5 u>> 2
...
label_748a4b:
    ...
    label_748a6f:
        ...
        if (count u< 4)
            jump(*(((count - 4) << 2) + &data_748b88))
        
        eax_1 = edi & 3
        void* ecx_2 = count - 4 + eax_1
        
        switch (jump_table_748a8c[eax_1])
            case 0x748a9c
                edx_1 = 3 & ecx_2
                eax_1.b = *esi
                *edi = eax_1.b
    ...
    if (((edi ^ esi) & 0xf) == 0 && test_bit(data_b4c488, 1))
        int32_t* var_c = edi
        void* eax_22 = esi & 0xf
