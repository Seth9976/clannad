            ...
            if (edi s>= var_50)
                ...
                if (ecx_7 != 0)
                    ...
                    if (var_114 != 0xff)
                        ...
                        if (ebx_61 != 0)
                            int32_t eax_35 = *((var_114 << 2) + &data_4d6e180)
                            *((eax_24 << 2) + eax_35)
                            *((eax_32 << 2) + eax_35)
                            int32_t eax_36
                            eax_36.b = edi[2]
                            edi[2] = (divu.dp.d(mulu.dp.d(eax_36, edx_5), ecx_7)).b
                            int32_t eax_41
                            eax_41.b = edi[1]
                            edi[1] = (divu.dp.d(mulu.dp.d(eax_41, edx_5), ecx_7)).b
                            int32_t eax_46
                            eax_46.b = *edi
                            *edi = divu.dp.d(mulu.dp.d(eax_46, edx_5), ecx_7).b
                            edi[3] = ecx_7.b
                        else
                            edi[2] = eax_16.b
                            edi[1] = eax_24.b
