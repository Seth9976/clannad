    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t ebx_26 = (*(((var_e0
                + *(((eax_13 + *(((ebx_13 - eax_13) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2)
                + *((eax_17 << 2) + &data_4e3da80)) - eax_21) << 2
            edi[2] = eax_21.b + (*(ebx_26 + edx_2)).b
            int32_t ebx_28
            ebx_28.b = var_18[1]
            int32_t eax_23
            eax_23.b = not.b(ebx_28.b)
            int32_t eax_27
            eax_27.b = edi[1]
            int32_t eax_31
            eax_31.b = edi[1]
            ...
            int32_t ebx_41 = (*(((var_dc
                + *(((eax_23 + *(((ebx_28 - eax_23) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                + *((eax_27 << 2) + &data_4e3da80)) - eax_31) << 2
            edi[1] = eax_31.b + (*(ebx_41 + edx_2)).b
            int32_t ebx_43
            ebx_43.b = *var_18
            int32_t eax_33
            eax_33.b = not.b(ebx_43.b)
            int32_t eax_37
            eax_37.b = *edi
            int32_t eax_41
            eax_41.b = *edi
            int32_t var_d8
            int32_t ebx_56 = (*(((var_d8
                + *(((eax_33 + *(((ebx_43 - eax_33) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                + *((eax_37 << 2) + &data_4e3da80)) - eax_41) << 2
            result = eax_41 + *(ebx_56 + edx_2)
            *edi = result.b
