                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                int32_t ebx_19
                                ebx_19.b = esi_1[2]
                                int32_t eax_13 = edx_10 + *(((ebx_19 - edx_10) << 2) + eax_11)
                                int32_t eax_14
                                ...
                                int32_t ebx_36
                                ebx_36.b = esi_1[1]
                                int32_t eax_21 = edx_10 + *(((ebx_36 - edx_10) << 2) + eax_11)
                                int32_t eax_22
                                ...
                                int32_t ebx_53
                                ebx_53.b = *esi_1
                                int32_t eax_29 = edx_10 + *(((ebx_53 - edx_10) << 2) + eax_11)
                                int32_t eax_30
                                eax_30.b = not.b(eax_29.b)
                                int32_t var_f0
                                int32_t var_e4
                                int32_t var_d8
                                int32_t eax_35 = var_f0 + *(((var_d8 + *(((eax_30
                                    + *(((eax_29 - eax_30) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                    - var_f0) << 2) + var_e4)
                                ...
                                if (ebx_13 != 0xff)
                                    ...
                                    if (ebx_75 != 0)
                                        int32_t eax_39 = *((ebx_13 << 2) + &data_4d6e180)
                                        *((eax_27 << 2) + eax_39)
                                        *((eax_35 << 2) + eax_39)
                                        int32_t eax_40
                                        eax_40.b = edi[2]
                                        edi[2] = (divu.dp.d(mulu.dp.d(eax_40, edx_6), ecx_8)).b
                                        int32_t eax_45
                                        eax_45.b = edi[1]
                                        edi[1] = (divu.dp.d(mulu.dp.d(eax_45, edx_6), ecx_8)).b
                                        int32_t eax_50
                                        eax_50.b = *edi
                                        *edi = (divu.dp.d(mulu.dp.d(eax_50, edx_6), ecx_8)).b
                                        edi[3] = ecx_8.b
                                    else
                                        edi[2] = eax_19.b
                                        edi[1] = eax_27.b
