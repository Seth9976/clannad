...
do
    ...
    int32_t var_d0
    *(edi + 2) = (eax_12 + *(((eax_11 - eax_12) << 2) + var_d0)).b
    int32_t ebx_13
    ebx_13.b = esi_3[1]
    int32_t eax_15 = edx_5 + *(((ebx_13 - edx_5) << 2) + eax_9)
    int32_t eax_16
    eax_16.b = not.b(eax_15.b)
    *(edi + 1) = (eax_16 + *(((eax_15 - eax_16) << 2) + var_d0)).b
    int32_t ebx_21
    ebx_21.b = *esi_3
    int32_t eax_19 = edx_5 + *(((ebx_21 - edx_5) << 2) + eax_9)
    int32_t eax_20
    eax_20.b = not.b(eax_19.b)
    result = eax_20 + *(((eax_19 - eax_20) << 2) + var_d0)
    *edi = result.b
    esi_4 = esi_1 + 4
    i = i_1
    i_1 -= 1
