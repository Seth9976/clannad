        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_e0
                    int32_t var_d4
                    int32_t eax_22 = eax_21 - *((neg.d(var_e0
                    ...
                    eax_27.b = edi[1]
                    int32_t var_dc
                    int32_t eax_28 = eax_27 - *((neg.d(var_dc
                        + *(((edx_6 + *(((ebx_40 - edx_6) << 2) + eax_16) - var_dc) << 2) + var_d4)
                        - 0xff) << 2) + edx_2)
                    ...
                    eax_33.b = *edi
                    int32_t var_d8
                    result = eax_33 - *((neg.d(var_d8
                        + *(((edx_6 + *(((ebx_54 - edx_6) << 2) + eax_16) - var_d8) << 2) + var_d4)
                        - 0xff) << 2) + edx_2)
