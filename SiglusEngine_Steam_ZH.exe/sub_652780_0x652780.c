...
int32_t (* var_c)(void* arg1) = sub_9c409b
TEB* fsbase
...
if (result == 0xffffffff || (result.b & 0x10) != 0)
    ...
    if (ebx.b != 0)
        ...
        var_8_1.b = 4
        int16_t* eax_5 = sub_548cb0(eax_4, 0xaf752c, &var_2c, eax_4)
        var_8_1.b = 5
    ...
    if (var_38 != 2 || var_34 != 0)
        int32_t var_18_5 = 7
        int32_t var_1c_5 = 0
        var_2c = 0
        sub_52e720(&var_2c, 0xaf75a8, 0x2e)
        var_8_1.b = 8
    ...
    label_652a3b:
        ...
        int32_t var_1c_3 = 0
        var_2c = 0
        sub_52e720(&var_2c, 0xaf7554, 0x11)
        var_8_1.b = 6
        ...
        int32_t var_1c_4 = 0
        var_2c = 0
        sub_52e720(&var_2c, 0xaf7578, 0x14)
        var_8_1.b = 7
        sub_684160(data_bac424, 5, &var_2c)
        sub_52e8a0(&var_2c)
        var_8_1.b = 1
