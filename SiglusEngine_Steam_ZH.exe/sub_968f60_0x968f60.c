...
do
    ...
    if (ecx_5 != 0)
        ...
        int32_t var_d0
        int32_t eax_16 =
            var_f8 + *(((eax_13 + *(((eax_12 - eax_13) << 2) + var_d0) - var_f8) << 2) + var_ec)
        int32_t ebx_18
        ebx_18.b = var_18[1]
        ...
        int32_t var_e8
        int32_t eax_22 =
            var_f4 + *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_f4) << 2) + var_e8)
        int32_t ebx_31
        ebx_31.b = *var_18
        ...
        int32_t var_e4
        int32_t eax_28 =
            var_f0 + *(((eax_25 + *(((eax_24 - eax_25) << 2) + var_d0) - var_f0) << 2) + var_e4)
        result = result_1
