                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_f4
                                int32_t var_e8
                                int32_t ebx_63 = (*(((var_f4 + *(((eax_24
                                    + *(((eax_23 - eax_24) << 2) + var_d0) - var_f4) << 2) + var_e8))
                                ...
                                int32_t var_f0
                                int32_t var_e4
                                int32_t ebx_82 = (*(((var_f0 + *(((eax_36
                                    + *(((eax_35 - eax_36) << 2) + var_d0) - var_f0) << 2) + var_e4))
