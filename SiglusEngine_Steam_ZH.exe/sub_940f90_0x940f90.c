...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            eax_22.b = edi[2]
            int32_t eax_23 =
                eax_22 - *((neg.d(edx_6 + *(((ebx_17 - edx_6) << 2) + eax_19) - 0xff) << 2) + edx_2)
            ...
            eax_26.b = edi[1]
            int32_t eax_27 =
                eax_26 - *((neg.d(edx_6 + *(((ebx_27 - edx_6) << 2) + eax_19) - 0xff) << 2) + edx_2)
            ...
            eax_30.b = *edi
            result =
                eax_30 - *((neg.d(edx_6 + *(((ebx_37 - edx_6) << 2) + eax_19) - 0xff) << 2) + edx_2)
