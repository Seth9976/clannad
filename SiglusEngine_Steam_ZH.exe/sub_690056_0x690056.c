...
if (temp1 == neg.b(arg1))
                                                ...
                                                if (sub_6afb70(var_20) == 0)
                                                    ...
                                                    if (sub_6afb70(var_20) == 0)
                                                        ...
                                                        if (sub_6afb70(var_20) == 0)
                                                            ...
                                                            var_20 = WHEEL_NEXT_MESSAGE . STR = %s"
                                                            sub_52e820(&var_1c, var_20)
                                                            var_20 = arg3
                            ...
                            if (sub_6afb70(var_20) == 0)
                                ...
                                if (sub_6afb70(var_20) == 0)
                                    ...
                                    if (sub_6afb70(arg3) == 0)
                                        ...
                                        sub_536260(
                                            esi_1 * 0xe4 + entry_ebx + arg_54 * 0x18 + 0x10538, 
                                            &arg_94)
                                        entry_ebx.b = 1
    ...
    sub_536260(entry_ebx + 0x10410, &arg_94)
    entry_ebx.b = 1
