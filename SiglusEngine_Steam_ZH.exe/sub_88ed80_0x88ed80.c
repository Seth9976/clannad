        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    int32_t eax_17
                    eax_17.b = edi[2]
                    edi[2] = eax_17.b + (*(((*ebx_24 - eax_17) << 2) + edx_2)).b
                    int32_t ebx_29
                    ebx_29.b = *(esi_1 + 1)
                    int32_t eax_25
                    eax_25.b = edi[1]
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t* ebx_43 = ((var_f4 + *(((var_dc
                        + *(((edx_6 + *(((ebx_29 - edx_6) << 2) + eax_6) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)) << 2) + *((eax_25 << 2) + &data_4e3da80)
                    int32_t eax_29
                    eax_29.b = edi[1]
                    edi[1] = eax_29.b + (*(((*ebx_43 - eax_29) << 2) + edx_2)).b
                    int32_t ebx_48
                    ebx_48.b = *esi_1
                    int32_t eax_37
                    eax_37.b = *edi
                    ...
                    int32_t eax_41
                    eax_41.b = *edi
                    *edi = eax_41.b + (*(((*ebx_62 - eax_41) << 2) + edx_2)).b
