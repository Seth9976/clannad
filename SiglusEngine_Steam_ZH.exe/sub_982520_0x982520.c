        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    eax_15.b = edi[1]
                    int32_t var_dc
                    edi[1] = eax_15.b + (*(((var_dc +
                        *(((eax_11 + *(((ebx_28 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - eax_15) << 2) + edx_2)).b
                    int32_t ebx_40
                    ebx_40.b = *edi
                    int32_t eax_17
                    eax_17.b = not.b(ebx_40.b)
                    int32_t eax_21
                    eax_21.b = *edi
                    int32_t var_d8
                    *edi = eax_21.b + (*(((var_d8 +
                        *(((eax_17 + *(((ebx_40 - eax_17) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - eax_21) << 2) + edx_2)).b
