                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                int32_t ebx_23
                                ebx_23.b = var_3c[1]
                                int32_t eax_16 = edx_10 + *(((ebx_23 - edx_10) << 2) + eax_12)
                                int32_t ebx_28
                                ebx_28.b = *var_3c
                                int32_t eax_18 = edx_10 + *(((ebx_28 - edx_10) << 2) + eax_12)
                                ...
                                if (ebx_12 != 0xff)
                                    ...
                                    if (ebx_38 != 0)
                                        int32_t eax_22 = *((ebx_12 << 2) + &data_4d6e180)
                                        *((eax_16 << 2) + eax_22)
                                        *((eax_18 << 2) + eax_22)
                                        int32_t eax_23
                                        eax_23.b = edi[2]
                                        edi[2] = (divu.dp.d(mulu.dp.d(eax_23, edx_6), ecx_8)).b
                                        int32_t eax_28
                                        eax_28.b = edi[1]
                                        edi[1] = (divu.dp.d(mulu.dp.d(eax_28, edx_6), ecx_8)).b
                                        int32_t eax_33
                                        eax_33.b = *edi
                                        *edi = (divu.dp.d(mulu.dp.d(eax_33, edx_6), ecx_8)).b
                                        edi[3] = ecx_8.b
                                    else
                                        edi[2] = eax_14.b
                                        edi[1] = eax_16.b
