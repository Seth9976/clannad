            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ebx_7 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_4 = var_f8 + *(((var_e0 + *(((ebx_11 - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec)
                        int32_t var_88
                        ...
                        int32_t eax_7
                        eax_7.b = edi[2]
                        edi[2] = eax_7.b + (*(((ebx_28 - eax_7) << 2) + edx_2)).b
                        int32_t ebx_37
                        ebx_37.b = var_3c[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t eax_12 = var_f4 + *(((var_dc + *(((ebx_37 - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8)
                        int32_t var_84
                        ...
                        if (eax_12 + var_84 s< 0)
                            ...
                            ebx_49.b = edi[1]
                            ebx_54 =
                                *(((ebx_49 - 0xff) << 2) + *((ebx_46 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_15
                        eax_15.b = edi[1]
                        edi[1] = eax_15.b + (*(((ebx_54 - eax_15) << 2) + edx_2)).b
                        int32_t ebx_63
                        ebx_63.b = *var_3c
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_20 = var_f0 + *(((var_d8 + *(((ebx_63 - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4)
                        int32_t var_80
                        ...
                        if (eax_20 + var_80 s< 0)
                            ...
                            ebx_75.b = *edi
                            ebx_80 =
                                *(((ebx_75 - 0xff) << 2) + *((ebx_72 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_23
                        eax_23.b = *edi
                        *edi = eax_23.b + (*(((ebx_80 - eax_23) << 2) + edx_2)).b
