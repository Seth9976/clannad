...
do
    ...
    do
        ...
        *(edi + 2) = eax_14.b + (*(((var_e0
            + *(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_14)
            << 2) + var_118)).b
        int32_t ebx_21
        ebx_21.b = esi_2[1]
        ...
        *(edi + 1) = eax_22.b + (*(((var_dc
            + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_22)
            << 2) + var_118)).b
        int32_t ebx_37
        ebx_37.b = *esi_2
        int32_t eax_25 = edx_4 + *(((ebx_37 - edx_4) << 2) + eax_7)
        int32_t eax_26
        eax_26.b = not.b(eax_25.b)
        int32_t eax_30
        eax_30.b = *edi
        int32_t var_d8
        result = eax_30.b + (*(((var_d8
            + *(((eax_26 + *(((eax_25 - eax_26) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_30)
            << 2) + var_118)).b
        *edi = result
        edi += 4
        j = j_1
