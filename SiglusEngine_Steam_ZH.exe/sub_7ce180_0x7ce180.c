        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    eax_20.b = edi[2]
                    int32_t var_d0
                    edi[2] = eax_20.b + (*(((*(((eax_14 + *(((eax_13 - eax_14) << 2) + var_d0))
                        << 2) + *((eax_16 << 2) + &data_4e3da80)) - eax_20) << 2) + edx_2)).b
                    int32_t ebx_35
                    ebx_35.b = esi_1[1]
                    int32_t eax_23 = edx_6 + *(((ebx_35 - edx_6) << 2) + eax_11)
                    int32_t eax_24
                    ...
                    int32_t eax_30
                    eax_30.b = edi[1]
                    edi[1] = eax_30.b + (*(((*(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0))
                        << 2) + *((eax_26 << 2) + &data_4e3da80)) - eax_30) << 2) + edx_2)).b
                    int32_t ebx_50
                    ebx_50.b = *esi_1
                    int32_t eax_33 = edx_6 + *(((ebx_50 - edx_6) << 2) + eax_11)
                    int32_t eax_34
                    ...
                    int32_t eax_40
                    eax_40.b = *edi
                    *edi = eax_40.b + (*(((*(((eax_34 + *(((eax_33 - eax_34) << 2) + var_d0)) << 2)
                        + *((eax_36 << 2) + &data_4e3da80)) - eax_40) << 2) + edx_2)).b
