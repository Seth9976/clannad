            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_45 = ((var_f8 + *(((var_e0 + *(((eax_14
                            + *(((eax_13 - eax_14) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec) - eax_20) << 2) + edx_2
                        edi[2] = eax_20.b + (*ebx_45).b
                        int32_t ebx_46
                        ebx_46.b = esi_1[1]
                        int32_t eax_23 = edx_6 + *(((ebx_46 - edx_6) << 2) + eax_11)
                        int32_t eax_24
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_65 = ((var_f4 + *(((var_dc + *(((eax_24
                            + *(((eax_23 - eax_24) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - eax_30) << 2) + edx_2
                        edi[1] = eax_30.b + (*ebx_65).b
                        int32_t ebx_66
                        ebx_66.b = *esi_1
                        int32_t eax_33 = edx_6 + *(((ebx_66 - edx_6) << 2) + eax_11)
                        int32_t eax_34
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_85 = ((var_f0 + *(((var_d8 + *(((eax_34
                            + *(((eax_33 - eax_34) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - eax_40) << 2) + edx_2
                        *edi = eax_40.b + (*ebx_85).b
