...
int32_t (* var_c)(void* arg1) = sub_9b71d4
TEB* fsbase
...
if (arg3 == 0)
    ...
    *(arg3 + 0x200) - *(arg3 + 0x1fc)
    void* var_a4_1 = arg3
    ecx_1 = sub_6ad9b0(&var_78)
    int32_t var_8_1 = 0
    ebx = 1
...
if (eax_9 != 0)
    eax_9(*(arg2 + 4), *arg4, *arg5, ecx_1, eax_2)
...
if (arg3 == 0)
    ...
    int32_t var_a4_5 = *(arg3 + 0x2b8) - *(arg3 + 0x2b4)
