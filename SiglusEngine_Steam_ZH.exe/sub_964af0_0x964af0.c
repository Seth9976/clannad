...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            eax_19.b = edi[2]
            int32_t var_d0
            edi[2] = eax_19.b + (*(((*(((eax_13 + *(((ebx_13 - eax_13) << 2) + var_d0)) << 2)
                + *((eax_15 << 2) + &data_4e3da80)) - eax_19) << 2) + edx_2)).b
            int32_t ebx_24
            ebx_24.b = var_18[1]
            int32_t eax_21
            eax_21.b = not.b(ebx_24.b)
            int32_t eax_23
            eax_23.b = edi[1]
            int32_t eax_27
            eax_27.b = edi[1]
            edi[1] = eax_27.b + (*(((*(((eax_21 + *(((ebx_24 - eax_21) << 2) + var_d0)) << 2)
                + *((eax_23 << 2) + &data_4e3da80)) - eax_27) << 2) + edx_2)).b
            int32_t ebx_35
            ebx_35.b = *var_18
            int32_t eax_29
            eax_29.b = not.b(ebx_35.b)
            int32_t eax_31
            eax_31.b = *edi
            int32_t eax_35
            eax_35.b = *edi
            result = eax_35 + *(((*(((eax_29 + *(((ebx_35 - eax_29) << 2) + var_d0)) << 2)
                + *((eax_31 << 2) + &data_4e3da80)) - eax_35) << 2) + edx_2)
            *edi = result.b
