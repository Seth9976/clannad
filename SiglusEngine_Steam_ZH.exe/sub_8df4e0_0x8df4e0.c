            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ebx_7 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_2 = var_e0 + *(((ebx_11 - var_e0) << 2) + var_d4)
                        int32_t var_88
                        ...
                        if (eax_2 + var_88 s< 0)
                            ...
                            ebx_19.b = edi[2]
                            ebx_24 =
                                *(((ebx_19 - 0xff) << 2) + *((ebx_16 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_5
                        eax_5.b = edi[2]
                        edi[2] = eax_5.b + (*(((ebx_24 - eax_5) << 2) + edx_2)).b
                        int32_t ebx_33
                        ebx_33.b = var_3c[1]
                        int32_t var_dc
                        int32_t eax_8 = var_dc + *(((ebx_33 - var_dc) << 2) + var_d4)
                        int32_t var_84
                        ...
                        if (eax_8 + var_84 s< 0)
                            ...
                            ebx_41.b = edi[1]
                            ebx_46 =
                                *(((ebx_41 - 0xff) << 2) + *((ebx_38 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_11
                        eax_11.b = edi[1]
                        edi[1] = eax_11.b + (*(((ebx_46 - eax_11) << 2) + edx_2)).b
                        int32_t ebx_55
                        ebx_55.b = *var_3c
                        int32_t var_d8
                        int32_t eax_14 = var_d8 + *(((ebx_55 - var_d8) << 2) + var_d4)
                        int32_t var_80
                        ...
                        int32_t eax_17
                        eax_17.b = *edi
                        *edi = eax_17.b + (*(((ebx_68 - eax_17) << 2) + edx_2)).b
