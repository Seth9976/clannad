            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_37 = neg.d(var_f8 + *(((var_e0 + *(((eax_12
                            + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec) - 0xff) << 2
                        int32_t eax_18
                        eax_18.b = edi[2]
                        int32_t eax_19 = eax_18 - *(ebx_37 + edx_2)
                        ...
                        int32_t ebx_40
                        ebx_40.b = esi_1[1]
                        int32_t eax_21 = edx_6 + *(((ebx_40 - edx_6) << 2) + eax_9)
                        int32_t eax_22
                        eax_22.b = not.b(eax_21.b)
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_59 = neg.d(var_f4 + *(((var_dc + *(((eax_22
                            + *(((eax_21 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - 0xff) << 2
                        int32_t eax_28
                        eax_28.b = edi[1]
                        int32_t eax_29 = eax_28 - *(ebx_59 + edx_2)
                        ...
                        int32_t ebx_62
                        ebx_62.b = *esi_1
                        int32_t eax_31 = edx_6 + *(((ebx_62 - edx_6) << 2) + eax_9)
                        int32_t eax_32
                        eax_32.b = not.b(eax_31.b)
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_81 = neg.d(var_f0 + *(((var_d8 + *(((eax_32
                            + *(((eax_31 - eax_32) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - 0xff) << 2
                        int32_t eax_38
                        eax_38.b = *edi
                        int32_t eax_39 = eax_38 - *(ebx_81 + edx_2)
