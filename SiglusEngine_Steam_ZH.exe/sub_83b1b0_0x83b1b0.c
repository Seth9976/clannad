    ...
    do
        ...
        if (ebx_1 != 0)
            ...
            if (ecx_5 != 0)
                ...
                int32_t var_d0
                int32_t eax_3 = eax_2 + *(((ebx_3 - eax_2) << 2) + var_d0)
                int32_t ebx_8
                ebx_8.b = var_124[1]
                int32_t eax_4
                eax_4.b = not.b(ebx_8.b)
                int32_t eax_5 = eax_4 + *(((ebx_8 - eax_4) << 2) + var_d0)
                int32_t ebx_13
                ebx_13.b = *var_124
                int32_t eax_6
                eax_6.b = not.b(ebx_13.b)
                int32_t eax_7 = eax_6 + *(((ebx_13 - eax_6) << 2) + var_d0)
                ...
                if (ebx_1 != 0xff)
                    ...
                    if (ebx_23 != 0)
                        int32_t eax_10 = *((ebx_1 << 2) + &data_4d6e180)
                        *((eax_5 << 2) + eax_10)
                        *((eax_7 << 2) + eax_10)
                        int32_t eax_11
                        eax_11.b = edi[2]
                        ...
                        int32_t eax_21
                        eax_21.b = *edi
                        *edi = divu.dp.d(mulu.dp.d(eax_21, edx_5), ecx_5).b
                        edi[3] = ecx_5.b
                    else
                        edi[2] = eax_3.b
                        edi[1] = eax_5.b
