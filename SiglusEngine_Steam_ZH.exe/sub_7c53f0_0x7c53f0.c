    ...
    do
        ...
        if (ebx_1 != 0)
            ...
            if (ebx_7 != 0)
                ...
                int32_t eax_18
                eax_18.b = *(edi + 2)
                *(edi + 2) = eax_18.b + (*(((*ebx_29 - eax_18) << 2) + edx_1)).b
                int32_t ebx_34
                ebx_34.b = *(esi_1 + 1)
                int32_t eax_26
                eax_26.b = *(edi + 1)
                ...
                int32_t* ebx_48 = ((var_f4 + *(((var_dc
                    + *(((edx_5 + *(((ebx_34 - edx_5) << 2) + eax_7) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)) << 2) + *((eax_26 << 2) + &data_4e3da80)
                int32_t eax_30
                eax_30.b = *(edi + 1)
                *(edi + 1) = eax_30.b + (*(((*ebx_48 - eax_30) << 2) + edx_1)).b
                int32_t ebx_53
                ebx_53.b = *esi_1
                int32_t eax_38
                eax_38.b = *edi
                ...
                int32_t* ebx_67 = ((var_f0 + *(((var_d8
                    + *(((edx_5 + *(((ebx_53 - edx_5) << 2) + eax_7) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4)) << 2) + *((eax_38 << 2) + &data_4e3da80)
                int32_t eax_42
                eax_42.b = *edi
                *edi = eax_42.b + (*(((*ebx_67 - eax_42) << 2) + edx_1)).b
