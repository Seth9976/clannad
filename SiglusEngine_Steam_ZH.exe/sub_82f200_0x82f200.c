    ...
    do
        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                *(edi + 2) = eax_22.b + (*(ebx_34 + edx_2)).b
                int32_t ebx_36
                ebx_36.b = var_124[1]
                int32_t eax_25 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_11)
                int32_t eax_26
                ...
                int32_t ebx_53 = (*(((var_f4
                    ...
                    << 2) + *((eax_30 << 2) + &data_4e3da80)) - eax_34) << 2
                *(edi + 1) = eax_34.b + (*(ebx_53 + edx_2)).b
                int32_t ebx_55
                ebx_55.b = *var_124
                int32_t eax_37 = edx_6 + *(((ebx_55 - edx_6) << 2) + eax_11)
                int32_t eax_38
                ...
                int32_t ebx_72 = (*(((var_f0
                    + *(((eax_38 + *(((eax_37 - eax_38) << 2) + var_d0) - var_f0) << 2) + var_e4))
                    << 2) + *((eax_42 << 2) + &data_4e3da80)) - eax_46) << 2
                *edi = eax_46.b + (*(ebx_72 + edx_2)).b
