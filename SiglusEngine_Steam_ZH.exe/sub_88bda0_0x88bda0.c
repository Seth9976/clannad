                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_dc
                                int32_t eax_14 = var_dc + *(((eax_11
                                    + *(((ebx_49 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                int32_t var_84
                                ...
                                int32_t var_d8
                                int32_t eax_22 = var_d8 + *(((eax_19
                                    + *(((ebx_75 - eax_19) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                int32_t var_80
