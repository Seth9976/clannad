    ...
    do
        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                int32_t var_d4
                int32_t var_d0
                int32_t eax_19 = eax_18 - *((neg.d(var_e0
                ...
                *(edi + 2) = eax_19.b
                int32_t ebx_35
                ebx_35.b = var_124[1]
                int32_t eax_21 = edx_6 + *(((ebx_35 - edx_6) << 2) + eax_11)
                int32_t eax_22
                eax_22.b = not.b(eax_21.b)
                int32_t eax_26
                eax_26.b = *(edi + 1)
                int32_t var_dc
                int32_t eax_27 = eax_26 - *((neg.d(var_dc
                ...
                *(edi + 1) = eax_27.b
                int32_t ebx_53
                ebx_53.b = *var_124
                int32_t eax_29 = edx_6 + *(((ebx_53 - edx_6) << 2) + eax_11)
                int32_t eax_30
                eax_30.b = not.b(eax_29.b)
                int32_t eax_34
                eax_34.b = *edi
                int32_t var_d8
                int32_t eax_35 = eax_34 - *((neg.d(var_d8
