            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_d0
                        edi[2] = eax_6.b + (
                            *(((eax_4 + *(((ebx_13 - eax_4) << 2) + var_d0) - eax_6) << 2) + edx_2)).b
                        int32_t ebx_21
                        ebx_21.b = esi_2[1]
                        int32_t eax_8
                        eax_8.b = not.b(ebx_21.b)
                        int32_t eax_10
                        eax_10.b = edi[1]
                        edi[1] = eax_10.b + (*
                            (((eax_8 + *(((ebx_21 - eax_8) << 2) + var_d0) - eax_10) << 2) + edx_2)).b
                        int32_t ebx_29
                        ebx_29.b = *esi_2
                        int32_t eax_12
                        ...
                        int32_t eax_14
                        eax_14.b = *edi
                        *edi = eax_14.b + (*(((eax_12 + *(((ebx_29 - eax_12) << 2) + var_d0)
                            - eax_14) << 2) + edx_2)).b
