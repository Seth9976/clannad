...
if (arg4 == 0)
    ...
    int32_t ebx
    int32_t var_10 = ebx
    int32_t edx_3 = (&data_b95720)[edx_2]
    ...
    label_7595be:
        ...
        int32_t eax_8 = sub_75bfb2(numberOfBytesWritten_1)
        enum CONSOLE_MODE var_1aec
        BOOL eax_15
        int32_t ecx_6
        
        if (eax_8 != 0 && (*(ecx_3 + (&data_b95720)[edx_2] + 4) & 0x80) != 0)
            enum CONSOLE_MODE* lpMode = &var_1aec
            ecx_6.b = *(__getptd()[0x1b] + 0xa8) == 0
            eax_15 = GetConsoleMode(*(ecx_3 + (&data_b95720)[edx_2]), lpMode)
        
        enum WIN32_ERROR wideCharStr
        int32_t ecx_11
        char* numberOfBytesWritten_4
        
        if (eax_8 != 0 && (*(ecx_3 + (&data_b95720)[edx_2] + 4) & 0x80) != 0 && eax_15 != 0
                && (ecx_6 == 0 || ebx.b != 0))
            ...
            while (true)
                ...
                if (ebx.b != 0)
                    ...
                    var_1aec = eax_16
                    int32_t eax_18 = (&data_b95720)[edx_2]
                    ...
                    if (*(ecx_3 + eax_18 + 0x38) == 0)
                        ...
                        if (arg3 - numberOfBytesWritten_7 + arg4 u<= 1)
                            ...
                            *(ecx_3 + (&data_b95720)[edx_2] + 0x34) = eax_24.b
                            *(ecx_3 + (&data_b95720)[edx_2] + 0x38) = 1
                            goto label_759a3d
                    ...
                    if (WriteFile(*(ecx_3 + (&data_b95720)[edx_2]), &var_10, nNumberOfBytesToWrite, 
                    ...
                    if (var_1aec != 0)
                        ...
                        if (WriteFile(*(ecx_3 + (&data_b95720)[edx_2]), &var_10, 1, 
                                &numberOfBytesWritten_1, nullptr) == 0)
                            goto label_75992c
        ...
        int32_t ecx_14 = (&data_b95720)[edx_2]
        ...
        if ((*(ecx_3 + ecx_14 + 4) & 0x80) != 0)
            ...
            if (ebx.b == 0)
                ...
                while (true)
                    ...
                    if (WriteFile(*(ecx_3 + (&data_b95720)[edx_2]), &buffer, 
            ...
            if (ebx.b == 2)
                ...
                do
                    ...
                    BOOL eax_55 = WriteFile(*(ecx_3 + (&data_b95720)[edx_2]), &buffer, 
            ...
            do
                ...
                do
                    if (WriteFile(*(ecx_3 + (&data_b95720)[edx_2]), &multiByteStr + ecx_20, 
    ...
    label_759a43:
        ...
        label_759d18:
            ...
            if ((*(ecx_3 + (&data_b95720)[edx_2] + 4) & 0x40) == 0
