...
if (arg1 != 0)
    ...
    if (arg3 != 0)
        ...
        void** eax_9 = sub_745f3f(ebx_1 * 0x48)
        var_8_1 = eax_9
        
        if (eax_9 != 0)
            int32_t eax_11 = arg2 * 0x48
            int32_t esi_1
            int32_t edi_4
            edi_4, esi_1 = __builtin_memcpy(var_8_1, eax_3, eax_11 u>> 2 << 2)
            __builtin_memcpy(edi_4, esi_1, eax_11 & 3)
            int32_t ecx_13 = arg4 * 0x48
            int32_t esi_3
            int32_t edi_6
            edi_6, esi_3 = __builtin_memcpy(&var_8_1[arg2 * 0x12], eax_5, ecx_13 u>> 2 << 2)
            __builtin_memcpy(edi_6, esi_3, ecx_13 & 3)
            result = sub_45edd0(var_8_1, ebx_1, arg5)
        else
            result = 0x8007000e
    else
        *arg5 = arg1
