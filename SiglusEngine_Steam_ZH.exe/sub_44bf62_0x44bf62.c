...
if (eax.w != 0xffff)
    ...
    if (eax_1 == 0xa000000 || eax_1 == 0xb000000)
        ...
        if (*(esi_6 + 4) != 0)
            int32_t result_1 = sub_448e65(arg1, esi_6)
            result = result_1
        ...
        if (*esi_3 != 0)
            *esi_3 = esi_3[1]
            int16_t x87control_1 = sub_44b676(arg1, arg2, zx.d(ebx_2[6].w))
            result = 0
        ...
        if (eax_1.w != 0)
            return sub_44bf62(zx.d(esi_5[1]) + zx.d(eax_1.w) - 1, arg3, arg4, arg5)
