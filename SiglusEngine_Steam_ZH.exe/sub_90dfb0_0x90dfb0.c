                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            if (ecx_8 != 0)
                                ...
                                int32_t var_d0
                                int32_t eax_7 = eax_6 + *(((ebx_14 - eax_6) << 2) + var_d0)
                                int32_t ebx_19
                                ebx_19.b = var_3c[1]
                                int32_t eax_8
                                eax_8.b = not.b(ebx_19.b)
                                int32_t eax_9 = eax_8 + *(((ebx_19 - eax_8) << 2) + var_d0)
                                int32_t ebx_24
                                ebx_24.b = *var_3c
                                int32_t eax_10
                                eax_10.b = not.b(ebx_24.b)
                                int32_t eax_11 = eax_10 + *(((ebx_24 - eax_10) << 2) + var_d0)
                                ...
                                if (ebx_12 != 0xff)
                                    ...
                                    if (ebx_34 != 0)
                                        int32_t eax_15 = *((ebx_12 << 2) + &data_4d6e180)
                                        *((eax_9 << 2) + eax_15)
                                        *((eax_11 << 2) + eax_15)
                                        int32_t eax_16
                                        eax_16.b = edi[2]
                                        edi[2] = (divu.dp.d(mulu.dp.d(eax_16, edx_6), ecx_8)).b
                                        int32_t eax_21
                                        eax_21.b = edi[1]
                                        edi[1] = (divu.dp.d(mulu.dp.d(eax_21, edx_6), ecx_8)).b
                                        int32_t eax_26
                                        eax_26.b = *edi
                                        *edi = (divu.dp.d(mulu.dp.d(eax_26, edx_6), ecx_8)).b
                                        edi[3] = ecx_8.b
                                    else
                                        edi[2] = eax_7.b
                                        edi[1] = eax_9.b
