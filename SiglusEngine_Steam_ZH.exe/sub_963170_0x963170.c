        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t eax_23
                    eax_23.b = edi[2]
                    edi[2] = eax_23.b + (*(((*(((edx_6 + *(((ebx_26 - edx_6) << 2) + eax_16)) << 2)
                    ...
                    int32_t eax_31
                    eax_31.b = edi[1]
                    edi[1] = eax_31.b + (*(((*(((edx_6 + *(((ebx_37 - edx_6) << 2) + eax_16)) << 2)
                        + *((eax_27 << 2) + &data_4e3da80)) - eax_31) << 2) + edx_2)).b
                    int32_t ebx_48
                    ebx_48.b = *var_18
                    int32_t eax_35
                    eax_35.b = *edi
                    int32_t eax_39
                    eax_39.b = *edi
                    result = eax_39 + *(((*(((edx_6 + *(((ebx_48 - edx_6) << 2) + eax_16)) << 2)
                        + *((eax_35 << 2) + &data_4e3da80)) - eax_39) << 2) + edx_2)
                    *edi = result.b
