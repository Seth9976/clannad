                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                if (ecx_8 != 0)
                                    ...
                                    int32_t var_d0
                                    int32_t eax_7 = eax_6 + *(((ebx_20 - eax_6) << 2) + var_d0)
                                    int32_t ebx_25
                                    ebx_25.b = var_3c[1]
                                    int32_t eax_8
                                    eax_8.b = not.b(ebx_25.b)
                                    int32_t eax_9 = eax_8 + *(((ebx_25 - eax_8) << 2) + var_d0)
                                    int32_t ebx_30
                                    ebx_30.b = *var_3c
                                    int32_t eax_10
                                    eax_10.b = not.b(ebx_30.b)
                                    int32_t eax_11 = eax_10 + *(((ebx_30 - eax_10) << 2) + var_d0)
                                    ...
                                    if (ebx_18 != 0xff)
                                        ...
                                        if (ebx_40 != 0)
                                            int32_t eax_15 = *((ebx_18 << 2) + &data_4d6e180)
                                            *((eax_9 << 2) + eax_15)
                                            *((eax_11 << 2) + eax_15)
                                            int32_t eax_16
                                            eax_16.b = edi[2]
