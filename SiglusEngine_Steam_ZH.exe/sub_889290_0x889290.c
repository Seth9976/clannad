                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_d0
                            int32_t eax_13 = eax_12 + *(((eax_11 - eax_12) << 2) + var_d0)
                            int32_t var_88
                            int32_t ebx_30 = eax_13 + var_88
                            int32_t ebx_38
                            ...
                            if (eax_13 + var_88 s< 0)
                                ...
                                int32_t ebx_33
                                ebx_33.b = edi[2]
                                ebx_38 = *(((ebx_33 - 0xff) << 2) + *((ebx_30 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_16
                            eax_16.b = edi[2]
                            edi[2] = eax_16.b + (*(((ebx_38 - eax_16) << 2) + edx_2)).b
                            int32_t ebx_47
                            ebx_47.b = esi_1[1]
                            int32_t eax_19 = edx_6 + *(((ebx_47 - edx_6) << 2) + eax_9)
                            int32_t eax_20
                            eax_20.b = not.b(eax_19.b)
                            int32_t eax_21 = eax_20 + *(((eax_19 - eax_20) << 2) + var_d0)
                            int32_t var_84
                            int32_t ebx_56 = eax_21 + var_84
                            int32_t ebx_64
                            ...
                            if (eax_21 + var_84 s< 0)
                                ...
                                int32_t ebx_59
                                ebx_59.b = edi[1]
                                ebx_64 = *(((ebx_59 - 0xff) << 2) + *((ebx_56 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_24
                            eax_24.b = edi[1]
                            edi[1] = eax_24.b + (*(((ebx_64 - eax_24) << 2) + edx_2)).b
                            int32_t ebx_73
                            ebx_73.b = *esi_1
                            int32_t eax_27 = edx_6 + *(((ebx_73 - edx_6) << 2) + eax_9)
                            int32_t eax_28
                            eax_28.b = not.b(eax_27.b)
                            int32_t eax_29 = eax_28 + *(((eax_27 - eax_28) << 2) + var_d0)
                            int32_t var_80
                            int32_t ebx_82 = eax_29 + var_80
                            int32_t ebx_90
                            ...
                            if (eax_29 + var_80 s< 0)
                                ...
                                int32_t ebx_85
                                ebx_85.b = *edi
                                ebx_90 = *(((ebx_85 - 0xff) << 2) + *((ebx_82 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_32
                            eax_32.b = *edi
                            *edi = eax_32.b + (*(((ebx_90 - eax_32) << 2) + edx_2)).b
