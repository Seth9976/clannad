...
arg1[1] = fconvert.s((x87_r7_2 * fconvert.t(arg5[1]) + fconvert.t(arg6) * fconvert.t(arg4[1])
    ...
    * x87_r6_3)
arg1[2] = fconvert.s((x87_r7_2 * fconvert.t(arg5[2]) + fconvert.t(arg6) * fconvert.t(arg4[2])
    + fconvert.t(var_8_1) * fconvert.t(arg3[2]) + fconvert.t(var_c_1) * fconvert.t(arg2[2]))
    * x87_r6_3)
arg1[3] = fconvert.s((x87_r7_2 * fconvert.t(arg5[3]) + fconvert.t(arg6) * fconvert.t(arg4[3])
    + fconvert.t(var_8_1) * fconvert.t(arg3[3]) + fconvert.t(var_c_1) * fconvert.t(arg2[3]))
    * x87_r6_3)
return arg1
