...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t ebx_18 = (*(((var_f8
            + *(((eax_2 + *(((ebx_5 - eax_2) << 2) + var_d0) - var_f8) << 2) + var_ec)) << 2)
            + *((eax_6 << 2) + &data_4e3da80)) - eax_10) << 2
        *(edi + 2) = eax_10.b + (*(ebx_18 + edx_2)).b
        int32_t ebx_20
        ebx_20.b = var_18[1]
        int32_t eax_12
        eax_12.b = not.b(ebx_20.b)
        int32_t eax_16
        eax_16.b = *(edi + 1)
        int32_t eax_20
        eax_20.b = *(edi + 1)
        ...
        int32_t ebx_33 = (*(((var_f4
            + *(((eax_12 + *(((ebx_20 - eax_12) << 2) + var_d0) - var_f4) << 2) + var_e8)) << 2)
        ...
        *(edi + 1) = eax_20.b + (*(ebx_33 + edx_2)).b
        ...
        int32_t ebx_48 = (*(((var_f0
            + *(((eax_22 + *(((ebx_35 - eax_22) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2)
