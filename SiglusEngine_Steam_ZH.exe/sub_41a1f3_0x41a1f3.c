    ...
    do
        ...
        if (ebx u< edx_2)
            do
                ...
                uint32_t ebx_1
                ebx_1.w = ecx_3.w & 0xf0f0
                uint32_t edi_3
                edi_3.w = edx_3.w & 0xf0f0
                uint32_t ebx_2
                ebx_2.w = ecx_2.w & 0xf0f0
                uint32_t ebx_3
                ebx_3.w = esi_3.w & 0xf0f0
                uint16_t edi_8 = ((edi_3 + ebx_1 + ebx_2 + ebx_3 + 0x2020) u>> 2).w ^ (((edx_3
                    & 0xffff0f0f) + (ecx_3 & 0xffff0f0f) + (ecx_2 & 0xffff0f0f) + (esi_3 & 0xffff0f0f)
                    + 0x202) u>> 2).w
                int16_t* ecx_17 = var_c_1
                var_c_1 = &var_c_1[1]
                *ecx_17 = (edi_8 & 0xf0f) ^ (((edx_3 & 0xf0f0) + (ecx_3 & 0xf0f0) + (ecx_2 & 0xf0f0)
                    + (esi_3 & 0xf0f0) + 0x2020) u>> 2).w
                ebx = &var_10_1[2]
                edi_2 = &var_14_1[2]
                var_10_1 = ebx
                var_14_1 = edi_2
