...
do
    ...
    if (ecx_5 != 0)
        ...
        int32_t eax_16 = var_f8 + *(((var_e0
            + *(((edx_9 + *(((ebx_5 - edx_9) << 2) + eax_10) - var_e0) << 2) + var_d4) - var_f8) << 2)
            + var_ec)
        int32_t ebx_18
        ebx_18.b = var_18[1]
        int32_t var_f4
        ...
        int32_t eax_22 = var_f4 + *(((var_dc
            + *(((edx_9 + *(((ebx_18 - edx_9) << 2) + eax_10) - var_dc) << 2) + var_d4) - var_f4) << 2)
            + var_e8)
        int32_t ebx_31
        ebx_31.b = *var_18
        int32_t var_f0
        ...
        int32_t eax_28 = var_f0 + *(((var_d8
            + *(((edx_9 + *(((ebx_31 - edx_9) << 2) + eax_10) - var_d8) << 2) + var_d4) - var_f0) << 2)
            + var_e4)
        result = result_1
