    ...
    if (temp0_1 + var_48 s>= 0)
        ...
        do
            ...
            if (edi s>= var_50)
                ...
                int32_t var_d0
                *(edi + 2) = eax_11.b
                    + (*(((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0) - eax_11) << 2) + var_118)).b
                int32_t ebx_18
                ebx_18.b = *(esi_1 + 1)
                int32_t eax_14 = edx_5 + *(((ebx_18 - edx_5) << 2) + eax_6)
                int32_t eax_15
                eax_15.b = not.b(eax_14.b)
                int32_t eax_17
                eax_17.b = *(edi + 1)
                *(edi + 1) = eax_17.b +
                    (*(((eax_15 + *(((eax_14 - eax_15) << 2) + var_d0) - eax_17) << 2) + var_118)).b
                int32_t ebx_30
                ebx_30.b = *esi_1
                int32_t eax_20 = edx_5 + *(((ebx_30 - edx_5) << 2) + eax_6)
                int32_t eax_21
                eax_21.b = not.b(eax_20.b)
                int32_t eax_23
                eax_23.b = *edi
                *edi = eax_23.b +
                    (*(((eax_21 + *(((eax_20 - eax_21) << 2) + var_d0) - eax_23) << 2) + var_118)).b
