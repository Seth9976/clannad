...
int32_t (* var_c)(void* arg1) = sub_9c9108
TEB* fsbase
...
int32_t var_14 = 0
void* edx_1 = *(arg1 + 0x64) * 0x54 + *(arg1 + 0x54)
int32_t* ebx = *(edx_1 + 0x14) + (arg3 << 3)
int32_t edi = *(edx_1 + 0x18) + (*ebx << 1)
int32_t eax_5 = ebx[1]
int32_t ecx_2
ecx_2.b = mulu.dp.d(eax_5, 2) u>> 0x20 != 0
int32_t var_2c = neg.d(ecx_2) | (eax_5 * 2)
