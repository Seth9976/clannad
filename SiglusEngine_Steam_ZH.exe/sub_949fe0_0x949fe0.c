...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t eax_13
        eax_13.b = edi[2]
        edi[2] = eax_13.b + (*(((ebx_22 - eax_13) << 2) + edx_2)).b
        int32_t ebx_31
        ebx_31.b = var_18[1]
        int32_t eax_16 = edx_6 + *(((ebx_31 - edx_6) << 2) + eax_8)
        int32_t var_84
        int32_t ebx_36 = eax_16 + var_84
        int32_t ebx_44
        ...
        int32_t eax_19
        eax_19.b = edi[1]
        edi[1] = eax_19.b + (*(((ebx_44 - eax_19) << 2) + edx_2)).b
        int32_t ebx_53
        ebx_53.b = *var_18
        int32_t eax_22 = edx_6 + *(((ebx_53 - edx_6) << 2) + eax_8)
        int32_t var_80
        int32_t ebx_58 = eax_22 + var_80
        int32_t ebx_66
        ...
        int32_t eax_25
        eax_25.b = *edi
        result = eax_25 + *(((ebx_66 - eax_25) << 2) + edx_2)
        *edi = result.b
