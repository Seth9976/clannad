                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t eax_14
                                eax_14.b = edi[2]
                                edi[2] = eax_14.b + (*(((ebx_40 - eax_14) << 2) + edx_2)).b
                                int32_t ebx_49
                                ebx_49.b = esi_1[1]
                                int32_t eax_17 = edx_6 + *(((ebx_49 - edx_6) << 2) + eax_9)
                                int32_t var_84
                                ...
                                if (eax_17 + var_84 s< 0)
                                    ...
                                    ebx_57.b = edi[1]
                                    ebx_62 =
                                        *(((ebx_57 - 0xff) << 2) + *((ebx_54 << 2) + data_4ced578))
                                        + 0xff
                                ...
                                int32_t ebx_71
                                ebx_71.b = *esi_1
                                int32_t eax_23 = edx_6 + *(((ebx_71 - edx_6) << 2) + eax_9)
                                int32_t var_80
                                int32_t ebx_76 = eax_23 + var_80
                                int32_t ebx_84
                                ...
                                if (eax_23 + var_80 s< 0)
                                    ...
                                    ebx_79.b = *edi
                                    ebx_84 =
                                        *(((ebx_79 - 0xff) << 2) + *((ebx_76 << 2) + data_4ced578))
                                        + 0xff
                                
                                int32_t eax_26
                                eax_26.b = *edi
                                *edi = eax_26.b + (*(((ebx_84 - eax_26) << 2) + edx_2)).b
