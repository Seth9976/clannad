            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t ebx_53 = ((var_f4 + *(((var_dc +
                        *(((eax_18 + *(((ebx_38 - eax_18) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - eax_24) << 2) + edx_2
                    edi[1] = eax_24.b + (*ebx_53).b
                    int32_t ebx_54
                    ebx_54.b = *edi
                    int32_t eax_26
                    ...
                    int32_t ebx_69 = ((var_f0 + *(((var_d8 +
                        *(((eax_26 + *(((ebx_54 - eax_26) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - eax_32) << 2) + edx_2
                    result = eax_32 + *ebx_69
                    *edi = result.b
