...
if (0x5d1745d - edx_9 u>= eax_8)
    int32_t eax_11 = eax_8 + edx_9
    
    if (eax_11 u< esi_5)
        eax_11 = esi_5
    
    return sub_55cd90(arg1, eax_11) __tailcall
...
return sub_55cd90(arg1, eax_9) __tailcall
