                            ...
                            if (ebx_19 != 0)
                                ...
                                if (ecx_8 != 0)
                                    ...
                                    int32_t eax_17 = var_f8 + *(((eax_14
                                        + *(((eax_13 - eax_14) << 2) + var_d0) - var_f8) << 2)
                                        + var_ec)
                                    int32_t ebx_38
                                    ebx_38.b = esi_1[1]
                                    int32_t eax_19 = edx_10 + *(((ebx_38 - edx_10) << 2) + eax_11)
                                    int32_t eax_20
                                    eax_20.b = not.b(eax_19.b)
                                    int32_t var_f4
                                    int32_t var_e8
                                    int32_t eax_23 = var_f4 + *(((eax_20
                                        + *(((eax_19 - eax_20) << 2) + var_d0) - var_f4) << 2)
                                        + var_e8)
                                    int32_t ebx_51
                                    ebx_51.b = *esi_1
                                    int32_t eax_25 = edx_10 + *(((ebx_51 - edx_10) << 2) + eax_11)
                                    int32_t eax_26
                                    eax_26.b = not.b(eax_25.b)
                                    int32_t var_f0
                                    int32_t var_e4
                                    int32_t eax_29 = var_f0 + *(((eax_26
                                        + *(((eax_25 - eax_26) << 2) + var_d0) - var_f0) << 2)
                                        + var_e4)
