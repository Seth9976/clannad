...
do
    ...
    do
        ...
        int32_t* ebx_19 = ((var_f8 + *(((var_e0
            ...
            + var_ec)) << 2) + *((eax_14 << 2) + &data_4e3da80)
        int32_t eax_18
        eax_18.b = *(edi + 2)
        int32_t var_118
        *(edi + 2) = eax_18.b + (*(((*ebx_19 - eax_18) << 2) + var_118)).b
        ...
        int32_t* ebx_38 = ((var_f4 + *(((var_dc
            + *(((edx_4 + *(((ebx_24 - edx_4) << 2) + eax_7) - var_dc) << 2) + var_d4) - var_f4) << 2)
            + var_e8)) << 2) + *((eax_26 << 2) + &data_4e3da80)
        int32_t eax_30
        eax_30.b = *(edi + 1)
        *(edi + 1) = eax_30.b + (*(((*ebx_38 - eax_30) << 2) + var_118)).b
        ...
        int32_t* ebx_57 = ((var_f0 + *(((var_d8
            + *(((edx_4 + *(((ebx_43 - edx_4) << 2) + eax_7) - var_d8) << 2) + var_d4) - var_f0) << 2)
            + var_e4)) << 2) + *((eax_38 << 2) + &data_4e3da80)
        int32_t eax_42
        eax_42.b = *edi
        result = eax_42.b + (*(((*ebx_57 - eax_42) << 2) + var_118)).b
        *edi = result
        edi += 4
        j = j_1
        j_1 -= 1
