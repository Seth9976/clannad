...
long double st1
bool c2
st1, st0, c2 = __fsincos(fconvert.t(arg2))
float var_c = fconvert.s(st0)
...
arg1[5] = fconvert.s(x87_r7_7)
arg1[7] = fconvert.s(float.t(0))
arg1[8] = fconvert.s(float.t(0))
arg1[9] = fconvert.s(fneg(fconvert.t(var_8)))
arg1[0xa] = fconvert.s(x87_r7_7)
