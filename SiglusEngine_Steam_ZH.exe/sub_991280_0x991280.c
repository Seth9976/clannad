...
do
    ...
    if (ebx_1 != 0)
        ...
        int32_t ebx_28 = ((var_f8 + *(((var_e0
            ...
            << 2) + var_ec) - eax_17) << 2) + edx_2
        edi[2] = eax_17.b + (*ebx_28).b
        int32_t ebx_29
        ebx_29.b = edi[1]
        int32_t eax_20 = edx_6 + *(((ebx_29 - edx_6) << 2) + eax_8)
        int32_t eax_21
        ...
        int32_t ebx_48 = ((var_f4 + *(((var_dc
            ...
            << 2) + var_e8) - eax_27) << 2) + edx_2
        edi[1] = eax_27.b + (*ebx_48).b
        int32_t ebx_49
        ebx_49.b = *edi
        int32_t eax_30 = edx_6 + *(((ebx_49 - edx_6) << 2) + eax_8)
        int32_t eax_31
        ...
        int32_t ebx_68 = ((var_f0 + *(((var_d8
            + *(((eax_31 + *(((eax_30 - eax_31) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
            << 2) + var_e4) - eax_37) << 2) + edx_2
        result = eax_37 + *ebx_68
        *edi = result.b
