            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        edi[2] = eax_7.b + (*(((var_e0 + *(((eax_3
                            + *(((ebx_14 - eax_3) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_7)
                            << 2) + edx_2)).b
                        int32_t ebx_26
                        ebx_26.b = esi_1[1]
                        int32_t eax_9
                        ...
                        eax_13.b = edi[1]
                        int32_t var_dc
                        edi[1] = eax_13.b + (*(((var_dc + *(((eax_9
                            + *(((ebx_26 - eax_9) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_13)
                            << 2) + edx_2)).b
                        int32_t ebx_38
                        ebx_38.b = *esi_1
                        int32_t eax_15
                        ...
                        eax_19.b = *edi
                        int32_t var_d8
                        *edi = eax_19.b + (*(((var_d8 + *(((eax_15
                            + *(((ebx_38 - eax_15) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_19)
                            << 2) + edx_2)).b
