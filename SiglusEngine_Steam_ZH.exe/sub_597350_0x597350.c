...
int32_t (* var_c)(void* arg1) = sub_9b8600
TEB* fsbase
...
if (ecx_2 u> arg2)
    ...
    int32_t* esi_1 = esi + (arg2 - ecx_2) * 0x14
    eax_3 = sub_597720(esi_1, arg1[1])
    arg1[1] = esi_1
else if (ecx_2 u< arg2)
    sub_5974c0(arg1, arg2 - ecx_2)
    int32_t var_8_1 = 0
    ...
    sub_5976f0(arg1[1], arg2 - ((edx_6 u>> 0x1f) + edx_6))
    int32_t esi_2 = arg1[1]
    int32_t eax_11
    int32_t edx_9
    edx_9:eax_11 = muls.dp.d(0x66666667, esi_2 - *arg1)
    int32_t edx_10 = edx_9 s>> 3
    int32_t eax_16 = esi_2 + (arg2 - ((edx_10 u>> 0x1f) + edx_10)) * 0x14
    arg1[1] = eax_16
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_16
