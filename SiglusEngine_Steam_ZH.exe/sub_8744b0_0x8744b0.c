                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_e0
                                int32_t var_d4
                                int32_t ebx_42 = neg.d(var_f8 + *(((var_e0 + *(((edx_6
                                    + *(((ebx_27 - edx_6) << 2) + eax_9) - var_e0) << 2) + var_d4)
                                    - var_f8) << 2) + var_ec) - 0xff) << 2
                                int32_t eax_16
                                eax_16.b = edi[2]
                                int32_t eax_17 = eax_16 - *(ebx_42 + edx_2)
                                ...
                                int32_t var_e8
                                int32_t var_dc
                                int32_t ebx_60 = neg.d(var_f4 + *(((var_dc + *(((edx_6
                                    + *(((ebx_45 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)
                                    - var_f4) << 2) + var_e8) - 0xff) << 2
                                int32_t eax_24
                                eax_24.b = edi[1]
                                int32_t eax_25 = eax_24 - *(ebx_60 + edx_2)
                                ...
                                int32_t var_e4
                                int32_t var_d8
                                int32_t ebx_78 = neg.d(var_f0 + *(((var_d8 + *(((edx_6
                                    + *(((ebx_63 - edx_6) << 2) + eax_9) - var_d8) << 2) + var_d4)
                                    - var_f0) << 2) + var_e4) - 0xff) << 2
                                int32_t eax_32
                                eax_32.b = *edi
                                int32_t eax_33 = eax_32 - *(ebx_78 + edx_2)
