                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_f8
                                int32_t var_ec
                                int32_t ebx_40 = (*(((var_f8 + *(((edx_6
                                    + *(((ebx_27 - edx_6) << 2) + eax_9) - var_f8) << 2) + var_ec))
                                    << 2) + *((eax_14 << 2) + &data_4e3da80)) - eax_18) << 2
                                edi[2] = eax_18.b + (*(ebx_40 + edx_2)).b
                                int32_t ebx_42
                                ebx_42.b = esi_1[1]
                                int32_t eax_24
                                eax_24.b = edi[1]
                                ...
                                int32_t var_f4
                                int32_t var_e8
                                int32_t ebx_55 = (*(((var_f4 + *(((edx_6
                                    + *(((ebx_42 - edx_6) << 2) + eax_9) - var_f4) << 2) + var_e8))
                                    << 2) + *((eax_24 << 2) + &data_4e3da80)) - eax_28) << 2
                                edi[1] = eax_28.b + (*(ebx_55 + edx_2)).b
                                int32_t ebx_57
                                ebx_57.b = *esi_1
                                int32_t eax_34
                                eax_34.b = *edi
                                ...
                                int32_t var_f0
                                int32_t var_e4
                                int32_t ebx_70 = (*(((var_f0 + *(((edx_6
                                    + *(((ebx_57 - edx_6) << 2) + eax_9) - var_f0) << 2) + var_e4))
                                    << 2) + *((eax_34 << 2) + &data_4e3da80)) - eax_38) << 2
                                *edi = eax_38.b + (*(ebx_70 + edx_2)).b
