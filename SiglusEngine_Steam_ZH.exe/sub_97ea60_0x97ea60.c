            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_57 = ((var_f4 + *(((var_dc + *(((edx_6
                            + *(((ebx_42 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - eax_26) << 2) + edx_2
                        edi[1] = eax_26.b + (*ebx_57).b
                        int32_t ebx_58
                        ebx_58.b = *edi
                        int32_t eax_34
                        eax_34.b = *edi
                        ...
                        int32_t ebx_73 = ((var_f0 + *(((var_d8 + *(((edx_6
                            + *(((ebx_58 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - eax_34) << 2) + edx_2
                        *edi = eax_34.b + (*ebx_73).b
