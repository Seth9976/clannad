                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            int32_t var_f8
                            int32_t var_ec
                            int32_t ebx_33 = (*(((var_f8 + *(((edx_6
                                + *(((ebx_20 - edx_6) << 2) + eax_10) - var_f8) << 2) + var_ec)) << 2)
                                + *((eax_15 << 2) + &data_4e3da80)) - eax_19) << 2
                            edi[2] = eax_19.b + (*(ebx_33 + edx_2)).b
                            int32_t ebx_35
                            ebx_35.b = var_3c[1]
                            int32_t eax_25
                            eax_25.b = edi[1]
                            ...
                            int32_t var_f4
                            int32_t var_e8
                            int32_t ebx_48 = (*(((var_f4 + *(((edx_6
                                + *(((ebx_35 - edx_6) << 2) + eax_10) - var_f4) << 2) + var_e8)) << 2)
                                + *((eax_25 << 2) + &data_4e3da80)) - eax_29) << 2
                            edi[1] = eax_29.b + (*(ebx_48 + edx_2)).b
                            int32_t ebx_50
                            ebx_50.b = *var_3c
                            int32_t eax_35
                            eax_35.b = *edi
                            ...
                            int32_t var_f0
                            int32_t var_e4
                            int32_t ebx_63 = (*(((var_f0 + *(((edx_6
                                + *(((ebx_50 - edx_6) << 2) + eax_10) - var_f0) << 2) + var_e4)) << 2)
                                + *((eax_35 << 2) + &data_4e3da80)) - eax_39) << 2
                            *edi = eax_39.b + (*(ebx_63 + edx_2)).b
