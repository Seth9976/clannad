                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_e8
                            int32_t var_dc
                            int32_t* ebx_54 = ((var_f4 + *(((var_dc + *(((edx_6
                                + *(((ebx_40 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)) << 2) + *((eax_28 << 2) + &data_4e3da80)
                            int32_t eax_32
                            eax_32.b = edi[1]
                            edi[1] = eax_32.b + (*(((*ebx_54 - eax_32) << 2) + edx_2)).b
                            int32_t ebx_59
                            ebx_59.b = *esi_1
                            int32_t eax_40
                            eax_40.b = *edi
                            ...
                            int32_t var_e4
                            int32_t var_d8
                            int32_t* ebx_73 = ((var_f0 + *(((var_d8 + *(((edx_6
                                + *(((ebx_59 - edx_6) << 2) + eax_9) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)) << 2) + *((eax_40 << 2) + &data_4e3da80)
                            int32_t eax_44
                            eax_44.b = *edi
                            *edi = eax_44.b + (*(((*ebx_73 - eax_44) << 2) + edx_2)).b
