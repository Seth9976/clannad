...
if (0x1861861 - esi_4 u< arg2)
    sub_743191("vector<T> too long")
    noreturn

int32_t eax_5
int32_t edx_6
edx_6:eax_5 = muls.dp.d(0x30c30c31, ebx - *arg1)
void* esi_5 = esi_4 + arg2
int32_t edx_7 = edx_6 s>> 5
int32_t eax_8 = (edx_7 u>> 0x1f) + edx_7
uint32_t edx_9 = eax_8 u>> 1

if (0x1861861 - edx_9 u>= eax_8)
    int32_t eax_11 = eax_8 + edx_9
    
    if (eax_11 u< esi_5)
        eax_11 = esi_5
    
    return sub_631900(arg1, eax_11) __tailcall

int64_t* eax_9 = nullptr

if (0 u< esi_5)
    eax_9 = esi_5

return sub_631900(arg1, eax_9) __tailcall
