                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_ec
                                int32_t var_d0
                                int32_t eax_8 = eax_7 + *(((var_f8 + *(((eax_3
                                ...
                                ebx_35.b = esi_1[1]
                                int32_t eax_9
                                eax_9.b = not.b(ebx_35.b)
                                int32_t eax_13
                                eax_13.b = edi[1]
                                int32_t var_f4
                                int32_t var_e8
                                int32_t eax_14 = eax_13 + *(((var_f4 + *(((eax_9
                                    + *(((ebx_35 - eax_9) << 2) + var_d0) - var_f4) << 2) + var_e8))
                                    << 2) + edx_2)
                                ...
                                ebx_47.b = *esi_1
                                int32_t eax_15
                                eax_15.b = not.b(ebx_47.b)
                                int32_t eax_19
                                eax_19.b = *edi
                                int32_t var_f0
                                int32_t var_e4
                                int32_t eax_20 = eax_19 + *(((var_f0 + *(((eax_15
                                    + *(((ebx_47 - eax_15) << 2) + var_d0) - var_f0) << 2) + var_e4))
                                    << 2) + edx_2)
