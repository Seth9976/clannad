                    ...
                    if (ebx_10 != 0)
                        ...
                        if (ecx_8 != 0)
                            ...
                            int32_t eax_15 = var_e0 + *(((edx_10
                                + *(((ebx_16 - edx_10) << 2) + eax_11) - var_e0) << 2) + var_d4)
                            int32_t ebx_25
                            ebx_25.b = esi_1[1]
                            int32_t var_dc
                            int32_t eax_19 = var_dc + *(((edx_10
                                + *(((ebx_25 - edx_10) << 2) + eax_11) - var_dc) << 2) + var_d4)
                            int32_t ebx_34
                            ebx_34.b = *esi_1
                            int32_t var_d8
                            int32_t eax_23 = var_d8 + *(((edx_10
                                + *(((ebx_34 - edx_10) << 2) + eax_11) - var_d8) << 2) + var_d4)
                            ...
                            if (ebx_10 != 0xff)
                                ...
                                if (ebx_48 != 0)
                                    int32_t eax_27 = *((ebx_10 << 2) + &data_4d6e180)
                                    *((eax_19 << 2) + eax_27)
                                    *((eax_23 << 2) + eax_27)
                                    int32_t eax_28
                                    eax_28.b = edi[2]
