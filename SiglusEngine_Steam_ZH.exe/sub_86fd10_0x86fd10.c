            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        eax_21.b = edi[1]
                        int32_t var_dc
                        int32_t eax_22 = eax_21 - *((neg.d(var_dc + *(((eax_17
                            + *(((eax_16 - eax_17) << 2) + var_d0) - var_dc) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        eax_29.b = *edi
                        int32_t var_d8
                        int32_t eax_30 = eax_29 - *((neg.d(var_d8 + *(((eax_25
                            + *(((eax_24 - eax_25) << 2) + var_d0) - var_d8) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
