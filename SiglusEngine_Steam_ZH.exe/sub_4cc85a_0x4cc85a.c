...
void var_100
void var_60
int32_t result = sub_4c73cc(arg1, ecx, 0xacbb18, &var_60, &i, &var_100, &var_20, 1, 1)

if (result == 1)
    result = sub_4c73cc(arg1, *(arg1 + 0x100), 0xacbb78, &var_60, &i, &var_100, &var_20, 1, 1)
    
    if (result == 1)
        result = sub_4c73cc(arg1, *(arg1 + 0x100), 0xacbbd8, &var_60, &i, &var_100, &var_20, 1, 1)
        
        if (result == 1)
            result =
                sub_4c73cc(arg1, *(arg1 + 0x100), 0xacbc38, &var_60, &i, &var_100, &var_20, 1, 1)
