        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (eax_14 + var_88 s< 0)
                    ...
                    int32_t ebx_32
                    ebx_32.b = edi[2]
                    eax_17 = (*((ebx_32 << 2) + *((ebx_23 << 2) + data_4ced578))).b
                else
                    if (ebx_23 s> 0xff)
                        ebx_23 = 0xff
                    ...
                    int32_t ebx_26
                    ebx_26.b = edi[2]
                    eax_17 = (*(((ebx_26 - 0xff) << 2) + *((ebx_23 << 2) + data_4ced578))).b - 1
                
                edi[2] = eax_17
                int32_t ebx_35
                ebx_35.b = esi_1[1]
                int32_t eax_20 = edx_5 + *(((ebx_35 - edx_5) << 2) + eax_6)
                int32_t eax_21
                ...
                if (eax_26 + var_84 s< 0)
                    ...
                    int32_t ebx_61
                    ebx_61.b = edi[1]
                    eax_29 = (*((ebx_61 << 2) + *((ebx_52 << 2) + data_4ced578))).b
                else
                    if (ebx_52 s> 0xff)
                        ebx_52 = 0xff
                    ...
                    int32_t ebx_55
                    ebx_55.b = edi[1]
                    eax_29 = (*(((ebx_55 - 0xff) << 2) + *((ebx_52 << 2) + data_4ced578))).b - 1
                
                edi[1] = eax_29
                int32_t ebx_64
                ebx_64.b = *esi_1
                int32_t eax_32 = edx_5 + *(((ebx_64 - edx_5) << 2) + eax_6)
                int32_t eax_33
                ...
                if (eax_38 + var_80 s< 0)
                    ...
                    int32_t ebx_90
                    ebx_90.b = *edi
                    eax_41 = (*((ebx_90 << 2) + *((ebx_81 << 2) + data_4ced578))).b
                else
                    if (ebx_81 s> 0xff)
                        ebx_81 = 0xff
                    ...
                    int32_t ebx_84
                    ebx_84.b = *edi
                    eax_41 = (*(((ebx_84 - 0xff) << 2) + *((ebx_81 << 2) + data_4ced578))).b - 1
