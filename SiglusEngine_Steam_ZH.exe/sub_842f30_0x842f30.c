            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_12 = var_f8 + *(((var_e0 + *(((eax_7
                            + *(((ebx_14 - eax_7) << 2) + var_d0) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec)
                        int32_t ebx_27
                        ebx_27.b = var_124[1]
                        int32_t eax_13
                        ...
                        int32_t eax_18 = var_f4 + *(((var_dc + *(((eax_13
                            + *(((ebx_27 - eax_13) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8)
                        int32_t ebx_40
                        ebx_40.b = *var_124
                        int32_t eax_19
                        eax_19.b = not.b(ebx_40.b)
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_24 = var_f0 + *(((var_d8 + *(((eax_19
                            + *(((ebx_40 - eax_19) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4)
                        ...
                        if (ebx_12 != 0xff)
                            ...
                            if (ebx_58 != 0)
                                int32_t eax_28 = *((ebx_12 << 2) + &data_4d6e180)
                                *((eax_18 << 2) + eax_28)
                                *((eax_24 << 2) + eax_28)
                                int32_t eax_29
                                eax_29.b = edi[2]
                                ...
                                int32_t eax_39
                                eax_39.b = *edi
                                *edi = (divu.dp.d(mulu.dp.d(eax_39, edx_6), ecx_6)).b
                                edi[3] = ecx_6.b
                            else
                                edi[2] = eax_12.b
                                edi[1] = eax_18.b
