                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_d4
                                int32_t var_d0
                                int32_t ebx_44 = (*(((var_e0 + *(((eax_12
                                    + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4))
                                    << 2) + *((eax_16 << 2) + &data_4e3da80)) - eax_20) << 2
                                edi[2] = eax_20.b + (*(ebx_44 + edx_2)).b
                                int32_t ebx_46
                                ebx_46.b = esi_1[1]
                                int32_t eax_23 = edx_6 + *(((ebx_46 - edx_6) << 2) + eax_9)
                                int32_t eax_24
                                ...
                                eax_32.b = edi[1]
                                int32_t var_dc
                                int32_t ebx_63 = (*(((var_dc + *(((eax_24
                                    + *(((eax_23 - eax_24) << 2) + var_d0) - var_dc) << 2) + var_d4))
                                    << 2) + *((eax_28 << 2) + &data_4e3da80)) - eax_32) << 2
                                edi[1] = eax_32.b + (*(ebx_63 + edx_2)).b
                                int32_t ebx_65
                                ebx_65.b = *esi_1
                                int32_t eax_35 = edx_6 + *(((ebx_65 - edx_6) << 2) + eax_9)
                                int32_t eax_36
                                ...
                                eax_44.b = *edi
                                int32_t var_d8
                                int32_t ebx_82 = (*(((var_d8 + *(((eax_36
                                    + *(((eax_35 - eax_36) << 2) + var_d0) - var_d8) << 2) + var_d4))
                                    << 2) + *((eax_40 << 2) + &data_4e3da80)) - eax_44) << 2
                                *edi = eax_44.b + (*(ebx_82 + edx_2)).b
