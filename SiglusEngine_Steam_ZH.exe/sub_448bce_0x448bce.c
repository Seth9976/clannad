...
if (ebx_2[0x14].w u> 0 || ebx_2[0xd] != 0)
    ...
    *ebx_2 = 1
    void var_18
    void var_10
    int32_t result_1 = sub_442fd3(arg4 + 0x68, &ebx_2[0xf], &var_18, &var_10)
    result = result_1
        ...
        if (eax_3 != 0)
            ...
            if (eax_9 != 0)
                ...
                if (*(eax_10 + 0xc) u> 0)
                    while (true)
                        ...
                        if (eax_13 != 0)
                            ...
                            *(ebx_2 + 0x4e) = ecx_5 + 1
                            sub_4438fa(arg1, arg2, arg3, zx.d(ecx_5), eax_13, var_24_1)
                            result = 0
                ...
                *(arg4 + 0x18) = eax_26
                ...
                uint32_t var_24_3 = ebx_11 u>> 3
                int32_t var_c_5 = ebx_11 & 7
                int32_t eax_28 = var_c_5 + (var_24_3 << 3)
                *(esi_2 + 0xc) = eax_28
                *(arg4 + 0x34) = eax_28
                ...
                *(esi_2 + 0xc) += ecx_9 << 5
                ...
                if (eax_37 u<= var_c_5 + ((var_24_3 + eax_26) << 3) + 8)
                    eax_37 = var_c_5 + ((var_24_3 + eax_26) << 3) + 8
