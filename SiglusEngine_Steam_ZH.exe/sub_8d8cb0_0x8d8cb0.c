            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t ebx_32 = neg.d(var_f8 + *(((var_e0 + *(((edx_6
                            + *(((ebx_17 - edx_6) << 2) + eax_10) - var_e0) << 2) + var_d4) - var_f8)
                            << 2) + var_ec) - 0xff) << 2
                        int32_t eax_17
                        eax_17.b = edi[2]
                        int32_t eax_18 = eax_17 - *(ebx_32 + edx_2)
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_50 = neg.d(var_f4 + *(((var_dc + *(((edx_6
                            + *(((ebx_35 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - 0xff) << 2
                        int32_t eax_25
                        eax_25.b = edi[1]
                        int32_t eax_26 = eax_25 - *(ebx_50 + edx_2)
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_68 = neg.d(var_f0 + *(((var_d8 + *(((edx_6
                            + *(((ebx_53 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - 0xff) << 2
                        int32_t eax_33
                        eax_33.b = *edi
                        int32_t eax_34 = eax_33 - *(ebx_68 + edx_2)
