...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_d4
            int32_t var_d0
            int32_t ebx_36 = neg.d(var_f8 + *(((var_e0
                + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0) - var_e0) << 2) + var_d4)
                - var_f8) << 2) + var_ec) - 0xff) << 2
            int32_t eax_28
            eax_28.b = edi[2]
            int32_t eax_29 = eax_28 - *(ebx_36 + edx_2)
            ...
            int32_t ebx_39
            ebx_39.b = var_18[1]
            int32_t eax_31 = edx_6 + *(((ebx_39 - edx_6) << 2) + eax_19)
            int32_t eax_32
            eax_32.b = not.b(eax_31.b)
            int32_t var_f4
            int32_t var_e8
            int32_t var_dc
            int32_t ebx_58 = neg.d(var_f4 + *(((var_dc
                + *(((eax_32 + *(((eax_31 - eax_32) << 2) + var_d0) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8) - 0xff) << 2
            int32_t eax_38
            eax_38.b = edi[1]
            int32_t eax_39 = eax_38 - *(ebx_58 + edx_2)
            ...
            int32_t ebx_61
            ebx_61.b = *var_18
            int32_t eax_41 = edx_6 + *(((ebx_61 - edx_6) << 2) + eax_19)
            int32_t eax_42
            eax_42.b = not.b(eax_41.b)
            int32_t var_f0
            int32_t var_e4
            int32_t var_d8
            int32_t ebx_80 = neg.d(var_f0 + *(((var_d8
                + *(((eax_42 + *(((eax_41 - eax_42) << 2) + var_d0) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4) - 0xff) << 2
            int32_t eax_48
            eax_48.b = *edi
            result = eax_48 - *(ebx_80 + edx_2)
