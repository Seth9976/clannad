        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_d4
                    int32_t var_d0
                    int32_t ebx_37 = neg.d(var_f8 + *(((var_e0 +
                        *(((eax_10 + *(((ebx_22 - eax_10) << 2) + var_d0) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec) - 0xff) << 2
                    int32_t eax_16
                    eax_16.b = edi[2]
                    int32_t eax_17 = eax_16 - *(ebx_37 + edx_2)
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_55 = neg.d(var_f4 + *(((var_dc +
                        *(((eax_18 + *(((ebx_40 - eax_18) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - 0xff) << 2
                    int32_t eax_24
                    eax_24.b = edi[1]
                    int32_t eax_25 = eax_24 - *(ebx_55 + edx_2)
                    ...
                    int32_t ebx_73 = neg.d(var_f0 + *(((var_d8 +
                        *(((eax_26 + *(((ebx_58 - eax_26) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - 0xff) << 2
                    int32_t eax_32
                    eax_32.b = *edi
                    result = eax_32 - *(ebx_73 + edx_2)
