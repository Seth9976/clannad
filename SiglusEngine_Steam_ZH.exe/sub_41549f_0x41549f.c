...
if ((0x400 & ecx_1) == 0 && (ecx_1.b & 0x40) == 0)
    ...
    if (eax_1 == 0)
        ...
        esi_3 = sub_4111ca(eax_1, *(edi_1 + 0x230), edi_1 + 0xc, esi_2)
    ...
    if (esi_3 != 0)
        ...
        void* eax_4 = sub_40dd7c(esi_3, *(edi_1 + 0x264), eax_3)
        arg1 = eax_4
        ...
        if (eax_4 s>= 0)
            ...
            void* eax_7 = sub_40f482(esi_3, edi_1)
            arg1 = eax_7
            ...
            if (eax_7 s>= 0)
                ...
                if (eax_9 s>= 0)
                    void* eax_10 = sub_4145e1(esi_3, edi_1, arg2, arg3, arg4, arg5, arg6, 
                        *(edi_1 + 0x234), nullptr)
                    arg1 = eax_10
