...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_d0
            int32_t eax_15 =
                var_e0 + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4)
            int32_t ebx_19
            ebx_19.b = var_18[1]
            int32_t eax_17 = edx_10 + *(((ebx_19 - edx_10) << 2) + eax_9)
            int32_t eax_18
            eax_18.b = not.b(eax_17.b)
            int32_t var_dc
            int32_t eax_21 =
                var_dc + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_dc) << 2) + var_d4)
            int32_t ebx_32
            ebx_32.b = *var_18
            int32_t eax_23 = edx_10 + *(((ebx_32 - edx_10) << 2) + eax_9)
            int32_t eax_24
            eax_24.b = not.b(eax_23.b)
            int32_t var_d8
            int32_t eax_27 =
                var_d8 + *(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0) - var_d8) << 2) + var_d4)
            result = result_1
