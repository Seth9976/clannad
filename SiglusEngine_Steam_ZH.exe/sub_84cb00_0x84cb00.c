                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_e8
                                int32_t var_dc
                                int32_t ebx_58 = ((var_f4 + *(((var_dc + *(((edx_6
                                    + *(((ebx_43 - edx_6) << 2) + eax_9) - var_dc) << 2) + var_d4)
                                    - var_f4) << 2) + var_e8) - eax_24) << 2) + edx_2
                                edi[1] = eax_24.b + (*ebx_58).b
                                int32_t ebx_59
                                ebx_59.b = *esi_1
                                int32_t eax_32
                                eax_32.b = *edi
