...
do
    ...
    int32_t var_ec
    *(edi + 2) = (*(((var_f8
        + *(((edx_5 + *(((ebx_5 - edx_5) << 2) + eax_9) - var_f8) << 2) + var_ec)) << 2)
    ...
    int32_t var_e8
    *(edi + 1) = (*(((var_f4
        + *(((edx_5 + *(((ebx_16 - edx_5) << 2) + eax_9) - var_f4) << 2) + var_e8)) << 2)
    ...
    int32_t var_f0
    int32_t var_e4
    result = (*(((var_f0 + *(((edx_5 + *(((ebx_27 - edx_5) << 2) + eax_9) - var_f0) << 2) + var_e4))
        << 2) + *((eax_32 << 2) + &data_4e3da80))).b
    *edi = result
    esi_4 = esi_1 + 4
    i = i_1
    i_1 -= 1
