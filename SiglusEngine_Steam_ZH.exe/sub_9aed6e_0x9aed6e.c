...
uint64_t xmm2_1[0x2] = __andpd_xmmxuq_memxuq(xmm7_2, data_b19e10)
...
if (not(is_unordered.q(xmm2_1, 16331239353195370.0)))
    if (not(xmm2_1 f>= 16331239353195370.0))
        if (not(xmm2_1 f>= 0.03125))
            ...
            double xmm5_8[0x2] = __addpd_xmmpd_mempd(
                _mm_mul_pd(
                    __addpd_xmmpd_mempd(
                        _mm_mul_pd(
                            __addpd_xmmpd_mempd(_mm_mul_pd(data_b19ee0, xmm3_2), data_b19ed0), 
                            xmm3_2), 
                        data_b19ec0), 
                    xmm3_2), 
                data_b19eb0) f* xmm1_1
        ...
        if (xmm2_1 f>= 8.0)
            ...
            double xmm5_30 = *((eax_1 << 3) + &data_b18600)
            double xmm2_3[0x2] = (xmm2_1 f- xmm5_30) / (xmm2_1 * xmm5_30 + 1.0)
            xmm2_4 = _mm_unpacklo_pd(xmm2_3, xmm2_3)
        
        double xmm0_3 = *((eax_1 << 3) + &data_b185f0)
        double xmm4 = *((eax_1 << 3) + &data_b185f8)
        ...
        double xmm5_38[0x2] = __addpd_xmmpd_mempd(
            _mm_mul_pd(
                __addpd_xmmpd_mempd(
                    _mm_mul_pd(__addpd_xmmpd_mempd(_mm_mul_pd(data_b19ee0, xmm3_17), data_b19ed0), 
                        xmm3_17), 
                    data_b19ec0), 
                xmm3_17), 
            data_b19eb0) f* xmm1_5
        arg2 = _mm_or_pd(
    ...
    if (not(is_unordered.q(_mm_and_pd(zx.o(xmm2_1), xmm3_20), xmm3_20)))
        return fconvert.t(4.7783097267364807e-299)
            + fconvert.t(*((arg2:4.d u>> 0x1f << 3) + &data_b19e20))

sub_75a7f9(&arg2, &arg2, &arg2, 0x3eb)
return fconvert.t(arg2)
