            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    int32_t eax_13 = eax_12 -
                        *((neg.d(eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - 0xff) << 2) + edx_2)
                    ...
                    int32_t ebx_23
                    ebx_23.b = var_3c[1]
                    int32_t eax_15 = edx_6 + *(((ebx_23 - edx_6) << 2) + eax_7)
                    int32_t eax_16
                    eax_16.b = not.b(eax_15.b)
                    int32_t eax_18
                    eax_18.b = edi[1]
                    int32_t eax_19 = eax_18 - *((
                        neg.d(eax_16 + *(((eax_15 - eax_16) << 2) + var_d0) - 0xff) << 2) + edx_2)
                    ...
                    int32_t ebx_37
                    ebx_37.b = *var_3c
                    int32_t eax_21 = edx_6 + *(((ebx_37 - edx_6) << 2) + eax_7)
                    int32_t eax_22
