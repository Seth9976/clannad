...
int32_t var_18 = arg2
int32_t var_14 = 0
var_20.o = _mm_mul_ps(var_20.o, data_ac7df0)
float var_30[0x4]
sub_4dbded(&var_20, &var_20, &var_30)
...
*arg1 = _mm_add_ps(xmm0_5, 
    _mm_mul_ps(_mm_mul_ps(xmm1_8, _mm_shuffle_ps(xmm2_1, xmm2_1, 0x51)), xmm5_1) ^ data_ac7de0)
return arg1
