...
int32_t (* var_c)(void* arg1) = sub_9b6a9a
TEB* fsbase
...
if (arg3 == 0)
    ...
    *(arg3 + 0x2f4)
    int16_t* var_a4_53 = ecx_73
    ecx_79 = sub_6ad9b0(&var_48)
    int32_t var_8_40 = 0x1a
    ebx_13 = ebx_12 | &data_4000000

int32_t var_7c_40 = ebx_13
int32_t eax_46 = *(data_bac4e0 + 0x34)

if (eax_46 != 0)
    ecx_79 = eax_46(*(arg2 + 4), *arg4, *arg5, ecx_79, eax_2)

if ((ebx_13 & 0x8000000) != 0)
    ebx_13 &= 0xf7ffffff
    int32_t var_7c_41 = ebx_13
    
    if (var_1c u>= 8)
        ecx_79 = j__free(var_30.d)
...
if ((ebx_13 & &data_4000000) != 0)
    ebx_13 &= 0xfbffffff
    int32_t var_7c_42 = ebx_13
    
    if (var_34 u>= 8)
        ecx_79 = j__free(var_48)
...
if (arg3 == 0)
    sub_52e820(&var_30, &data_ad7c90)
    ecx_85 = &var_30
    int32_t var_8_44 = 0x1d
    ebx_14 = ebx_13 | 0x20000000
else
    *(arg3 + 0x308)
    int16_t* var_a4_57 = ecx_79
    ecx_85 = sub_6ad9b0(&var_48)
    int32_t var_8_43 = 0x1c
    ebx_14 = ebx_13 | 0x10000000

int32_t var_7c_43 = ebx_14
int32_t eax_49 = *(data_bac4e0 + 0x34)

if (eax_49 != 0)
    ecx_85 = eax_49(*(arg2 + 4), *arg4, *arg5, ecx_85, eax_2)

if ((ebx_14 & 0x20000000) != 0)
    ebx_14 &= 0xdfffffff
    int32_t var_7c_44 = ebx_14
    
    if (var_1c u>= 8)
        ecx_85 = j__free(var_30.d)
...
if ((ebx_14 & 0x10000000) != 0)
    ebx_14 &= 0xefffffff
    int32_t var_7c_45 = ebx_14
    
    if (var_34 u>= 8)
        ecx_85 = j__free(var_48)
...
if (arg3 == 0)
    sub_52e820(&var_30, &data_ad7c90)
    ecx_91 = &var_30
    int32_t var_8_47 = 0x1f
    ebx_15 = ebx_14 | 0x80000000
else
    *(arg3 + 0x30c)
    int16_t* var_a4_61 = ecx_85
    ecx_91 = sub_6ad9b0(&var_48)
    int32_t var_8_46 = 0x1e
    ebx_15 = ebx_14 | 0x40000000

int32_t var_7c_46 = ebx_15
int32_t eax_52 = *(data_bac4e0 + 0x34)

if (eax_52 != 0)
    ecx_91 = eax_52(*(arg2 + 4), *arg4, *arg5, ecx_91, eax_2)

if (ebx_15 s< 0)
    ebx_15 &= 0x7fffffff
    
    if (var_1c u>= 8)
        ecx_91 = j__free(var_30.d)
...
if ((ebx_15 & 0x40000000) != 0 && var_34 u>= 8)
    ecx_91 = j__free(var_48)
...
if (arg3 == 0)
    sub_52e820(&var_30, &data_ad7c90)
    ecx_97 = &var_30
    int32_t var_8_50 = 0x21
    ebx_16 = 2
else
    *(arg3 + 0x310)
    int16_t* var_a4_65 = ecx_91
    ecx_97 = sub_6ad9b0(&var_48)
    int32_t var_8_49 = 0x20
    ebx_16 = 1

int32_t var_8c_1 = ebx_16
int32_t eax_55 = *(data_bac4e0 + 0x34)

if (eax_55 != 0)
    ecx_97 = eax_55(*(arg2 + 4), *arg4, *arg5, ecx_97, eax_2)

if ((ebx_16.b & 2) != 0)
    ebx_16 &= 0xfffffffd
    int32_t var_8c_2 = ebx_16
    
    if (var_1c u>= 8)
        ecx_97 = j__free(var_30.d)
    
    var_1c = 7
    int32_t var_20_26 = 0
    var_30 = 0

int32_t var_8_51 = 0xffffffff

if ((ebx_16.b & 1) != 0)
    ebx_16 &= 0xfffffffe
    int32_t var_8c_3 = ebx_16
    
    if (var_34 u>= 8)
        ecx_97 = j__free(var_48)
...
if (arg3 == 0)
    sub_52e820(&var_30, &data_ad7c90)
    ecx_103 = &var_30
    int32_t var_8_53 = 0x23
    ebx_17 = ebx_16 | 8
else
    *(arg3 + 0x314)
    int16_t* var_a4_69 = ecx_97
    ecx_103 = sub_6ad9b0(&var_48)
    int32_t var_8_52 = 0x22
    ebx_17 = ebx_16 | 4

int32_t var_8c_4 = ebx_17
int32_t eax_58 = *(data_bac4e0 + 0x34)

if (eax_58 != 0)
    ecx_103 = eax_58(*(arg2 + 4), *arg4, *arg5, ecx_103, eax_2)

if ((ebx_17.b & 8) != 0)
    ebx_17 &= 0xfffffff7
    int32_t var_8c_5 = ebx_17
    
    if (var_1c u>= 8)
        ecx_103 = j__free(var_30.d)
...
if ((ebx_17.b & 4) != 0)
    ebx_17 &= 0xfffffffb
    int32_t var_8c_6 = ebx_17
    
    if (var_34 u>= 8)
        ecx_103 = j__free(var_48)
...
if (arg3 == 0)
    sub_52e820(&var_30, &data_ad7c90)
    ecx_109 = &var_30
    int32_t var_8_56 = 0x25
    ebx_18 = ebx_17 | 0x20
else
    *(arg3 + 0x318)
    int16_t* var_a4_73 = ecx_103
    ecx_109 = sub_6ad9b0(&var_48)
    int32_t var_8_55 = 0x24
    ebx_18 = ebx_17 | 0x10

int32_t var_8c_7 = ebx_18
int32_t eax_61 = *(data_bac4e0 + 0x34)

if (eax_61 != 0)
    ecx_109 = eax_61(*(arg2 + 4), *arg4, *arg5, ecx_109, eax_2)

if ((ebx_18.b & 0x20) != 0)
    ebx_18 &= 0xffffffdf
    int32_t var_8c_8 = ebx_18
    
    if (var_1c u>= 8)
        ecx_109 = j__free(var_30.d)
    
    int32_t var_1c_1 = 7
    int32_t var_20_28 = 0
    var_30 = 0

int32_t var_8_57 = 0xffffffff

if ((ebx_18.b & 0x10) != 0)
    ebx_18 &= 0xffffffef
    int32_t var_8c_9 = ebx_18
    
    if (var_34 u>= 8)
        ecx_109 = j__free(var_48)
...
if (arg3 == 0)
    ...
    ecx_115 = &var_60
    int32_t var_8_59 = 0x27
    ebx_19 = ebx_18 | 0x80
else
    *(arg3 + 0x31c)
    int16_t* var_a4_77 = ecx_109
    ecx_115 = sub_6ad9b0(&var_78)
    int32_t var_8_58 = 0x26
    ebx_19 = ebx_18 | 0x40

int32_t var_8c_10 = ebx_19
int32_t result = *(data_bac4e0 + 0x34)

if (result != 0)
    result = result(*(arg2 + 4), *arg4, *arg5, ecx_115, eax_2)
