        ...
        if (result_1 != 0)
            ...
            if (ecx_6 != 0)
                ...
                int32_t eax_19 = var_f8 + *(((var_e0
                    + *(((eax_14 + *(((ebx_10 - eax_14) << 2) + var_d0) - var_e0) << 2) + var_d4)
                    - var_f8) << 2) + var_ec)
                int32_t ebx_23
                ebx_23.b = var_18[1]
                int32_t eax_20
                eax_20.b = not.b(ebx_23.b)
                int32_t var_f4
                int32_t var_e8
                int32_t var_dc
                int32_t eax_25 = var_f4 + *(((var_dc
                    + *(((eax_20 + *(((ebx_23 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)
                int32_t ebx_36
                ebx_36.b = *var_18
                int32_t eax_26
                ...
                int32_t var_e4
                int32_t var_d8
                int32_t eax_31 = var_f0 + *(((var_d8
                    + *(((eax_26 + *(((ebx_36 - eax_26) << 2) + var_d0) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4)
                result = result_1
                ...
                if (result != 0xff)
                    ...
                    if (ebx_54 != 0)
                        int32_t eax_34 = *((result << 2) + &data_4d6e180)
                        *((eax_25 << 2) + eax_34)
                        *((eax_31 << 2) + eax_34)
                        int32_t eax_35
                        eax_35.b = edi[2]
                        edi[2] = (divu.dp.d(mulu.dp.d(eax_35, edx_6), ecx_6)).b
                        int32_t eax_40
                        eax_40.b = edi[1]
                        edi[1] = (divu.dp.d(mulu.dp.d(eax_40, edx_6), ecx_6)).b
                        int32_t eax_45
                        eax_45.b = *edi
                        result = divu.dp.d(mulu.dp.d(eax_45, edx_6), ecx_6)
                        *edi = result.b
                        edi[3] = ecx_6.b
                    else
                        edi[2] = eax_19.b
