...
void* var_8 = &data_becd40
int32_t ebx = 0
void* i_3 = &data_becd40
void* i
...
do
    ...
    *((ebx << 2) + &data_c6cd40) = i_3
    i = i_3 + 0x400
    ebx += 1
    i_3 = i
while (i s< &data_c2cd40)
void* eax_5 = &data_c2cd40
int32_t edi_2 = 0
void* ebx_1 = &data_c2cd40
...
int32_t ebx_2 = 0
int32_t esi_1 = 0
void* i_2 = &data_bac540
void* ecx_8 = &data_bac540
int32_t result
...
do
    ...
    *((ebx_2 << 2) + &data_bec940) = i_2
    esi_1 += 0xff
    i_2 += 0x400
    ebx_2 += 1
while (i_2 s< &data_bec540)
