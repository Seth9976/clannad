                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t eax_11
                            eax_11.b = edi[2]
                            edi[2] = eax_11.b + (*(((ebx_38 - eax_11) << 2) + edx_2)).b
                            int32_t ebx_47
                            ebx_47.b = esi_1[1]
                            int32_t eax_13
                            eax_13.b = not.b(ebx_47.b)
                            int32_t var_f4
                            int32_t var_e8
                            int32_t var_dc
                            int32_t eax_18 = var_f4 + *(((var_dc + *(((eax_13
                                + *(((ebx_47 - eax_13) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)
                            int32_t var_84
                            int32_t ebx_60 = eax_18 + var_84
                            int32_t ebx_68
                            ...
                            if (eax_18 + var_84 s< 0)
                                ...
                                int32_t ebx_63
                                ebx_63.b = edi[1]
                                ebx_68 = *(((ebx_63 - 0xff) << 2) + *((ebx_60 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_21
                            eax_21.b = edi[1]
                            edi[1] = eax_21.b + (*(((ebx_68 - eax_21) << 2) + edx_2)).b
                            int32_t ebx_77
                            ebx_77.b = *esi_1
                            int32_t eax_23
                            eax_23.b = not.b(ebx_77.b)
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t eax_28 = var_f0 + *(((var_d8 + *(((eax_23
                                + *(((ebx_77 - eax_23) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)
                            int32_t var_80
                            int32_t ebx_90 = eax_28 + var_80
                            int32_t ebx_98
                            ...
                            if (eax_28 + var_80 s< 0)
                                ...
                                int32_t ebx_93
                                ebx_93.b = *edi
                                ebx_98 = *(((ebx_93 - 0xff) << 2) + *((ebx_90 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_31
                            eax_31.b = *edi
                            *edi = eax_31.b + (*(((ebx_98 - eax_31) << 2) + edx_2)).b
