...
int32_t (* var_c)(void* arg1) = sub_9b36c0
TEB* fsbase
...
if (arg2 != 0)
    if (arg2 u<= 0x6bca1a)
        eax_3 = sub_745f3f(arg2 * 0x260)
        esi = eax_3
        struct _EXCEPTION_REGISTRATION_RECORD** var_18_1 = esi
    
    if (arg2 u> 0x6bca1a || esi == 0)
        sub_743132()
        noreturn

int32_t var_8_1 = 0
int32_t var_2c_2 = arg2
sub_56adb0(eax_3, arg1[1], *arg1, esi)
int32_t eax_5
int32_t edx_1
...
if (ecx_3 != 0)
    ...
    void* var_30_1 = ecx_3
    sub_56ad60(ecx_3, arg1[1])
    j__free(*arg1)

*arg1 = esi
arg1[2] = arg2 * 0x260 + esi
void* result = eax_8 * 0x260 + esi
arg1[1] = result
fsbase->NtTib.ExceptionList = ExceptionList
return result
