...
do
    ...
    int32_t var_d0
    *(edi + 2) =
        (var_f8 + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_f8) << 2) + var_ec)).b
    int32_t ebx_17
    ebx_17.b = esi_3[1]
    ...
    int32_t var_e8
    *(edi + 1) =
        (var_f4 + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_f4) << 2) + var_e8)).b
    int32_t ebx_29
    ebx_29.b = *esi_3
    ...
    int32_t var_f0
    int32_t var_e4
    result = var_f0 + *(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0) - var_f0) << 2) + var_e4)
    *edi = result.b
    esi_4 = esi_1 + 4
    i = i_1
    i_1 -= 1
