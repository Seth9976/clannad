        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t eax_21
                    eax_21.b = edi[2]
                    edi[2] = eax_21.b + (*(((ebx_39 - eax_21) << 2) + edx_2)).b
                    int32_t ebx_48
                    ebx_48.b = var_18[1]
                    int32_t eax_24 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_16)
                    int32_t var_84
                    int32_t ebx_53 = eax_24 + var_84
                    int32_t ebx_61
                    ...
                    int32_t eax_27
                    eax_27.b = edi[1]
                    edi[1] = eax_27.b + (*(((ebx_61 - eax_27) << 2) + edx_2)).b
                    int32_t ebx_70
                    ebx_70.b = *var_18
                    int32_t eax_30 = edx_6 + *(((ebx_70 - edx_6) << 2) + eax_16)
                    int32_t var_80
                    int32_t ebx_75 = eax_30 + var_80
                    int32_t ebx_83
                    ...
                    int32_t eax_33
                    eax_33.b = *edi
                    result = eax_33 + *(((ebx_83 - eax_33) << 2) + edx_2)
                    *edi = result.b
