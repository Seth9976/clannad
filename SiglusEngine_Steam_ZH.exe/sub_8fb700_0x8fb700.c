                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                eax_19.b = edi[2]
                                int32_t var_d0
                                edi[2] = eax_19.b + (*(((*(((eax_13
                                    + *(((eax_12 - eax_13) << 2) + var_d0)) << 2)
                                    + *((eax_15 << 2) + &data_4e3da80)) - eax_19) << 2) + edx_2)).b
                                int32_t ebx_41
                                ebx_41.b = var_3c[1]
                                int32_t eax_22 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_10)
                                int32_t eax_23
                                ...
                                int32_t eax_29
                                eax_29.b = edi[1]
                                edi[1] = eax_29.b + (*(((*(((eax_23
                                    + *(((eax_22 - eax_23) << 2) + var_d0)) << 2)
                                    + *((eax_25 << 2) + &data_4e3da80)) - eax_29) << 2) + edx_2)).b
                                int32_t ebx_56
                                ebx_56.b = *var_3c
                                int32_t eax_32 = edx_6 + *(((ebx_56 - edx_6) << 2) + eax_10)
                                int32_t eax_33
                                ...
                                eax_39.b = *edi
                                *edi = eax_39.b + (*(((*(((eax_33
                                    + *(((eax_32 - eax_33) << 2) + var_d0)) << 2)
                                    + *((eax_35 << 2) + &data_4e3da80)) - eax_39) << 2) + edx_2)).b
