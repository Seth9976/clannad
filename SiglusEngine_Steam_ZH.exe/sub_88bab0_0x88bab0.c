                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t eax_6 = var_e0 + *(((eax_3 + *(((ebx_17 - eax_3) << 2) + var_d0)
                                - var_e0) << 2) + var_d4)
                            int32_t var_88
                            ...
                            ebx_43.b = esi_1[1]
                            int32_t eax_11
                            eax_11.b = not.b(ebx_43.b)
                            int32_t var_dc
                            int32_t eax_14 = var_dc + *(((eax_11
                                + *(((ebx_43 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)
                            int32_t var_84
                            ...
                            ebx_69.b = *esi_1
                            int32_t eax_19
                            eax_19.b = not.b(ebx_69.b)
                            int32_t var_d8
                            int32_t eax_22 = var_d8 + *(((eax_19
                                + *(((ebx_69 - eax_19) << 2) + var_d0) - var_d8) << 2) + var_d4)
                            int32_t var_80
