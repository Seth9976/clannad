...
if (eax_3 u< edx_3)
    ...
    do
        ...
        *esi = fconvert.s(x87_r6_1 * x87_r7_1)
        esi = &esi[4]
        esi[-3] = fconvert.s(float.t(zx.d(*(eax_3 - 3))) * x87_r7_1)
        esi[-2] = fconvert.s(float.t(zx.d(*(eax_3 - 2))) * x87_r7_1)
        esi[-1] = fconvert.s(float.t(zx.d(*(eax_3 - 1))) * x87_r7_1)
    while (eax_3 u< edx_3)
