                    ...
                    if (ebx_8 != 0)
                        ...
                        if (eax_2 != 0)
                            ...
                            if (ebx_19 != 0)
                                ...
                                int32_t var_d0
                                int32_t eax_6 = eax_5 -
                                    *(((eax_3 + *(((ebx_23 - eax_3) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                ebx_31.b = esi_1[1]
                                int32_t eax_7
                                eax_7.b = not.b(ebx_31.b)
                                int32_t eax_9
                                eax_9.b = edi[1]
                                int32_t eax_10 = eax_9 -
                                    *(((eax_7 + *(((ebx_31 - eax_7) << 2) + var_d0)) << 2) + edx_2)
                                ...
                                int32_t eax_13
                                eax_13.b = *edi
                                int32_t eax_14 = eax_13 - *(((eax_11
                                    + *(((ebx_39 - eax_11) << 2) + var_d0)) << 2) + edx_2)
