...
do
    ...
    if (eax_17 + var_88 s< 0)
        ...
        int32_t ebx_31
        ebx_31.b = edi[2]
        eax_20 = (*((ebx_31 << 2) + *((ebx_22 << 2) + data_4ced578))).b
    else
        if (ebx_22 s> 0xff)
            ebx_22 = 0xff
        ...
        int32_t ebx_25
        ebx_25.b = edi[2]
        eax_20 = (*(((ebx_25 - 0xff) << 2) + *((ebx_22 << 2) + data_4ced578))).b - 1
    
    edi[2] = eax_20
    int32_t ebx_34
    ebx_34.b = var_18[1]
    int32_t eax_23 = edx_5 + *(((ebx_34 - edx_5) << 2) + eax_9)
    int32_t eax_24
    ...
    if (eax_29 + var_84 s< 0)
        ...
        int32_t ebx_60
        ebx_60.b = edi[1]
        eax_32 = (*((ebx_60 << 2) + *((ebx_51 << 2) + data_4ced578))).b
    else
        if (ebx_51 s> 0xff)
            ebx_51 = 0xff
        ...
        int32_t ebx_54
        ebx_54.b = edi[1]
        eax_32 = (*(((ebx_54 - 0xff) << 2) + *((ebx_51 << 2) + data_4ced578))).b - 1
    
    edi[1] = eax_32
    int32_t ebx_63
    ebx_63.b = *var_18
    int32_t eax_35 = edx_5 + *(((ebx_63 - edx_5) << 2) + eax_9)
    int32_t eax_36
