...
do
    ...
    int32_t eax_17 = eax_16 + *(((var_f8
        + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_f8) << 2) + var_ec)) << 2) + var_118)
    ...
    int32_t eax_25 = eax_24 + *(((var_f4
        + *(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - var_f4) << 2) + var_e8)) << 2) + var_118)
    ...
    result = eax_32 + *(((var_f0
        + *(((eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2) + var_118)
