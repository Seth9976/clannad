...
do
    ...
    int32_t var_d0
    int32_t eax_6 =
        var_e0 + *(((eax_3 + *(((ebx_1 - eax_3) << 2) + var_d0) - var_e0) << 2) + var_d4)
    int32_t var_88
    ...
    ebx_22.b = var_18[1]
    int32_t eax_11
    eax_11.b = not.b(ebx_22.b)
    int32_t var_dc
    int32_t eax_14 =
        var_dc + *(((eax_11 + *(((ebx_22 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)
    int32_t var_84
    ...
    ebx_43.b = *var_18
    int32_t eax_19
    eax_19.b = not.b(ebx_43.b)
    int32_t var_d8
    int32_t eax_22 =
        var_d8 + *(((eax_19 + *(((ebx_43 - eax_19) << 2) + var_d0) - var_d8) << 2) + var_d4)
    int32_t var_80
