            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_10 = var_f8 + *(((var_e0 + *(((ebx_14 - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec)
                        int32_t ebx_23
                        ebx_23.b = esi_1[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t eax_14 = var_f4 + *(((var_dc + *(((ebx_23 - var_dc) << 2) + var_d4)
                            - var_f4) << 2) + var_e8)
                        int32_t ebx_32
                        ebx_32.b = *esi_1
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t eax_18 = var_f0 + *(((var_d8 + *(((ebx_32 - var_d8) << 2) + var_d4)
                            - var_f0) << 2) + var_e4)
