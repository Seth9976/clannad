    ...
    if (result != 0)
        ...
        if (result_1 != 0)
            ...
            if (ecx_6 != 0)
                ...
                int32_t var_d4
                int32_t var_d0
                int32_t eax_28 = var_f8 + *(((var_e0
                    + *(((eax_23 + *(((eax_22 - eax_23) << 2) + var_d0) - var_e0) << 2) + var_d4)
                    - var_f8) << 2) + var_ec)
                int32_t ebx_31
                ebx_31.b = var_18[1]
                int32_t eax_30 = edx_10 + *(((ebx_31 - edx_10) << 2) + eax_20)
                int32_t eax_31
                ...
                int32_t ebx_48
                ebx_48.b = *var_18
                int32_t eax_38 = edx_10 + *(((ebx_48 - edx_10) << 2) + eax_20)
                int32_t eax_39
                eax_39.b = not.b(eax_38.b)
                int32_t var_f0
                int32_t var_e4
                int32_t var_d8
                int32_t eax_44 = var_f0 + *(((var_d8
                ...
                if (result != 0xff)
                    ...
                    if (ebx_70 != 0)
                        int32_t eax_47 = *((result << 2) + &data_4d6e180)
                        *((eax_36 << 2) + eax_47)
                        *((eax_44 << 2) + eax_47)
                        int32_t eax_48
                        eax_48.b = edi[2]
                        edi[2] = (divu.dp.d(mulu.dp.d(eax_48, edx_6), ecx_6)).b
                        int32_t eax_53
                        eax_53.b = edi[1]
                        edi[1] = (divu.dp.d(mulu.dp.d(eax_53, edx_6), ecx_6)).b
                        int32_t eax_58
                        eax_58.b = *edi
                        result = divu.dp.d(mulu.dp.d(eax_58, edx_6), ecx_6)
                        *edi = result.b
                        edi[3] = ecx_6.b
                    else
                        edi[2] = eax_28.b
