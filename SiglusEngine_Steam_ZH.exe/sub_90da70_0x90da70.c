                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                if (ecx_8 != 0)
                                    ...
                                    int32_t var_d4
                                    int32_t var_d0
                                    int32_t eax_9 = var_e0 + *(((eax_6
                                        + *(((ebx_20 - eax_6) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                    int32_t ebx_29
                                    ebx_29.b = var_3c[1]
                                    int32_t eax_10
                                    eax_10.b = not.b(ebx_29.b)
                                    int32_t var_dc
                                    int32_t eax_13 = var_dc + *(((eax_10
                                        + *(((ebx_29 - eax_10) << 2) + var_d0) - var_dc) << 2)
                                        + var_d4)
                                    int32_t ebx_38
                                    ebx_38.b = *var_3c
                                    int32_t eax_14
                                    eax_14.b = not.b(ebx_38.b)
                                    int32_t var_d8
                                    int32_t eax_17 = var_d8 + *(((eax_14
                                        + *(((ebx_38 - eax_14) << 2) + var_d0) - var_d8) << 2)
                                        + var_d4)
                                    ...
                                    if (ebx_18 != 0xff)
                                        ...
                                        if (ebx_52 != 0)
                                            int32_t eax_21 = *((ebx_18 << 2) + &data_4d6e180)
                                            *((eax_13 << 2) + eax_21)
                                            *((eax_17 << 2) + eax_21)
                                            int32_t eax_22
                                            eax_22.b = edi[2]
