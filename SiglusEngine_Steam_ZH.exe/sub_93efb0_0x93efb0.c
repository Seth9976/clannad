        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_ec
                    int32_t var_d0
                    int32_t eax_24 = eax_23 - *((neg.d(var_f8 +
                    ...
                    int32_t ebx_44
                    ebx_44.b = var_18[1]
                    int32_t eax_26 = edx_6 + *(((ebx_44 - edx_6) << 2) + eax_16)
                    int32_t eax_27
                    ...
                    int32_t var_f4
                    int32_t var_e8
                    int32_t eax_32 = eax_31 - *((neg.d(var_f4 +
                        *(((eax_27 + *(((eax_26 - eax_27) << 2) + var_d0) - var_f4) << 2) + var_e8)
                        - 0xff) << 2) + edx_2)
                    ...
                    int32_t ebx_62
                    ebx_62.b = *var_18
                    int32_t eax_34 = edx_6 + *(((ebx_62 - edx_6) << 2) + eax_16)
                    int32_t eax_35
                    ...
                    int32_t var_f0
                    int32_t var_e4
                    result = eax_39 - *((neg.d(var_f0 +
                        *(((eax_35 + *(((eax_34 - eax_35) << 2) + var_d0) - var_f0) << 2) + var_e4)
                        - 0xff) << 2) + edx_2)
