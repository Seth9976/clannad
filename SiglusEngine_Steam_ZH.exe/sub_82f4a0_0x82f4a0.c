        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t var_ec
                    int32_t var_d0
                    int32_t ebx_37 = (*(((var_f8 +
                        *(((eax_14 + *(((eax_13 - eax_14) << 2) + var_d0) - var_f8) << 2) + var_ec))
                        << 2) + *((eax_18 << 2) + &data_4e3da80)) - eax_22) << 2
                    edi[2] = eax_22.b + (*(ebx_37 + edx_2)).b
                    int32_t ebx_39
                    ebx_39.b = var_124[1]
                    int32_t eax_25 = edx_6 + *(((ebx_39 - edx_6) << 2) + eax_11)
                    int32_t eax_26
                    ...
                    int32_t var_f4
                    int32_t var_e8
                    int32_t ebx_56 = (*(((var_f4 +
                        *(((eax_26 + *(((eax_25 - eax_26) << 2) + var_d0) - var_f4) << 2) + var_e8))
                        << 2) + *((eax_30 << 2) + &data_4e3da80)) - eax_34) << 2
                    edi[1] = eax_34.b + (*(ebx_56 + edx_2)).b
                    int32_t ebx_58
                    ebx_58.b = *var_124
                    int32_t eax_37 = edx_6 + *(((ebx_58 - edx_6) << 2) + eax_11)
                    int32_t eax_38
