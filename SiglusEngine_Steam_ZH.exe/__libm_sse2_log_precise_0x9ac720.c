...
if ((arg1 & 0x7f80) == 0x1f80)
    ...
    if (eax_1.w == 0x7f)
        ...
        while (true)
            ...
            uint64_t xmm1_1[0x2] = data_b12420
            uint64_t xmm3_1[0x2] = data_b12480
            double xmm4_1[0x2] = data_b12430
            uint64_t xmm6_1[0x2] = data_b12440
            uint64_t xmm0_2[0x2] = _mm_or_pd(_mm_and_pd(xmm0, xmm1_1), xmm3_1)
            eax_3 = _mm_extract_epi16(_mm_add_pd(xmm4_1, xmm0_2), 0) & 0x7f0
            double xmm4_3[0x2] = *(eax_3 + 0xb12500)
            xmm7_1 = (*(eax_3 + 0xb12910)).q
            ...
            if (_mm_extract_epi16(xmm1_10, 0) u> 0)
                ...
                return sub_75a7f9(&var_8, &var_8, &var_10, 2)
            ...
            if ((ecx_1 & 0xfff) != 0)
                ...
                if ((ecx_1 & 0xfff) - 1 u> 0x7fe)
                    ...
                    xmm1_10 = data_b12420
                    uint64_t xmm2_3[0x2] = data_b12480
        ...
        double xmm2_1[0x2] = data_b124e0
        double xmm1_3[0x2] = _mm_mul_pd(data_b124d0, xmm0_5)
        double xmm3_3 = _mm_mul_pd(xmm0_5, xmm0_5)
        double xmm1_4[0x2] = _mm_add_pd(xmm1_3, xmm2_1)
        double xmm2_2[0x2] = data_b124f0
        double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, data_b12450)
        uint64_t xmm4_5[0x2] = _mm_and_pd(xmm0_4, *(edx_1 + 0xb12460))
