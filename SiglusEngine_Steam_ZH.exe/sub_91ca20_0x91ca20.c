...
do
    ...
    int32_t var_e8
    int32_t var_dc
    int32_t eax_25 = eax_24 + var_f4 + *(((var_dc
        + *(((edx_5 + *(((ebx_18 - edx_5) << 2) + eax_9) - var_dc) << 2) + var_d4) - var_f4) << 2)
        + var_e8)
    ...
    int32_t var_e4
    int32_t var_d8
    result = eax_32 + var_f0 + *(((var_d8
        + *(((edx_5 + *(((ebx_31 - edx_5) << 2) + eax_9) - var_d8) << 2) + var_d4) - var_f0) << 2)
        + var_e4)
