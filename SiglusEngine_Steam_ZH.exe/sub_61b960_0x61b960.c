...
int32_t* eax_3 = data_bac450
char var_139_1

if (*eax_3 == 0xdd)
    var_139_1 = 1

if (*eax_3 != 0xdd || eax_3[6] == 0)
    var_139_1 = 0
...
if (result == 0)
    ...
    if (ebx_1 != 0xfffffffe && result == 0)
        ...
        int32_t eax_4
        eax_4.b = var_139_1 != 0
        int32_t var_140 = eax_4 + 1
        
        if (eax_4 != 0xfffffffe)
            result = sub_6120a0(eax_4 + 1)
        
        if (eax_4 != 0xfffffffe && result == 0)
            result = false
            ...
            if (result == 0)
                ...
                if (ebx_1 != 0xfffffffe && result == 0)
                    ...
                    if (result == 0)
                        ...
                        int32_t eax_7 = var_140
                        
                        if (eax_7 != 0xffffffff)
                            result = sub_612160(eax_7)
                        
                        if (eax_7 != 0xffffffff && result == 0)
                            result = false
                        else
                            int32_t var_138
                            sub_6efae0(&var_138)
                            ...
                            var_168 = &var_138
                            int32_t ecx_16 = sub_61bc00(arg1, var_168, arg2)
                            int32_t var_164_11 = ecx_16
                            var_168 = &var_140
                            ...
                            void var_174
                            char eax_8 = sub_6f01c0(&var_138, 0, ecx_18, 0, var_174)
                            ...
                            label_61bbbf:
                                ...
                                int32_t var_150_1 = 0
                                int32_t var_14c_1 = *(eax_9 + 8)
                                int32_t var_148_1 = *(eax_9 + 0xc)
