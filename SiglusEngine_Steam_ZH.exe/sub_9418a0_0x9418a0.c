        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                int32_t eax_15 = eax_14 - *((neg.d(var_f8
                    + *(((eax_10 + *(((ebx_16 - eax_10) << 2) + var_d0) - var_f8) << 2) + var_ec)
                    - 0xff) << 2) + edx_2)
                ...
                ebx_30.b = var_18[1]
                int32_t eax_16
                eax_16.b = not.b(ebx_30.b)
                int32_t eax_20
                eax_20.b = edi[1]
                int32_t var_f4
                int32_t var_e8
                int32_t eax_21 = eax_20 - *((neg.d(var_f4
                    + *(((eax_16 + *(((ebx_30 - eax_16) << 2) + var_d0) - var_f4) << 2) + var_e8)
                    - 0xff) << 2) + edx_2)
                ...
                ebx_44.b = *var_18
                int32_t eax_22
                eax_22.b = not.b(ebx_44.b)
                int32_t eax_26
                eax_26.b = *edi
                int32_t var_f0
                int32_t var_e4
                result = eax_26 - *((neg.d(var_f0
                    + *(((eax_22 + *(((ebx_44 - eax_22) << 2) + var_d0) - var_f0) << 2) + var_e4)
                    - 0xff) << 2) + edx_2)
