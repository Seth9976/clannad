            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_27 = (*(((var_e0 + *(((eax_3
                            + *(((ebx_14 - eax_3) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2)
                            + *((eax_7 << 2) + &data_4e3da80)) - eax_11) << 2
                        edi[2] = eax_11.b + (*(ebx_27 + edx_2)).b
                        int32_t ebx_29
                        ebx_29.b = esi_1[1]
                        int32_t eax_13
                        ...
                        eax_21.b = edi[1]
                        int32_t var_dc
                        int32_t ebx_42 = (*(((var_dc + *(((eax_13
                            + *(((ebx_29 - eax_13) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                            + *((eax_17 << 2) + &data_4e3da80)) - eax_21) << 2
                        edi[1] = eax_21.b + (*(ebx_42 + edx_2)).b
                        int32_t ebx_44
                        ebx_44.b = *esi_1
                        int32_t eax_23
                        eax_23.b = not.b(ebx_44.b)
                        int32_t eax_27
                        eax_27.b = *edi
                        int32_t eax_31
                        eax_31.b = *edi
                        int32_t var_d8
                        int32_t ebx_57 = (*(((var_d8 + *(((eax_23
                            + *(((ebx_44 - eax_23) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + *((eax_27 << 2) + &data_4e3da80)) - eax_31) << 2
                        *edi = eax_31.b + (*(ebx_57 + edx_2)).b
