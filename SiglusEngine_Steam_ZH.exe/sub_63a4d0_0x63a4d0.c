...
struct C_cfg_wnd_solo::Ccfg_wnd_solo_volume_bgmfade::VTable** result = arg1
struct C_cfg_wnd_solo::Ccfg_wnd_solo_volume_bgmfade::VTable** result_1 = result
sub_575830(arg1)
result[0x2e].b = 0
int32_t var_8_1 = 0
*result = &Ccfg_wnd_solo_volume_bgmfade::`vftable'{for `C_cfg_wnd_solo'}
result[0x30] = 0
result[0x31] = 0
*(result + 0xcd) = 0
*(result + 0xcf) = 0
