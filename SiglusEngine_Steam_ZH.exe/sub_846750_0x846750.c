        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_41 = ((var_f4 + *(((var_dc
                        + *(((edx_6 + *(((ebx_26 - edx_6) << 2) + eax_6) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - eax_21) << 2) + edx_2
                    edi[1] = eax_21.b + (*ebx_41).b
                    int32_t ebx_42
                    ebx_42.b = *esi_1
                    int32_t eax_29
                    eax_29.b = *edi
                    ...
                    int32_t ebx_57 = ((var_f0 + *(((var_d8
                        + *(((edx_6 + *(((ebx_42 - edx_6) << 2) + eax_6) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - eax_29) << 2) + edx_2
                    *edi = eax_29.b + (*ebx_57).b
