...
if (0x2762762 - edx_9 u>= eax_8)
    int32_t eax_11 = eax_8 + edx_9
    
    if (eax_11 u< esi_4 + 1)
        eax_11 = esi_4 + 1
    
    return sub_70c870(arg1, eax_11)

struct NT3::C_d3d_effect_global_val::VTable** eax_9 = nullptr

if (0 u< esi_4 + 1)
    eax_9 = esi_4 + 1

return sub_70c870(arg1, eax_9)
