                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                if (ecx_8 != 0)
                                    ...
                                    int32_t var_e0
                                    int32_t var_d4
                                    int32_t eax_18 = var_f8 + *(((var_e0 + *(((edx_10
                                        + *(((ebx_24 - edx_10) << 2) + eax_12) - var_e0) << 2)
                                    ...
                                    int32_t var_e8
                                    int32_t var_dc
                                    int32_t eax_24 = var_f4 + *(((var_dc + *(((edx_10
                                        + *(((ebx_37 - edx_10) << 2) + eax_12) - var_dc) << 2)
                                    ...
                                    int32_t var_e4
                                    int32_t var_d8
                                    int32_t eax_30 = var_f0 + *(((var_d8 + *(((edx_10
                                        + *(((ebx_50 - edx_10) << 2) + eax_12) - var_d8) << 2)
