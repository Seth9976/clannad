            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_ec
                        int32_t var_d0
                        edi[2] = eax_17.b + (*(((var_f8 + *(((eax_13
                            + *(((eax_12 - eax_13) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_17)
                            << 2) + edx_2)).b
                        int32_t ebx_33
                        ebx_33.b = esi_2[1]
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        edi[1] = eax_25.b + (*(((var_f4 + *(((eax_21
                            + *(((eax_20 - eax_21) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_25)
                            << 2) + edx_2)).b
                        int32_t ebx_49
                        ebx_49.b = *esi_2
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        *edi = eax_33.b + (*(((var_f0 + *(((eax_29
                            + *(((eax_28 - eax_29) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_33)
                            << 2) + edx_2)).b
