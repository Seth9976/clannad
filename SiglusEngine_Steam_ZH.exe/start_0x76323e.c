...
if ((0x7ffff & xmm0) - 0x3fb00 u< 0x3bb)
    ...
    double xmm1_2 = *((((xmm0 & 0xfffc) - 0xfb00) << 1) + &data_ad12d0)
    ...
    double xmm4_2[0x2] = __subpd_xmmpd_mempd(
        _mm_xor_pd(*((((xmm0 & 0xfffc) - 0xfb00) << 2) + &data_ad03d0), 
...
if ((0x7ffff & xmm0) - 0x3febb u< 0x41)
    ...
    double xmm7_8 = xmm3_8.q f* *((edx_6 << 2) + &data_ad12d0)
    double xmm6_6 = xmm7_5 * xmm2_6 - xmm7_8 + xmm1_6 * xmm2_6
    double xmm4_8 = (xmm3_6 - xmm2_6 * xmm2_6 - xmm0_10) / (xmm7_8 + xmm7_8 + xmm6_6)
    double xmm3_13[0x2] = __addpd_xmmpd_mempd(__andpd_xmmxuq_memxuq(xmm3_11, data_ad1ae0), 
        *((edx_6 << 3) + &data_ad03d0))
...
if ((0x7ffff & xmm0) - 0x3c300 u< 0x3800)
    ...
    double xmm6_9[0x2] = data_ad1b50
    double xmm1_11[0x2] = _mm_unpacklo_pd(xmm1, xmm0_18)
    double xmm2_8[0x2] = data_ad1b60
    double xmm4_10[0x2] = data_ad1b70
    double xmm0_19[0x2] = _mm_mul_pd(xmm0_18, xmm0_18)
    uint32_t xmm5_9[0x4] = data_ad1ad0
...
double xmm7_12 = __andpd_xmmxuq_memxuq(xmm7, data_ad1b90)
double xmm1_16[0x2] = data_ad1b50
double xmm2_10[0x2] = data_ad1b60
uint32_t xmm4_12[0x4] = 0.5 - xmm7_12 * 0.5
double xmm3_17[0x2] = data_ad1b70
...
uint64_t xmm0_26[0x2] = __andpd_xmmxuq_memxuq(_mm_shuffle_epi32(xmm0_24, 0x44), data_ad1ae0)
