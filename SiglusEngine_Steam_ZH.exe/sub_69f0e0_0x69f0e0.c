...
int32_t (* var_c)(void* arg1) = sub_9c9990
TEB* fsbase
...
label_69f1dc:
    ...
    int32_t var_34_4 = edi[4]
    
    if (sub_536340(&esi_1[4], &esi_1[4], esi_1[8], eax_10) s>= 0)
        *arg2 = esi_1
        arg2[1].b = 0
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
    
    int32_t var_34_5 = arg3
    ecx_3 = arg1
    eax_7 = &var_1c
    var_38_3 = edi
    var_3c_3 = ebx
...
*arg2 = *sub_69f230(ecx_3, eax_7, var_40_3, var_3c_3, var_38_3)
arg2[1].b = 1
fsbase->NtTib.ExceptionList = ExceptionList
return arg2
