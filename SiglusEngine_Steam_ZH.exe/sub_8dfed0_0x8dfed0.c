            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    if (ebx_7 != 0)
                        ...
                        int32_t var_f8
                        int32_t var_ec
                        int32_t eax_11 = var_f8 +
                            *(((edx_6 + *(((ebx_15 - edx_6) << 2) + eax_7) - var_f8) << 2) + var_ec)
                        int32_t var_88
                        ...
                        int32_t eax_14
                        eax_14.b = edi[2]
                        edi[2] = eax_14.b + (*(((ebx_32 - eax_14) << 2) + edx_2)).b
                        int32_t ebx_41
                        ebx_41.b = var_3c[1]
                        int32_t var_f4
                        int32_t var_e8
                        int32_t eax_19 = var_f4 +
                            *(((edx_6 + *(((ebx_41 - edx_6) << 2) + eax_7) - var_f4) << 2) + var_e8)
                        int32_t var_84
                        ...
                        int32_t eax_22
                        eax_22.b = edi[1]
                        edi[1] = eax_22.b + (*(((ebx_58 - eax_22) << 2) + edx_2)).b
                        int32_t ebx_67
                        ebx_67.b = *var_3c
                        int32_t var_f0
                        int32_t var_e4
                        int32_t eax_27 = var_f0 +
                            *(((edx_6 + *(((ebx_67 - edx_6) << 2) + eax_7) - var_f0) << 2) + var_e4)
                        int32_t var_80
                        ...
                        if (eax_27 + var_80 s< 0)
                            ...
                            ebx_79.b = *edi
                            ebx_84 =
                                *(((ebx_79 - 0xff) << 2) + *((ebx_76 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_30
                        eax_30.b = *edi
                        *edi = eax_30.b + (*(((ebx_84 - eax_30) << 2) + edx_2)).b
