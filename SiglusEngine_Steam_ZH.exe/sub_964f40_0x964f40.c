        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    eax_16.b = edi[2]
                    int32_t var_d0
                    edi[2] = eax_16.b + (*(((*(((eax_10 + *(((ebx_22 - eax_10) << 2) + var_d0))
                        << 2) + *((eax_12 << 2) + &data_4e3da80)) - eax_16) << 2) + edx_2)).b
                    int32_t ebx_33
                    ebx_33.b = var_18[1]
                    int32_t eax_18
                    eax_18.b = not.b(ebx_33.b)
                    int32_t eax_20
                    eax_20.b = edi[1]
                    int32_t eax_24
                    eax_24.b = edi[1]
                    edi[1] = eax_24.b + (*(((*(((eax_18 + *(((ebx_33 - eax_18) << 2) + var_d0))
                        << 2) + *((eax_20 << 2) + &data_4e3da80)) - eax_24) << 2) + edx_2)).b
                    int32_t ebx_44
                    ebx_44.b = *var_18
                    int32_t eax_26
                    eax_26.b = not.b(ebx_44.b)
                    int32_t eax_28
                    eax_28.b = *edi
                    int32_t eax_32
                    eax_32.b = *edi
                    result = eax_32 + *(((*(((eax_26 + *(((ebx_44 - eax_26) << 2) + var_d0)) << 2)
