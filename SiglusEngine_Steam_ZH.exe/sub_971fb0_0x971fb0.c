            ...
            if (result_2 != 0)
                ...
                if (ecx_6 != 0)
                    ...
                    int32_t eax_25 = var_f8 + *(((var_e0 +
                        *(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec)
                    int32_t ebx_34
                    ebx_34.b = var_18[1]
                    int32_t eax_27 = edx_10 + *(((ebx_34 - edx_10) << 2) + eax_17)
                    int32_t eax_28
                    eax_28.b = not.b(eax_27.b)
                    int32_t var_f4
                    int32_t var_e8
                    int32_t var_dc
                    int32_t eax_33 = var_f4 + *(((var_dc +
                        *(((eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)
                    int32_t ebx_51
                    ebx_51.b = *var_18
                    int32_t eax_35 = edx_10 + *(((ebx_51 - edx_10) << 2) + eax_17)
                    int32_t eax_36
