                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        if (ecx_8 != 0)
                            ...
                            int32_t var_f8
                            int32_t var_ec
                            int32_t eax_7 = var_f8 + *(((ebx_11 - var_f8) << 2) + var_ec)
                            int32_t ebx_16
                            ebx_16.b = var_3c[1]
                            int32_t var_f4
                            int32_t var_e8
                            int32_t eax_9 = var_f4 + *(((ebx_16 - var_f4) << 2) + var_e8)
                            int32_t ebx_21
                            ebx_21.b = *var_3c
                            int32_t var_f0
                            int32_t var_e4
                            int32_t eax_11 = var_f0 + *(((ebx_21 - var_f0) << 2) + var_e4)
                            ...
                            if (ebx_9 != 0xff)
                                ...
                                if (ebx_31 != 0)
                                    int32_t eax_15 = *((ebx_9 << 2) + &data_4d6e180)
                                    *((eax_9 << 2) + eax_15)
                                    *((eax_11 << 2) + eax_15)
                                    int32_t eax_16
                                    eax_16.b = edi[2]
