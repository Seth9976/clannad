...
if (esi_1 s>= NO_ERROR)
    ...
    if (eax_7 != 0)
        ...
        if (esi_1 s>= NO_ERROR)
            esi_1 = sub_699ab0(&var_a6c, u"Module_Raw", &var_a38)
            
            if (esi_1 s>= NO_ERROR)
                PWSTR eax_22 = zx.d(arg2)
                enum WIN32_ERROR eax_8
                
                if (arg3 == 0)
                    eax_8 = sub_699b50(&filename, eax_22, u"REGISTRY", 0)
                else
                    eax_8 = sub_699b50(&filename, eax_22, u"REGISTRY", 1)
