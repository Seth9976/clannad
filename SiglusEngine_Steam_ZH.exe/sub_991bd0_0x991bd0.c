...
do
    ...
    int32_t var_d4
    int32_t var_d0
    *(edi + 2) = eax_16.b + (*(((var_e0
        + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_16) << 2)
        + var_118)).b
    int32_t ebx_21
    ebx_21.b = esi_3[1]
    ...
    eax_24.b = *(edi + 1)
    int32_t var_dc
    *(edi + 1) = eax_24.b + (*(((var_dc
        + *(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_24) << 2)
        + var_118)).b
    int32_t ebx_37
    ebx_37.b = *esi_3
    ...
    eax_32.b = *edi
    int32_t var_d8
    result = eax_32.b + (*(((var_d8
        + *(((eax_28 + *(((eax_27 - eax_28) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_32) << 2)
        + var_118)).b
    *edi = result
    esi_4 = esi_1 + 4
    i = i_1
