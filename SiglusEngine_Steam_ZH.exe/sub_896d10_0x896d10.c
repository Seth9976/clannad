            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_ec
                        int32_t var_d0
                        int32_t ebx_35 = (*(((var_f8 + *(((eax_12
                            + *(((eax_11 - eax_12) << 2) + var_d0) - var_f8) << 2) + var_ec)) << 2)
                            + *((eax_16 << 2) + &data_4e3da80)) - eax_20) << 2
                        edi[2] = eax_20.b + (*(ebx_35 + edx_2)).b
                        int32_t ebx_37
                        ebx_37.b = esi_1[1]
                        int32_t eax_23 = edx_6 + *(((ebx_37 - edx_6) << 2) + eax_9)
                        int32_t eax_24
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        int32_t ebx_54 = (*(((var_f4 + *(((eax_24
                            + *(((eax_23 - eax_24) << 2) + var_d0) - var_f4) << 2) + var_e8)) << 2)
                            + *((eax_28 << 2) + &data_4e3da80)) - eax_32) << 2
                        edi[1] = eax_32.b + (*(ebx_54 + edx_2)).b
                        int32_t ebx_56
                        ebx_56.b = *esi_1
                        int32_t eax_35 = edx_6 + *(((ebx_56 - edx_6) << 2) + eax_9)
                        int32_t eax_36
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        int32_t ebx_73 = (*(((var_f0 + *(((eax_36
                            + *(((eax_35 - eax_36) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2)
                            + *((eax_40 << 2) + &data_4e3da80)) - eax_44) << 2
                        *edi = eax_44.b + (*(ebx_73 + edx_2)).b
