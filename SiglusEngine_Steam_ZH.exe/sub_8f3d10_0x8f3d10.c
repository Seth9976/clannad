        ...
        do
            ...
            if (edi s>= var_50)
                ...
                if (ebx_1 != 0)
                    ...
                    int32_t eax_20
                    eax_20.b = edi[2]
                    edi[2] = eax_20.b + (*(((*ebx_27 - eax_20) << 2) + edx_2)).b
                    int32_t ebx_32
                    ebx_32.b = var_3c[1]
                    int32_t eax_23 = edx_6 + *(((ebx_32 - edx_6) << 2) + eax_7)
                    int32_t eax_24
                    ...
                    int32_t ebx_55
                    ebx_55.b = *var_3c
                    int32_t eax_37 = edx_6 + *(((ebx_55 - edx_6) << 2) + eax_7)
                    int32_t eax_38
                    ...
                    int32_t eax_48
                    eax_48.b = *edi
                    *edi = eax_48.b + (*(((*ebx_73 - eax_48) << 2) + edx_2)).b
