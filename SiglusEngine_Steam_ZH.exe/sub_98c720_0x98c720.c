                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                eax_15.b = edi[2]
                                int32_t var_d0
                                edi[2] = eax_15.b + (*(((eax_13
                                    + *(((eax_12 - eax_13) << 2) + var_d0) - eax_15) << 2) + edx_2)).b
                                int32_t ebx_38
                                ebx_38.b = edi[1]
                                ...
                                int32_t eax_21
                                eax_21.b = edi[1]
                                edi[1] = eax_21.b + (*(((eax_19
                                    + *(((eax_18 - eax_19) << 2) + var_d0) - eax_21) << 2) + edx_2)).b
                                int32_t ebx_50
                                ebx_50.b = *edi
                                ...
                                int32_t eax_27
                                eax_27.b = *edi
                                *edi = eax_27.b + (*(((eax_25 + *(((eax_24 - eax_25) << 2) + var_d0)
                                    - eax_27) << 2) + edx_2)).b
