...
if (eax_3 u< edi_1)
    ...
    do
        ...
        edx_2.w = *eax_3
        edx_2.w u>>= 0xb
        *esi = fconvert.s(float.t(zx.d(edx_2.w)) * x87_r7_1)
        int32_t edx_4
        edx_4.w = *eax_3
        esi = &esi[4]
        esi[-3] = fconvert.s(float.t(edx_4 u>> 5 & 0x3f) * fconvert.t(0.0158730168f))
        int32_t edx_7
        edx_7.b = *eax_3
        eax_3 = &eax_3[1]
        esi[-2] = fconvert.s(float.t(edx_7 & 0x1f) * x87_r7_1)
