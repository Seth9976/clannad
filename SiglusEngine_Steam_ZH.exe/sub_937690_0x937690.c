...
do
    ...
    eax_16.b = edi[2]
    int32_t var_118
    int32_t eax_17 = eax_16 - *(ebx_20 + var_118)
    ...
    int32_t ebx_38 = neg.d(var_f4 + *(((var_dc
        + *(((edx_5 + *(((ebx_23 - edx_5) << 2) + eax_9) - var_dc) << 2) + var_d4) - var_f4) << 2)
        + var_e8) - 0xff) << 2
    int32_t eax_24
    eax_24.b = edi[1]
    int32_t eax_25 = eax_24 - *(ebx_38 + var_118)
    ...
    int32_t ebx_56 = neg.d(var_f0 + *(((var_d8
        + *(((edx_5 + *(((ebx_41 - edx_5) << 2) + eax_9) - var_d8) << 2) + var_d4) - var_f0) << 2)
        + var_e4) - 0xff) << 2
    int32_t eax_32
    eax_32.b = *edi
    result = eax_32 - *(ebx_56 + var_118)
