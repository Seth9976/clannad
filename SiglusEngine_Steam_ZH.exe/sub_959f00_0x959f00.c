...
do
    ...
    if (ebx_1 != 0)
        ...
        *(edi + 2) = eax_19.b + (*(ebx_26 + edx_2)).b
        int32_t ebx_28
        ebx_28.b = var_18[1]
        int32_t eax_22 = edx_6 + *(((ebx_28 - edx_6) << 2) + eax_8)
        int32_t eax_23
        ...
        *(edi + 1) = eax_31.b + (*(ebx_45 + edx_2)).b
        int32_t ebx_47
        ebx_47.b = *var_18
        int32_t eax_34 = edx_6 + *(((ebx_47 - edx_6) << 2) + eax_8)
        int32_t eax_35
        ...
        int32_t var_f0
        int32_t var_e4
        int32_t ebx_64 = (*(((var_f0
            + *(((eax_35 + *(((eax_34 - eax_35) << 2) + var_d0) - var_f0) << 2) + var_e4)) << 2)
            + *((eax_39 << 2) + &data_4e3da80)) - eax_43) << 2
        result = eax_43 + *(ebx_64 + edx_2)
        *edi = result.b
