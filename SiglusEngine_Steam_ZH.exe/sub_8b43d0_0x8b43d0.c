            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_48 = ((var_f4 + *(((var_dc + *(((edx_6
                            + *(((ebx_33 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - eax_25) << 2) + edx_2
                        edi[1] = eax_25.b + (*ebx_48).b
                        int32_t ebx_49
                        ebx_49.b = *var_3c
                        int32_t eax_33
                        eax_33.b = *edi
                        ...
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_64 = ((var_f0 + *(((var_d8 + *(((edx_6
                            + *(((ebx_49 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - eax_33) << 2) + edx_2
                        *edi = eax_33.b + (*ebx_64).b
