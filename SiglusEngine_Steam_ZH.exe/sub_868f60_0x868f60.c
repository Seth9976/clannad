                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t eax_15 = eax_14
                                - *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0)) << 2) + edx_2)
                            ...
                            int32_t ebx_33
                            ebx_33.b = esi_1[1]
                            int32_t eax_17 = edx_6 + *(((ebx_33 - edx_6) << 2) + eax_9)
                            int32_t eax_18
                            eax_18.b = not.b(eax_17.b)
                            int32_t eax_20
                            eax_20.b = edi[1]
                            int32_t eax_21 = eax_20
                                - *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0)) << 2) + edx_2)
                            ...
                            int32_t ebx_45
                            ebx_45.b = *esi_1
                            int32_t eax_23 = edx_6 + *(((ebx_45 - edx_6) << 2) + eax_9)
                            int32_t eax_24
                            eax_24.b = not.b(eax_23.b)
                            int32_t eax_26
                            eax_26.b = *edi
                            int32_t eax_27 = eax_26
                                - *(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0)) << 2) + edx_2)
