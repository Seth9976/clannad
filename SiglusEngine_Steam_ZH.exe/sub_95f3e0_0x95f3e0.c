        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_f8
                    int32_t var_ec
                    int32_t ebx_39 = (*(((var_f8 +
                        *(((edx_6 + *(((ebx_26 - edx_6) << 2) + eax_16) - var_f8) << 2) + var_ec)) << 2)
                        + *((eax_21 << 2) + &data_4e3da80)) - eax_25) << 2
                    edi[2] = eax_25.b + (*(ebx_39 + edx_2)).b
                    int32_t ebx_41
                    ebx_41.b = var_18[1]
                    int32_t eax_31
                    eax_31.b = edi[1]
                    ...
                    int32_t var_f4
                    int32_t var_e8
                    int32_t ebx_54 = (*(((var_f4 +
                        *(((edx_6 + *(((ebx_41 - edx_6) << 2) + eax_16) - var_f4) << 2) + var_e8)) << 2)
                        + *((eax_31 << 2) + &data_4e3da80)) - eax_35) << 2
                    edi[1] = eax_35.b + (*(ebx_54 + edx_2)).b
                    int32_t ebx_56
                    ebx_56.b = *var_18
                    int32_t eax_41
                    eax_41.b = *edi
                    ...
                    int32_t var_f0
                    int32_t var_e4
                    int32_t ebx_69 = (*(((var_f0 +
                        *(((edx_6 + *(((ebx_56 - edx_6) << 2) + eax_16) - var_f0) << 2) + var_e4)) << 2)
                        + *((eax_41 << 2) + &data_4e3da80)) - eax_45) << 2
                    result = eax_45 + *(ebx_69 + edx_2)
                    *edi = result.b
