                ...
                if (ebx_2 != 0)
                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t ebx_32 = neg.d(var_f8 + *(((var_e0 + *(((eax_3
                                + *(((ebx_17 - eax_3) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec) - 0xff) << 2
                            int32_t eax_9
                            eax_9.b = edi[2]
                            int32_t eax_10 = eax_9 - *(ebx_32 + edx_2)
                            ...
                            int32_t var_e8
                            int32_t var_dc
                            int32_t ebx_50 = neg.d(var_f4 + *(((var_dc + *(((eax_11
                                + *(((ebx_35 - eax_11) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8) - 0xff) << 2
                            int32_t eax_17
                            eax_17.b = edi[1]
                            int32_t eax_18 = eax_17 - *(ebx_50 + edx_2)
                            ...
                            int32_t var_e4
                            int32_t var_d8
                            int32_t ebx_68 = neg.d(var_f0 + *(((var_d8 + *(((eax_19
                                + *(((ebx_53 - eax_19) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4) - 0xff) << 2
                            int32_t eax_25
                            eax_25.b = *edi
                            int32_t eax_26 = eax_25 - *(ebx_68 + edx_2)
