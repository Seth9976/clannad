                    ...
                    if (eax_2 != 0)
                        ...
                        if (ebx_13 != 0)
                            ...
                            if (eax_17 + var_88 s< 0)
                                ...
                                int32_t ebx_41
                                ebx_41.b = edi[2]
                                ebx_46 = *(((ebx_41 - 0xff) << 2) + *((ebx_38 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_20
                            eax_20.b = edi[2]
                            edi[2] = eax_20.b + (*(((ebx_46 - eax_20) << 2) + edx_2)).b
                            int32_t ebx_55
                            ebx_55.b = esi_1[1]
                            int32_t eax_23 = edx_6 + *(((ebx_55 - edx_6) << 2) + eax_9)
                            int32_t eax_24
                            ...
                            int32_t eax_29 = var_f4 + *(((var_dc + *(((eax_24
                                + *(((eax_23 - eax_24) << 2) + var_d0) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)
                            int32_t var_84
                            int32_t ebx_72 = eax_29 + var_84
                            int32_t ebx_80
                            ...
                            if (eax_29 + var_84 s< 0)
                                ...
                                int32_t ebx_75
                                ebx_75.b = edi[1]
                                ebx_80 = *(((ebx_75 - 0xff) << 2) + *((ebx_72 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_32
                            eax_32.b = edi[1]
                            edi[1] = eax_32.b + (*(((ebx_80 - eax_32) << 2) + edx_2)).b
                            int32_t ebx_89
                            ebx_89.b = *esi_1
                            int32_t eax_35 = edx_6 + *(((ebx_89 - edx_6) << 2) + eax_9)
                            int32_t eax_36
                            ...
                            int32_t eax_41 = var_f0 + *(((var_d8 + *(((eax_36
                                + *(((eax_35 - eax_36) << 2) + var_d0) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)
                            int32_t var_80
                            int32_t ebx_106 = eax_41 + var_80
                            int32_t ebx_114
                            
                            if (eax_41 + var_80 s< 0)
                                if (ebx_106 s< 0xffffff01)
                                    ebx_106 = 0xffffff01
                                
                                int32_t ebx_117
                                ebx_117.b = *edi
                                ebx_114 = *((ebx_117 << 2) + *((ebx_106 << 2) + data_4ced578))
                            else
                                if (ebx_106 s> 0xff)
                                    ebx_106 = 0xff
                                ...
                                ebx_109.b = *edi
                                ebx_114 =
                                    *(((ebx_109 - 0xff) << 2) + *((ebx_106 << 2) + data_4ced578))
                                    + 0xff
                            
                            int32_t eax_44
                            eax_44.b = *edi
                            *edi = eax_44.b + (*(((ebx_114 - eax_44) << 2) + edx_2)).b
