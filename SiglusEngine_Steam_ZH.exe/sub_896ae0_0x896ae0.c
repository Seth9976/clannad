            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t eax_16
                        eax_16.b = edi[2]
                        edi[2] = eax_16.b + (*(((*(((edx_6 + *(((ebx_18 - edx_6) << 2) + eax_9))
                        ...
                        int32_t eax_24
                        eax_24.b = edi[1]
                        edi[1] = eax_24.b + (*(((*(((edx_6 + *(((ebx_29 - edx_6) << 2) + eax_9))
                        ...
                        int32_t eax_32
                        eax_32.b = *edi
                        *edi = eax_32.b + (*(((*(((edx_6 + *(((ebx_40 - edx_6) << 2) + eax_9)) << 2)
                            + *((eax_28 << 2) + &data_4e3da80)) - eax_32) << 2) + edx_2)).b
