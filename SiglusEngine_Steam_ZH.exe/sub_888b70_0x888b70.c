            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_15 = var_e0 + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0)
                            - var_e0) << 2) + var_d4)
                        int32_t var_88
                        int32_t ebx_31 = eax_15 + var_88
                        int32_t ebx_39
                        ...
                        int32_t eax_18
                        eax_18.b = edi[2]
                        edi[2] = eax_18.b + (*(((ebx_39 - eax_18) << 2) + edx_2)).b
                        int32_t ebx_48
                        ebx_48.b = esi_1[1]
                        int32_t eax_21 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_9)
                        int32_t eax_22
                        eax_22.b = not.b(eax_21.b)
                        int32_t var_dc
                        int32_t eax_25 = var_dc + *(((eax_22 + *(((eax_21 - eax_22) << 2) + var_d0)
                            - var_dc) << 2) + var_d4)
                        int32_t var_84
                        int32_t ebx_61 = eax_25 + var_84
                        int32_t ebx_69
                        ...
                        int32_t eax_28
                        eax_28.b = edi[1]
                        edi[1] = eax_28.b + (*(((ebx_69 - eax_28) << 2) + edx_2)).b
                        int32_t ebx_78
                        ebx_78.b = *esi_1
                        int32_t eax_31 = edx_6 + *(((ebx_78 - edx_6) << 2) + eax_9)
                        int32_t eax_32
                        ...
                        if (eax_35 + var_80 s< 0)
                            ...
                            ebx_94.b = *edi
                            ebx_99 =
                                *(((ebx_94 - 0xff) << 2) + *((ebx_91 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_38
                        eax_38.b = *edi
                        *edi = eax_38.b + (*(((ebx_99 - eax_38) << 2) + edx_2)).b
