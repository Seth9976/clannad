...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t eax_26
            eax_26.b = edi[2]
            int32_t eax_27 = eax_26 - *(ebx_32 + edx_2)
            ...
            int32_t ebx_50 = neg.d(var_f4 + *(((var_dc
                + *(((edx_6 + *(((ebx_35 - edx_6) << 2) + eax_19) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8) - 0xff) << 2
            int32_t eax_34
            eax_34.b = edi[1]
            int32_t eax_35 = eax_34 - *(ebx_50 + edx_2)
            ...
            int32_t ebx_68 = neg.d(var_f0 + *(((var_d8
                + *(((edx_6 + *(((ebx_53 - edx_6) << 2) + eax_19) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4) - 0xff) << 2
            int32_t eax_42
            eax_42.b = *edi
            result = eax_42 - *(ebx_68 + edx_2)
