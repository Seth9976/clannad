        ...
        if (ebx_1 != 0)
            ...
            if (ebx_7 != 0)
                ...
                *(edi + 2) = eax_16.b + (*(((*(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0)) << 2)
                    + *((eax_12 << 2) + &data_4e3da80)) - eax_16) << 2) + edx_1)).b
                int32_t ebx_30
                ebx_30.b = var_124[1]
                int32_t eax_19 = edx_5 + *(((ebx_30 - edx_5) << 2) + eax_7)
                int32_t eax_20
                ...
                *(edi + 1) = eax_26.b + (*(((*(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0))
                    << 2) + *((eax_22 << 2) + &data_4e3da80)) - eax_26) << 2) + edx_1)).b
                int32_t ebx_45
                ebx_45.b = *var_124
                ...
                *edi = eax_36.b + (*(((*(((eax_30 + *(((eax_29 - eax_30) << 2) + var_d0)) << 2)
                    + *((eax_32 << 2) + &data_4e3da80)) - eax_36) << 2) + edx_1)).b
