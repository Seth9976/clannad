                    ...
                    if (ebx_8 != 0)
                        ...
                        if (ecx_7 != 0)
                            ...
                            int32_t eax_5 = var_f8 + *(((var_e0
                                + *(((ebx_10 - var_e0) << 2) + var_d4) - var_f8) << 2) + var_ec)
                            int32_t ebx_19
                            ebx_19.b = esi_1[1]
                            int32_t var_f4
                            int32_t var_e8
                            int32_t var_dc
                            int32_t eax_9 = var_f4 + *(((var_dc
                                + *(((ebx_19 - var_dc) << 2) + var_d4) - var_f4) << 2) + var_e8)
                            int32_t ebx_28
                            ebx_28.b = *esi_1
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t eax_13 = var_f0 + *(((var_d8
                                + *(((ebx_28 - var_d8) << 2) + var_d4) - var_f0) << 2) + var_e4)
