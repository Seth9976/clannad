            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_33 = (*(((var_e0 + *
                            (((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0) - var_e0) << 2) + var_d4))
                            << 2) + *((eax_13 << 2) + &data_4e3da80)) - eax_17) << 2
                        edi[2] = eax_17.b + (*(ebx_33 + edx_2)).b
                        int32_t ebx_35
                        ebx_35.b = esi_1[1]
                        int32_t eax_20 = edx_6 + *(((ebx_35 - edx_6) << 2) + eax_6)
                        int32_t eax_21
                        ...
                        eax_29.b = edi[1]
                        int32_t var_dc
                        int32_t ebx_52 = (*(((var_dc + *(((eax_21
                            + *(((eax_20 - eax_21) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                            + *((eax_25 << 2) + &data_4e3da80)) - eax_29) << 2
                        edi[1] = eax_29.b + (*(ebx_52 + edx_2)).b
                        int32_t ebx_54
                        ebx_54.b = *esi_1
                        int32_t eax_32 = edx_6 + *(((ebx_54 - edx_6) << 2) + eax_6)
                        int32_t eax_33
                        ...
                        eax_41.b = *edi
                        int32_t var_d8
                        int32_t ebx_71 = (*(((var_d8 + *(((eax_33
                            + *(((eax_32 - eax_33) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + *((eax_37 << 2) + &data_4e3da80)) - eax_41) << 2
                        *edi = eax_41.b + (*(ebx_71 + edx_2)).b
