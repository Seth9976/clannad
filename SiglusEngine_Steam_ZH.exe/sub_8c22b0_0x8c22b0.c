            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t eax_18 = eax_17 + *(((var_e0 + *(((eax_13
                        ...
                        int32_t ebx_33
                        ebx_33.b = var_3c[1]
                        int32_t eax_20 = edx_6 + *(((ebx_33 - edx_6) << 2) + eax_10)
                        int32_t eax_21
                        eax_21.b = not.b(eax_20.b)
                        int32_t eax_25
                        eax_25.b = edi[1]
                        int32_t var_dc
                        int32_t eax_26 = eax_25 + *(((var_dc + *(((eax_21
                        ...
                        int32_t ebx_49
                        ebx_49.b = *var_3c
                        int32_t eax_28 = edx_6 + *(((ebx_49 - edx_6) << 2) + eax_10)
                        int32_t eax_29
                        eax_29.b = not.b(eax_28.b)
                        int32_t eax_33
                        eax_33.b = *edi
                        int32_t var_d8
                        int32_t eax_34 = eax_33 + *(((var_d8 + *(((eax_29
                            + *(((eax_28 - eax_29) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + edx_2)
