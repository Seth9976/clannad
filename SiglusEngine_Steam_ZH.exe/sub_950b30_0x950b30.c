    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                int32_t ebx_50
                ebx_50.b = var_18[1]
                int32_t eax_28 = edx_6 + *(((ebx_50 - edx_6) << 2) + eax_16)
                int32_t eax_29
                eax_29.b = not.b(eax_28.b)
                int32_t var_f4
                int32_t var_e8
                int32_t eax_32 = var_f4
                    + *(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0) - var_f4) << 2) + var_e8)
                int32_t var_84
                ...
                int32_t ebx_80
                ebx_80.b = *var_18
                int32_t eax_38 = edx_6 + *(((ebx_80 - edx_6) << 2) + eax_16)
                int32_t eax_39
                eax_39.b = not.b(eax_38.b)
                int32_t var_f0
                int32_t var_e4
                int32_t eax_42 = var_f0
                    + *(((eax_39 + *(((eax_38 - eax_39) << 2) + var_d0) - var_f0) << 2) + var_e4)
                int32_t var_80
