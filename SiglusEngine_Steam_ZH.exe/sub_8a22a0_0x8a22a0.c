                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        if (ecx_7 != 0)
                            ...
                            int32_t var_ec
                            int32_t var_d0
                            int32_t eax_5 = var_f8 + *(((eax_2 + *(((ebx_10 - eax_2) << 2) + var_d0)
                                - var_f8) << 2) + var_ec)
                            int32_t ebx_19
                            ebx_19.b = esi_1[1]
                            int32_t eax_6
                            ...
                            int32_t var_f4
                            int32_t var_e8
                            int32_t eax_9 = var_f4 + *(((eax_6 + *(((ebx_19 - eax_6) << 2) + var_d0)
                                - var_f4) << 2) + var_e8)
                            int32_t ebx_28
                            ebx_28.b = *esi_1
                            int32_t eax_10
                            ...
                            int32_t var_f0
                            int32_t var_e4
                            int32_t eax_13 = var_f0 + *(((eax_10
                                + *(((ebx_28 - eax_10) << 2) + var_d0) - var_f0) << 2) + var_e4)
                            ...
                            if (ebx_8 != 0xff)
                                ...
                                if (ebx_42 != 0)
                                    int32_t eax_17 = *((ebx_8 << 2) + &data_4d6e180)
                                    *((eax_9 << 2) + eax_17)
                                    *((eax_13 << 2) + eax_17)
                                    int32_t eax_18
                                    eax_18.b = edi[2]
