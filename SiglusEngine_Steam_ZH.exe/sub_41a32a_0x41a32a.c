...
while (ebx u< edi_3)
    ...
    if (ebx u< eax_3)
        do
            ...
            int32_t edx_6 = (eax_4 & 0x1c) + (ecx_3 & 0x1c) + (ecx_2 & 0x1c)
            uint32_t var_20_1 = ecx_3
            ecx_3.w &= 0xe3
            uint32_t ebx_7
            ebx_7.w = eax_4.w & 0xe3
            uint8_t edx_8 = ((edx_6 + (edi_4 & 0x1c) + 8) u>> 2).b
            eax_4.w &= 0xe3
            uint32_t ecx_4
            ecx_4.w = ecx_2.w & 0xe3
            uint32_t ecx_5
            ecx_5.w = edi_4.w & 0xe3
            edi_4.w &= 0xe3
            uint32_t ecx_8
            ecx_8.w = var_20_1.w & 0xe3
            uint32_t ecx_9
            ecx_9.w = ecx_2.w & 0xe3
            uint8_t* eax_9 = var_c_1
            var_c_1 = &var_c_1[1]
            *eax_9 = ((edx_8 ^ ((ebx_7 + ecx_3 + ecx_4 + ecx_5 + 0x42) u>> 2).b) & 0x1c)
                ^ ((eax_4 + ecx_8 + ecx_9 + edi_4 + 0x42) u>> 2).b
            ebx = &var_10_1[2]
            edx_2 = &var_14_1[2]
            var_10_1 = ebx
            var_14_1 = edx_2
