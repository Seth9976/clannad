    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                edi[2] = eax_25.b + (*ebx_39).b
                int32_t ebx_40
                ebx_40.b = var_18[1]
                int32_t eax_28 = edx_6 + *(((ebx_40 - edx_6) << 2) + eax_16)
                int32_t eax_29
                ...
                edi[1] = eax_35.b + (*ebx_59).b
                int32_t ebx_60
                ebx_60.b = *var_18
                int32_t eax_38 = edx_6 + *(((ebx_60 - edx_6) << 2) + eax_16)
                int32_t eax_39
