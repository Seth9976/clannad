...
do
    ...
    *(edi + 2) = (*ebx_23).b
    int32_t ebx_24
    ebx_24.b = var_18[1]
    int32_t eax_24 = edx_5 + *(((ebx_24 - edx_5) << 2) + eax_9)
    int32_t eax_25
    ...
    int32_t* ebx_42 = ((var_f4 + *(((var_dc
        + *(((eax_25 + *(((eax_24 - eax_25) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4) << 2)
        + var_e8)) << 2) + *((eax_31 << 2) + &data_4e3da80)
    *(edi + 1) = (*ebx_42).b
    int32_t ebx_43
    ebx_43.b = *var_18
    int32_t eax_37 = edx_5 + *(((ebx_43 - edx_5) << 2) + eax_9)
    int32_t eax_38
    ...
    int32_t* ebx_61 = ((var_f0 + *(((var_d8
        + *(((eax_38 + *(((eax_37 - eax_38) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0) << 2)
        + var_e4)) << 2) + *((eax_44 << 2) + &data_4e3da80)
    result = (*ebx_61).b
    *edi = result
    esi_4 = esi_1 + 4
    i = i_1
