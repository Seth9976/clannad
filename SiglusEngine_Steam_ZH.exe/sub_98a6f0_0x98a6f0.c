            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        edi[2] = eax_15.b + (*(((var_e0 + *(((edx_6
                            + *(((ebx_17 - edx_6) << 2) + eax_10) - var_e0) << 2) + var_d4) - eax_15)
                            << 2) + edx_2)).b
                        int32_t ebx_29
                        ebx_29.b = esi_2[1]
                        int32_t eax_21
                        eax_21.b = edi[1]
                        int32_t var_dc
                        edi[1] = eax_21.b + (*(((var_dc + *(((edx_6
                            + *(((ebx_29 - edx_6) << 2) + eax_10) - var_dc) << 2) + var_d4) - eax_21)
                            << 2) + edx_2)).b
                        int32_t ebx_41
                        ebx_41.b = *esi_2
                        int32_t eax_27
                        eax_27.b = *edi
                        int32_t var_d8
                        *edi = eax_27.b + (*(((var_d8 + *(((edx_6
                            + *(((ebx_41 - edx_6) << 2) + eax_10) - var_d8) << 2) + var_d4) - eax_27)
                            << 2) + edx_2)).b
