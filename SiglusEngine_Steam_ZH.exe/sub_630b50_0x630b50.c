...
int32_t (* var_c)(void* arg1) = sub_9c1160
TEB* fsbase
...
if (ecx_2 u> arg2)
    ...
    int32_t* esi_1 = esi + (arg2 - ecx_2) * 0xc
    eax_3 = sub_6331e0(esi_1, arg1[1])
    arg1[1] = esi_1
else if (ecx_2 u< arg2)
    sub_6310c0(arg1, arg2 - ecx_2)
    int32_t var_8_1 = 0
    ...
    sub_633150(arg1[1], arg2 - ((edx_6 u>> 0x1f) + edx_6))
