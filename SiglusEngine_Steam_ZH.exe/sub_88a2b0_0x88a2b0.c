            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        ebx_14.b = esi_1[2]
                        int32_t var_88
                        int32_t ebx_15 = ebx_14 + var_88
                        int32_t ebx_23
                        
                        if (ebx_14 + var_88 s< 0)
                            ...
                            ebx_18.b = edi[2]
                            ebx_23 =
                                *(((ebx_18 - 0xff) << 2) + *((ebx_15 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_5
                        eax_5.b = edi[2]
                        edi[2] = eax_5.b + (*(((ebx_23 - eax_5) << 2) + edx_2)).b
                        int32_t ebx_32
                        ebx_32.b = esi_1[1]
                        int32_t var_84
                        int32_t ebx_33 = ebx_32 + var_84
                        int32_t ebx_41
                        
                        if (ebx_32 + var_84 s< 0)
                        ...
                        int32_t eax_9
                        eax_9.b = edi[1]
                        edi[1] = eax_9.b + (*(((ebx_41 - eax_9) << 2) + edx_2)).b
                        int32_t ebx_50
                        ebx_50.b = *esi_1
                        int32_t var_80
                        int32_t ebx_51 = ebx_50 + var_80
                        int32_t ebx_59
                        
                        if (ebx_50 + var_80 s< 0)
                        ...
                        int32_t eax_13
                        eax_13.b = *edi
                        *edi = eax_13.b + (*(((ebx_59 - eax_13) << 2) + edx_2)).b
