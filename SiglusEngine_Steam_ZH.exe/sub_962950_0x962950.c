    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                eax_25.b = edi[2]
                int32_t var_d0
                edi[2] = eax_25.b + (*(((*(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0)) << 2)
                    + *((eax_21 << 2) + &data_4e3da80)) - eax_25) << 2) + edx_2)).b
                int32_t ebx_35
                ebx_35.b = var_18[1]
                int32_t eax_28 = edx_6 + *(((ebx_35 - edx_6) << 2) + eax_16)
                int32_t eax_29
                ...
                int32_t eax_35
                eax_35.b = edi[1]
                edi[1] = eax_35.b + (*(((*(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0)) << 2)
                    + *((eax_31 << 2) + &data_4e3da80)) - eax_35) << 2) + edx_2)).b
                int32_t ebx_50
                ebx_50.b = *var_18
                int32_t eax_38 = edx_6 + *(((ebx_50 - edx_6) << 2) + eax_16)
                int32_t eax_39
