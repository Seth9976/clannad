...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t eax_19
            eax_19.b = edi[2]
            int32_t eax_20 = eax_19 - *(ebx_28 + edx_2)
            ...
            int32_t ebx_46 = neg.d(var_f4 + *(((var_dc
                + *(((eax_21 + *(((ebx_31 - eax_21) << 2) + var_d0) - var_dc) << 2) + var_d4)
                - var_f4) << 2) + var_e8) - 0xff) << 2
            int32_t eax_27
            eax_27.b = edi[1]
            int32_t eax_28 = eax_27 - *(ebx_46 + edx_2)
            ...
            ebx_49.b = *var_18
            int32_t eax_29
            eax_29.b = not.b(ebx_49.b)
            int32_t var_f0
            int32_t var_e4
            int32_t var_d8
            int32_t ebx_64 = neg.d(var_f0 + *(((var_d8
                + *(((eax_29 + *(((ebx_49 - eax_29) << 2) + var_d0) - var_d8) << 2) + var_d4)
                - var_f0) << 2) + var_e4) - 0xff) << 2
            int32_t eax_35
            eax_35.b = *edi
            result = eax_35 - *(ebx_64 + edx_2)
