...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_d4
            int32_t eax_13 =
                var_e0 + *(((edx_10 + *(((ebx_6 - edx_10) << 2) + eax_9) - var_e0) << 2) + var_d4)
            int32_t ebx_15
            ebx_15.b = var_18[1]
            int32_t var_dc
            int32_t eax_17 =
                var_dc + *(((edx_10 + *(((ebx_15 - edx_10) << 2) + eax_9) - var_dc) << 2) + var_d4)
            int32_t ebx_24
            ebx_24.b = *var_18
            int32_t var_d8
            int32_t eax_21 =
                var_d8 + *(((edx_10 + *(((ebx_24 - edx_10) << 2) + eax_9) - var_d8) << 2) + var_d4)
            result = result_1
