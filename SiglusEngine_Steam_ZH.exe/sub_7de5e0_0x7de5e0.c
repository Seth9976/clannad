                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        if (ecx_6 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t eax_19 = var_e0 + *(((eax_16
                                + *(((eax_15 - eax_16) << 2) + var_d0) - var_e0) << 2) + var_d4)
                            int32_t ebx_37
                            ebx_37.b = esi_1[1]
                            int32_t eax_21 = edx_10 + *(((ebx_37 - edx_10) << 2) + eax_13)
                            int32_t eax_22
                            ...
                            int32_t ebx_50
                            ebx_50.b = *esi_1
                            int32_t eax_27 = edx_10 + *(((ebx_50 - edx_10) << 2) + eax_13)
                            int32_t eax_28
                            eax_28.b = not.b(eax_27.b)
                            int32_t var_d8
                            int32_t eax_31 = var_d8 + *(((eax_28
                                + *(((eax_27 - eax_28) << 2) + var_d0) - var_d8) << 2) + var_d4)
                            ...
                            if (ebx_18 != 0xff)
                                ...
                                if (ebx_68 != 0)
                                    int32_t eax_35 = *((ebx_18 << 2) + &data_4d6e180)
                                    *((eax_25 << 2) + eax_35)
                                    *((eax_31 << 2) + eax_35)
                                    int32_t eax_36
                                    eax_36.b = edi[2]
