        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t ebx_36
                    ebx_36.b = var_124[1]
                    int32_t eax_21 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_11)
                    int32_t eax_22
                    ...
                    int32_t ebx_52
                    ebx_52.b = *var_124
                    int32_t eax_29 = edx_6 + *(((ebx_52 - edx_6) << 2) + eax_11)
                    int32_t eax_30
