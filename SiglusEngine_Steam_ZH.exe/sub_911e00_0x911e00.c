...
do
    ...
    int32_t var_d0
    *(edi + 2) =
        (var_e0 + *(((eax_12 + *(((eax_11 - eax_12) << 2) + var_d0) - var_e0) << 2) + var_d4)).b
    int32_t ebx_17
    ebx_17.b = var_18[1]
    ...
    int32_t var_dc
    *(edi + 1) =
        (var_dc + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_dc) << 2) + var_d4)).b
    int32_t ebx_29
    ebx_29.b = *var_18
    ...
    int32_t var_d8
    result = var_d8 + *(((eax_24 + *(((eax_23 - eax_24) << 2) + var_d0) - var_d8) << 2) + var_d4)
    *edi = result.b
    esi_4 = esi_1 + 4
    i = i_1
    i_1 -= 1
