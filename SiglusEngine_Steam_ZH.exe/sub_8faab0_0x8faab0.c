            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_34 = (*(((var_e0 + *(((eax_13
                            + *(((eax_12 - eax_13) << 2) + var_d0) - var_e0) << 2) + var_d4)) << 2)
                            + *((eax_17 << 2) + &data_4e3da80)) - eax_21) << 2
                        edi[2] = eax_21.b + (*(ebx_34 + edx_2)).b
                        int32_t ebx_36
                        ebx_36.b = var_3c[1]
                        int32_t eax_24 = edx_6 + *(((ebx_36 - edx_6) << 2) + eax_10)
                        int32_t eax_25
                        ...
                        eax_33.b = edi[1]
                        int32_t var_dc
                        int32_t ebx_53 = (*(((var_dc + *(((eax_25
                            + *(((eax_24 - eax_25) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                            + *((eax_29 << 2) + &data_4e3da80)) - eax_33) << 2
                        edi[1] = eax_33.b + (*(ebx_53 + edx_2)).b
                        int32_t ebx_55
                        ebx_55.b = *var_3c
                        int32_t eax_36 = edx_6 + *(((ebx_55 - edx_6) << 2) + eax_10)
                        int32_t eax_37
                        ...
                        eax_45.b = *edi
                        int32_t var_d8
                        int32_t ebx_72 = (*(((var_d8 + *(((eax_37
                            + *(((eax_36 - eax_37) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
                            + *((eax_41 << 2) + &data_4e3da80)) - eax_45) << 2
                        *edi = eax_45.b + (*(ebx_72 + edx_2)).b
