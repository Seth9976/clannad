                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        if (ecx_6 != 0)
                            ...
                            int32_t var_d4
                            int32_t var_d0
                            int32_t eax_21 = var_f8 + *(((var_e0 + *(((eax_16
                                + *(((eax_15 - eax_16) << 2) + var_d0) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec)
                            int32_t ebx_41
                            ebx_41.b = esi_1[1]
                            int32_t eax_23 = edx_10 + *(((ebx_41 - edx_10) << 2) + eax_13)
                            int32_t eax_24
                            ...
                            int32_t ebx_58
                            ebx_58.b = *esi_1
                            int32_t eax_31 = edx_10 + *(((ebx_58 - edx_10) << 2) + eax_13)
                            int32_t eax_32
                            eax_32.b = not.b(eax_31.b)
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t eax_37 = var_f0 + *(((var_d8 + *(((eax_32
                            ...
                            if (ebx_18 != 0xff)
                                ...
                                if (ebx_80 != 0)
                                    int32_t eax_41 = *((ebx_18 << 2) + &data_4d6e180)
                                    *((eax_29 << 2) + eax_41)
                                    *((eax_37 << 2) + eax_41)
                                    int32_t eax_42
                                    eax_42.b = edi[2]
