    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                int32_t var_d0
                int32_t eax_22 =
                    eax_21 - *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0)) << 2) + edx_2)
                ...
                int32_t ebx_32
                ebx_32.b = var_18[1]
                int32_t eax_24 = edx_6 + *(((ebx_32 - edx_6) << 2) + eax_16)
                int32_t eax_25
                eax_25.b = not.b(eax_24.b)
                int32_t eax_27
                eax_27.b = edi[1]
                int32_t eax_28 =
                    eax_27 - *(((eax_25 + *(((eax_24 - eax_25) << 2) + var_d0)) << 2) + edx_2)
                ...
                int32_t ebx_44
                ebx_44.b = *var_18
                int32_t eax_30 = edx_6 + *(((ebx_44 - edx_6) << 2) + eax_16)
                int32_t eax_31
                eax_31.b = not.b(eax_30.b)
                int32_t eax_33
                eax_33.b = *edi
                result = eax_33 - *(((eax_31 + *(((eax_30 - eax_31) << 2) + var_d0)) << 2) + edx_2)
