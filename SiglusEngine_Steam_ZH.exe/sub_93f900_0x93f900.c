        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_d4
                    int32_t var_d0
                    int32_t ebx_45 = neg.d(var_f8 + *(((var_e0 +
                        *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec) - 0xff) << 2
                    int32_t eax_25
                    eax_25.b = edi[2]
                    int32_t eax_26 = eax_25 - *(ebx_45 + edx_2)
                    ...
                    int32_t ebx_48
                    ebx_48.b = var_18[1]
                    int32_t eax_28 = edx_6 + *(((ebx_48 - edx_6) << 2) + eax_16)
                    int32_t eax_29
                    eax_29.b = not.b(eax_28.b)
                    int32_t var_f4
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_67 = neg.d(var_f4 + *(((var_dc +
                        *(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - 0xff) << 2
                    int32_t eax_35
                    eax_35.b = edi[1]
                    int32_t eax_36 = eax_35 - *(ebx_67 + edx_2)
                    ...
                    int32_t ebx_70
                    ebx_70.b = *var_18
                    int32_t eax_38 = edx_6 + *(((ebx_70 - edx_6) << 2) + eax_16)
                    int32_t eax_39
                    eax_39.b = not.b(eax_38.b)
                    int32_t var_f0
                    int32_t var_e4
                    int32_t var_d8
                    int32_t ebx_89 = neg.d(var_f0 + *(((var_d8 +
                        *(((eax_39 + *(((eax_38 - eax_39) << 2) + var_d0) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - 0xff) << 2
                    int32_t eax_45
                    eax_45.b = *edi
                    result = eax_45 - *(ebx_89 + edx_2)
