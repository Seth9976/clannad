...
do
    ...
    if (result_1 != 0)
        ...
        if (ecx_5 != 0)
            ...
            int32_t var_d0
            int32_t eax_6 =
                var_e0 + *(((eax_3 + *(((ebx_2 - eax_3) << 2) + var_d0) - var_e0) << 2) + var_d4)
            int32_t ebx_11
            ebx_11.b = var_18[1]
            int32_t eax_7
            ...
            int32_t var_dc
            int32_t eax_10 =
                var_dc + *(((eax_7 + *(((ebx_11 - eax_7) << 2) + var_d0) - var_dc) << 2) + var_d4)
            int32_t ebx_20
            ebx_20.b = *var_18
            int32_t eax_11
            ...
            int32_t var_d8
            int32_t eax_14 =
                var_d8 + *(((eax_11 + *(((ebx_20 - eax_11) << 2) + var_d0) - var_d8) << 2) + var_d4)
            result = result_1
