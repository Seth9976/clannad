        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_ec
                    int32_t var_d0
                    int32_t ebx_43 = (*(((var_f8 +
                        *(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0) - var_f8) << 2) + var_ec))
                        << 2) + *((eax_23 << 2) + &data_4e3da80)) - eax_27) << 2
                    edi[2] = eax_27.b + (*(ebx_43 + edx_2)).b
                    int32_t ebx_45
                    ebx_45.b = var_18[1]
                    int32_t eax_30 = edx_6 + *(((ebx_45 - edx_6) << 2) + eax_16)
                    int32_t eax_31
                    ...
                    int32_t var_f4
                    int32_t var_e8
                    int32_t ebx_62 = (*(((var_f4 +
                        *(((eax_31 + *(((eax_30 - eax_31) << 2) + var_d0) - var_f4) << 2) + var_e8))
                        << 2) + *((eax_35 << 2) + &data_4e3da80)) - eax_39) << 2
                    edi[1] = eax_39.b + (*(ebx_62 + edx_2)).b
                    int32_t ebx_64
                    ebx_64.b = *var_18
                    int32_t eax_42 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_16)
                    int32_t eax_43
                    ...
                    int32_t var_f0
                    int32_t var_e4
                    int32_t ebx_81 = (*(((var_f0 +
                        *(((eax_43 + *(((eax_42 - eax_43) << 2) + var_d0) - var_f0) << 2) + var_e4))
                        << 2) + *((eax_47 << 2) + &data_4e3da80)) - eax_51) << 2
                    result = eax_51 + *(ebx_81 + edx_2)
                    *edi = result.b
