...
if (eax_3 u< edi_1)
    ...
    do
        int32_t ebx_3 = *eax_3 u>> 0x14 & 0x3ff
        long double x87_r6_1 = float.t(ebx_3)
        
        if (ebx_3 s< 0)
            x87_r6_1 = x87_r6_1 + fconvert.t(4.2949673e+09f)
        
        *esi = fconvert.s(x87_r6_1 * x87_r7_1)
        int32_t ebx_6 = *eax_3 u>> 0xa & 0x3ff
        long double x87_r6_3 = float.t(ebx_6)
        
        if (ebx_6 s< 0)
            x87_r6_3 = x87_r6_3 + fconvert.t(4.2949673e+09f)
        
        esi[1] = fconvert.s(x87_r6_3 * x87_r7_1)
        int32_t ebx_8 = *eax_3 & 0x3ff
