            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_17 = eax_16 - *((neg.d(var_e0 + *(((edx_6
                            + *(((ebx_26 - edx_6) << 2) + eax_11) - var_e0) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        eax_22.b = edi[1]
                        int32_t var_dc
                        int32_t eax_23 = eax_22 - *((neg.d(var_dc + *(((edx_6
                            + *(((ebx_40 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
                        ...
                        eax_28.b = *edi
                        int32_t var_d8
                        int32_t eax_29 = eax_28 - *((neg.d(var_d8 + *(((edx_6
                            + *(((ebx_54 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4) - 0xff)
                            << 2) + edx_2)
