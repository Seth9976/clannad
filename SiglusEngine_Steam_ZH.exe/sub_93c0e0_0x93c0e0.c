            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t eax_13 = eax_12 - *((
                        neg.d(var_f8 + *(((ebx_22 - var_f8) << 2) + var_ec) - 0xff) << 2) + edx_2)
                    ...
                    int32_t eax_17 = eax_16 - *((
                        neg.d(var_f4 + *(((ebx_32 - var_f4) << 2) + var_e8) - 0xff) << 2) + edx_2)
                    ...
                    int32_t var_f0
                    int32_t var_e4
                    result = eax_20 - *((neg.d(var_f0 + *(((ebx_42 - var_f0) << 2) + var_e4) - 0xff)
                        << 2) + edx_2)
