            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        int32_t ebx_35 = neg.d(var_f8 + *(((var_e0 +
                            *(((eax_9 + *(((eax_8 - eax_9) << 2) + var_d0) - var_e0) << 2) + var_d4)
                            - var_f8) << 2) + var_ec) - 0xff) << 2
                        int32_t eax_15
                        eax_15.b = edi[2]
                        int32_t eax_16 = eax_15 - *(ebx_35 + edx_2)
                        ...
                        int32_t ebx_38
                        ebx_38.b = esi_1[1]
                        int32_t eax_18 = edx_6 + *(((ebx_38 - edx_6) << 2) + eax_6)
                        int32_t eax_19
                        eax_19.b = not.b(eax_18.b)
                        int32_t var_f4
                        int32_t var_e8
                        int32_t var_dc
                        int32_t ebx_57 = neg.d(var_f4 + *(((var_dc + *(((eax_19
                            + *(((eax_18 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4) - var_f4)
                            << 2) + var_e8) - 0xff) << 2
                        int32_t eax_25
                        eax_25.b = edi[1]
                        int32_t eax_26 = eax_25 - *(ebx_57 + edx_2)
                        ...
                        int32_t ebx_60
                        ebx_60.b = *esi_1
                        int32_t eax_28 = edx_6 + *(((ebx_60 - edx_6) << 2) + eax_6)
                        int32_t eax_29
                        eax_29.b = not.b(eax_28.b)
                        int32_t var_f0
                        int32_t var_e4
                        int32_t var_d8
                        int32_t ebx_79 = neg.d(var_f0 + *(((var_d8 + *(((eax_29
                            + *(((eax_28 - eax_29) << 2) + var_d0) - var_d8) << 2) + var_d4) - var_f0)
                            << 2) + var_e4) - 0xff) << 2
                        int32_t eax_35
                        eax_35.b = *edi
                        int32_t eax_36 = eax_35 - *(ebx_79 + edx_2)
