    ...
    do
        ...
        if (ebx_1 != 0)
            ...
            if (ebx_7 != 0)
                ...
                int32_t var_d4
                int32_t var_d0
                int32_t ebx_34 = neg.d(var_f8 + *(((var_e0
                    + *(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - var_e0) << 2) + var_d4)
                    - var_f8) << 2) + var_ec) - 0xff) << 2
                int32_t eax_16
                eax_16.b = edi[2]
                int32_t eax_17 = eax_16 - *(ebx_34 + edx_1)
                ...
                int32_t ebx_37
                ebx_37.b = var_124[1]
                int32_t eax_19 = edx_5 + *(((ebx_37 - edx_5) << 2) + eax_7)
                int32_t eax_20
                eax_20.b = not.b(eax_19.b)
                int32_t var_f4
                int32_t var_e8
                int32_t var_dc
                int32_t ebx_56 = neg.d(var_f4 + *(((var_dc
                    + *(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8) - 0xff) << 2
                int32_t eax_26
                eax_26.b = edi[1]
                int32_t eax_27 = eax_26 - *(ebx_56 + edx_1)
                ...
                int32_t ebx_59
                ebx_59.b = *var_124
                int32_t eax_29 = edx_5 + *(((ebx_59 - edx_5) << 2) + eax_7)
                int32_t eax_30
                eax_30.b = not.b(eax_29.b)
                int32_t var_f0
                int32_t var_e4
                int32_t var_d8
                int32_t ebx_78 = neg.d(var_f0 + *(((var_d8
                    + *(((eax_30 + *(((eax_29 - eax_30) << 2) + var_d0) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4) - 0xff) << 2
                int32_t eax_36
                eax_36.b = *edi
                int32_t eax = eax_36 - *(ebx_78 + edx_1)
