            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_d4
                        int32_t var_d0
                        edi[2] = eax_18.b + (*(((var_e0 + *(((eax_14
                            + *(((eax_13 - eax_14) << 2) + var_d0) - var_e0) << 2) + var_d4) - eax_18)
                            << 2) + edx_2)).b
                        int32_t ebx_42
                        ebx_42.b = esi_1[1]
                        ...
                        eax_26.b = edi[1]
                        int32_t var_dc
                        edi[1] = eax_26.b + (*(((var_dc + *(((eax_22
                            + *(((eax_21 - eax_22) << 2) + var_d0) - var_dc) << 2) + var_d4) - eax_26)
                            << 2) + edx_2)).b
                        int32_t ebx_58
                        ebx_58.b = *esi_1
                        ...
                        eax_34.b = *edi
                        int32_t var_d8
                        *edi = eax_34.b + (*(((var_d8 + *(((eax_30
                            + *(((eax_29 - eax_30) << 2) + var_d0) - var_d8) << 2) + var_d4) - eax_34)
                            << 2) + edx_2)).b
