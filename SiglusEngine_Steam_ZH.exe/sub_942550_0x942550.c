...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_d4
            int32_t var_d0
            int32_t eax_18 = eax_17 - *((neg.d(var_e0
            ...
            int32_t eax_24 = eax_23 - *((neg.d(var_dc
                + *(((eax_19 + *(((ebx_27 - eax_19) << 2) + var_d0) - var_dc) << 2) + var_d4)
                - 0xff) << 2) + edx_2)
            ...
            eax_29.b = *edi
            int32_t var_d8
            result = eax_29 - *((neg.d(var_d8
                + *(((eax_25 + *(((ebx_41 - eax_25) << 2) + var_d0) - var_d8) << 2) + var_d4)
                - 0xff) << 2) + edx_2)
