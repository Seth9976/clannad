...
do
    ...
    if (result != 0)
        ...
        if (ebx_9 != 0)
            ...
            int32_t var_e0
            int32_t var_d4
            int32_t eax_25 = eax_24 - *((neg.d(var_e0
                + *(((edx_6 + *(((ebx_17 - edx_6) << 2) + eax_19) - var_e0) << 2) + var_d4) - 0xff)
                << 2) + edx_2)
            ...
            eax_30.b = edi[1]
            int32_t var_dc
            int32_t eax_31 = eax_30 - *((neg.d(var_dc
                + *(((edx_6 + *(((ebx_31 - edx_6) << 2) + eax_19) - var_dc) << 2) + var_d4) - 0xff)
                << 2) + edx_2)
            ...
            eax_36.b = *edi
            int32_t var_d8
            result = eax_36 - *((neg.d(var_d8
                + *(((edx_6 + *(((ebx_45 - edx_6) << 2) + eax_19) - var_d8) << 2) + var_d4) - 0xff)
                << 2) + edx_2)
