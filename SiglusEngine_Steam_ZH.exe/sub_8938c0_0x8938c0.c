            ...
            if (edi s>= var_50)
                ...
                if (ebx_2 != 0)
                    ...
                    if (ebx_8 != 0)
                        ...
                        eax_18.b = edi[1]
                        int32_t var_dc
                        int32_t ebx_40 = (*(((var_dc + *(((eax_10
                            + *(((ebx_27 - eax_10) << 2) + var_d0) - var_dc) << 2) + var_d4)) << 2)
                        ...
                        eax_28.b = *edi
                        int32_t var_d8
                        int32_t ebx_55 = (*(((var_d8 + *(((eax_20
                            + *(((ebx_42 - eax_20) << 2) + var_d0) - var_d8) << 2) + var_d4)) << 2)
