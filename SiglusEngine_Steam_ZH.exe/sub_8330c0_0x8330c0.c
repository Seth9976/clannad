        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    eax_11.b = edi[2]
                    int32_t var_d0
                    edi[2] = eax_11.b + (*(((*(((eax_5 + *(((ebx_16 - eax_5) << 2) + var_d0)) << 2)
                    ...
                    int32_t eax_19
                    eax_19.b = edi[1]
                    edi[1] = eax_19.b + (*(((*(((eax_13 + *(((ebx_27 - eax_13) << 2) + var_d0))
                        << 2) + *((eax_15 << 2) + &data_4e3da80)) - eax_19) << 2) + edx_2)).b
                    int32_t ebx_38
                    ebx_38.b = *var_124
                    int32_t eax_21
                    eax_21.b = not.b(ebx_38.b)
                    int32_t eax_23
                    eax_23.b = *edi
                    int32_t eax_27
                    eax_27.b = *edi
                    *edi = eax_27.b + (*(((*(((eax_21 + *(((ebx_38 - eax_21) << 2) + var_d0)) << 2)
