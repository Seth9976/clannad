            ...
            label_4129ad:
                ...
                if (*(arg1 + 0x264) u> 0)
                    ...
                    do
                        ...
                        for (int32_t j = 0; j u< 3; j += 1)
                            ...
                            if (edi_1.w == 0xffff)
                                *(ecx_25 + (j << 2)) = 0xffffffff
                            else
                                *(ecx_25 + (j << 2)) = zx.d(edi_1.w)
                ...
                if ((*(arg1 + 0x218) & 1) != 0)
                    ...
                    if (*(arg1 + 0x264) u> 0)
                        ...
                        do
                            int32_t eax_13 = *(edi_1 + 0x250) + arg2
                            int32_t ecx_27 = *(arg1 + 0x250) + var_10_2
                            
                            for (int32_t j_1 = 0; j_1 u< 3; j_1 += 1)
                                esi_7.w = *(ecx_27 + (j_1 << 1))
                                
                                if (esi_7.w == 0xffff)
                                    *(eax_13 + (j_1 << 2)) = 0xffffffff
                                else
                                    *(eax_13 + (j_1 << 2)) = zx.d(esi_7.w)
