...
int32_t (* var_10)(void* arg1) = sub_9b05b2
TEB* fsbase
...
*(arg1 + 0x78) = 5
*(arg1 + 0x7c) = 0
int32_t eax_5 = GetDlgItem(hDlg_6, 0x457)
*(arg1 + 0x20) = eax_5
...
*(arg1 + 0x108) = 7
*(arg1 + 0x10c) = 0
HWND eax_7 = GetDlgItem(hDlg, 0x4c7)
*(arg1 + 0xb0) = eax_7
...
*(arg1 + 0x198) = 8
*(arg1 + 0x19c) = 0
HWND eax_9 = GetDlgItem(hDlg_1, 0x4c5)
*(arg1 + 0x140) = eax_9
...
*(arg1 + 0x228) = 9
*(arg1 + 0x22c) = 0
HWND eax_11 = GetDlgItem(hDlg_2, 0x4c6)
*(arg1 + 0x1d0) = eax_11
...
*(arg1 + 0x2b8) = 8
*(arg1 + 0x2bc) = 0
HWND eax_12 = GetDlgItem(hDlg_3, 0x49f)
*(arg1 + 0x260) = eax_12
sub_6c0100(arg1 + 0x25c, eax_12)
hDlg_7 = arg1 + 0x25c
sub_530ba0(edi_4 + 0x64, &hDlg_7)
...
*(arg1 + 0x348) = 7
*(arg1 + 0x34c) = 0
HWND eax_14 = GetDlgItem(hDlg_4, 0x41a)
*(arg1 + 0x2f0) = eax_14
sub_6c0100(arg1 + 0x2ec, eax_14)
int32_t* ecx_28 = var_f8 + 0x64
hDlg_7 = arg1 + 0x2ec
sub_530ba0(ecx_28, &hDlg_7)
...
*(arg1 + 0x3d8) = 7
*(arg1 + 0x3dc) = 0
HWND eax_16 = GetDlgItem(hDlg_5, 0x418)
*(arg1 + 0x380) = eax_16
sub_6c0100(arg1 + 0x37c, eax_16)
int32_t* ecx_33 = var_f8 + 0x64
hDlg_7 = arg1 + 0x37c
sub_530ba0(ecx_33, &hDlg_7)
...
int32_t var_c_15 = 7
sub_6c4400(*(arg1 + 4), arg1 + 0x40c, 0x419, &var_f4, 7, 0)
...
int32_t var_c_17 = 8
sub_6c4400(*(arg1 + 4), arg1 + 0x49c, 0x3fe, &var_f4, 3, 0)
...
int32_t var_c_19 = 9
sub_6c4400(*(arg1 + 4), arg1 + 0x52c, 0x3fd, &var_34, 3, 0)
...
if (*(arg1 + 0x12) != 0)
    sub_6c2db0(arg1 + 0x52c, &data_b68f84)

HWND hWnd = *(arg1 + 0x260)

if (hWnd != 0)
    SendMessageW(hWnd, 0x406, 1, 0x80000)

int32_t result = sub_53ad80(arg1)
fsbase->NtTib.ExceptionList = ExceptionList
