                ...
                if (ebx_1 != 0)
                    ...
                    if (eax_3 != 0)
                        ...
                        if (ebx_12 != 0)
                            ...
                            eax_15.b = edi[2]
                            int32_t var_d0
                            edi[2] = eax_15.b + (*(((eax_13 + *(((eax_12 - eax_13) << 2) + var_d0)
                                - eax_15) << 2) + edx_2)).b
                            int32_t ebx_32
                            ebx_32.b = edi[1]
                            int32_t eax_18 = edx_6 + *(((ebx_32 - edx_6) << 2) + eax_10)
                            int32_t eax_19
                            eax_19.b = not.b(eax_18.b)
                            int32_t eax_21
                            eax_21.b = edi[1]
                            edi[1] = eax_21.b + (*(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0)
                                - eax_21) << 2) + edx_2)).b
                            int32_t ebx_44
                            ebx_44.b = *edi
                            int32_t eax_24 = edx_6 + *(((ebx_44 - edx_6) << 2) + eax_10)
                            int32_t eax_25
