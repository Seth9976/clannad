...
if (esi u>= 0xffffffff || arg3 u>= 0xffffffff)
    result = 0x8876086c
...
label_40ed1b:
        ...
        *(arg1 + 0x264) = esi
        ...
        if (result s>= 0)
            ...
            if (result s>= 0)
                ...
                if (var_50c u< *(arg1 + 0x240) || var_50c u<= 0xffff || var_510 u< *(arg1 + 0x268))
                    *(arg1 + 0x218) |= 0x40
                ...
                if (data_b95b00 == *(arg1 + 0x230))
                    ...
                    *(arg1 + 0x278) = data_b95b08
                    ...
                    int32_t* eax_49 = var_470
                    int32_t var_5c0
                    void var_454
                    result = (*(*eax_49 + 0x14))(eax_49, var_5c0, 0, &var_454)
                    ...
                    if (result s>= 0)
                        ...
                        if (var_2c != 0x1002 || var_28 u< 0x5144 || var_28 u> 0x5147)
                            ...
                            *(edi_20 + 4) = 0
                            ...
                            if ((*(*eax_51 + 0x1d8))(eax_51, 4, 0) s< 0)
                            label_40f00f:
                                var_480 = 1
                                var_47c = 0xc
                                var_478 = 7
                                ...
                                int32_t* eax_53 = *(arg1 + 0x230)
                                
                                if ((*(*eax_53 + 0x1d8))(eax_53, 4, &var_460) s< 0)
                                    goto label_40f00f
                                
                                int32_t* eax_55 = var_460
                                result = (*(*eax_55 + 0x18))(eax_55, 1)
                                ...
                                if (result s>= 0)
                                    ...
                                    while (not(cond:2_1))
                                        ...
                                        result = (*(*eax_57 + 0x1c))(eax_57, &var_484, 0x10, 1)
                                        cond:2_1 = result == 0
                                        
                                        if (result s< 0)
                                            break
                                
                                int32_t* eax_59 = var_460
                                (*(*eax_59 + 8))(eax_59)
        ...
        if ((*(arg1 + 0x218) & 2) != 0)
            eax_26 = sub_40c06a(arg1 + 0x244, arg3, *(arg1 + 0x23c), &var_494)
    ...
    result =
        (*(*eax_4 + 0x6c))(eax_4, esi * 0xc, *(arg1 + 0x224), 0x66, *(arg1 + 0x21c), &var_45c, 0)
    ...
    if (result s>= 0)
        ...
        if (result s>= 0)
            ...
            if (result s>= 0)
                int32_t ecx_4 = *(arg1 + 0x264) * 0xc
                int32_t esi_2
                int32_t edi_3
                edi_3, esi_2 = __builtin_memcpy(var_464, var_474, ecx_4 u>> 2 << 2)
                __builtin_memcpy(edi_3, esi_2, ecx_4 & 3)
                int32_t edx_5 = *(arg1 + 0x264)
                int32_t ecx_9 = (arg2 - edx_5) * 0xc
                __builtin_memset(__builtin_memset(var_464 + edx_5 * 0xc, 0, ecx_9 u>> 2 << 2), 0, 
                    ecx_9 & 3)
                ...
                if (result s>= 0)
                    ...
                    label_40ec53:
                        ...
                        *(arg1 + 0x268) = esi
                        ...
                        if (not(cond:1_1))
                            eax_21 = sub_40c181(arg1 + 0x250, esi, *(arg1 + 0x264), &var_48c)
...
if (var_464 != 0)
    int32_t* eax_66 = var_45c
    (*(*eax_66 + 0x30))(eax_66)

if (var_474 != 0)
    int32_t* eax_67 = *(arg1 + 0x248)
    (*(*eax_67 + 0x30))(eax_67)

if (var_468 != 0)
    int32_t* eax_68 = var_458
    (*(*eax_68 + 0x30))(eax_68)
