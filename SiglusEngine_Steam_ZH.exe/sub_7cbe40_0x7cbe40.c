    ...
    do
        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                int32_t var_e0
                int32_t var_d4
                int32_t ebx_30 = (*(((var_e0
                    + *(((edx_6 + *(((ebx_17 - edx_6) << 2) + eax_11) - var_e0) << 2) + var_d4)) << 2)
                    + *((eax_16 << 2) + &data_4e3da80)) - eax_20) << 2
                *(edi + 2) = eax_20.b + (*(ebx_30 + edx_2)).b
                int32_t ebx_32
                ebx_32.b = *(esi_1 + 1)
                int32_t eax_26
                eax_26.b = *(edi + 1)
                ...
                int32_t ebx_45 = (*(((var_dc
                    + *(((edx_6 + *(((ebx_32 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4)) << 2)
                ...
                *(edi + 1) = eax_30.b + (*(ebx_45 + edx_2)).b
                ...
                int32_t ebx_60 = (*(((var_d8
                    + *(((edx_6 + *(((ebx_47 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4)) << 2)
                    + *((eax_36 << 2) + &data_4e3da80)) - eax_40) << 2
                *edi = eax_40.b + (*(ebx_60 + edx_2)).b
