...
if (ebx s<= esi)
    ...
    do
        ...
        arg5 = sub_625d60(arg5, edi, &var_30, edx, edx, eax_5, 0, nullptr, 0)[4]
...
if (esi s> eax_3)
    ...
    sub_625d60(arg5, edi, &var_30, edx_3, edx_3, var_14, 0, nullptr, 0)
else
    int32_t var_4c_2 = 0
    int32_t var_48_2 = 0
    int32_t var_44_3 = arg5
    sub_625a20(arg5, edi, &var_30, arg2, 0, 0)
