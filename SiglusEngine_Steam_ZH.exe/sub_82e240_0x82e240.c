    ...
    do
        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                int32_t eax_22
                eax_22.b = *(edi + 2)
                *(edi + 2) = eax_22.b + (*(((*ebx_31 - eax_22) << 2) + edx_2)).b
                int32_t ebx_36
                ebx_36.b = var_124[1]
                int32_t eax_30
                eax_30.b = *(edi + 1)
                ...
                int32_t* ebx_50 = ((var_f4 + *(((var_dc
                    + *(((edx_6 + *(((ebx_36 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)) << 2) + *((eax_30 << 2) + &data_4e3da80)
                int32_t eax_34
                eax_34.b = *(edi + 1)
                *(edi + 1) = eax_34.b + (*(((*ebx_50 - eax_34) << 2) + edx_2)).b
                int32_t ebx_55
                ebx_55.b = *var_124
                int32_t eax_42
                eax_42.b = *edi
                ...
                int32_t* ebx_69 = ((var_f0 + *(((var_d8
                    + *(((edx_6 + *(((ebx_55 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4)
                    - var_f0) << 2) + var_e4)) << 2) + *((eax_42 << 2) + &data_4e3da80)
                int32_t eax_46
                eax_46.b = *edi
                *edi = eax_46.b + (*(((*ebx_69 - eax_46) << 2) + edx_2)).b
