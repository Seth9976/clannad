        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t ebx_42
                    ebx_42.b = esi_1[1]
                    int32_t eax_19 = edx_6 + *(((ebx_42 - edx_6) << 2) + eax_11)
                    int32_t var_84
                    int32_t ebx_47 = eax_19 + var_84
                    int32_t ebx_55
                    ...
                    if (eax_19 + var_84 s< 0)
                        ...
                        int32_t ebx_50
                        ebx_50.b = edi[1]
                        ebx_55 = *(((ebx_50 - 0xff) << 2) + *((ebx_47 << 2) + data_4ced578)) + 0xff
                    
                    int32_t eax_22
                    eax_22.b = edi[1]
                    edi[1] = eax_22.b + (*(((ebx_55 - eax_22) << 2) + edx_2)).b
                    int32_t ebx_64
                    ebx_64.b = *esi_1
                    int32_t eax_25 = edx_6 + *(((ebx_64 - edx_6) << 2) + eax_11)
                    int32_t var_80
                    int32_t ebx_69 = eax_25 + var_80
                    int32_t ebx_77
                    ...
                    int32_t eax_28
                    eax_28.b = *edi
                    *edi = eax_28.b + (*(((ebx_77 - eax_28) << 2) + edx_2)).b
