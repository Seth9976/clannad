...
do
    ...
    do
        ...
        *(edi + 2) = eax_14.b + (*(((var_f8
            + *(((eax_10 + *(((eax_9 - eax_10) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_14)
            << 2) + var_118)).b
        int32_t ebx_21
        ebx_21.b = *(esi_1 + 1)
        ...
        *(edi + 1) = eax_22.b + (*(((var_f4
            + *(((eax_18 + *(((eax_17 - eax_18) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_22)
            << 2) + var_118)).b
        int32_t ebx_37
        ebx_37.b = *esi_1
        ...
        int32_t var_f0
        int32_t var_e4
        result = eax_30.b + (*(((var_f0
            + *(((eax_26 + *(((eax_25 - eax_26) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_30)
            << 2) + var_118)).b
        *edi = result
        esi_1 += 4
        edi += 4
