            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t ebx_41
                        ebx_41.b = esi_1[1]
                        int32_t eax_23 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_11)
                        int32_t eax_24
                        ...
                        int32_t ebx_56
                        ebx_56.b = *esi_1
                        int32_t eax_33 = edx_6 + *(((ebx_56 - edx_6) << 2) + eax_11)
                        int32_t eax_34
                        ...
                        int32_t eax_40
                        eax_40.b = *edi
                        *edi = eax_40.b + (*(((*(((eax_34 + *(((eax_33 - eax_34) << 2) + var_d0))
                            << 2) + *((eax_36 << 2) + &data_4e3da80)) - eax_40) << 2) + edx_2)).b
