    ...
    do
        ...
        if (eax_4 != 0)
            ...
            if (ebx_9 != 0)
                ...
                int32_t var_d0
                *(edi + 2) = eax_16.b +
                    (*(((eax_14 + *(((eax_13 - eax_14) << 2) + var_d0) - eax_16) << 2) + edx_2)).b
                int32_t ebx_29
                ebx_29.b = *(esi_1 + 1)
                int32_t eax_19 = edx_6 + *(((ebx_29 - edx_6) << 2) + eax_11)
                int32_t eax_20
                eax_20.b = not.b(eax_19.b)
                int32_t eax_22
                eax_22.b = *(edi + 1)
                *(edi + 1) = eax_22.b +
                    (*(((eax_20 + *(((eax_19 - eax_20) << 2) + var_d0) - eax_22) << 2) + edx_2)).b
                int32_t ebx_41
                ebx_41.b = *esi_1
                int32_t eax_25 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_11)
                int32_t eax_26
                eax_26.b = not.b(eax_25.b)
                int32_t eax_28
                eax_28.b = *edi
                *edi = eax_28.b +
                    (*(((eax_26 + *(((eax_25 - eax_26) << 2) + var_d0) - eax_28) << 2) + edx_2)).b
