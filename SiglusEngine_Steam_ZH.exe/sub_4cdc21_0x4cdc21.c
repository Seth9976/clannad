...
void var_100
void var_60
int32_t result = sub_4c73cc(arg1, eax, 0xacc118, &var_60, &var_8, &var_100, &var_20, esi_1, 1)

if (result == 1)
    var_10 = 1
    result =
        sub_4c73cc(arg1, *(arg1 + 0x100), 0xacc178, &var_60, &var_8, &var_100, &var_20, esi_1, 1)
...
if (var_10 == 0)
    ecx_8 = ecx_7 | 0x74500000
else
    ecx_8 = ecx_7 | 0x74400000
