        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    int32_t var_e0
                    int32_t var_d4
                    int32_t* ebx_40 = ((var_f8 + *(((var_e0
                        + *(((edx_6 + *(((ebx_26 - edx_6) << 2) + eax_16) - var_e0) << 2) + var_d4)
                        - var_f8) << 2) + var_ec)) << 2) + *((eax_23 << 2) + &data_4e3da80)
                    int32_t eax_27
                    eax_27.b = edi[2]
                    edi[2] = eax_27.b + (*(((*ebx_40 - eax_27) << 2) + edx_2)).b
                    int32_t ebx_45
                    ebx_45.b = var_18[1]
                    int32_t eax_35
                    eax_35.b = edi[1]
                    ...
                    int32_t* ebx_59 = ((var_f4 + *(((var_dc
                        + *(((edx_6 + *(((ebx_45 - edx_6) << 2) + eax_16) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8)) << 2) + *((eax_35 << 2) + &data_4e3da80)
                    int32_t eax_39
                    eax_39.b = edi[1]
                    edi[1] = eax_39.b + (*(((*ebx_59 - eax_39) << 2) + edx_2)).b
                    int32_t ebx_64
                    ebx_64.b = *var_18
                    int32_t eax_47
                    eax_47.b = *edi
                    ...
                    int32_t var_e4
                    int32_t var_d8
                    int32_t* ebx_78 = ((var_f0 + *(((var_d8
                        + *(((edx_6 + *(((ebx_64 - edx_6) << 2) + eax_16) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4)) << 2) + *((eax_47 << 2) + &data_4e3da80)
                    int32_t eax_51
                    eax_51.b = *edi
                    result = eax_51 + *(((*ebx_78 - eax_51) << 2) + edx_2)
                    *edi = result.b
