        ...
        if (ebx_1 != 0)
            ...
            if (eax_4 != 0)
                ...
                if (ebx_12 != 0)
                    ...
                    int32_t eax_18
                    eax_18.b = edi[2]
                    int32_t eax_19 = eax_18 - *(ebx_35 + edx_2)
                    ...
                    int32_t var_e8
                    int32_t var_dc
                    int32_t ebx_53 = neg.d(var_f4 + *(((var_dc
                        + *(((edx_6 + *(((ebx_38 - edx_6) << 2) + eax_11) - var_dc) << 2) + var_d4)
                        - var_f4) << 2) + var_e8) - 0xff) << 2
                    int32_t eax_26
                    eax_26.b = edi[1]
                    int32_t eax_27 = eax_26 - *(ebx_53 + edx_2)
                    ...
                    int32_t var_e4
                    int32_t var_d8
                    int32_t ebx_71 = neg.d(var_f0 + *(((var_d8
                        + *(((edx_6 + *(((ebx_56 - edx_6) << 2) + eax_11) - var_d8) << 2) + var_d4)
                        - var_f0) << 2) + var_e4) - 0xff) << 2
                    int32_t eax_34
                    eax_34.b = *edi
                    int32_t eax_35 = eax_34 - *(ebx_71 + edx_2)
