    ...
    if (ebx_2 != 0)
        ...
        if (result != 0)
            ...
            if (ebx_12 != 0)
                ...
                int32_t eax_27
                eax_27.b = edi[2]
                edi[2] = eax_27.b + (*(((*ebx_34 - eax_27) << 2) + edx_2)).b
                int32_t ebx_39
                ebx_39.b = var_18[1]
                int32_t eax_35
                eax_35.b = edi[1]
                ...
                int32_t* ebx_53 = ((var_f4 + *(((var_dc
                    + *(((edx_6 + *(((ebx_39 - edx_6) << 2) + eax_16) - var_dc) << 2) + var_d4)
                    - var_f4) << 2) + var_e8)) << 2) + *((eax_35 << 2) + &data_4e3da80)
                int32_t eax_39
                eax_39.b = edi[1]
                edi[1] = eax_39.b + (*(((*ebx_53 - eax_39) << 2) + edx_2)).b
                int32_t ebx_58
                ebx_58.b = *var_18
                int32_t eax_47
                eax_47.b = *edi
                ...
                int32_t eax_51
                eax_51.b = *edi
                result = eax_51 + *(((*ebx_72 - eax_51) << 2) + edx_2)
                *edi = result.b
