...
if (arg1 != 0xfffffffe)
    ...
    if (arg1 s>= 0 && arg1 u< data_4ecd224)
        ...
        ebx_3 = (arg1 & 0x1f) << 6
        var_10_1 = ecx_2
        edx_1 = (&data_b95720)[ecx_2]
        eax.b = *(edx_1 + ebx_3 + 4)
    
    if (arg1 s< 0 || arg1 u>= data_4ecd224 || (eax.b & 1) == 0)
        *___doserrno() = 0
        *__errno() = 9
        ...
        if (arg2 != 0)
            ...
            label_758daa:
                int32_t edx_4 = (&data_b95720)[ecx_2]
                ...
                if ((*(edx_4 + ebx_3 + 4) & 0x48) != 0)
                    ...
                    if (edx_4.b != 0xa && nNumberOfBytesToRead != 0)
                        *eax_16 = edx_4.b
                        ...
                        lpBuffer = &eax_16[1]
                        *((&data_b95720)[var_10_1] + ebx_3 + 5) = 0xa
                        
                        if (arg3:3.b != 0)
                            int32_t eax_18
                            eax_18.b = *((&data_b95720)[var_10_1] + ebx_3 + 0x25)
                            ...
                            if (eax_18.b != 0xa && nNumberOfBytesToRead != 0)
                                ...
                                lpBuffer = &eax_16[2]
                                edi = 2
                                *((&data_b95720)[var_10_1] + ebx_3 + 0x25) = 0xa
                                
                                if (arg3:3.b == 1)
                                    int32_t eax_20
                                    eax_20.b = *((&data_b95720)[var_10_1] + ebx_3 + 0x26)
                                    ...
                                    if (eax_20.b != 0xa && nNumberOfBytesToRead != 0)
                                        ...
                                        edi = 3
                                        lpBuffer = &eax_16[3]
                                        *((&data_b95720)[var_10_1] + ebx_3 + 0x26) = 0xa
                
                int32_t eax_23 = var_10_1
                
                if (sub_75bfb2(arg1) == 0)
                    goto label_758edc
                
                HANDLE* ecx_8 = (&data_b95720)[eax_23]
                ...
                if (mode_1 == 0 || arg3:3.b != 2)
                    eax_23 = var_10_1
                label_758edc:
                    eax_28 = ReadFile((&data_b95720)[eax_23][(arg1 & 0x1f) * 0x10], lpBuffer, 
                    ...
                    if (eax_27 != ERROR_ACCESS_DENIED)
                        ...
                        *___doserrno() = 5
                        ebx_4 = 0xffffffff
                        lpMultiByteStr_3 = lpMultiByteStr
                else if (ReadConsoleW((&data_b95720)[var_10_1][(arg1 & 0x1f) * 0x10], lpBuffer, 
                ...
                label_758efd:
                    ...
                    edi += ecx_10
                    int32_t esi_1 = (&data_b95720)[edx_8]
                            ...
                            *(esi_1 + ebx_3 + 4) = eax_28.b
                            ...
                            if (lpMultiByteStr u< mode_2)
                                ...
                                do
                                    ...
                                    if (eax_68 == 0x1a)
                                        int32_t ecx_25 = (&data_b95720)[edx_8]
                                    ...
                                    if (eax_68 != 0xd)
                                        *lpMultiByteStr_6 = eax_68
                                        ...
                                        eax_63, ecx_22 = ReadFile(
                                            (&data_b95720)[edx_8][(arg1 & 0x1f) * 0x10], &buffer, 
                                            2, &var_18, nullptr)
                                        ...
                                        label_7592cd:
                                            edx_8 = var_10_1
                                            int32_t eax_65 = (&data_b95720)[edx_8]
                                            int32_t var_3c_9
                                            ...
                                            if ((*(eax_65 + ebx_3 + 4) & 0x48) == 0)
                                                ...
                                                *lpMultiByteStr_6 = 0xd
                                                lpMultiByteStr_6 = &lpMultiByteStr_6[2]
                                                *((&data_b95720)[edx_8] + ebx_3 + 5) = buffer.b
                                                *((&data_b95720)[edx_8] + ebx_3 + 0x25) = buffer:1.b
                                                *((&data_b95720)[edx_8] + ebx_3 + 0x26) = 0xa
                                                var_3c_9 = 0xd
                                            else
                                                *lpMultiByteStr_6 = 0xa
                                                lpMultiByteStr_6 = &lpMultiByteStr_6[2]
                            ...
                            if (lpMultiByteStr_5 u< edx_12)
                                ...
                                do
                                    ...
                                    if (eax_54 == 0x1a)
                                        int32_t eax_58 = (&data_b95720)[var_10_1]
                                        *(eax_58 + ebx_3 + 4) |= 2
                                        break
                        ...
                        *(esi_1 + ebx_3 + 4) = eax_28.b
                        ...
                        if (lpMultiByteStr u< ecx_12)
                            ...
                            do
                                ...
                                if (eax_30.b == 0x1a)
                                    int32_t ecx_15 = (&data_b95720)[edx_8]
                                ...
                                if (eax_30.b != 0xd)
                                    *lpMultiByteStr_4 = eax_30.b
                                    ...
                                    eax_30, ecx_13 = ReadFile(
                                        (&data_b95720)[edx_8][(arg1 & 0x1f) * 0x10], &buffer_1, 1, 
                                        &var_18, nullptr)
                                        ...
                                        if ((eax_30[ebx_3 + 4] & 0x48) == 0)
                                            ...
                                            if (buffer_1 != 0xa)
                                                *lpMultiByteStr_4 = 0xd
                                                lpMultiByteStr_4 = &lpMultiByteStr_4[1]
                                                eax_30.b = buffer_1
                                                *((&data_b95720)[edx_8] + ebx_3 + 5) = eax_30.b
                                            else
                                                *lpMultiByteStr_4 = 0xa
                                                lpMultiByteStr_4 = &lpMultiByteStr_4[1]
                        ...
                        if (arg3:3.b != 1 || edi == 0)
                            ...
                            if (lpMultiByteStr_3.b s< 0)
                                ...
                                if (*(zx.d(lpMultiByteStr_3.b) + 0xb4cee0) == 0)
                                    while (i s<= 4)
                                        ...
                                        if (*(zx.d(*esi_2) + 0xb4cee0) != 0)
                                            break
                                
                                int32_t eax_37 = sx.d(*(zx.d(*esi_2) + 0xb4cee0))
                                
                                if (eax_37 != 0)
                                    if (eax_37 + 1 != i)
                                        int32_t ecx_16 = (&data_b95720)[var_10_1]
                                        ...
                                        if ((*(ecx_16 + ebx_3 + 4) & 0x48) == 0)
                                            ...
                                            *(ecx_16 + ebx_3 + 5) = eax_40.b
                                            ...
                                            if (i s>= 2)
                                                int32_t ecx_17 = (&data_b95720)[eax_41]
                                                eax_41.b = *esi_3
                                                esi_3 += 1
                                            ...
                                            if (i == 3)
                                                int32_t ecx_18 = (&data_b95720)[eax_41]
                                                eax_41.b = *esi_3
                                                esi_3 += 1
                            ...
                            label_759134:
                                ...
                                edi *= 2
                                *((&data_b95720)[var_10_1] + ebx_3 + 0x30) = ecx_19
                                lpMultiByteStr_3 = lpMultiByteStr
                                ebx_4 = var_1c
                else
                label_758ea2:
            ...
            int32_t edx_2
            lpMultiByteStr_2, edx_2 = sub_74cd17(nNumberOfBytesToRead)
            ...
            if (lpMultiByteStr_2 != 0)
                ...
                int32_t ecx_5 = (&data_b95720)[var_10_1]
