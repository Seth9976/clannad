                    ...
                    if (ebx_7 != 0)
                        ...
                        if (eax_3 != 0)
                            ...
                            if (ebx_18 != 0)
                                ...
                                eax_22.b = edi[1]
                                int32_t var_dc
                                int32_t ebx_50 = (*(((var_dc + *(((eax_14
                                    + *(((ebx_37 - eax_14) << 2) + var_d0) - var_dc) << 2) + var_d4))
                                ...
                                eax_32.b = *edi
                                int32_t var_d8
                                int32_t ebx_65 = (*(((var_d8 + *(((eax_24
                                    + *(((ebx_52 - eax_24) << 2) + var_d0) - var_d8) << 2) + var_d4))
