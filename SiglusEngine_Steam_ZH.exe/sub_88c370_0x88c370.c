            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t var_d0
                        int32_t eax_4 = eax_3 + *(((ebx_14 - eax_3) << 2) + var_d0)
                        int32_t var_88
                        int32_t ebx_19 = eax_4 + var_88
                        int32_t ebx_27
                        ...
                        if (eax_4 + var_88 s< 0)
                            ...
                            ebx_22.b = edi[2]
                            ebx_27 =
                                *(((ebx_22 - 0xff) << 2) + *((ebx_19 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_7
                        eax_7.b = edi[2]
                        edi[2] = eax_7.b + (*(((ebx_27 - eax_7) << 2) + edx_2)).b
                        int32_t ebx_36
                        ebx_36.b = esi_1[1]
                        int32_t eax_9
                        eax_9.b = not.b(ebx_36.b)
                        int32_t eax_10 = eax_9 + *(((ebx_36 - eax_9) << 2) + var_d0)
                        int32_t var_84
                        int32_t ebx_41 = eax_10 + var_84
                        int32_t ebx_49
                        ...
                        int32_t eax_13
                        eax_13.b = edi[1]
                        edi[1] = eax_13.b + (*(((ebx_49 - eax_13) << 2) + edx_2)).b
                        int32_t ebx_58
                        ebx_58.b = *esi_1
                        int32_t eax_15
                        eax_15.b = not.b(ebx_58.b)
                        int32_t eax_16 = eax_15 + *(((ebx_58 - eax_15) << 2) + var_d0)
                        int32_t var_80
                        int32_t ebx_63 = eax_16 + var_80
                        int32_t ebx_71
                        ...
                        if (eax_16 + var_80 s< 0)
                            ...
                            ebx_66.b = *edi
                            ebx_71 =
                                *(((ebx_66 - 0xff) << 2) + *((ebx_63 << 2) + data_4ced578)) + 0xff
                        
                        int32_t eax_19
                        eax_19.b = *edi
                        *edi = eax_19.b + (*(((ebx_71 - eax_19) << 2) + edx_2)).b
