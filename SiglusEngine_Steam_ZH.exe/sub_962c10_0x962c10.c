        ...
        if (ebx_8 != 0)
            ...
            if (result != 0)
                ...
                if (ebx_18 != 0)
                    ...
                    eax_25.b = edi[2]
                    int32_t var_d0
                    edi[2] = eax_25.b + (*(((*(((eax_19 + *(((eax_18 - eax_19) << 2) + var_d0))
                        << 2) + *((eax_21 << 2) + &data_4e3da80)) - eax_25) << 2) + edx_2)).b
                    int32_t ebx_41
                    ebx_41.b = var_18[1]
                    int32_t eax_28 = edx_6 + *(((ebx_41 - edx_6) << 2) + eax_16)
                    int32_t eax_29
                    ...
                    int32_t eax_35
                    eax_35.b = edi[1]
                    edi[1] = eax_35.b + (*(((*(((eax_29 + *(((eax_28 - eax_29) << 2) + var_d0))
                        << 2) + *((eax_31 << 2) + &data_4e3da80)) - eax_35) << 2) + edx_2)).b
                    int32_t ebx_56
                    ebx_56.b = *var_18
                    int32_t eax_38 = edx_6 + *(((ebx_56 - edx_6) << 2) + eax_16)
                    int32_t eax_39
                    ...
                    int32_t eax_45
                    eax_45.b = *edi
                    result = eax_45 + *(((*(((eax_39 + *(((eax_38 - eax_39) << 2) + var_d0)) << 2)
                        + *((eax_41 << 2) + &data_4e3da80)) - eax_45) << 2) + edx_2)
                    *edi = result.b
