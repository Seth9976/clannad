                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        if (ecx_6 != 0)
                            ...
                            int32_t var_e0
                            int32_t var_d4
                            int32_t eax_19 = var_f8 + *(((var_e0 + *(((edx_10
                                + *(((ebx_24 - edx_10) << 2) + eax_13) - var_e0) << 2) + var_d4)
                                - var_f8) << 2) + var_ec)
                            int32_t ebx_37
                            ebx_37.b = var_124[1]
                            int32_t var_f4
                            int32_t var_e8
                            int32_t var_dc
                            int32_t eax_25 = var_f4 + *(((var_dc + *(((edx_10
                                + *(((ebx_37 - edx_10) << 2) + eax_13) - var_dc) << 2) + var_d4)
                                - var_f4) << 2) + var_e8)
                            int32_t ebx_50
                            ebx_50.b = *var_124
                            int32_t var_f0
                            int32_t var_e4
                            int32_t var_d8
                            int32_t eax_31 = var_f0 + *(((var_d8 + *(((edx_10
                                + *(((ebx_50 - edx_10) << 2) + eax_13) - var_d8) << 2) + var_d4)
                                - var_f0) << 2) + var_e4)
