            ...
            if (edi s>= var_50)
                ...
                if (ecx_7 != 0)
                    ...
                    int32_t eax_12 = var_f8
                        + *(((edx_9 + *(((ebx_6 - edx_9) << 2) + eax_8) - var_f8) << 2) + var_ec)
                    int32_t ebx_15
                    ebx_15.b = *(esi_1 + 1)
                    int32_t var_f4
                    int32_t var_e8
                    int32_t eax_16 = var_f4
                        + *(((edx_9 + *(((ebx_15 - edx_9) << 2) + eax_8) - var_f4) << 2) + var_e8)
                    int32_t ebx_24
                    ebx_24.b = *esi_1
                    int32_t var_f0
                    int32_t var_e4
                    int32_t eax_20 = var_f0
                        + *(((edx_9 + *(((ebx_24 - edx_9) << 2) + eax_8) - var_f0) << 2) + var_e4)
                    ...
                    if (var_114 != 0xff)
                        ...
                        if (ebx_38 != 0)
                            int32_t eax_24 = *((var_114 << 2) + &data_4d6e180)
                            *((eax_16 << 2) + eax_24)
                            *((eax_20 << 2) + eax_24)
                            int32_t eax_25
                            eax_25.b = edi[2]
                            edi[2] = (divu.dp.d(mulu.dp.d(eax_25, edx_5), ecx_7)).b
                            int32_t eax_30
                            eax_30.b = edi[1]
                            edi[1] = (divu.dp.d(mulu.dp.d(eax_30, edx_5), ecx_7)).b
                            int32_t eax_35
                            eax_35.b = *edi
                            *edi = (divu.dp.d(mulu.dp.d(eax_35, edx_5), ecx_7)).b
                            edi[3] = ecx_7.b
                        else
                            edi[2] = eax_12.b
                            edi[1] = eax_16.b
