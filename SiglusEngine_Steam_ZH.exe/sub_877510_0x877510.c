            ...
            if (edi s>= var_50)
                ...
                if (eax_2 != 0)
                    ...
                    if (ebx_10 != 0)
                        ...
                        int32_t eax_3
                        eax_3.b = edi[2]
                        int32_t eax_4 = eax_3 - *((neg.d(ebx_14 - 0xff) << 2) + edx_2)
                        ...
                        int32_t eax_5
                        eax_5.b = edi[1]
                        int32_t eax_6 = eax_5 - *((neg.d(ebx_20 - 0xff) << 2) + edx_2)
                        ...
                        int32_t eax_7
                        eax_7.b = *edi
                        int32_t eax_8 = eax_7 - *((neg.d(ebx_26 - 0xff) << 2) + edx_2)
