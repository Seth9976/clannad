            ...
            if (result != 0)
                ...
                if (result_2 != 0)
                    ...
                    if (ecx_6 != 0)
                        ...
                        int32_t var_e0
                        int32_t var_d4
                        int32_t eax_21 = var_e0 + *(((edx_10 + *(((ebx_23 - edx_10) << 2) + eax_17)
                            - var_e0) << 2) + var_d4)
                        int32_t ebx_32
                        ebx_32.b = var_18[1]
                        int32_t var_dc
                        int32_t eax_25 = var_dc + *(((edx_10 + *(((ebx_32 - edx_10) << 2) + eax_17)
                            - var_dc) << 2) + var_d4)
                        int32_t ebx_41
                        ebx_41.b = *var_18
                        int32_t var_d8
                        int32_t eax_29 = var_d8 + *(((edx_10 + *(((ebx_41 - edx_10) << 2) + eax_17)
                            - var_d8) << 2) + var_d4)
                        result = result_2
