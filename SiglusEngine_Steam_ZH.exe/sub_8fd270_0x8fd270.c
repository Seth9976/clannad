            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        eax_10.b = edi[2]
                        int32_t var_d0
                        edi[2] = eax_10.b + (*(((*(((eax_4 + *(((ebx_13 - eax_4) << 2) + var_d0))
                            << 2) + *((eax_6 << 2) + &data_4e3da80)) - eax_10) << 2) + edx_2)).b
                        int32_t ebx_24
                        ebx_24.b = var_3c[1]
                        int32_t eax_12
                        ...
                        int32_t eax_18
                        eax_18.b = edi[1]
                        edi[1] = eax_18.b + (*(((*(((eax_12 + *(((ebx_24 - eax_12) << 2) + var_d0))
                            << 2) + *((eax_14 << 2) + &data_4e3da80)) - eax_18) << 2) + edx_2)).b
                        int32_t ebx_35
                        ebx_35.b = *var_3c
                        int32_t eax_20
                        eax_20.b = not.b(ebx_35.b)
                        int32_t eax_22
                        eax_22.b = *edi
                        int32_t eax_26
                        eax_26.b = *edi
                        *edi = eax_26.b + (*(((*(((eax_20 + *(((ebx_35 - eax_20) << 2) + var_d0))
