            ...
            if (ebx_7 != 0)
                ...
                if (eax_4 != 0)
                    ...
                    if (ebx_18 != 0)
                        ...
                        int32_t var_ec
                        int32_t var_d0
                        edi[2] = eax_18.b + (*(((var_f8 + *(((eax_14
                            + *(((eax_13 - eax_14) << 2) + var_d0) - var_f8) << 2) + var_ec) - eax_18)
                            << 2) + edx_2)).b
                        int32_t ebx_42
                        ebx_42.b = var_124[1]
                        ...
                        int32_t var_f4
                        int32_t var_e8
                        edi[1] = eax_26.b + (*(((var_f4 + *(((eax_22
                            + *(((eax_21 - eax_22) << 2) + var_d0) - var_f4) << 2) + var_e8) - eax_26)
                            << 2) + edx_2)).b
                        int32_t ebx_58
                        ebx_58.b = *var_124
                        ...
                        int32_t var_f0
                        int32_t var_e4
                        *edi = eax_34.b + (*(((var_f0 + *(((eax_30
                            + *(((eax_29 - eax_30) << 2) + var_d0) - var_f0) << 2) + var_e4) - eax_34)
                            << 2) + edx_2)).b
