            ...
            if (edi s>= var_50)
                ...
                if (eax_3 != 0)
                    ...
                    if (ebx_9 != 0)
                        ...
                        int32_t eax_17
                        eax_17.b = edi[2]
                        edi[2] = eax_17.b + (*(((*(((edx_6 + *(((ebx_17 - edx_6) << 2) + eax_10))
                        ...
                        int32_t eax_25
                        eax_25.b = edi[1]
                        edi[1] = eax_25.b + (*(((*(((edx_6 + *(((ebx_28 - edx_6) << 2) + eax_10))
                        ...
                        int32_t eax_33
                        eax_33.b = *edi
                        *edi = eax_33.b + (*(((*(((edx_6 + *(((ebx_39 - edx_6) << 2) + eax_10))
                            << 2) + *((eax_29 << 2) + &data_4e3da80)) - eax_33) << 2) + edx_2)).b
